...
|----------|-----------------|-------------------|-------------|-------------------|-------------|------------|---------------------|
| **ARC-065** diversity stack (umbrella) | partial: MECH-313 + MECH-314 component readiness PASSed; integrated ablation not yet run | V3-EXQ-545 MECH-314 substrate readiness (non_contributory 2026-05-10) | pre-Rung 9: no integrated calibration run | No ablation/relative-weight test; MECH-314 readiness non_contributory (curiosity bias may not survive competitive scoring) | uncalibrated-weights (10) | 5-arm matched-entropy sweep: baseline / MECH-313 noise / MECH-314 curiosity / MECH-320 vigor / combined | sleep experiments, ARC-062 rule apprehension, SD-029 |
...
| **MECH-320** tonic vigor | landed: V3-EXQ-547 non_contributory (substrate readable; v_t not moving); V3-EXQ-549 non_contributory (discriminative pair) | V3-EXQ-549 ARC-066 discriminative pair (non_contributory 2026-05-11); v_t=0, gate_product=1.0 | **Rung 2**: internal signal zero even though gates open | v_raw / v_t stays zero; score-receipt may have sign error or floor issue; action_density 0.5/0.5 in both arms | gate-open-zero-signal (2) + possible mismatched-convention (8) | forced-vigor probe: v_raw=1.0 or tonic_vigor_floor > 0; then no-op class audit; score-receipt sign check | ARC-065, action selection, wanting/approach pipeline |
...
| **B** | ARC-065 / MECH-320 combined heartbeat: 5-arm matched-entropy test | pending |
