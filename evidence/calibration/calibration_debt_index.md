...
| **B** | ARC-065 / MECH-320 combined heartbeat: candidate support and bias-scale calibration | V3-EXQ-567 PASS 2026-05-15 (SP-CEM lifts candidate entropy: ARM_0 CEM=0.012, ARM_1 SP-CEM=0.497). V3-EXQ-569 FAIL 2026-05-16 (matched-entropy sweep): all 6 arms identical selected_action_entropy ~0.496; SP-CEM + MECH-313/314/320/260 produce ZERO behavioral entropy lift vs noise-floor control; P1/P2/P3 all False. V3-EXQ-570 PASS 2026-05-16 (E2 rollout diagnostic): E2 is not the bottleneck (rollout diversity ratio=52.1). V3-EXQ-571 PASS 2026-05-16 (E3 score variance decomp): F dominates (88-89% temporal variance); ALL bias_fractions = 0.0000; recommendation: 5-10x bias_scale on all diversity components. **Next: bias_scale 5-10x sweep experiment (all diversity components)** -- design and queue via /queue-experiment. |
| **C** | Goal-stream calibration ladder: forced -> naturalistic | V3-EXQ-562 Rung 1 FAIL (z_goal injection fires, goal component ~0.1% score variance, monostrategy persists); V3-EXQ-564 Rung 2 scripted + queued 2026-05-15 but did not run (queue cleared overnight 2026-05-16); V3-EXQ-566 Rung 3 same -- scripted + queued but did not run; both need re-queuing via /queue-experiment |
...
Rung 2: forced VALENCE_WANTING write -- V3-EXQ-564 scripted 2026-05-15; did not run (queue cleared overnight); needs re-queuing
Rung 3: forced schema_salience -- V3-EXQ-566 scripted 2026-05-15; did not run (queue cleared overnight); needs re-queuing
