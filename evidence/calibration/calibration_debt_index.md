...
|----------|-----------------|-------------------|-------------|-------------------|-------------|------------|---------------------|
| **ARC-065** diversity stack (umbrella) | partial: MECH-313 + MECH-314 component readiness PASSed; score-bias seam confirmed (EXQ-563a); support-preserving CEM path shows promise (EXQ-563b); stratified CEM + ao_std_floor + E3 score/bias diagnostics implemented 2026-05-15 (V3-EXQ-563c queued -- 7-arm wiring diagnostic) | V3-EXQ-563b candidate support repair (PASS 2026-05-14): P2 PASS (support-preserving CEM increases candidate diversity), P3 PASS (weak forced bias shifts selection on support-preserving path), P1 FAIL (scaffold+normal path insufficient); V3-EXQ-563c queued 2026-05-15 (stratified elites + ao_std_floor + normalize_score_bias_to_e3_range; 7 arms, dry-run P1-P6 all True) | **pre-Rung 7**: normal CEM collapses to 1 first-action class; support-preserving CEM increases support but P1 full path not yet cleared; natural selected_action_entropy still 0 | V3-EXQ-563: candidate_first_action_entropy=0.0 all arms. V3-EXQ-563a: min_candidate_unique_first_action_classes=5 under scaffold, score_bias seam proven. V3-EXQ-563b: support_preserving_cem_increases_support=True, weak_forced_bias_moves_selection=True under support-preserving path; P1 (scaffold+normal) still False. V3-EXQ-563c: stratified elite selection always fires + ao_std_floor prevents distribution collapse + normalize_score_bias_to_e3_range rescales bias to raw score range + last_score_diagnostics populated all arms | upstream CEM collapse (7) + uncalibrated score-bias magnitude (10) | next: V3-EXQ-567 PASS 2026-05-15 (SP-CEM entropy lift confirmed: ARM_0 CEM=0.012, ARM_1 SP-CEM=0.497; ARC-065 first support); V3-EXQ-569 queued 2026-05-15 (6-arm matched-entropy sweep: SP-CEM base x {MECH-313, MECH-314, MECH-320, MECH-260, matched-entropy noise-floor T=2.5}; structured diversity vs entropy-matched noise, priority 2 any machine ~90 min); do not claim agency solved until state coverage lift above entropy-matched noise is confirmed; V3-EXQ-571 diagnostic PASS 2026-05-16 (E3 score variance decomp): F (trajectory forward model) dominates temporal variance (ARM_0=0.886, ARM_1=0.894); ALL diversity bias components (MECH-313/314/320, dACC, lateral_pfc, ofc, gated_policy, mech295) contribute ~0 to temporal variance; bias_scale on all diversity components needs 5-10x increase to compete with F term; V3-EXQ-569 6-arm matched-entropy sweep is next structural validation | sleep experiments, ARC-062 rule apprehension, SD-029 |
...
| **B** | ARC-065 / MECH-320 combined heartbeat: candidate support and bias-scale calibration | V3-EXQ-563b PASS 2026-05-14: support-preserving CEM increases candidate diversity (P2 PASS); weak forced bias shifts selection on support-preserving path (P3 PASS); P1 (scaffold+normal full path) still FAIL; live path confirmed: support_and_weak_bias_move_selection. V3-EXQ-563c queued 2026-05-15: 7-arm wiring diagnostic (stratified_cem + ao_std_floor + normalize_score_bias_to_e3_range + last_score_diagnostics); dry-run P1-P6 all True. V3-EXQ-567 queued 2026-05-15: WPB natural entropy measurement -- SP-CEM + stratified_elites + ao_std_floor=0.2 vs normal CEM, no scaffold, no forced bias; 3 seeds x 40 ep; smoke PASS (P1/P2/P3 all True at dry-run scale). Next: run V3-EXQ-563c then V3-EXQ-567 full; on PASS -> ARC-065 matched-entropy sweep |
