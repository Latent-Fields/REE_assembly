...
**Date:** 2026-05-10. **Entries:** 10 papers (Graybiel 1998 + 2008, Yin & Knowlton 2006, Smith & Graybiel 2013, Wymbs 2012, Sakai 2003, Botvinick / Niv / Barto 2009, Sutton / Precup / Singh 1999, Albouy 2013, Thompson et al. 2026).
...
**2026-08-01 addendum:** Thompson, Rollik, Waked et al. 2026 adds direct rodent DLS procedural-replay evidence to R6. The source strengthens the biological premise behind MECH-322: DLS procedural replay occurs during offline consolidation, replay content predicts later procedural improvement, and replay features persist after large bilateral hippocampal lesions. This narrows the old Albouy caveat (human fMRI, hippocampal-striatal coupling, indirect chunk inference) by showing hippocampus-independent procedural replay in the striatal substrate itself. It does not require a new governance choice because MECH-322 already registered the narrow sleep-replay carve-out; it does require preserving a boundary condition: hippocampal replay should not be described as the universal orchestrator of all offline consolidation.
...
- **Thompson, Rollik, Waked et al. 2026 (PMID 42493550)** -- in mice, DLS neural sequences linked to a learned multistep procedural task replay during post-task sleep; replay content predicts later performance improvement; offline DLS activity/plasticity is required for consolidation; and replay features persist after large bilateral hippocampal lesions. This is the direct DLS procedural-replay source the Albouy entry named as the cleaner causal neighborhood, though the paper still stops short of selective DLS replay disruption.

The supporting context from the broader literature (Lansink 2009 hippocampal-VTA-ventral striatal replay coupling; van der Meer 2016 striatal replay; sleep-dependent motor consolidation more generally): sleep-replay-driven plasticity in the chunking circuit is well-documented. The newer Thompson result updates the framing: procedural replay can be generated in parallel within DLS, not necessarily as a hippocampal command broadcast. Replay content is still behaviorally/outcome shaped, but hippocampus-as-universal-source is the wrong architecture for procedural memory.
...
| Thompson, Rollik, Waked et al. 2026 | [10.1038/s41593-026-02362-5](https://doi.org/10.1038/s41593-026-02362-5) | R6 / MECH-322 procedural replay boundary | supports | 0.84 |

**Aggregate ARC-071 lit_conf:** expected to land in the **0.78-0.80 range**, supports-direction net (9 supports + 1 weakens; load-bearing supports cluster averaging roughly 0.80; the weakens-entry on Albouy 2013 (0.78 conf) applies specifically to the MECH-094 sub-assumption that biology gates replay-driven chunking -- it does NOT weaken the architectural commitment ARC-071 makes about chunk formation; it weakens the cleanness of the safety story). With Thompson 2026 added, the R6 finding is no longer merely "biology does replay-driven motor consolidation"; it is "procedural/DLS replay can persist independent of hippocampal orchestration." The R3 verdict (transition mechanism for MECH-163 confirmed) remains the strongest structural support; the R6 / MECH-322 verdict remains the most architecturally consequential safety finding.
