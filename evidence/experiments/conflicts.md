...
| `ARC-016` | directional, mixed_evidence | 9 | 10 | 0.947 | `v3_exq_038_arc016_precision_sweep_20260322T020909Z_v3` | 21 |
...
| `MECH-090` | directional, mixed_evidence | 5 | 3 | 0.75 | `v3_exq_062_mech104_surprise_gate_20260322T034449Z_v3` | 13 |
...
| `SD-005` | directional, mixed_evidence | 4 | 5 | 0.889 | `v3_exq_047c_sd005_info_probe_20260322T034515Z_v3` | 15 |
...
- Evidence breakdown: supports=3, weakens=3, conflict_ratio=1, overall_confidence=0.647
- Recent entries:
...
- Evidence breakdown: supports=9, weakens=10, conflict_ratio=0.947, overall_confidence=0.71
- Recent entries:
...
### ARC-018
- Conflict types: directional
- Evidence breakdown: supports=2, weakens=1, conflict_ratio=0.667, overall_confidence=0.695
- Recent entries:
...
### ARC-024
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=6, weakens=7, conflict_ratio=0.923, overall_confidence=0.542
- Recent entries:
...
### MECH-057b
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=2, weakens=1, conflict_ratio=0.667, overall_confidence=0.661
- Recent entries:
...
### MECH-071
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=11, weakens=9, conflict_ratio=0.9, overall_confidence=0.555
- Recent entries:
  - `2026-03-19T06:07:20Z` `experimental` `v3_exq_039_training_progression` direction=`mixed` confidence=0.5
...
### MECH-089
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=7, weakens=3, conflict_ratio=0.6, overall_confidence=0.691
- Recent entries:
  - `2026-03-19T09:05:29Z` `experimental` `claim_probe_sd_004` direction=`supports` confidence=0.75
  - `2026-03-19T09:05:29Z` `experimental` `v3_exq_042_hippocampal_terrain_training` direction=`supports` confidence=0.75
...
- Recent entries:
  - `2026-03-21T13:21:43.640349Z` `experimental` `v3_exq_060_arc016_beta_gate_fixed_threshold` direction=`supports` confidence=0.75
  - `2026-03-21T13:21:43.640926Z` `experimental` `v3_exq_060_arc016_beta_gate_fixed_threshold` direction=`supports` confidence=0.75
  - `2026-03-21T18:05:17Z` `experimental` `v3_exq_049e_mech090_two_condition` direction=`supports` confidence=0.75
  - `2026-03-21T19:14:19Z` `experimental` `v3_exq_061_mech104_volatility_jitter` direction=`supports` confidence=0.75
...
- Evidence breakdown: supports=1, weakens=4, conflict_ratio=0.4, overall_confidence=0.904
- Recent entries:
...
### MECH-098
- Conflict types: directional, source_disagreement, mixed_evidence
- Evidence breakdown: supports=6, weakens=8, conflict_ratio=0.857, overall_confidence=0.792
- Recent entries:
...
### MECH-102
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=3, weakens=9, conflict_ratio=0.5, overall_confidence=0.738
- Recent entries:
...
### SD-003
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=12, weakens=21, conflict_ratio=0.727, overall_confidence=0.631
- Recent entries:
...
### SD-005
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=4, weakens=5, conflict_ratio=0.889, overall_confidence=0.564
- Recent entries:
  ...
  - `2026-03-21T19:15:58Z` `experimental` `v3_exq_047b_sd005_sd010_joint` direction=`mixed` confidence=0.5
  - `2026-03-22T03:45:15Z` `experimental` `v3_exq_047c_sd005_info_probe` direction=`weakens` confidence=0.75
- Suggested resolution actions:
  - Run one targeted adjudication experiment with narrower stop criteria.
  - Add one replication run with seed sweep to reduce variance ambiguity.
  - If disagreement persists, split claim scope into separable subclaims.
...
### SD-007
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=7, weakens=7, conflict_ratio=1, overall_confidence=0.518
- Recent entries:
...
### SD-008
- Conflict types: directional
- Evidence breakdown: supports=1, weakens=3, conflict_ratio=0.5, overall_confidence=0.693
- Recent entries:
