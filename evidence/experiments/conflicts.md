...
|---|---|---|---|---|---|---|
| `ARC-003` | directional, source_disagreement | 4 | 4 | 1 | `2026-02-26_cowley_2023_compact_v4` | 8 |
| `ARC-007` | directional | 8 | 5 | 0.769 | `20260308T114644_path_memory_ablation_v2` | 13 |
| `ARC-016` | directional, source_disagreement, mixed_evidence | 3 | 1 | 0.5 | `20260308T123428_precision_regime_probe_v2` | 5 |
| `ARC-018` | directional | 6 | 5 | 0.909 | `20260315T125844_rollout_viability_mapping_v2` | 11 |
| `MECH-025` | directional, source_disagreement, mixed_evidence | 3 | 1 | 0.5 | `20260308T132031_action_doing_mode_probe_v2` | 5 |
| `MECH-033` | directional | 7 | 5 | 0.833 | `20260315T165927_kernel_chaining_interface_v2` | 12 |
...
| `MECH-056` | directional, source_disagreement, mixed_evidence | 26 | 90 | 0.448 | `20260314T220919_residue_trajectory_placement_v2` | 122 |
| `MECH-057` | directional | 6 | 7 | 0.923 | `20260315T094933_attribution_completion_gating_v2` | 13 |
| `MECH-058` | directional, mixed_evidence | 58 | 41 | 0.828 | `20260315T045933_e1_e2_terrain_timescale_v2` | 100 |
| `MECH-059` | directional, mixed_evidence | 43 | 11 | 0.407 | `20260314T202143_control_plane_precision_separation_v2` | 104 |
| `MECH-060` | directional, mixed_evidence | 61 | 40 | 0.792 | `20260314T235933_write_locus_contamination_v2` | 102 |
| `MECH-061` | directional | 7 | 4 | 0.727 | `20260315T024049_commitment_boundary_validation_v2` | 11 |
...
| `Q-007` | directional | 8 | 5 | 0.769 | `20260315T150155_valence_regime_correlation_v2` | 14 |
| `Q-012` | directional | 4 | 4 | 1 | `2026-02-15T213633Z_claim-probe-q-012_seed1002_trajectory_first_enabled_toyenv_internal_minimal` | 8 |
| `Q-013` | directional | 9 | 4 | 0.615 | `runtime_authority_commit_boundary_seed29_20260225T195039901451Z` | 13 |
| `Q-014` | directional | 9 | 4 | 0.615 | `runtime_authority_commit_boundary_seed29_20260225T195039901451Z` | 13 |
| `Q-015` | directional | 5 | 4 | 0.889 | `exp_0010_20260215T213710798125Z` | 9 |
| `Q-017` | directional, mixed_evidence | 59 | 40 | 0.808 | `runtime_authority_commit_boundary_seed29_20260225T195039901451Z` | 100 |

## Conflict Details

### ARC-003
- Conflict types: directional, source_disagreement
- Evidence breakdown: supports=4, weakens=4, conflict_ratio=1, overall_confidence=0.672
- Recent entries:
  ...
  - `2026-02-26T00:00:00Z` `literature` `visual_cortex_compact_models` direction=`supports` confidence=0.72
...
- Evidence breakdown: supports=8, weakens=5, conflict_ratio=0.769, overall_confidence=0.643
- Recent entries:
...
- Recent entries:
  - `2026-02-21T17:08:00Z` `literature` `targeted_review_connectome_arc_016` direction=`supports` confidence=0.82
  - `2026-02-21T17:09:00Z` `literature` `targeted_review_connectome_arc_016` direction=`supports` confidence=0.77
  - `2026-02-21T17:10:00Z` `literature` `targeted_review_connectome_arc_016` direction=`supports` confidence=0.74
  - `2026-02-21T17:11:00Z` `literature` `targeted_review_connectome_arc_016` direction=`mixed` confidence=0.73
  - `2026-03-08T12:34:28.042879+00:00` `experimental` `claim_probe_arc_016` direction=`weakens` confidence=0.75
- Recurring failure signatures:
  - `mode_discreteness_overreach` (1)
  - `v2_verdict_fail:precision_regime_probe` (1)
- Suggested resolution actions:
  - Run one targeted adjudication experiment with narrower stop criteria.
  - Add one replication run with seed sweep to reduce variance ambiguity.
  - If disagreement persists, split claim scope into separable subclaims.
...
### ARC-018
- Conflict types: directional
- Evidence breakdown: supports=6, weakens=5, conflict_ratio=0.909, overall_confidence=0.659
- Recent entries:
...
- Recent entries:
  - `2026-02-21T17:12:00Z` `literature` `targeted_review_connectome_mech_025` direction=`supports` confidence=0.81
  - `2026-02-21T17:13:00Z` `literature` `targeted_review_connectome_mech_025` direction=`supports` confidence=0.79
  - `2026-02-21T17:14:00Z` `literature` `targeted_review_connectome_mech_025` direction=`supports` confidence=0.72
  - `2026-02-21T17:15:00Z` `literature` `targeted_review_connectome_mech_025` direction=`mixed` confidence=0.76
  - `2026-03-08T13:20:31.377993+00:00` `experimental` `claim_probe_mech_025` direction=`weakens` confidence=0.75
- Recurring failure signatures:
  - `strict_dmn_suppression_overreach` (1)
  - `v2_verdict_fail:action_doing_mode_probe` (1)
- Suggested resolution actions:
  - Run one targeted adjudication experiment with narrower stop criteria.
  - Add one replication run with seed sweep to reduce variance ambiguity.
  - If disagreement persists, split claim scope into separable subclaims.
...
### MECH-033
- Conflict types: directional
- Evidence breakdown: supports=7, weakens=5, conflict_ratio=0.833, overall_confidence=0.678
- Recent entries:
...
### MECH-040
- Conflict types: directional
- Evidence breakdown: supports=5, weakens=4, conflict_ratio=0.889, overall_confidence=0.626
- Recent entries:
...
### MECH-046
- Conflict types: directional
- Evidence breakdown: supports=5, weakens=4, conflict_ratio=0.889, overall_confidence=0.616
- Recent entries:
...
### MECH-056
- Conflict types: directional, source_disagreement, mixed_evidence
- Evidence breakdown: supports=26, weakens=90, conflict_ratio=0.448, overall_confidence=0.791
- Recent entries:
  - `2026-02-25T17:14:57Z` `experimental` `trajectory_integrity` direction=`mixed` confidence=0.4
  - `2026-02-25T17:14:58Z` `experimental` `trajectory_integrity` direction=`weakens` confidence=0.75
  - `2026-02-25T19:50:39.888432Z` `experimental` `runtime_authority_commit_boundary` direction=`supports` confidence=0.75
  - `2026-02-25T19:50:39.901451Z` `experimental` `runtime_authority_commit_boundary` direction=`supports` confidence=0.75
  - `2026-03-14T22:09:19.450396+00:00` `experimental` `claim_probe_mech_056` direction=`supports` confidence=0.75
- Recurring failure signatures:
  - `ledger_editing` (90)
  - `domination_lock_in` (68)
  - `stop:ledger_edit_detected_count>0` (57)
  - `explanation_policy_divergence` (48)
  - `stop:domination_lock_in_events>0` (44)
- Suggested resolution actions:
  - Run one targeted adjudication experiment with narrower stop criteria.
  - Add one replication run with seed sweep to reduce variance ambiguity.
  - If disagreement persists, split claim scope into separable subclaims.
...
### MECH-057
- Conflict types: directional
- Evidence breakdown: supports=6, weakens=7, conflict_ratio=0.923, overall_confidence=0.727
- Recent entries:
  - `2026-02-15T21:37:02Z` `experimental` `claim_probe_mech_057` direction=`weakens` confidence=0.75
  - `2026-02-25T19:18:52.357612Z` `experimental` `claim_probe_mech_057` direction=`weakens` confidence=0.75
  - `2026-02-25T19:50:39.888432Z` `experimental` `runtime_authority_commit_boundary` direction=`supports` confidence=0.75
  - `2026-02-25T19:50:39.901451Z` `experimental` `runtime_authority_commit_boundary` direction=`supports` confidence=0.75
  - `2026-03-15T09:49:33.165765+00:00` `experimental` `claim_probe_mech_057` direction=`weakens` confidence=0.75
- Recurring failure signatures:
  - `ledger_editing` (4)
  - `domination_lock_in` (4)
  - `mech057:action_prediction_gap` (1)
  - `mech057:consequence_model_drift` (1)
  - `mech057:lineage_integrity_drop` (1)
- Suggested resolution actions:
  - Run one targeted adjudication experiment with narrower stop criteria.
  - Add one replication run with seed sweep to reduce variance ambiguity.
  - If disagreement persists, split claim scope into separable subclaims.
...
- Evidence breakdown: supports=58, weakens=41, conflict_ratio=0.828, overall_confidence=0.715
- Recent entries:
  ...
  - `2026-02-21T15:14:42Z` `experimental` `jepa_anchor_ablation` direction=`supports` confidence=0.75
  - `2026-03-15T04:59:33.847875+00:00` `experimental` `claim_probe_mech_058` direction=`weakens` confidence=0.75
- Recurring failure signatures:
...
### MECH-059
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=43, weakens=11, conflict_ratio=0.407, overall_confidence=0.771
- Recent entries:
  ...
  - `2026-03-14T20:21:43.211016+00:00` `experimental` `claim_probe_mech_059` direction=`supports` confidence=0.75
- Recurring failure signatures:
...
### MECH-060
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=61, weakens=40, conflict_ratio=0.792, overall_confidence=0.71
- Recent entries:
  - `2026-02-21T15:14:42Z` `experimental` `commit_dual_error_channels` direction=`supports` confidence=0.75
  - `2026-02-21T15:14:42Z` `experimental` `commit_dual_error_channels` direction=`supports` confidence=0.75
  - `2026-02-25T19:50:39.888432Z` `experimental` `runtime_authority_commit_boundary` direction=`supports` confidence=0.75
  - `2026-02-25T19:50:39.901451Z` `experimental` `runtime_authority_commit_boundary` direction=`supports` confidence=0.75
  - `2026-03-14T23:59:33.224038+00:00` `experimental` `claim_probe_mech_060` direction=`supports` confidence=0.75
- Recurring failure signatures:
...
### MECH-061
- Conflict types: directional
- Evidence breakdown: supports=7, weakens=4, conflict_ratio=0.727, overall_confidence=0.715
- Recent entries:
  ...
  - `2026-02-25T19:50:39.888432Z` `experimental` `runtime_authority_commit_boundary` direction=`supports` confidence=0.75
  - `2026-02-25T19:50:39.901451Z` `experimental` `runtime_authority_commit_boundary` direction=`supports` confidence=0.75
  - `2026-03-15T02:40:49.515478+00:00` `experimental` `claim_probe_mech_061` direction=`supports` confidence=0.75
- Recurring failure signatures:
  - `mech060:postcommit_channel_contamination` (4)
  - `mech060:attribution_reliability_break` (4)
  - `mech060:commitment_reversal_spike` (4)
...
### Q-001
- Conflict types: directional
- Evidence breakdown: supports=7, weakens=4, conflict_ratio=0.727, overall_confidence=0.552
- Recent entries:
...
### Q-007
- Conflict types: directional
- Evidence breakdown: supports=8, weakens=5, conflict_ratio=0.769, overall_confidence=0.583
- Recent entries:
  ...
  - `2026-03-15T15:01:55.006956+00:00` `experimental` `claim_probe_q_007` direction=`weakens` confidence=0.75
- Recurring failure signatures:
  - `ledger_editing` (4)
  - `domination_lock_in` (3)
...
### Q-012
- Conflict types: directional
- Evidence breakdown: supports=4, weakens=4, conflict_ratio=1, overall_confidence=0.625
- Recent entries:
...
### Q-013
- Conflict types: directional
- Evidence breakdown: supports=9, weakens=4, conflict_ratio=0.615, overall_confidence=0.656
- Recent entries:
...
### Q-015
- Conflict types: directional
- Evidence breakdown: supports=5, weakens=4, conflict_ratio=0.889, overall_confidence=0.605
- Recent entries:
...
### Q-017
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=59, weakens=40, conflict_ratio=0.808, overall_confidence=0.708
- Recent entries:
