...
| `ARC-016` | directional, mixed_evidence | 7 | 9 | 0.875 | `20260320T204910Z_v3_exq_059_arc016_beta_gate_fixed_threshold_v3` | 17 |
...
| `MECH-089` | directional, mixed_evidence | 6 | 3 | 0.667 | `v3_exq_052_sd006_multirate_validation_20260320T042636Z_v3` | 11 |
| `MECH-090` | directional, source_disagreement, mixed_evidence | 1 | 3 | 0.5 | `v3_exq_048b_mech057b_completion_gate_fixed_20260320T223120Z_v3` | 5 |
...
| `MECH-102` | directional, mixed_evidence | 2 | 9 | 0.364 | `v3_exq_059_sd010_mech102_advantage_20260320T193434Z_v3` | 18 |
...
- Evidence breakdown: supports=3, weakens=3, conflict_ratio=1, overall_confidence=0.651
- Recent entries:
...
- Evidence breakdown: supports=7, weakens=9, conflict_ratio=0.875, overall_confidence=0.728
- Recent entries:
...
### ARC-018
- Conflict types: directional
- Evidence breakdown: supports=2, weakens=1, conflict_ratio=0.667, overall_confidence=0.697
- Recent entries:
...
### ARC-024
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=6, weakens=7, conflict_ratio=0.923, overall_confidence=0.545
- Recent entries:
...
### MECH-071
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=11, weakens=9, conflict_ratio=0.9, overall_confidence=0.559
- Recent entries:
  - `2026-03-19T06:07:20Z` `experimental` `v3_exq_039_training_progression` direction=`mixed` confidence=0.5
...
### MECH-089
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=6, weakens=3, conflict_ratio=0.667, overall_confidence=0.663
- Recent entries:
  - `2026-03-19T07:55:21Z` `experimental` `v3_exq_041_full_pipeline_smoke_test` direction=`supports` confidence=0.75
  - `2026-03-19T09:05:29Z` `experimental` `claim_probe_sd_004` direction=`supports` confidence=0.75
  - `2026-03-19T09:05:29Z` `experimental` `v3_exq_042_hippocampal_terrain_training` direction=`supports` confidence=0.75
...
- Evidence breakdown: supports=1, weakens=3, conflict_ratio=0.5, overall_confidence=0.874
- Recent entries:
  ...
  - `2026-03-20T05:19:26Z` `experimental` `v3_exq_049_mech090_beta_gate` direction=`weakens` confidence=0.75
  - `2026-03-20T21:45:33.174086Z` `experimental` `v3_exq_059_arc016_beta_gate_fixed_threshold` direction=`weakens` confidence=0.75
...
- Evidence breakdown: supports=1, weakens=3, conflict_ratio=0.5, overall_confidence=0.831
- Recent entries:
...
### MECH-098
- Conflict types: directional, source_disagreement, mixed_evidence
- Evidence breakdown: supports=6, weakens=8, conflict_ratio=0.857, overall_confidence=0.794
- Recent entries:
...
### MECH-102
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=2, weakens=9, conflict_ratio=0.364, overall_confidence=0.801
- Recent entries:
...
### SD-003
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=12, weakens=21, conflict_ratio=0.727, overall_confidence=0.635
- Recent entries:
...
### SD-005
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=4, weakens=4, conflict_ratio=1, overall_confidence=0.513
- Recent entries:
...
### SD-007
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=6, weakens=7, conflict_ratio=0.923, overall_confidence=0.553
- Recent entries:
...
### SD-008
- Conflict types: directional
- Evidence breakdown: supports=1, weakens=3, conflict_ratio=0.5, overall_confidence=0.696
- Recent entries:
