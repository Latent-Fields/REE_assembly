...
- Evidence breakdown: supports=24, weakens=22, conflict_ratio=0.957, overall_confidence=0.676
- Recent entries:
  ...
  - `2026-02-15T09:51:20.253293Z` `experimental` `jepa_anchor_ablation` direction=`weakens` confidence=0.75
- Recurring failure signatures:
...
### MECH-059
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=24, weakens=19, conflict_ratio=0.884, overall_confidence=0.705
- Recent entries:
  ...
  - `2026-02-15T09:51:23.788473Z` `experimental` `jepa_uncertainty_channels` direction=`weakens` confidence=0.75
- Recurring failure signatures:
