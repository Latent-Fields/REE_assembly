...
- Evidence breakdown: supports=8, weakens=4, conflict_ratio=0.667, overall_confidence=0.672
- Recent entries:
...
### MECH-040
- Conflict types: directional
- Evidence breakdown: supports=5, weakens=4, conflict_ratio=0.889, overall_confidence=0.65
- Recent entries:
...
- Evidence breakdown: supports=25, weakens=90, conflict_ratio=0.435, overall_confidence=0.795
- Recent entries:
...
### MECH-057
- Conflict types: directional
- Evidence breakdown: supports=6, weakens=6, conflict_ratio=1, overall_confidence=0.717
- Recent entries:
...
- Evidence breakdown: supports=58, weakens=40, conflict_ratio=0.816, overall_confidence=0.719
- Recent entries:
...
### MECH-060
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=60, weakens=40, conflict_ratio=0.8, overall_confidence=0.712
- Recent entries:
...
### MECH-061
- Conflict types: directional
- Evidence breakdown: supports=6, weakens=4, conflict_ratio=0.8, overall_confidence=0.703
- Recent entries:
...
### Q-007
- Conflict types: directional
- Evidence breakdown: supports=8, weakens=4, conflict_ratio=0.667, overall_confidence=0.604
- Recent entries:
...
### Q-012
- Conflict types: directional
- Evidence breakdown: supports=4, weakens=4, conflict_ratio=1, overall_confidence=0.645
- Recent entries:
...
### Q-013
- Conflict types: directional
- Evidence breakdown: supports=9, weakens=4, conflict_ratio=0.615, overall_confidence=0.68
- Recent entries:
...
### Q-015
- Conflict types: directional
- Evidence breakdown: supports=5, weakens=4, conflict_ratio=0.889, overall_confidence=0.629
- Recent entries:
...
### Q-017
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=59, weakens=40, conflict_ratio=0.808, overall_confidence=0.729
- Recent entries:
