...
| `MECH-056` | directional, source_disagreement, mixed_evidence | 25 | 90 | 0.435 | `runtime_authority_commit_boundary_seed29_20260225T195039901451Z` | 121 |
| `MECH-057` | directional | 6 | 6 | 1 | `runtime_authority_commit_boundary_seed29_20260225T195039901451Z` | 12 |
...
| `MECH-061` | directional | 6 | 4 | 0.8 | `runtime_authority_commit_boundary_seed29_20260225T195039901451Z` | 10 |
...
- Evidence breakdown: supports=4, weakens=4, conflict_ratio=1, overall_confidence=0.684
- Recent entries:
...
- Evidence breakdown: supports=8, weakens=4, conflict_ratio=0.667, overall_confidence=0.66
- Recent entries:
...
### ARC-018
- Conflict types: directional
- Evidence breakdown: supports=6, weakens=4, conflict_ratio=0.8, overall_confidence=0.666
- Recent entries:
...
- Evidence breakdown: supports=25, weakens=90, conflict_ratio=0.435, overall_confidence=0.786
- Recent entries:
  - `2026-02-25T17:14:57Z` `experimental` `trajectory_integrity` direction=`weakens` confidence=0.75
...
### MECH-057
- Conflict types: directional
- Evidence breakdown: supports=6, weakens=6, conflict_ratio=1, overall_confidence=0.708
- Recent entries:
...
- Evidence breakdown: supports=58, weakens=40, conflict_ratio=0.816, overall_confidence=0.71
- Recent entries:
...
### MECH-059
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=42, weakens=11, conflict_ratio=0.415, overall_confidence=0.763
- Recent entries:
...
### MECH-060
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=60, weakens=40, conflict_ratio=0.8, overall_confidence=0.703
- Recent entries:
...
### MECH-061
- Conflict types: directional
- Evidence breakdown: supports=6, weakens=4, conflict_ratio=0.8, overall_confidence=0.693
- Recent entries:
...
### Q-001
- Conflict types: directional
- Evidence breakdown: supports=7, weakens=4, conflict_ratio=0.727, overall_confidence=0.568
- Recent entries:
...
### Q-007
- Conflict types: directional
- Evidence breakdown: supports=8, weakens=4, conflict_ratio=0.667, overall_confidence=0.592
- Recent entries:
...
### Q-012
- Conflict types: directional
- Evidence breakdown: supports=4, weakens=4, conflict_ratio=1, overall_confidence=0.636
- Recent entries:
...
### Q-013
- Conflict types: directional
- Evidence breakdown: supports=9, weakens=4, conflict_ratio=0.615, overall_confidence=0.67
- Recent entries:
...
### Q-015
- Conflict types: directional
- Evidence breakdown: supports=5, weakens=4, conflict_ratio=0.889, overall_confidence=0.619
- Recent entries:
...
### Q-017
- Conflict types: directional, mixed_evidence
- Evidence breakdown: supports=59, weakens=40, conflict_ratio=0.808, overall_confidence=0.721
- Recent entries:
