# V3-EXQ-187 -- MECH-153 Supervised Context-Labeling Validation
...
| harm_r2 (cue -> harm) | -0.0183 | > 0.3 | 0.23 |
...
C3 FAIL: harm_r2=-0.0183 <= 0.3 (passed 0/3 seeds). Cue context does NOT reliably encode harm information.

## Per-Seed Results

  seed=42: n_A=678 n_B=441 cos_sim=0.9999999403953552 w_harm_acc=0.3941 harm_r2=-0.0203 C1=FAIL C2=FAIL C3=FAIL
  seed=7: n_A=710 n_B=488 cos_sim=1.0 w_harm_acc=0.4073 harm_r2=-0.0229 C1=FAIL C2=FAIL C3=FAIL
  seed=11: n_A=694 n_B=493 cos_sim=0.9999999403953552 w_harm_acc=0.4153 harm_r2=-0.0117 C1=FAIL C2=FAIL C3=FAIL
