...
|---|---|
| Hippocampal (terrain-guided) | nan |
| Random | 0.394714 |
| Quality gap (random - hippo) | nan |
...
- C2 FAIL: hippo_quality_gap=nan <= 0 (hippo=nan  random=0.394714). Hippocampal proposals not terrain-informed.
