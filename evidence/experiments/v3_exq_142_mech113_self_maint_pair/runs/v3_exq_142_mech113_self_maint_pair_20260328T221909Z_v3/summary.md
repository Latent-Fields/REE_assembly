...
|-----------|----------------|------------|-------|----------|
| SELF_MAINT_ON      | 22.2928 | 22.2267 | 0.997x | 0.00001 |
| SELF_MAINT_ABLATED | 22.2928 | 22.2267 | 0.997x | 0.00001 |
...
|---|---|---|
| C1: ON ratio <= 1.5 (both seeds) | PASS | [1.0032, 0.99] |
| C2: ABLATED ratio >= 2.0 (both seeds) | FAIL | [1.0032, 0.99] |
| C3: gap >= 0.5x ABLATED_post (both seeds) | FAIL | [0.0, 0.0] |
| C4: e2_ON <= e2_ABL + 0.01 (both seeds) | PASS | ON=0.00001 ABL=0.00001 |
| C5: n_d_eff_min >= 50 | PASS | 59 |
...
SELF_MAINT_ON:
  seed=42: d_eff_baseline=23.7569 d_eff_post=23.8321 ratio=1.003x e2_loss=0.00000 n_samples=82
  seed=123: d_eff_baseline=20.8287 d_eff_post=20.6212 ratio=0.990x e2_loss=0.00001 n_samples=59
...
- C2 FAIL: ABLATED d_eff_ratio [1.0032, 0.99] < 2.0 -- ablated condition does not disperse; D_eff may be architecture-bounded independent of maintenance signal
