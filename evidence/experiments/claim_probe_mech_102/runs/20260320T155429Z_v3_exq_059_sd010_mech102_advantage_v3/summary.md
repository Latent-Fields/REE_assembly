...
|---|---|---|
| none (safe locomotion)    | 0.007828 | 24683 |
| hazard_approach (medium)  | 0.005600 | 398 |
| contact (high — combined) | 0.005532 | 24 |
...
|---|---|---|
| C1: advantage_sig_contact > advantage_sig_none | FAIL | 0.005532 vs 0.007828 |
| C2: advantage_sig_contact > 0.001 | PASS | 0.005532 |
| C3: world_forward_r2 > 0.05 | PASS | 0.9470 |
| C4: n_contact >= 50 | FAIL | 24 |

Criteria met: 2/4 → **FAIL**

## Failure Notes

- C1 FAIL: advantage_sig_contact=0.005532 <= advantage_sig_none=0.007828. Ethical z_harm policy not advantageous near hazards vs safe regions.
- C4 FAIL: n_contact=24 < 50
