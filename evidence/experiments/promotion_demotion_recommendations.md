...
| `Q-020` | `resolved` | Question narrowing review | `narrow_open_question` | `applied` |
...
| `SD-013` | `candidate` | Promotion review: candidate -> provisional | `promote_to_provisional` | `pending_user` |
| `SD-015` | `candidate` | Conflict resolution before promotion | `hold_candidate_resolve_conflict` | `applied` |
| `SD-022` | `candidate` | Promotion review: candidate -> provisional | `promote_to_provisional` | `pending_user` |
...
- Why this decision is needed: overall_conf=0.666, conflict_ratio=0.8, exp_entries=8, lit_entries=2; directions supports=3, weakens=2, mixed=1, unknown=0, conflict_ratio=0.8
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.729, conflict_ratio=0.75, exp_entries=18, lit_entries=9; directions supports=10, weakens=6, mixed=1, unknown=0, conflict_ratio=0.75
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.654, conflict_ratio=0.857, exp_entries=8, lit_entries=3; directions supports=3, weakens=4, mixed=0, unknown=0, conflict_ratio=0.857
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.793, conflict_ratio=0.533, exp_entries=25, lit_entries=7; directions supports=11, weakens=4, mixed=3, unknown=0, conflict_ratio=0.533
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.529, conflict_ratio=0.667, exp_entries=3, lit_entries=2; directions supports=2, weakens=1, mixed=1, unknown=0, conflict_ratio=0.667
- Recommendation: `hold_candidate_resolve_conflict`
- Options (pros/cons):
  - Keep candidate and run conflict-resolution experiments (most balanced)
  - Promote despite conflict (speed, high lock-in risk)
...
- Why this decision is needed: overall_conf=0.849, conflict_ratio=0, exp_entries=3, lit_entries=5; directions supports=6, weakens=0, mixed=1, unknown=1, conflict_ratio=0
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.512, conflict_ratio=0.5, exp_entries=4, lit_entries=1; directions supports=1, weakens=3, mixed=1, unknown=0, conflict_ratio=0.5
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.604, conflict_ratio=0.5, exp_entries=6, lit_entries=2; directions supports=1, weakens=3, mixed=3, unknown=0, conflict_ratio=0.5
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.744, conflict_ratio=0.833, exp_entries=10, lit_entries=4; directions supports=7, weakens=5, mixed=1, unknown=0, conflict_ratio=0.833
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.74, conflict_ratio=0.8, exp_entries=24, lit_entries=3; directions supports=8, weakens=12, mixed=7, unknown=0, conflict_ratio=0.8
- Recommendation: `hold_candidate_resolve_conflict`
- Options (pros/cons):
  - Keep candidate and run conflict-resolution experiments (most balanced)
  - Promote despite conflict (speed, high lock-in risk)
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.697, conflict_ratio=0.727, exp_entries=6, lit_entries=7; directions supports=7, weakens=4, mixed=2, unknown=0, conflict_ratio=0.727
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.542, conflict_ratio=0.667, exp_entries=3, lit_entries=2; directions supports=2, weakens=1, mixed=2, unknown=0, conflict_ratio=0.667
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.815, conflict_ratio=0.632, exp_entries=42, lit_entries=6; directions supports=13, weakens=6, mixed=7, unknown=0, conflict_ratio=0.632
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.68, conflict_ratio=0.8, exp_entries=7, lit_entries=6; directions supports=6, weakens=4, mixed=0, unknown=0, conflict_ratio=0.8
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.707, conflict_ratio=0.667, exp_entries=4, lit_entries=3; directions supports=4, weakens=2, mixed=1, unknown=0, conflict_ratio=0.667
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.668, conflict_ratio=0.444, exp_entries=4, lit_entries=7; directions supports=7, weakens=2, mixed=0, unknown=0, conflict_ratio=0.444
- Evidence quality note: >
- Recommendation: `hold_candidate_resolve_conflict`
- Options (pros/cons):
  - Keep candidate and run conflict-resolution experiments (most balanced)
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.57, conflict_ratio=0.667, exp_entries=2, lit_entries=2; directions supports=2, weakens=1, mixed=1, unknown=0, conflict_ratio=0.667
- Recommendation: `hold_candidate_resolve_conflict`
- Options (pros/cons):
  - Keep candidate and run conflict-resolution experiments (most balanced)
  - Promote despite conflict (speed, high lock-in risk)
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.6, conflict_ratio=0.5, exp_entries=3, lit_entries=3; directions supports=3, weakens=1, mixed=0, unknown=0, conflict_ratio=0.5
- Evidence quality note: >
- Recommendation: `hold_candidate_resolve_conflict`
- Options (pros/cons):
  - Keep candidate and run conflict-resolution experiments (most balanced)
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.612, conflict_ratio=0.8, exp_entries=2, lit_entries=3; directions supports=3, weakens=2, mixed=0, unknown=0, conflict_ratio=0.8
- Evidence quality note: >
- Recommendation: `hold_candidate_resolve_conflict`
- Options (pros/cons):
  - Keep candidate and run conflict-resolution experiments (most balanced)
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.592, conflict_ratio=0.5, exp_entries=3, lit_entries=3; directions supports=3, weakens=1, mixed=0, unknown=0, conflict_ratio=0.5
- Evidence quality note: >
- Recommendation: `hold_candidate_resolve_conflict`
- Options (pros/cons):
  - Keep candidate and run conflict-resolution experiments (most balanced)
...
- Why this decision is needed: overall_conf=0.892, conflict_ratio=0, exp_entries=0, lit_entries=10; directions supports=6, weakens=0, mixed=4, unknown=0, conflict_ratio=0
...
- Decision needed: Question narrowing review
- Why this decision is needed: overall_conf=0.603, conflict_ratio=0.286, exp_entries=3, lit_entries=6; directions supports=1, weakens=6, mixed=1, unknown=0, conflict_ratio=0.286
- Recommendation: `narrow_open_question`
- Options (pros/cons):
  - Narrow the question into testable sub-questions (higher tractability)
  - Keep broad question (flexibility, weaker experiment planning)
...
- Discussion scope with Codex:
  ...
  - If this decision is wrong, what downstream architecture risk is largest?
- Decision status: `applied`
- Last logged decision: `applied` by `user` at `2026-04-10T18:06:06.975132Z`
- Last selected option: Narrow the question into testable sub-questions (higher tractability)
- Last rationale: Q-020 already resolved via literature synthesis (Resolution A, 2026-04-02): ARC-007 and MECH-073 are co-true. Experimental FAILs (EXQ-266 x2, conditions identical) flagged for /diagnose-errors. The question is closed at the resolution level; experimental validation requires separate /diagnose-errors investigation.

### Q-021
- Current status: `open`
- Decision needed: Question narrowing review
- Why this decision is needed: overall_conf=0.687, conflict_ratio=0, exp_entries=2, lit_entries=3; directions supports=3, weakens=0, mixed=2, unknown=0, conflict_ratio=0
...
- Current status: `open`
- Decision needed: Question narrowing review
- Why this decision is needed: overall_conf=0.641, conflict_ratio=0, exp_entries=3, lit_entries=2; directions supports=2, weakens=0, mixed=3, unknown=0, conflict_ratio=0
...
- Current status: `open`
- Decision needed: Question narrowing review
- Why this decision is needed: overall_conf=0.832, conflict_ratio=0, exp_entries=0, lit_entries=4; directions supports=3, weakens=0, mixed=1, unknown=0, conflict_ratio=0
- Recommendation: `narrow_open_question`
- Options (pros/cons):
  - Narrow the question into testable sub-questions (higher tractability)
  - Keep broad question (flexibility, weaker experiment planning)
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.844, conflict_ratio=0.385, exp_entries=36, lit_entries=13; directions supports=21, weakens=5, mixed=3, unknown=0, conflict_ratio=0.385
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.728, conflict_ratio=1, exp_entries=22, lit_entries=5; directions supports=6, weakens=6, mixed=4, unknown=0, conflict_ratio=1
...
- Current status: `candidate`
- Decision needed: Promotion review: candidate -> provisional
- Why this decision is needed: overall_conf=0.787, conflict_ratio=0, exp_entries=2, lit_entries=0; directions supports=1, weakens=0, mixed=0, unknown=0, conflict_ratio=0
- Evidence quality note: >
- Recommendation: `promote_to_provisional`
- Options (pros/cons):
  - Promote now (faster convergence, risk premature lock-in)
...
- Last logged decision: `applied` by `user` at `2026-04-10T18:06:07.024550Z`
- Last selected option: Keep candidate and run conflict-resolution experiments (most balanced)
- Last rationale: Hold at candidate. New evidence this session: EXQ-320 PASS (dry) adds supports; EXQ-330 (dry) reclassified non_contributory. Conflict reduced from 1.0 to ~0.5 (2 supports/1 weakens). Full EXQ-330 run queued to provide definitive interventional vs observational gap evidence.

### SD-015
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.708, conflict_ratio=0.857, exp_entries=14, lit_entries=3; directions supports=4, weakens=3, mixed=1, unknown=0, conflict_ratio=0.857
...
- Decision status: `pending_user`
- Status note: Prior decision exists but recommendation changed; needs fresh review.
- Last logged decision: `applied` by `user` at `2026-04-10T18:06:07.070511Z`
- Last selected option: Keep candidate and run conflict-resolution experiments (most balanced)
- Last rationale: Hold at candidate. New evidence this session: EXQ-319 PASS (dissociation test, supports) brings score to 2 supports/1 opposing (EXQ-318 reclassified non_contributory as diagnostic). Conflict_ratio improved from 1.0 to ~0.5. SD-022 substrate confirmed working by EXQ-319. Hold pending additional replication.
