...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.586, conflict_ratio=1, exp_entries=5, lit_entries=2; directions supports=2, weakens=2, mixed=3, unknown=0, conflict_ratio=1
...
- Why this decision is needed: overall_conf=0.784, conflict_ratio=0, exp_entries=2, lit_entries=2; directions supports=3, weakens=0, mixed=1, unknown=0, conflict_ratio=0
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.542, conflict_ratio=1, exp_entries=1, lit_entries=1; directions supports=1, weakens=1, mixed=0, unknown=0, conflict_ratio=1
