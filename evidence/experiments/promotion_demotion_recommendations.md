...
- Why this decision is needed: overall_conf=0.564, conflict_ratio=0.4, exp_entries=5, lit_entries=1; directions supports=1, weakens=4, mixed=1, unknown=0, conflict_ratio=0.4
...
- Current status: `candidate`
- Decision needed: Conflict resolution before promotion
- Why this decision is needed: overall_conf=0.658, conflict_ratio=0.4, exp_entries=3, lit_entries=4; directions supports=4, weakens=1, mixed=2, unknown=0, conflict_ratio=0.4
- Recommendation: `hold_candidate_resolve_conflict`
- Options (pros/cons):
  - Keep candidate and run conflict-resolution experiments (most balanced)
  - Promote despite conflict (speed, high lock-in risk)
