...
|---|---|---|
| none (locomotion) | 0.0021 | 971 |
| env_caused_hazard | 0.0021 | 74 |
| agent_caused_hazard | 0.0020 | 53 |

- **calibration_gap** (agent - none): **-0.0001**
- **env_gap** (env - none): **-0.0001**
- harm_pred_std: 0.0003
...
|---|---|---|
| C1: calibration_gap > 0.05 (agent-caused > none) | FAIL | -0.0001 |
| C2: env_gap > 0.01 (env-caused > none) | FAIL | -0.0001 |
| C3: harm_pred_std > 0.01 (not collapsed) | FAIL | 0.0003 |
...
- C2 FAIL: env_gap=-0.0001 <= 0.01
- C3 FAIL: harm_pred_std=0.0003 <= 0.01 (collapsed)
