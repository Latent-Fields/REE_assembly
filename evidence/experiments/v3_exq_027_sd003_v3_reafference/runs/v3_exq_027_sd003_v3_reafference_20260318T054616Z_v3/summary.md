...
|---|---|---|
| none (locomotion) | 0.0008 | 906 |
| env_caused_hazard | 0.0008 | 80 |
| agent_caused_hazard | 0.0008 | 49 |

- **calibration_gap** (agent - none): **0.0000**  (PASS threshold: 0.15)
- env_gap (env - none): 0.0000
- harm_pred_std: 0.0001
...
|---|---|---|
| C1: calibration_gap > 0.15 (SD-003 threshold) | FAIL | 0.0000 |
| C2: reafference_r2 > 0.20 (SD-007 predictive) | FAIL | 0.0304 |
| C3: harm_pred_std > 0.01 (E3 not collapsed) | FAIL | 0.0001 |
...
- C1 FAIL: calibration_gap=0.0000 <= 0.15
- C2 FAIL: reafference_r2=0.0304 <= 0.20
- C3 FAIL: harm_pred_std=0.0001 <= 0.01 (collapsed)
