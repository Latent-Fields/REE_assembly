...
Generated: `2026-08-10T16:17:52.813218Z`
...
| `MECH-152` | mechanism_hypothesis | provisional | 0.689 | 0.000 | 0.689 | 0 | 2 | plausible_unproven |
...
| `MECH-057b` | - | - | 0.680 | 0.199 | 0.841 | 1 | 4 | plausible_unproven |
| `INV-088` | invariant | candidate | 0.679 | 0.260 | 0.819 | 1 | 6 | plausible_unproven |
...
| `MECH-329` | mechanism_hypothesis | candidate | 0.658 | 0.283 | 0.783 | 1 | 5 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.737 | 0.298 | 0.883 | 1 | 6 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.681 | 0.298 | 0.809 | 1 | 5 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.715 | 0.305 | 0.852 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.694 | 0.305 | 0.823 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.729 | 0.308 | 0.869 | 1 | 4 | plausible_unproven |
| `MECH-267` | mechanism_hypothesis | provisional | 0.727 | 0.308 | 0.867 | 1 | 5 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.741 | 0.308 | 0.886 | 1 | 6 | plausible_unproven |
| `MECH-428` | mechanism | candidate | 0.639 | 0.308 | 0.749 | 1 | 3 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.660 | 0.320 | 0.773 | 1 | 3 | plausible_unproven |
| `MECH-357` | mechanism_hypothesis | candidate | 0.655 | 0.321 | 0.766 | 1 | 3 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.631 | 0.333 | 0.829 | 2 | 22 | plausible_unproven |
| `MECH-314b` | - | - | 0.709 | 0.338 | 0.833 | 1 | 3 | plausible_unproven |
| `MECH-314c` | - | - | 0.737 | 0.338 | 0.870 | 1 | 6 | plausible_unproven |
| `MECH-321` | mechanism_hypothesis | candidate | 0.633 | 0.358 | 0.816 | 2 | 14 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.653 | 0.359 | 0.849 | 2 | 5 | plausible_unproven |
...
| `MECH-476` | mechanism_hypothesis | retired | 0.624 | 0.405 | 0.843 | 3 | 5 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.642 | 0.411 | 0.874 | 3 | 4 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.656 | 0.428 | 0.885 | 19 | 9 | plausible_unproven |
| `MECH-180` | mechanism_hypothesis | candidate | 0.769 | 0.460 | 0.872 | 1 | 4 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.674 | 0.461 | 0.887 | 3 | 11 | plausible_unproven |
| `ARC-032` | architecture_hypothesis | candidate | 0.655 | 0.472 | 0.839 | 4 | 8 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.659 | 0.482 | 0.836 | 5 | 8 | plausible_unproven |
...
| `MECH-025b` | - | - | 0.680 | 0.513 | 0.791 | 2 | 4 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.691 | 0.514 | 0.868 | 6 | 7 | plausible_unproven |
| `ARC-026` | architecture_hypothesis | provisional | 0.647 | 0.518 | 0.775 | 3 | 5 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.676 | 0.535 | 0.818 | 11 | 24 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.686 | 0.536 | 0.786 | 2 | 3 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.702 | 0.538 | 0.866 | 3 | 14 | plausible_unproven |
...
| `SD-014` | design_decision | candidate | 0.718 | 0.570 | 0.866 | 3 | 13 | plausible_unproven |
...
| `SD-048` | design_decision | candidate | 0.750 | 0.586 | 0.860 | 2 | 6 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.720 | 0.588 | 0.852 | 38 | 4 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.707 | 0.588 | 0.826 | 4 | 7 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.722 | 0.593 | 0.851 | 19 | 5 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.712 | 0.602 | 0.822 | 25 | 9 | plausible_unproven |
...
| `MECH-295` | candidate | 0.217 | 2 |
| `INV-054` | candidate | 0.225 | 3 |
| `SD-021` | candidate | 0.225 | 3 |
| `MECH-445` | candidate | 0.249 | 1 |
| `INV-088` | candidate | 0.260 | 1 |
