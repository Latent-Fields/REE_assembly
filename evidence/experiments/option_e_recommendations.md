...
Generated: `2026-06-16T04:18:31.286686Z`
...
| `MECH-165` | mechanism_hypothesis | candidate | 0.654 | 0.166 | 0.817 | 1 | 3 | plausible_unproven |
| `MECH-188` | mechanism_hypothesis | candidate | 0.640 | 0.170 | 0.797 | 1 | 3 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.693 | 0.195 | 0.859 | 1 | 4 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.694 | 0.195 | 0.860 | 1 | 4 | plausible_unproven |
| `SD-032c` | - | - | 0.642 | 0.200 | 0.789 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.682 | 0.201 | 0.842 | 1 | 6 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.629 | 0.220 | 0.902 | 2 | 11 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.679 | 0.231 | 0.828 | 1 | 10 | plausible_unproven |
| `MECH-047` | mechanism_hypothesis | provisional | 0.716 | 0.286 | 0.859 | 1 | 4 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.721 | 0.310 | 0.858 | 1 | 6 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.724 | 0.310 | 0.862 | 1 | 6 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.726 | 0.313 | 0.864 | 1 | 5 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.738 | 0.315 | 0.879 | 1 | 7 | plausible_unproven |
| `MECH-057b` | - | - | 0.723 | 0.323 | 0.857 | 1 | 4 | plausible_unproven |
| `MECH-295` | mechanism_hypothesis | candidate | 0.657 | 0.340 | 0.869 | 2 | 6 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.632 | 0.381 | 0.883 | 5 | 7 | plausible_unproven |
| `SD-032b` | - | - | 0.652 | 0.421 | 0.883 | 10 | 16 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate_substrate_landed | 0.734 | 0.431 | 0.835 | 1 | 3 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.636 | 0.435 | 0.838 | 24 | 9 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.777 | 0.450 | 0.886 | 1 | 5 | plausible_unproven |
| `MECH-314b` | - | - | 0.682 | 0.461 | 0.792 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.732 | 0.461 | 0.823 | 1 | 3 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.683 | 0.466 | 0.900 | 7 | 10 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.671 | 0.509 | 0.834 | 10 | 24 | plausible_unproven |
| `SD-016` | design_decision | implemented | 0.643 | 0.510 | 0.777 | 6 | 3 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.710 | 0.530 | 0.890 | 7 | 14 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.719 | 0.538 | 0.900 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.744 | 0.560 | 0.867 | 2 | 5 | plausible_unproven |
| `ARC-024` | architecture_hypothesis | provisional | 0.684 | 0.563 | 0.805 | 28 | 3 | plausible_unproven |
...
| `SD-003` | design_decision | superseded | 0.707 | 0.584 | 0.831 | 83 | 7 | plausible_unproven |
| `MECH-089` | mechanism_hypothesis | active | 0.730 | 0.593 | 0.867 | 12 | 10 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.701 | 0.595 | 0.807 | 9 | 13 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.730 | 0.606 | 0.854 | 5 | 5 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.732 | 0.610 | 0.853 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.707 | 0.613 | 0.801 | 26 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.700 | 0.614 | 0.786 | 5 | 6 | plausible_unproven |
| `SD-012` | design_decision | provisional | 0.738 | 0.615 | 0.861 | 5 | 25 | plausible_unproven |
| `MECH-187` | mechanism_hypothesis | candidate | 0.792 | 0.618 | 0.850 | 1 | 7 | plausible_unproven |
...
|---|---|---:|---:|---:|---:|
| `MECH-346` | candidate | 0.757 | 0.000 | 1 | 0 |
| `MECH-347` | candidate | 0.757 | 0.000 | 1 | 0 |
| `SD-057` | candidate | 0.757 | 0.000 | 1 | 0 |
| `onboarding` | - | 0.624 | 0.000 | 1 | 0 |
...
| `MECH-150` | candidate | 0.155 | 1 |
| `MECH-165` | candidate | 0.166 | 1 |
| `SD-018` | implemented | 0.168 | 1 |
| `MECH-188` | candidate | 0.170 | 1 |
| `MECH-220` | candidate | 0.195 | 1 |
| `SD-023` | candidate | 0.195 | 1 |
| `ARC-032` | candidate | 0.196 | 2 |
| `MECH-116` | candidate | 0.196 | 2 |
| `SD-032c` | - | 0.200 | 1 |
| `MECH-091` | candidate | 0.201 | 1 |
| `MECH-120` | candidate | 0.220 | 2 |
| `MECH-186` | candidate | 0.220 | 2 |
| `MECH-155` | candidate | 0.222 | 2 |
| `SD-047` | provisional | 0.231 | 1 |
| `MECH-128` | candidate | 0.255 | 3 |
| `MECH-047` | provisional | 0.286 | 1 |
| `INV-054` | candidate | 0.298 | 3 |
| `SD-021` | candidate | 0.300 | 3 |
| `MECH-026` | provisional | 0.310 | 1 |
| `MECH-029` | provisional | 0.310 | 1 |
| `MECH-022` | provisional | 0.313 | 1 |
| `MECH-025` | candidate | 0.315 | 1 |
| `MECH-057b` | - | 0.323 | 1 |
| `MECH-070` | retiring | 0.328 | 4 |
| `MECH-153` | candidate | 0.333 | 4 |
| `MECH-099` | candidate | 0.338 | 6 |
| `MECH-295` | candidate | 0.340 | 2 |
| `MECH-097` | candidate | 0.362 | 1 |
| `MECH-075` | candidate | 0.381 | 5 |
| ... | ... | ... | ... (14 more) |
