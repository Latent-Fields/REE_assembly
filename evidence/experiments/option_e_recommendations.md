...
Generated: `2026-07-30T19:42:46.555506Z`
...
Total: **258** discrepant claims (standard-gating only).
...
| `MECH-476` | mechanism_hypothesis | candidate | 0.846 | 0.000 | 0.846 | 0 | 5 | plausible_unproven |
...
| `SD-036` | design_decision | candidate | 0.805 | 0.000 | 0.805 | 0 | 2 | plausible_unproven |
...
| `SD-076` | design_decision | candidate | 0.724 | 0.000 | 0.724 | 0 | 4 | plausible_unproven |
| `SD-078` | design_decision | candidate_substrate_landed | 0.769 | 0.000 | 0.769 | 0 | 2 | plausible_unproven |
| `SD-080` | design_decision | candidate | 0.806 | 0.000 | 0.806 | 0 | 3 | plausible_unproven |
...
| `SD-047` | design_decision | provisional | 0.645 | 0.131 | 0.816 | 1 | 10 | plausible_unproven |
| `MECH-057b` | - | - | 0.689 | 0.223 | 0.844 | 1 | 4 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.685 | 0.285 | 0.819 | 1 | 4 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.666 | 0.307 | 0.786 | 1 | 5 | plausible_unproven |
| `INV-091` | invariant | candidate | 0.687 | 0.318 | 0.810 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.690 | 0.322 | 0.812 | 1 | 5 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.745 | 0.323 | 0.886 | 1 | 6 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.750 | 0.332 | 0.889 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.642 | 0.357 | 0.832 | 2 | 22 | plausible_unproven |
| `MECH-314b` | - | - | 0.640 | 0.362 | 0.779 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.745 | 0.362 | 0.873 | 1 | 6 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.642 | 0.396 | 0.888 | 7 | 10 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.675 | 0.406 | 0.855 | 2 | 5 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.663 | 0.438 | 0.888 | 19 | 9 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.632 | 0.468 | 0.795 | 9 | 13 | plausible_unproven |
| `MECH-324` | mechanism_hypothesis | candidate | 0.770 | 0.473 | 0.869 | 1 | 4 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.688 | 0.485 | 0.890 | 3 | 11 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.673 | 0.506 | 0.840 | 5 | 7 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.675 | 0.510 | 0.841 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.651 | 0.514 | 0.789 | 26 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.644 | 0.515 | 0.773 | 5 | 6 | plausible_unproven |
| `ARC-026` | architecture_hypothesis | provisional | 0.653 | 0.528 | 0.778 | 3 | 5 | plausible_unproven |
| `SD-012` | design_decision | provisional | 0.697 | 0.545 | 0.849 | 5 | 25 | plausible_unproven |
| `MECH-256` | mechanism_hypothesis | candidate | 0.700 | 0.553 | 0.847 | 6 | 9 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.690 | 0.559 | 0.821 | 11 | 24 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.697 | 0.560 | 0.789 | 2 | 3 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.716 | 0.562 | 0.869 | 3 | 14 | plausible_unproven |
...
| `SD-048` | design_decision | candidate | 0.792 | 0.581 | 0.863 | 1 | 6 | plausible_unproven |
...
| `MECH-153` | mechanism_hypothesis | candidate | 0.721 | 0.612 | 0.829 | 4 | 7 | plausible_unproven |
...
| `MECH-295` | candidate | 0.241 | 2 |
| `MECH-075` | candidate | 0.263 | 4 |
| `MECH-445` | candidate | 0.273 | 1 |
...
| `MECH-476` | candidate | 0.846 | 5 |
| `INV-048` | candidate | 0.845 | 4 |
| `INV-064` | candidate | 0.844 | 5 |
| ... | ... | ... | ... (155 more) |
