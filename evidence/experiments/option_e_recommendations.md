...
Generated: `2026-07-13T04:18:46.561254Z`
...
| **low lit**             | novel_discovery: **0**         | speculative: **7** |

Total scored claims: 481
...
| `ARC-060` | architecture_hypothesis | candidate | 0.863 | 0.000 | 0.863 | 0 | 13 | plausible_unproven |
| `ARC-078` | architecture_hypothesis | candidate | 0.861 | 0.000 | 0.861 | 0 | 11 | plausible_unproven |
| `ARC-090` | architecture_hypothesis | candidate | 0.744 | 0.000 | 0.744 | 0 | 2 | plausible_unproven |
| `CANDIDATE-autonomic-rebound-parasympathetic-recovery` | - | - | 0.842 | 0.000 | 0.842 | 0 | 4 | plausible_unproven |
...
| `INV-048` | derived_prediction | candidate | 0.849 | 0.000 | 0.849 | 0 | 4 | plausible_unproven |
| `INV-050` | invariant | candidate | 0.831 | 0.000 | 0.831 | 0 | 3 | plausible_unproven |
...
| `INV-082` | invariant | candidate | 0.815 | 0.000 | 0.815 | 0 | 4 | plausible_unproven |
...
| `MECH-044` | mechanism_hypothesis | provisional | 0.849 | 0.000 | 0.849 | 0 | 7 | plausible_unproven |
| `MECH-046` | mechanism_hypothesis | provisional | 0.867 | 0.000 | 0.867 | 0 | 4 | plausible_unproven |
| `MECH-048` | mechanism_hypothesis | provisional | 0.839 | 0.000 | 0.839 | 0 | 4 | plausible_unproven |
| `MECH-053` | mechanism_hypothesis | provisional | 0.739 | 0.000 | 0.739 | 0 | 2 | plausible_unproven |
...
| `MECH-068` | mechanism_hypothesis | candidate | 0.672 | 0.000 | 0.672 | 0 | 1 | plausible_unproven |
| `MECH-074` | mechanism_hypothesis | provisional | 0.871 | 0.000 | 0.871 | 0 | 9 | plausible_unproven |
| `MECH-074c` | - | - | 0.760 | 0.000 | 0.760 | 0 | 2 | plausible_unproven |
...
| `MECH-088` | mechanism_hypothesis | candidate | 0.788 | 0.000 | 0.788 | 0 | 3 | plausible_unproven |
...
| `MECH-103` | mechanism_hypothesis | candidate | 0.823 | 0.000 | 0.823 | 0 | 3 | plausible_unproven |
...
| `MECH-148` | mechanism_hypothesis | candidate | 0.774 | 0.000 | 0.774 | 0 | 2 | plausible_unproven |
...
| `MECH-172` | derived_prediction | candidate | 0.873 | 0.000 | 0.873 | 0 | 6 | plausible_unproven |
...
| `MECH-178` | mechanism_hypothesis | candidate | 0.781 | 0.000 | 0.781 | 0 | 3 | plausible_unproven |
| `MECH-179` | mechanism_hypothesis | candidate | 0.781 | 0.000 | 0.781 | 0 | 3 | plausible_unproven |
| `MECH-180` | mechanism_hypothesis | candidate | 0.879 | 0.000 | 0.879 | 0 | 4 | plausible_unproven |
...
| `MECH-203` | mechanism_hypothesis | candidate | 0.869 | 0.000 | 0.869 | 0 | 7 | plausible_unproven |
...
| `MECH-257` | mechanism_hypothesis | candidate | 0.753 | 0.000 | 0.753 | 0 | 2 | plausible_unproven |
| `MECH-263` | mechanism_hypothesis | candidate | 0.893 | 0.000 | 0.893 | 0 | 4 | plausible_unproven |
| `MECH-264` | mechanism_hypothesis | candidate | 0.874 | 0.000 | 0.874 | 0 | 6 | plausible_unproven |
| `MECH-265` | mechanism_hypothesis | candidate | 0.881 | 0.000 | 0.881 | 0 | 8 | plausible_unproven |
| `MECH-266` | mechanism_hypothesis | provisional | 0.832 | 0.000 | 0.832 | 0 | 6 | plausible_unproven |
| `MECH-267` | mechanism_hypothesis | provisional | 0.875 | 0.000 | 0.875 | 0 | 5 | plausible_unproven |
| `MECH-269` | mechanism_hypothesis | candidate | 0.856 | 0.000 | 0.856 | 0 | 34 | plausible_unproven |
...
| `MECH-286` | mechanism_hypothesis | candidate | 0.824 | 0.000 | 0.824 | 0 | 3 | plausible_unproven |
| `MECH-287` | mechanism_hypothesis | candidate | 0.845 | 0.000 | 0.845 | 0 | 7 | plausible_unproven |
...
| `MECH-292` | mechanism_hypothesis | candidate | 0.876 | 0.000 | 0.876 | 0 | 24 | plausible_unproven |
| `MECH-293` | mechanism_hypothesis | candidate | 0.875 | 0.000 | 0.875 | 0 | 12 | plausible_unproven |
...
| `MECH-337` | mechanism_hypothesis | candidate | 0.862 | 0.000 | 0.862 | 0 | 4 | plausible_unproven |
...
| `MECH-359` | mechanism_hypothesis | candidate | 0.754 | 0.000 | 0.754 | 0 | 2 | plausible_unproven |
...
| `MECH-391` | mechanism_hypothesis | candidate | 0.834 | 0.000 | 0.834 | 0 | 6 | plausible_unproven |
...
| `SD-014` | design_decision | candidate | 0.874 | 0.000 | 0.874 | 0 | 13 | plausible_unproven |
...
| `SD-033e` | - | - | 0.880 | 0.000 | 0.880 | 0 | 12 | plausible_unproven |
...
| `SD-039` | design_decision | candidate | 0.862 | 0.000 | 0.862 | 0 | 6 | plausible_unproven |
| `SD-040` | design_decision | candidate | 0.739 | 0.000 | 0.739 | 0 | 1 | plausible_unproven |
| `SD-042` | design_decision | candidate | 0.779 | 0.000 | 0.779 | 0 | 2 | plausible_unproven |
...
| `MECH-220` | mechanism_hypothesis | candidate | 0.673 | 0.135 | 0.852 | 1 | 4 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.673 | 0.135 | 0.853 | 1 | 4 | plausible_unproven |
| `SD-032c` | - | - | 0.622 | 0.140 | 0.782 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.661 | 0.141 | 0.834 | 1 | 6 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.658 | 0.171 | 0.821 | 1 | 10 | plausible_unproven |
| `MECH-057b` | - | - | 0.702 | 0.263 | 0.849 | 1 | 4 | plausible_unproven |
...
| `MECH-022` | mechanism_hypothesis | provisional | 0.712 | 0.280 | 0.856 | 1 | 5 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.724 | 0.280 | 0.872 | 1 | 7 | plausible_unproven |
| `MECH-295` | mechanism_hypothesis | candidate | 0.629 | 0.280 | 0.862 | 2 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.748 | 0.325 | 0.889 | 1 | 5 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.759 | 0.371 | 0.889 | 1 | 5 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.766 | 0.390 | 0.891 | 1 | 6 | plausible_unproven |
| `MECH-314b` | - | - | 0.656 | 0.401 | 0.784 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.759 | 0.401 | 0.878 | 1 | 6 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.650 | 0.406 | 0.893 | 7 | 10 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.620 | 0.411 | 0.830 | 24 | 9 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.686 | 0.478 | 0.893 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.716 | 0.500 | 0.860 | 2 | 5 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.701 | 0.518 | 0.883 | 7 | 14 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.709 | 0.524 | 0.895 | 3 | 11 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.674 | 0.524 | 0.823 | 83 | 7 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.668 | 0.535 | 0.800 | 9 | 13 | plausible_unproven |
| `ARC-024` | architecture_hypothesis | provisional | 0.669 | 0.540 | 0.798 | 28 | 3 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.696 | 0.546 | 0.846 | 5 | 5 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.698 | 0.550 | 0.846 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.674 | 0.553 | 0.794 | 26 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.666 | 0.554 | 0.778 | 5 | 6 | plausible_unproven |
| `SD-012` | design_decision | provisional | 0.705 | 0.555 | 0.854 | 5 | 25 | plausible_unproven |
| `ARC-026` | architecture_hypothesis | provisional | 0.674 | 0.567 | 0.782 | 3 | 5 | plausible_unproven |
...
| `MECH-060` | mechanism_hypothesis | provisional | 0.762 | 0.575 | 0.825 | 1 | 18 | plausible_unproven |
...
| `MECH-259` | mechanism_hypothesis | stable | 0.680 | 0.590 | 0.725 | 1 | 2 | plausible_unproven |
| `SD-032a` | - | - | 0.800 | 0.590 | 0.870 | 1 | 20 | plausible_unproven |
| `MECH-256` | mechanism_hypothesis | candidate | 0.723 | 0.593 | 0.852 | 6 | 9 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.729 | 0.598 | 0.860 | 38 | 4 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.712 | 0.598 | 0.826 | 11 | 24 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.731 | 0.603 | 0.859 | 19 | 5 | plausible_unproven |
| `MECH-262` | mechanism_hypothesis | candidate | 0.799 | 0.604 | 0.864 | 1 | 8 | plausible_unproven |
| `MECH-062` | mechanism_hypothesis | candidate | 0.710 | 0.610 | 0.760 | 1 | 2 | plausible_unproven |
| `SD-035` | design_decision | stable | 0.800 | 0.610 | 0.864 | 1 | 6 | plausible_unproven |
| `MECH-106` | mechanism_hypothesis | provisional | 0.755 | 0.613 | 0.849 | 2 | 5 | plausible_unproven |
| `MECH-119` | mechanism_hypothesis | stable | 0.713 | 0.615 | 0.779 | 2 | 3 | plausible_unproven |
| `SD-013` | design_decision | provisional | 0.732 | 0.615 | 0.849 | 4 | 4 | plausible_unproven |

_Suppressed by gating: 56 substrate_coherence (ARC + universal invariant), 54 answer_state (open_question). These cross the gate under one regime but not the other; the discrepancy is not actionable under their evidence rules. See suppressed sections below._
...
| `ARC-014` | architectural_commitment | active | 0.771 | 3 |
| `ARC-011` | architectural_commitment | active | 0.763 | 1 |
| `ARC-001` | architectural_commitment | active | 0.672 | 1 |
| `INV-014` | invariant | active | 0.672 | 1 |
...
| `Q-020` | open_question | resolved | 0.762 | 6 |
...
| `MECH-220` | candidate | 0.135 | 1 |
| `SD-023` | candidate | 0.135 | 1 |
| `SD-032c` | - | 0.140 | 1 |
| `MECH-091` | candidate | 0.141 | 1 |
| `MECH-155` | candidate | 0.162 | 2 |
| `SD-047` | provisional | 0.171 | 1 |
| `ARC-032` | candidate | 0.175 | 2 |
| `MECH-116` | candidate | 0.175 | 2 |
| `MECH-186` | candidate | 0.175 | 2 |
| `MECH-128` | candidate | 0.217 | 3 |
| `INV-054` | candidate | 0.238 | 3 |
| `SD-021` | candidate | 0.240 | 3 |
| `MECH-057b` | - | 0.263 | 1 |
| `MECH-070` | retiring | 0.268 | 4 |
| `MECH-153` | candidate | 0.273 | 4 |
...
| `MECH-295` | candidate | 0.280 | 2 |
| `MECH-097` | candidate | 0.302 | 1 |
| `MECH-445` | candidate | 0.312 | 1 |
| `MECH-099` | candidate | 0.317 | 6 |
| `MECH-075` | candidate | 0.321 | 5 |
| ... | ... | ... | ... (21 more) |
...
| `SD-033e` | - | 0.880 | 12 |
| `MECH-180` | candidate | 0.879 | 4 |
| `DEV-NEED-009` | - | 0.877 | 4 |
| `MECH-122` | provisional | 0.877 | 4 |
| `MECH-292` | candidate | 0.876 | 24 |
| `SD-032b` | - | 0.876 | 16 |
| `MECH-267` | provisional | 0.875 | 5 |
| `MECH-288` | candidate | 0.875 | 11 |
| `MECH-293` | candidate | 0.875 | 12 |
| `MECH-030` | provisional | 0.874 | 4 |
| `MECH-264` | candidate | 0.874 | 6 |
| `SD-014` | candidate | 0.874 | 13 |
| `MECH-172` | candidate | 0.873 | 6 |
...
| `MECH-203` | candidate | 0.869 | 7 |
| `MECH-046` | provisional | 0.867 | 4 |
| `MECH-316` | candidate | 0.867 | 9 |
| `MECH-303` | candidate | 0.864 | 5 |
| `SD-054` | candidate | 0.864 | 7 |
| `ARC-060` | candidate | 0.863 | 13 |
| `MECH-171` | candidate | 0.862 | 4 |
| `MECH-198` | candidate | 0.862 | 8 |
| `MECH-337` | candidate | 0.862 | 4 |
| `SD-039` | candidate | 0.862 | 6 |
...
| `MECH-281` | candidate | 0.857 | 4 |
| `MECH-434` | candidate | 0.857 | 4 |
| ... | ... | ... | ... (158 more) |
