...
Generated: `2026-05-04T21:33:43.299126Z`
...
| `MECH-303` | mechanism_hypothesis | candidate | 0.875 | 0.000 | 0.875 | 0 | 4 | plausible_unproven |
...
| `SD-049` | design_decision | candidate | 0.809 | 0.000 | 0.809 | 0 | 11 | plausible_unproven |
| `MECH-165` | mechanism_hypothesis | candidate | 0.687 | 0.260 | 0.829 | 1 | 3 | plausible_unproven |
| `MECH-188` | mechanism_hypothesis | candidate | 0.673 | 0.264 | 0.809 | 1 | 3 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.732 | 0.289 | 0.879 | 1 | 5 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.726 | 0.289 | 0.871 | 1 | 4 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.726 | 0.289 | 0.871 | 1 | 4 | plausible_unproven |
| `ARC-032` | architecture_hypothesis | candidate | 0.636 | 0.290 | 0.866 | 2 | 8 | plausible_unproven |
| `MECH-116` | mechanism_hypothesis | candidate | 0.640 | 0.290 | 0.874 | 2 | 7 | plausible_unproven |
| `SD-032c` | - | - | 0.674 | 0.294 | 0.801 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.714 | 0.295 | 0.853 | 1 | 6 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.664 | 0.314 | 0.898 | 2 | 7 | plausible_unproven |
| `MECH-155` | mechanism_hypothesis | candidate | 0.653 | 0.316 | 0.877 | 2 | 5 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.711 | 0.325 | 0.840 | 1 | 10 | plausible_unproven |
| `MECH-047` | mechanism_hypothesis | provisional | 0.748 | 0.380 | 0.871 | 1 | 4 | plausible_unproven |
| `SD-021` | design_decision | candidate | 0.644 | 0.394 | 0.895 | 3 | 8 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.753 | 0.404 | 0.870 | 1 | 6 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.756 | 0.404 | 0.874 | 1 | 6 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.758 | 0.406 | 0.875 | 1 | 5 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.755 | 0.409 | 0.871 | 1 | 5 | plausible_unproven |
| `MECH-302` | mechanism_hypothesis | candidate | 0.664 | 0.424 | 0.904 | 3 | 6 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.640 | 0.427 | 0.853 | 4 | 7 | plausible_unproven |
| `MECH-099` | mechanism_hypothesis | candidate | 0.667 | 0.432 | 0.901 | 6 | 7 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.656 | 0.451 | 0.861 | 4 | 9 | plausible_unproven |
| `SD-016` | design_decision | implemented | 0.625 | 0.462 | 0.788 | 4 | 3 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.678 | 0.475 | 0.881 | 5 | 6 | plausible_unproven |
| `MECH-113` | mechanism_hypothesis | candidate | 0.666 | 0.498 | 0.835 | 3 | 3 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.689 | 0.529 | 0.849 | 24 | 9 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.736 | 0.560 | 0.912 | 7 | 10 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.757 | 0.602 | 0.912 | 18 | 9 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.724 | 0.603 | 0.845 | 10 | 24 | plausible_unproven |
...
|---|---|---:|---:|
| `MECH-150` | candidate | 0.249 | 1 |
| `MECH-165` | candidate | 0.260 | 1 |
| `SD-018` | implemented | 0.262 | 1 |
| `MECH-188` | candidate | 0.264 | 1 |
| `MECH-111` | candidate | 0.281 | 2 |
| `MECH-118` | candidate | 0.281 | 2 |
| `MECH-216` | provisional | 0.289 | 1 |
| `MECH-220` | candidate | 0.289 | 1 |
| `SD-023` | candidate | 0.289 | 1 |
| `ARC-032` | candidate | 0.290 | 2 |
| `MECH-116` | candidate | 0.290 | 2 |
| `SD-032c` | - | 0.294 | 1 |
| `MECH-091` | candidate | 0.295 | 1 |
| `MECH-120` | candidate | 0.314 | 2 |
| `MECH-186` | candidate | 0.314 | 2 |
| `MECH-155` | candidate | 0.316 | 2 |
| `SD-047` | provisional | 0.325 | 1 |
| `MECH-128` | candidate | 0.349 | 3 |
| `MECH-047` | provisional | 0.380 | 1 |
| `INV-054` | candidate | 0.392 | 3 |
| `SD-021` | candidate | 0.394 | 3 |
| `MECH-026` | provisional | 0.404 | 1 |
| `MECH-029` | provisional | 0.404 | 1 |
| `MECH-022` | provisional | 0.406 | 1 |
| `MECH-025` | candidate | 0.409 | 1 |
| `MECH-070` | retiring | 0.422 | 4 |
| `MECH-302` | candidate | 0.424 | 3 |
| `MECH-153` | candidate | 0.427 | 4 |
| `MECH-099` | candidate | 0.432 | 6 |
| `SD-029` | candidate | 0.451 | 4 |
| ... | ... | ... | ... (6 more) |
