...
Generated: `2026-08-30T15:50:59.057491Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **84** | plausible_unproven: **477** |
| **low lit**             | novel_discovery: **3**         | speculative: **9** |

Total scored claims: 573
...
Total: **297** discrepant claims (standard-gating only).
...
| `MECH-260` | mechanism_hypothesis | candidate | 0.684 | 0.000 | 0.684 | 0 | 1 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.664 | 0.216 | 0.813 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.672 | 0.217 | 0.824 | 1 | 21 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.643 | 0.239 | 0.778 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.666 | 0.254 | 0.803 | 1 | 5 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.700 | 0.260 | 0.846 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.678 | 0.260 | 0.817 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.669 | 0.263 | 0.805 | 1 | 3 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.699 | 0.275 | 0.841 | 1 | 6 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.644 | 0.276 | 0.767 | 1 | 3 | plausible_unproven |
| `MECH-258` | mechanism_hypothesis | candidate | 0.708 | 0.280 | 0.850 | 1 | 9 | plausible_unproven |
| `MECH-439` | mechanism_hypothesis | candidate | 0.678 | 0.302 | 0.803 | 1 | 7 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.624 | 0.368 | 0.879 | 3 | 10 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.671 | 0.375 | 0.869 | 2 | 4 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.664 | 0.390 | 0.846 | 2 | 5 | plausible_unproven |
| `MECH-180` | mechanism_hypothesis | candidate | 0.792 | 0.416 | 0.917 | 1 | 7 | plausible_unproven |
| `MECH-025b` | - | - | 0.694 | 0.419 | 0.786 | 1 | 4 | plausible_unproven |
...
| `ARC-032` | architecture_hypothesis | candidate | 0.657 | 0.484 | 0.830 | 5 | 6 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.664 | 0.491 | 0.780 | 2 | 3 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.643 | 0.500 | 0.786 | 4 | 13 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.663 | 0.510 | 0.816 | 18 | 8 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.723 | 0.518 | 0.860 | 2 | 14 | plausible_unproven |
| `Q-034` | question | open | 0.645 | 0.525 | 0.765 | 3 | 6 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.694 | 0.526 | 0.861 | 3 | 13 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.701 | 0.532 | 0.869 | 23 | 4 | plausible_unproven |
| `MECH-150` | mechanism_hypothesis | candidate | 0.687 | 0.549 | 0.779 | 2 | 3 | plausible_unproven |
...
| `MECH-153` | mechanism_hypothesis | candidate | 0.693 | 0.567 | 0.820 | 3 | 7 | plausible_unproven |
...
| `MECH-072` | mechanism_hypothesis | candidate | 0.730 | 0.575 | 0.782 | 1 | 6 | plausible_unproven |
...
| `MECH-230` | mechanism_hypothesis | provisional | 0.750 | 0.577 | 0.807 | 1 | 11 | plausible_unproven |
| `MECH-306` | mechanism_hypothesis | provisional | 0.796 | 0.577 | 0.869 | 1 | 4 | plausible_unproven |
| `MECH-268` | mechanism_hypothesis | provisional | 0.760 | 0.580 | 0.820 | 1 | 8 | plausible_unproven |
| `MECH-314` | mechanism_hypothesis | candidate_substrate_landed | 0.799 | 0.589 | 0.869 | 1 | 10 | plausible_unproven |
| `MECH-314a` | - | - | 0.785 | 0.589 | 0.851 | 1 | 6 | plausible_unproven |
| `MECH-144` | mechanism_hypothesis | candidate | 0.719 | 0.590 | 0.805 | 2 | 4 | plausible_unproven |
| `MECH-346` | mechanism_hypothesis | candidate | 0.743 | 0.590 | 0.794 | 1 | 3 | plausible_unproven |
| `MECH-347` | mechanism_hypothesis | candidate | 0.747 | 0.590 | 0.799 | 1 | 3 | plausible_unproven |
| `MECH-440` | mechanism_hypothesis | candidate | 0.760 | 0.590 | 0.874 | 2 | 5 | plausible_unproven |
| `SD-057` | design_decision | candidate | 0.690 | 0.590 | 0.740 | 1 | 2 | plausible_unproven |
| `MECH-045` | mechanism_hypothesis | provisional | 0.778 | 0.593 | 0.840 | 1 | 14 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.720 | 0.594 | 0.845 | 18 | 5 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.704 | 0.597 | 0.810 | 82 | 7 | plausible_unproven |
| `MECH-087` | mechanism_hypothesis | candidate | 0.651 | 0.599 | 0.703 | 1 | 1 | plausible_unproven |
...
| `MECH-358` | mechanism_hypothesis | candidate | 0.736 | 0.610 | 0.778 | 1 | 3 | plausible_unproven |
| `SD-059` | design_decision | candidate | 0.781 | 0.610 | 0.838 | 1 | 4 | plausible_unproven |
...
| `MECH-120` | mechanism_hypothesis | candidate | 0.815 | 0.617 | 0.881 | 1 | 11 | plausible_unproven |
| `MECH-436` | mechanism_hypothesis | candidate | 0.726 | 0.618 | 0.780 | 1 | 2 | plausible_unproven |
| `MECH-094` | mechanism_hypothesis | stable | 0.755 | 0.619 | 0.845 | 2 | 26 | plausible_unproven |
...
|---|---|---:|---:|---:|---:|
| `MECH-219` | candidate | 0.773 | 0.000 | 1 | 0 |
| `SD-019b` | - | 0.773 | 0.000 | 1 | 0 |
| `MECH-290` | candidate | 0.772 | 0.000 | 1 | 0 |
...
| `MECH-445` | candidate | 0.205 | 1 |
| `INV-088` | candidate | 0.216 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `MECH-457` | candidate | 0.217 | 1 |
| `MECH-329` | candidate | 0.239 | 1 |
| `MECH-466` | candidate | 0.250 | 1 |
| `MECH-475` | retired | 0.254 | 1 |
| `MECH-294` | candidate | 0.260 | 1 |
| `SD-087` | candidate | 0.260 | 1 |
| `MECH-122` | provisional | 0.263 | 1 |
| `MECH-029` | provisional | 0.275 | 1 |
| `SD-009` | candidate | 0.276 | 1 |
...
| `MECH-463` | candidate | 0.282 | 2 |
| `MECH-152` | provisional | 0.284 | 1 |
| ... | ... | ... | ... (30 more) |
