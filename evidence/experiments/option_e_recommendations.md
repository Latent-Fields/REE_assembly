...
Generated: `2026-09-02T05:51:23.930734Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **79** | plausible_unproven: **484** |
| **low lit**             | novel_discovery: **4**         | speculative: **9** |

Total scored claims: 576
...
Total: **305** discrepant claims (standard-gating only).
...
| `INV-088` | invariant | candidate | 0.662 | 0.210 | 0.813 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.670 | 0.211 | 0.823 | 1 | 21 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.641 | 0.233 | 0.777 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.663 | 0.248 | 0.802 | 1 | 5 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.698 | 0.254 | 0.846 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.676 | 0.255 | 0.817 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.667 | 0.258 | 0.804 | 1 | 3 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.716 | 0.258 | 0.868 | 1 | 4 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.643 | 0.270 | 0.767 | 1 | 3 | plausible_unproven |
...
| `MECH-144` | mechanism_hypothesis | candidate | 0.683 | 0.317 | 0.805 | 1 | 4 | plausible_unproven |
...
| `MECH-180` | mechanism_hypothesis | candidate | 0.790 | 0.410 | 0.916 | 1 | 7 | plausible_unproven |
| `MECH-025b` | - | - | 0.692 | 0.413 | 0.785 | 1 | 4 | plausible_unproven |
| `SD-012` | design_decision | provisional | 0.630 | 0.419 | 0.840 | 4 | 25 | plausible_unproven |
...
| `ARC-032` | architecture_hypothesis | candidate | 0.654 | 0.478 | 0.830 | 5 | 6 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.662 | 0.485 | 0.780 | 2 | 3 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.659 | 0.504 | 0.815 | 18 | 8 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.646 | 0.505 | 0.786 | 5 | 13 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.721 | 0.513 | 0.859 | 2 | 14 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.690 | 0.520 | 0.860 | 3 | 13 | plausible_unproven |
...
| `MECH-150` | mechanism_hypothesis | candidate | 0.685 | 0.543 | 0.779 | 2 | 3 | plausible_unproven |
...
| `MECH-153` | mechanism_hypothesis | candidate | 0.691 | 0.561 | 0.820 | 3 | 7 | plausible_unproven |
| `MECH-230` | mechanism_hypothesis | provisional | 0.747 | 0.571 | 0.806 | 1 | 11 | plausible_unproven |
...
| `MECH-314` | mechanism_hypothesis | candidate_substrate_landed | 0.797 | 0.583 | 0.868 | 1 | 10 | plausible_unproven |
| `MECH-314a` | - | - | 0.783 | 0.583 | 0.850 | 1 | 6 | plausible_unproven |
| `MECH-346` | mechanism_hypothesis | candidate | 0.742 | 0.584 | 0.794 | 1 | 3 | plausible_unproven |
| `MECH-347` | mechanism_hypothesis | candidate | 0.745 | 0.584 | 0.799 | 1 | 3 | plausible_unproven |
| `MECH-440` | mechanism_hypothesis | candidate | 0.647 | 0.584 | 0.689 | 2 | 10 | plausible_unproven |
| `SD-057` | design_decision | candidate | 0.687 | 0.584 | 0.739 | 1 | 2 | plausible_unproven |
| `MECH-045` | mechanism_hypothesis | provisional | 0.776 | 0.587 | 0.839 | 1 | 14 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.700 | 0.592 | 0.809 | 82 | 7 | plausible_unproven |
| `MECH-087` | mechanism_hypothesis | candidate | 0.648 | 0.594 | 0.703 | 1 | 1 | plausible_unproven |
...
| `MECH-358` | mechanism_hypothesis | candidate | 0.735 | 0.604 | 0.778 | 1 | 3 | plausible_unproven |
| `SD-059` | design_decision | candidate | 0.779 | 0.604 | 0.838 | 1 | 4 | plausible_unproven |
...
| `MECH-120` | mechanism_hypothesis | candidate | 0.813 | 0.611 | 0.881 | 1 | 11 | plausible_unproven |
| `MECH-436` | mechanism_hypothesis | candidate | 0.723 | 0.612 | 0.779 | 1 | 2 | plausible_unproven |
...
| `MECH-285` | mechanism_hypothesis | candidate | 0.783 | 0.617 | 0.839 | 1 | 14 | plausible_unproven |
| `DEV-NEED-006` | - | - | 0.767 | 0.619 | 0.817 | 1 | 5 | plausible_unproven |
| `SD-079` | design_decision | provisional | 0.618 | 0.691 | 0.582 | 1 | 2 | confirmed_established |

_Suppressed by gating: 64 substrate_coherence (ARC + universal invariant), 69 answer_state (open_question). These cross the gate under one regime but not the other; the discrepancy is not actionable under their evidence rules. See suppressed sections below._
...
|---|---|---:|---:|---:|---:|
| `MECH-219` | candidate | 0.767 | 0.000 | 1 | 0 |
| `MECH-290` | candidate | 0.767 | 0.000 | 1 | 0 |
| `SD-019b` | - | 0.767 | 0.000 | 1 | 0 |
...
| `MECH-220` | candidate | 0.175 | 2 |
| `MECH-295` | candidate | 0.175 | 2 |
| `MECH-445` | candidate | 0.199 | 1 |
| `INV-088` | candidate | 0.210 | 1 |
| `MECH-457` | candidate | 0.211 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `MECH-329` | candidate | 0.233 | 1 |
| `MECH-466` | candidate | 0.244 | 1 |
| `MECH-475` | retired | 0.248 | 1 |
| `MECH-294` | candidate | 0.254 | 1 |
| `SD-087` | candidate | 0.255 | 1 |
| `MECH-122` | provisional | 0.258 | 1 |
| `MECH-166` | candidate | 0.258 | 1 |
| `SD-009` | candidate | 0.270 | 1 |
| `MECH-029` | provisional | 0.275 | 1 |
| `MECH-463` | candidate | 0.276 | 2 |
| `MECH-152` | provisional | 0.278 | 1 |
