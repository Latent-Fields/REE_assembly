...
Generated: `2026-05-03T02:58:48.709348Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **69** | plausible_unproven: **196** |
| **low lit**             | novel_discovery: **1**         | speculative: **3** |

Total scored claims: 269
...
Total: **129** discrepant claims (standard-gating only).
...
| `MECH-165` | mechanism_hypothesis | candidate | 0.688 | 0.264 | 0.829 | 1 | 3 | plausible_unproven |
| `MECH-188` | mechanism_hypothesis | candidate | 0.674 | 0.268 | 0.809 | 1 | 3 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.718 | 0.293 | 0.860 | 1 | 4 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.727 | 0.293 | 0.871 | 1 | 4 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.727 | 0.293 | 0.872 | 1 | 4 | plausible_unproven |
| `ARC-032` | architecture_hypothesis | candidate | 0.637 | 0.294 | 0.866 | 2 | 8 | plausible_unproven |
| `MECH-116` | mechanism_hypothesis | candidate | 0.643 | 0.294 | 0.875 | 2 | 7 | plausible_unproven |
| `SD-032c` | - | - | 0.675 | 0.298 | 0.801 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.715 | 0.299 | 0.854 | 1 | 6 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.666 | 0.318 | 0.898 | 2 | 7 | plausible_unproven |
| `MECH-155` | mechanism_hypothesis | candidate | 0.654 | 0.320 | 0.877 | 2 | 5 | plausible_unproven |
| `MECH-047` | mechanism_hypothesis | provisional | 0.749 | 0.384 | 0.871 | 1 | 4 | plausible_unproven |
| `SD-021` | design_decision | candidate | 0.646 | 0.398 | 0.895 | 3 | 8 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.754 | 0.408 | 0.870 | 1 | 6 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.757 | 0.408 | 0.874 | 1 | 6 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.760 | 0.410 | 0.876 | 1 | 5 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.757 | 0.413 | 0.872 | 1 | 5 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.642 | 0.431 | 0.853 | 4 | 7 | plausible_unproven |
| `MECH-099` | mechanism_hypothesis | candidate | 0.669 | 0.436 | 0.902 | 6 | 7 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.658 | 0.455 | 0.861 | 4 | 9 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.680 | 0.479 | 0.881 | 5 | 6 | plausible_unproven |
| `MECH-113` | mechanism_hypothesis | candidate | 0.669 | 0.502 | 0.836 | 3 | 3 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.713 | 0.526 | 0.900 | 9 | 7 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.692 | 0.533 | 0.850 | 24 | 9 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.735 | 0.564 | 0.906 | 7 | 9 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.762 | 0.606 | 0.918 | 18 | 7 | plausible_unproven |
...
|---|---|---:|---:|
| `MECH-150` | candidate | 0.253 | 1 |
| `MECH-165` | candidate | 0.264 | 1 |
| `SD-018` | implemented | 0.266 | 1 |
| `MECH-188` | candidate | 0.268 | 1 |
| `MECH-111` | candidate | 0.285 | 2 |
| `MECH-118` | candidate | 0.285 | 2 |
| `MECH-216` | provisional | 0.293 | 1 |
| `MECH-220` | candidate | 0.293 | 1 |
| `SD-023` | candidate | 0.293 | 1 |
| `ARC-032` | candidate | 0.294 | 2 |
| `MECH-116` | candidate | 0.294 | 2 |
| `SD-032c` | - | 0.298 | 1 |
| `MECH-091` | candidate | 0.299 | 1 |
| `MECH-120` | candidate | 0.318 | 2 |
| `MECH-186` | candidate | 0.318 | 2 |
| `MECH-155` | candidate | 0.320 | 2 |
| `MECH-128` | candidate | 0.353 | 3 |
| `MECH-047` | provisional | 0.384 | 1 |
| `INV-054` | candidate | 0.396 | 3 |
| `SD-021` | candidate | 0.398 | 3 |
| `MECH-026` | provisional | 0.408 | 1 |
| `MECH-029` | provisional | 0.408 | 1 |
| `MECH-022` | provisional | 0.410 | 1 |
| `MECH-025` | candidate | 0.413 | 1 |
| `SD-016` | implemented | 0.416 | 3 |
| `MECH-070` | retiring | 0.426 | 4 |
| `MECH-153` | candidate | 0.431 | 4 |
| `MECH-099` | candidate | 0.436 | 6 |
| `SD-029` | candidate | 0.455 | 4 |
| `MECH-097` | candidate | 0.460 | 1 |
| ... | ... | ... | ... (5 more) |
...
| `MECH-284` | candidate | 0.851 | 14 |
| `MECH-268` | provisional | 0.849 | 6 |
| ... | ... | ... | ... (53 more) |
