...
Generated: `2026-09-16T13:13:53.051808Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **82** | plausible_unproven: **561** |
| **low lit**             | novel_discovery: **10**         | speculative: **17** |

Total scored claims: 670
...
Total: **345** discrepant claims (standard-gating only).
...
| `MECH-016` | mechanism_hypothesis | candidate | 0.759 | 0.000 | 0.759 | 0 | 5 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.651 | 0.178 | 0.809 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.659 | 0.180 | 0.819 | 1 | 21 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.630 | 0.201 | 0.773 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.653 | 0.216 | 0.798 | 1 | 5 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.665 | 0.223 | 0.813 | 1 | 4 | plausible_unproven |
| `MECH-025b` | - | - | 0.642 | 0.226 | 0.781 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.707 | 0.226 | 0.867 | 1 | 4 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.723 | 0.226 | 0.889 | 1 | 5 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.632 | 0.238 | 0.763 | 1 | 3 | plausible_unproven |
...
| `MECH-144` | mechanism_hypothesis | candidate | 0.672 | 0.285 | 0.801 | 1 | 4 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.622 | 0.368 | 0.875 | 3 | 10 | plausible_unproven |
| `MECH-180` | mechanism_hypothesis | candidate | 0.779 | 0.378 | 0.912 | 1 | 7 | plausible_unproven |
...
| `ARC-032` | architecture_hypothesis | candidate | 0.636 | 0.446 | 0.826 | 5 | 6 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.647 | 0.454 | 0.776 | 2 | 3 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.644 | 0.463 | 0.826 | 5 | 8 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.642 | 0.472 | 0.811 | 18 | 8 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.705 | 0.481 | 0.855 | 2 | 14 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.672 | 0.488 | 0.856 | 3 | 13 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.641 | 0.500 | 0.782 | 4 | 13 | plausible_unproven |
| `MECH-150` | mechanism_hypothesis | candidate | 0.669 | 0.511 | 0.775 | 2 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.643 | 0.525 | 0.760 | 3 | 6 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.672 | 0.529 | 0.816 | 3 | 7 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.699 | 0.532 | 0.865 | 23 | 4 | plausible_unproven |
| `MECH-440` | mechanism_hypothesis | candidate | 0.632 | 0.552 | 0.685 | 2 | 10 | plausible_unproven |
...
| `SD-003` | design_decision | superseded | 0.680 | 0.555 | 0.805 | 81 | 7 | plausible_unproven |
...
| `MECH-120` | mechanism_hypothesis | candidate | 0.802 | 0.579 | 0.877 | 1 | 11 | plausible_unproven |
| `MECH-436` | mechanism_hypothesis | candidate | 0.710 | 0.580 | 0.775 | 1 | 2 | plausible_unproven |
| `MECH-285` | mechanism_hypothesis | candidate | 0.795 | 0.586 | 0.865 | 1 | 16 | plausible_unproven |
| `DEV-NEED-006` | - | - | 0.756 | 0.587 | 0.813 | 1 | 5 | plausible_unproven |
| `SD-034` | design_decision | provisional | 0.757 | 0.590 | 0.813 | 1 | 9 | plausible_unproven |
...
| `ARC-024` | architecture_hypothesis | provisional | 0.696 | 0.612 | 0.780 | 26 | 3 | plausible_unproven |
...
| `SD-079` | design_decision | provisional | 0.605 | 0.659 | 0.578 | 1 | 2 | confirmed_established |

_Suppressed by gating: 92 substrate_coherence (ARC + universal invariant), 69 answer_state (open_question). These cross the gate under one regime but not the other; the discrepancy is not actionable under their evidence rules. See suppressed sections below._
...
|---|---|---:|---:|---:|---:|
| `SD-074` | candidate | 0.773 | 0.000 | 1 | 0 |
| `SD-077` | candidate | 0.772 | 0.000 | 1 | 0 |
| `SD-075` | candidate | 0.771 | 0.000 | 1 | 0 |
| `MECH-349` | candidate | 0.764 | 0.000 | 1 | 0 |
| `MECH-464` | candidate | 0.762 | 0.000 | 1 | 0 |
| `EXT-001` | candidate | 0.745 | 0.000 | 1 | 0 |
| `MECH-219` | candidate | 0.736 | 0.000 | 1 | 0 |
| `SD-019b` | - | 0.736 | 0.000 | 1 | 0 |
| `MECH-290` | candidate | 0.735 | 0.000 | 1 | 0 |
...
| `MECH-445` | candidate | 0.167 | 1 |
| `MECH-111` | candidate | 0.175 | 2 |
| `MECH-116` | candidate | 0.175 | 2 |
| `MECH-295` | candidate | 0.175 | 2 |
| `INV-088` | candidate | 0.178 | 1 |
| `MECH-457` | candidate | 0.180 | 1 |
| `MECH-329` | candidate | 0.201 | 1 |
| `MECH-466` | candidate | 0.212 | 1 |
| `MECH-475` | retired | 0.216 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `SD-087` | candidate | 0.223 | 1 |
| `MECH-025b` | - | 0.226 | 1 |
| `MECH-122` | provisional | 0.226 | 1 |
| `MECH-166` | candidate | 0.226 | 1 |
| `SD-009` | candidate | 0.238 | 1 |
| `MECH-463` | candidate | 0.245 | 2 |
| `MECH-152` | provisional | 0.246 | 1 |
