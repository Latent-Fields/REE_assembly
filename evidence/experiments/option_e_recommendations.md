...
Generated: `2026-09-05T02:32:14.780253Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **82** | plausible_unproven: **503** |
| **low lit**             | novel_discovery: **5**         | speculative: **9** |

Total scored claims: 599
...
Total: **315** discrepant claims (standard-gating only).
...
| `DEV-NEED-007` | - | - | 0.690 | 0.000 | 0.690 | 0 | 1 | plausible_unproven |
...
| `DEV-NEED-029` | - | - | 0.710 | 0.000 | 0.710 | 0 | 1 | plausible_unproven |
...
| `MECH-529` | mechanism_hypothesis | candidate | 0.767 | 0.000 | 0.767 | 0 | 3 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.660 | 0.204 | 0.812 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.668 | 0.205 | 0.822 | 1 | 21 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.639 | 0.227 | 0.776 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.662 | 0.242 | 0.802 | 1 | 5 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.696 | 0.248 | 0.845 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.674 | 0.248 | 0.816 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.715 | 0.251 | 0.870 | 1 | 4 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.732 | 0.251 | 0.892 | 1 | 5 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.640 | 0.263 | 0.766 | 1 | 3 | plausible_unproven |
...
| `MECH-144` | mechanism_hypothesis | candidate | 0.681 | 0.311 | 0.804 | 1 | 4 | plausible_unproven |
...
| `MECH-180` | mechanism_hypothesis | candidate | 0.787 | 0.404 | 0.915 | 1 | 7 | plausible_unproven |
| `MECH-025b` | - | - | 0.690 | 0.407 | 0.784 | 1 | 4 | plausible_unproven |
...
| `ARC-032` | architecture_hypothesis | candidate | 0.650 | 0.471 | 0.829 | 5 | 6 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.659 | 0.479 | 0.779 | 2 | 3 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.656 | 0.498 | 0.814 | 18 | 8 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.642 | 0.500 | 0.785 | 4 | 13 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.718 | 0.506 | 0.859 | 2 | 14 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.686 | 0.513 | 0.860 | 3 | 13 | plausible_unproven |
...
| `MECH-150` | mechanism_hypothesis | candidate | 0.682 | 0.537 | 0.778 | 2 | 3 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.686 | 0.554 | 0.819 | 3 | 7 | plausible_unproven |
...
| `MECH-230` | mechanism_hypothesis | provisional | 0.746 | 0.565 | 0.806 | 1 | 11 | plausible_unproven |
...
| `MECH-314` | mechanism_hypothesis | candidate_substrate_landed | 0.794 | 0.577 | 0.867 | 1 | 10 | plausible_unproven |
| `MECH-314a` | - | - | 0.781 | 0.577 | 0.849 | 1 | 6 | plausible_unproven |
| `MECH-346` | mechanism_hypothesis | candidate | 0.739 | 0.578 | 0.793 | 1 | 3 | plausible_unproven |
| `MECH-347` | mechanism_hypothesis | candidate | 0.743 | 0.578 | 0.798 | 1 | 3 | plausible_unproven |
| `MECH-440` | mechanism_hypothesis | candidate | 0.644 | 0.578 | 0.688 | 2 | 10 | plausible_unproven |
| `SD-057` | design_decision | candidate | 0.685 | 0.578 | 0.738 | 1 | 2 | plausible_unproven |
| `MECH-045` | mechanism_hypothesis | provisional | 0.774 | 0.581 | 0.839 | 1 | 14 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.697 | 0.585 | 0.809 | 82 | 7 | plausible_unproven |
| `MECH-087` | mechanism_hypothesis | candidate | 0.644 | 0.587 | 0.702 | 1 | 1 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.719 | 0.594 | 0.844 | 18 | 5 | plausible_unproven |
| `MECH-358` | mechanism_hypothesis | candidate | 0.732 | 0.597 | 0.777 | 1 | 3 | plausible_unproven |
| `SD-059` | design_decision | candidate | 0.777 | 0.597 | 0.837 | 1 | 4 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.724 | 0.604 | 0.845 | 32 | 4 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.811 | 0.605 | 0.880 | 1 | 11 | plausible_unproven |
| `MECH-309` | mechanism_hypothesis | candidate | 0.756 | 0.605 | 0.857 | 2 | 14 | plausible_unproven |
| `MECH-436` | mechanism_hypothesis | candidate | 0.721 | 0.606 | 0.778 | 1 | 2 | plausible_unproven |
| `SD-013` | design_decision | provisional | 0.721 | 0.608 | 0.834 | 4 | 4 | plausible_unproven |
| `MECH-285` | mechanism_hypothesis | candidate | 0.804 | 0.611 | 0.868 | 1 | 16 | plausible_unproven |
| `DEV-NEED-006` | - | - | 0.765 | 0.612 | 0.816 | 1 | 5 | plausible_unproven |
...
| `SD-034` | design_decision | provisional | 0.766 | 0.615 | 0.816 | 1 | 9 | plausible_unproven |
| `SD-079` | design_decision | provisional | 0.616 | 0.684 | 0.582 | 1 | 2 | confirmed_established |
...
|---|---|---:|---:|---:|---:|
| `EXT-001` | candidate | 0.770 | 0.000 | 1 | 0 |
| `MECH-219` | candidate | 0.761 | 0.000 | 1 | 0 |
| `SD-019b` | - | 0.761 | 0.000 | 1 | 0 |
| `MECH-290` | candidate | 0.760 | 0.000 | 1 | 0 |
...
| `MECH-445` | candidate | 0.192 | 1 |
| `INV-088` | candidate | 0.204 | 1 |
| `MECH-457` | candidate | 0.205 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `MECH-329` | candidate | 0.227 | 1 |
| `MECH-466` | candidate | 0.238 | 1 |
| `MECH-475` | retired | 0.242 | 1 |
| `MECH-294` | candidate | 0.248 | 1 |
| `SD-087` | candidate | 0.248 | 1 |
| `MECH-122` | provisional | 0.251 | 1 |
| `MECH-166` | candidate | 0.251 | 1 |
| `SD-009` | candidate | 0.263 | 1 |
| `MECH-463` | candidate | 0.270 | 2 |
| `MECH-152` | provisional | 0.272 | 1 |
