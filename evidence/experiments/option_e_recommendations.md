...
Generated: `2026-09-08T07:15:29.325148Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **82** | plausible_unproven: **520** |
| **low lit**             | novel_discovery: **5**         | speculative: **10** |

Total scored claims: 617
...
Total: **321** discrepant claims (standard-gating only).
...
| `IMPL-026` | reference_note | candidate | 0.831 | 0.000 | 0.831 | 0 | 5 | plausible_unproven |
...
| `INV-040` | invariant | candidate | 0.677 | 0.000 | 0.677 | 0 | 4 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.658 | 0.197 | 0.811 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.665 | 0.198 | 0.821 | 1 | 21 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.636 | 0.220 | 0.775 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.659 | 0.235 | 0.801 | 1 | 5 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.693 | 0.241 | 0.844 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.671 | 0.241 | 0.815 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.713 | 0.244 | 0.869 | 1 | 4 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.729 | 0.244 | 0.891 | 1 | 5 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.638 | 0.256 | 0.765 | 1 | 3 | plausible_unproven |
...
| `MECH-144` | mechanism_hypothesis | candidate | 0.678 | 0.304 | 0.803 | 1 | 4 | plausible_unproven |
...
| `MECH-180` | mechanism_hypothesis | candidate | 0.786 | 0.397 | 0.915 | 1 | 7 | plausible_unproven |
| `MECH-025b` | - | - | 0.688 | 0.400 | 0.784 | 1 | 4 | plausible_unproven |
...
| `ARC-032` | architecture_hypothesis | candidate | 0.646 | 0.464 | 0.828 | 5 | 6 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.656 | 0.472 | 0.778 | 2 | 3 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.651 | 0.490 | 0.813 | 18 | 8 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.714 | 0.499 | 0.858 | 2 | 14 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.642 | 0.500 | 0.784 | 4 | 13 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.682 | 0.506 | 0.859 | 3 | 13 | plausible_unproven |
| `Q-034` | question | open | 0.644 | 0.525 | 0.763 | 3 | 6 | plausible_unproven |
| `MECH-150` | mechanism_hypothesis | candidate | 0.678 | 0.530 | 0.777 | 2 | 3 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.700 | 0.532 | 0.867 | 23 | 4 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.682 | 0.547 | 0.818 | 3 | 7 | plausible_unproven |
...
| `MECH-230` | mechanism_hypothesis | provisional | 0.743 | 0.558 | 0.805 | 1 | 11 | plausible_unproven |
| `MECH-440` | mechanism_hypothesis | candidate | 0.641 | 0.571 | 0.687 | 2 | 10 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.691 | 0.573 | 0.808 | 81 | 7 | plausible_unproven |
| `MECH-045` | mechanism_hypothesis | provisional | 0.772 | 0.575 | 0.838 | 1 | 14 | plausible_unproven |
...
| `MECH-087` | mechanism_hypothesis | candidate | 0.640 | 0.580 | 0.701 | 1 | 1 | plausible_unproven |
| `MECH-358` | mechanism_hypothesis | candidate | 0.730 | 0.590 | 0.776 | 1 | 3 | plausible_unproven |
| `SD-059` | design_decision | candidate | 0.774 | 0.590 | 0.836 | 1 | 4 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.719 | 0.594 | 0.843 | 18 | 5 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.809 | 0.598 | 0.879 | 1 | 11 | plausible_unproven |
| `MECH-436` | mechanism_hypothesis | candidate | 0.718 | 0.599 | 0.777 | 1 | 2 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.724 | 0.604 | 0.844 | 32 | 4 | plausible_unproven |
| `MECH-285` | mechanism_hypothesis | candidate | 0.801 | 0.604 | 0.867 | 1 | 16 | plausible_unproven |
| `DEV-NEED-006` | - | - | 0.762 | 0.605 | 0.815 | 1 | 5 | plausible_unproven |
...
| `SD-034` | design_decision | provisional | 0.763 | 0.608 | 0.815 | 1 | 9 | plausible_unproven |
...
| `SD-079` | design_decision | provisional | 0.613 | 0.677 | 0.581 | 1 | 2 | confirmed_established |

_Suppressed by gating: 80 substrate_coherence (ARC + universal invariant), 68 answer_state (open_question). These cross the gate under one regime but not the other; the discrepancy is not actionable under their evidence rules. See suppressed sections below._
...
|---|---|---:|---:|---:|---:|
| `EXT-001` | candidate | 0.763 | 0.000 | 1 | 0 |
| `MECH-219` | candidate | 0.754 | 0.000 | 1 | 0 |
| `SD-019b` | - | 0.754 | 0.000 | 1 | 0 |
| `MECH-290` | candidate | 0.753 | 0.000 | 1 | 0 |
...
| `MECH-445` | candidate | 0.185 | 1 |
| `INV-088` | candidate | 0.197 | 1 |
| `MECH-457` | candidate | 0.198 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `MECH-329` | candidate | 0.220 | 1 |
| `MECH-466` | candidate | 0.231 | 1 |
| `MECH-475` | retired | 0.235 | 1 |
| `MECH-294` | candidate | 0.241 | 1 |
| `SD-087` | candidate | 0.241 | 1 |
| `MECH-122` | provisional | 0.244 | 1 |
| `MECH-166` | candidate | 0.244 | 1 |
| `SD-009` | candidate | 0.256 | 1 |
| `MECH-463` | candidate | 0.263 | 2 |
| `MECH-152` | provisional | 0.265 | 1 |
