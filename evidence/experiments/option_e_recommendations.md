...
Generated: `2026-07-19T11:18:15.233195Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **75** | plausible_unproven: **408** |
| **low lit**             | novel_discovery: **0**         | speculative: **5** |

Total scored claims: 488
...
| `INV-047` | derived_prediction | candidate | 0.691 | 0.000 | 0.691 | 0 | 1 | plausible_unproven |
...
| `MECH-459` | mechanism_hypothesis | candidate | 0.802 | 0.000 | 0.802 | 0 | 3 | plausible_unproven |
...
| `MECH-091` | mechanism_hypothesis | candidate | 0.656 | 0.127 | 0.833 | 1 | 6 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.653 | 0.157 | 0.819 | 1 | 10 | plausible_unproven |
| `MECH-057b` | - | - | 0.698 | 0.249 | 0.847 | 1 | 4 | plausible_unproven |
| `MECH-295` | mechanism_hypothesis | candidate | 0.622 | 0.266 | 0.860 | 2 | 6 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.694 | 0.310 | 0.822 | 1 | 4 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.704 | 0.311 | 0.835 | 1 | 22 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.755 | 0.357 | 0.888 | 1 | 5 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.761 | 0.376 | 0.889 | 1 | 6 | plausible_unproven |
| `MECH-314b` | - | - | 0.651 | 0.387 | 0.783 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.754 | 0.387 | 0.876 | 1 | 6 | plausible_unproven |
...
| `MECH-098` | mechanism_hypothesis | candidate | 0.678 | 0.464 | 0.891 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.709 | 0.486 | 0.858 | 2 | 5 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.702 | 0.510 | 0.893 | 3 | 11 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.666 | 0.510 | 0.822 | 83 | 7 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.700 | 0.518 | 0.881 | 7 | 14 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.660 | 0.521 | 0.798 | 9 | 13 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.688 | 0.532 | 0.843 | 5 | 7 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.690 | 0.536 | 0.844 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.666 | 0.539 | 0.792 | 26 | 3 | plausible_unproven |
| `ARC-024` | architecture_hypothesis | provisional | 0.668 | 0.540 | 0.796 | 28 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.658 | 0.540 | 0.777 | 5 | 6 | plausible_unproven |
| `SD-012` | design_decision | provisional | 0.699 | 0.545 | 0.852 | 5 | 25 | plausible_unproven |
| `ARC-026` | architecture_hypothesis | provisional | 0.667 | 0.553 | 0.781 | 3 | 5 | plausible_unproven |
...
| `MECH-259` | mechanism_hypothesis | stable | 0.674 | 0.576 | 0.723 | 1 | 2 | plausible_unproven |
| `SD-032a` | - | - | 0.795 | 0.576 | 0.868 | 1 | 20 | plausible_unproven |
| `MECH-256` | mechanism_hypothesis | candidate | 0.715 | 0.579 | 0.850 | 6 | 9 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.704 | 0.584 | 0.824 | 11 | 24 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.709 | 0.585 | 0.792 | 2 | 3 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.723 | 0.588 | 0.858 | 38 | 4 | plausible_unproven |
| `MECH-262` | mechanism_hypothesis | candidate | 0.794 | 0.590 | 0.862 | 1 | 8 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.725 | 0.593 | 0.857 | 19 | 5 | plausible_unproven |
| `MECH-062` | mechanism_hypothesis | candidate | 0.704 | 0.596 | 0.758 | 1 | 2 | plausible_unproven |
| `SD-035` | design_decision | stable | 0.796 | 0.596 | 0.863 | 1 | 6 | plausible_unproven |
| `SD-048` | design_decision | candidate | 0.801 | 0.606 | 0.866 | 1 | 6 | plausible_unproven |
...
| `SD-032c` | - | 0.126 | 1 |
| `MECH-091` | candidate | 0.127 | 1 |
| `MECH-155` | candidate | 0.153 | 2 |
| `SD-047` | provisional | 0.157 | 1 |
...
| `MECH-097` | candidate | 0.288 | 1 |
| `MECH-445` | candidate | 0.298 | 1 |
| `INV-088` | candidate | 0.310 | 1 |
| `MECH-111` | candidate | 0.310 | 4 |
| ... | ... | ... | ... (26 more) |
