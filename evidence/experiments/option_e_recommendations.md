...
Generated: `2026-07-26T15:39:10.148745Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **81** | plausible_unproven: **412** |
| **low lit**             | novel_discovery: **1**         | speculative: **9** |

Total scored claims: 503
...
| `MECH-321` | mechanism_hypothesis | candidate | 0.695 | 0.000 | 0.695 | 0 | 2 | plausible_unproven |
| `MECH-323` | mechanism_hypothesis | candidate | 0.782 | 0.000 | 0.782 | 0 | 2 | plausible_unproven |
...
| `SD-047` | design_decision | provisional | 0.648 | 0.141 | 0.817 | 1 | 10 | plausible_unproven |
| `MECH-057b` | - | - | 0.692 | 0.233 | 0.845 | 1 | 4 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.689 | 0.294 | 0.820 | 1 | 4 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.670 | 0.317 | 0.787 | 1 | 5 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.754 | 0.341 | 0.891 | 1 | 6 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.755 | 0.360 | 0.887 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.646 | 0.366 | 0.833 | 2 | 22 | plausible_unproven |
| `MECH-314b` | - | - | 0.644 | 0.371 | 0.781 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.749 | 0.371 | 0.875 | 1 | 6 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.642 | 0.396 | 0.889 | 7 | 10 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.668 | 0.448 | 0.889 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.702 | 0.470 | 0.856 | 2 | 5 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.657 | 0.494 | 0.820 | 83 | 7 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.693 | 0.495 | 0.891 | 3 | 11 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.650 | 0.505 | 0.796 | 9 | 13 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.678 | 0.516 | 0.841 | 5 | 7 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.681 | 0.520 | 0.842 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.656 | 0.523 | 0.790 | 26 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.650 | 0.524 | 0.775 | 5 | 6 | plausible_unproven |
| `ARC-026` | architecture_hypothesis | provisional | 0.658 | 0.537 | 0.779 | 3 | 5 | plausible_unproven |
...
| `MECH-256` | mechanism_hypothesis | candidate | 0.705 | 0.563 | 0.848 | 6 | 9 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.696 | 0.568 | 0.823 | 11 | 24 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.702 | 0.569 | 0.790 | 2 | 3 | plausible_unproven |
| `MECH-089` | mechanism_hypothesis | active | 0.713 | 0.569 | 0.856 | 12 | 10 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.736 | 0.571 | 0.902 | 3 | 13 | plausible_unproven |
...
| `MECH-245` | mechanism_hypothesis | candidate | 0.646 | 0.575 | 0.752 | 3 | 2 | plausible_unproven |
| `MECH-259` | mechanism_hypothesis | stable | 0.672 | 0.575 | 0.721 | 1 | 2 | plausible_unproven |
| `MECH-262` | mechanism_hypothesis | candidate | 0.789 | 0.575 | 0.860 | 1 | 8 | plausible_unproven |
| `SD-003-prereq` | - | - | 0.736 | 0.575 | 0.789 | 1 | 3 | plausible_unproven |
| `SD-032a` | - | - | 0.793 | 0.575 | 0.866 | 1 | 20 | plausible_unproven |
| `MECH-062` | mechanism_hypothesis | candidate | 0.697 | 0.580 | 0.756 | 1 | 2 | plausible_unproven |
| `SD-035` | design_decision | stable | 0.791 | 0.580 | 0.861 | 1 | 6 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.722 | 0.588 | 0.856 | 38 | 4 | plausible_unproven |
| `SD-048` | design_decision | candidate | 0.795 | 0.590 | 0.864 | 1 | 6 | plausible_unproven |
...
|---|---|---:|---:|---:|---:|
| `SD-079` | provisional | 0.774 | 0.000 | 1 | 0 |
...
| `MECH-445` | candidate | 0.282 | 1 |
| `INV-088` | candidate | 0.294 | 1 |
| `MECH-111` | candidate | 0.294 | 4 |
| ... | ... | ... | ... (28 more) |
