...
Generated: `2026-05-13T04:18:20.176446Z`
...
| `MECH-118` | mechanism_hypothesis | candidate | 0.663 | 0.224 | 0.809 | 1 | 3 | plausible_unproven |
| `MECH-165` | mechanism_hypothesis | candidate | 0.680 | 0.241 | 0.826 | 1 | 3 | plausible_unproven |
| `MECH-188` | mechanism_hypothesis | candidate | 0.667 | 0.246 | 0.807 | 1 | 3 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.719 | 0.270 | 0.869 | 1 | 4 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.719 | 0.271 | 0.868 | 1 | 4 | plausible_unproven |
| `ARC-032` | architecture_hypothesis | candidate | 0.627 | 0.272 | 0.863 | 2 | 8 | plausible_unproven |
| `MECH-116` | mechanism_hypothesis | candidate | 0.632 | 0.272 | 0.872 | 2 | 7 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.707 | 0.276 | 0.851 | 1 | 6 | plausible_unproven |
| `SD-032c` | - | - | 0.667 | 0.276 | 0.798 | 1 | 3 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.656 | 0.295 | 0.896 | 2 | 7 | plausible_unproven |
| `MECH-155` | mechanism_hypothesis | candidate | 0.644 | 0.298 | 0.874 | 2 | 5 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.705 | 0.307 | 0.838 | 1 | 10 | plausible_unproven |
| `SD-049` | design_decision | candidate | 0.682 | 0.308 | 0.807 | 1 | 11 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.754 | 0.318 | 0.899 | 1 | 4 | plausible_unproven |
| `MECH-047` | mechanism_hypothesis | provisional | 0.741 | 0.361 | 0.868 | 1 | 4 | plausible_unproven |
| `SD-021` | design_decision | candidate | 0.634 | 0.376 | 0.892 | 3 | 8 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.747 | 0.386 | 0.867 | 1 | 6 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.750 | 0.386 | 0.871 | 1 | 6 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.752 | 0.388 | 0.873 | 1 | 5 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.749 | 0.390 | 0.869 | 1 | 5 | plausible_unproven |
| `MECH-302` | mechanism_hypothesis | candidate | 0.654 | 0.406 | 0.901 | 3 | 6 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.629 | 0.409 | 0.850 | 4 | 7 | plausible_unproven |
| `MECH-099` | mechanism_hypothesis | candidate | 0.656 | 0.413 | 0.899 | 6 | 7 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.667 | 0.456 | 0.878 | 5 | 6 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.789 | 0.471 | 0.895 | 1 | 5 | plausible_unproven |
| `MECH-113` | mechanism_hypothesis | candidate | 0.656 | 0.480 | 0.833 | 3 | 3 | plausible_unproven |
| `SD-032b` | - | - | 0.690 | 0.496 | 0.884 | 10 | 14 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.678 | 0.510 | 0.847 | 24 | 9 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.726 | 0.542 | 0.909 | 7 | 10 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.715 | 0.567 | 0.863 | 3 | 5 | plausible_unproven |
| `SD-016` | design_decision | implemented | 0.680 | 0.575 | 0.786 | 7 | 3 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.758 | 0.581 | 0.876 | 2 | 5 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.713 | 0.584 | 0.843 | 10 | 24 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.753 | 0.606 | 0.899 | 7 | 14 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.761 | 0.613 | 0.910 | 19 | 9 | plausible_unproven |
...
|---|---|---:|---:|
| `MECH-118` | candidate | 0.224 | 1 |
| `MECH-150` | candidate | 0.230 | 1 |
| `MECH-165` | candidate | 0.241 | 1 |
| `SD-018` | implemented | 0.244 | 1 |
| `MECH-188` | candidate | 0.246 | 1 |
| `SD-023` | candidate | 0.270 | 1 |
| `MECH-220` | candidate | 0.271 | 1 |
| `ARC-032` | candidate | 0.272 | 2 |
| `MECH-116` | candidate | 0.272 | 2 |
| `MECH-091` | candidate | 0.276 | 1 |
| `SD-032c` | - | 0.276 | 1 |
| `MECH-120` | candidate | 0.295 | 2 |
| `MECH-186` | candidate | 0.295 | 2 |
| `MECH-155` | candidate | 0.298 | 2 |
| `SD-047` | provisional | 0.307 | 1 |
| `SD-049` | candidate | 0.308 | 1 |
| `MECH-166` | candidate | 0.318 | 1 |
| `MECH-320` | candidate_substrate_landed | 0.322 | 1 |
| `MECH-128` | candidate | 0.331 | 3 |
| `MECH-047` | provisional | 0.361 | 1 |
| `INV-054` | candidate | 0.374 | 3 |
| `SD-021` | candidate | 0.376 | 3 |
| `MECH-026` | provisional | 0.386 | 1 |
| `MECH-029` | provisional | 0.386 | 1 |
| `MECH-022` | provisional | 0.388 | 1 |
| `MECH-025` | candidate | 0.390 | 1 |
| `MECH-070` | retiring | 0.404 | 4 |
| `MECH-302` | candidate | 0.406 | 3 |
| `MECH-153` | candidate | 0.409 | 4 |
| `MECH-099` | candidate | 0.413 | 6 |
| ... | ... | ... | ... (9 more) |
