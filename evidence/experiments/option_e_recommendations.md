...
Generated: `2026-06-12T22:17:47.180467Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **68** | plausible_unproven: **307** |
...
Total: **202** discrepant claims (standard-gating only).
...
| `INV-043` | invariant | candidate | 0.837 | 0.000 | 0.837 | 0 | 9 | plausible_unproven |
...
| `MECH-088` | mechanism_hypothesis | candidate | 0.797 | 0.000 | 0.797 | 0 | 3 | plausible_unproven |
...
| `MECH-372` | mechanism_hypothesis | candidate | 0.827 | 0.000 | 0.827 | 0 | 3 | plausible_unproven |
...
| `MECH-118` | mechanism_hypothesis | candidate | 0.640 | 0.156 | 0.801 | 1 | 3 | plausible_unproven |
| `MECH-165` | mechanism_hypothesis | candidate | 0.657 | 0.173 | 0.818 | 1 | 3 | plausible_unproven |
| `MECH-188` | mechanism_hypothesis | candidate | 0.643 | 0.177 | 0.798 | 1 | 3 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.696 | 0.202 | 0.861 | 1 | 4 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.696 | 0.203 | 0.860 | 1 | 4 | plausible_unproven |
| `SD-032c` | - | - | 0.644 | 0.207 | 0.790 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.684 | 0.208 | 0.843 | 1 | 6 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.633 | 0.227 | 0.903 | 2 | 11 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.681 | 0.238 | 0.829 | 1 | 10 | plausible_unproven |
| `MECH-334` | mechanism_hypothesis | candidate | 0.718 | 0.267 | 0.868 | 1 | 3 | plausible_unproven |
| `MECH-047` | mechanism_hypothesis | provisional | 0.718 | 0.293 | 0.860 | 1 | 4 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.724 | 0.317 | 0.859 | 1 | 6 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.727 | 0.317 | 0.863 | 1 | 6 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.729 | 0.320 | 0.865 | 1 | 5 | plausible_unproven |
| `MECH-358` | mechanism_hypothesis | candidate | 0.680 | 0.320 | 0.800 | 1 | 3 | plausible_unproven |
| `SD-059` | design_decision | candidate | 0.725 | 0.320 | 0.860 | 1 | 4 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.741 | 0.322 | 0.880 | 1 | 7 | plausible_unproven |
| `MECH-263` | mechanism_hypothesis | candidate | 0.757 | 0.323 | 0.901 | 1 | 4 | plausible_unproven |
| `SD-033b` | - | - | 0.754 | 0.323 | 0.898 | 1 | 5 | plausible_unproven |
| `MECH-295` | mechanism_hypothesis | candidate | 0.661 | 0.347 | 0.870 | 2 | 6 | plausible_unproven |
| `MECH-266` | mechanism_hypothesis | provisional | 0.654 | 0.374 | 0.841 | 2 | 6 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.629 | 0.388 | 0.870 | 5 | 6 | plausible_unproven |
| `MECH-171` | mechanism_hypothesis | candidate | 0.646 | 0.423 | 0.870 | 3 | 4 | plausible_unproven |
| `SD-032b` | - | - | 0.651 | 0.428 | 0.875 | 10 | 14 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.640 | 0.442 | 0.839 | 24 | 9 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.779 | 0.457 | 0.887 | 1 | 5 | plausible_unproven |
| `MECH-314b` | - | - | 0.685 | 0.469 | 0.793 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.735 | 0.469 | 0.824 | 1 | 3 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.687 | 0.473 | 0.901 | 7 | 10 | plausible_unproven |
| `SD-034` | design_decision | provisional | 0.659 | 0.475 | 0.843 | 4 | 6 | plausible_unproven |
| `MECH-025b` | - | - | 0.726 | 0.478 | 0.808 | 1 | 4 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate_substrate_landed | 0.698 | 0.491 | 0.836 | 2 | 3 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.677 | 0.499 | 0.855 | 3 | 5 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.675 | 0.516 | 0.834 | 10 | 24 | plausible_unproven |
| `SD-016` | design_decision | implemented | 0.648 | 0.517 | 0.778 | 6 | 3 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.714 | 0.537 | 0.891 | 7 | 14 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.723 | 0.545 | 0.901 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.748 | 0.567 | 0.868 | 2 | 5 | plausible_unproven |
| `ARC-024` | architecture_hypothesis | provisional | 0.688 | 0.570 | 0.806 | 28 | 3 | plausible_unproven |
| `SD-032a` | - | - | 0.726 | 0.574 | 0.878 | 3 | 20 | plausible_unproven |
...
| `SD-003-prereq` | - | - | 0.745 | 0.576 | 0.801 | 1 | 3 | plausible_unproven |
| `MECH-057a` | - | - | 0.776 | 0.577 | 0.842 | 1 | 5 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.712 | 0.591 | 0.832 | 83 | 7 | plausible_unproven |
| `MECH-314a` | - | - | 0.754 | 0.598 | 0.858 | 2 | 5 | plausible_unproven |
| `MECH-089` | mechanism_hypothesis | active | 0.734 | 0.600 | 0.868 | 12 | 10 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.705 | 0.602 | 0.808 | 9 | 13 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.736 | 0.617 | 0.854 | 5 | 12 | plausible_unproven |
...
|---|---|---:|---:|---:|---:|
| `MECH-346` | candidate | 0.765 | 0.000 | 1 | 0 |
| `MECH-347` | candidate | 0.765 | 0.000 | 1 | 0 |
| `SD-057` | candidate | 0.765 | 0.000 | 1 | 0 |
| `onboarding` | - | 0.631 | 0.000 | 1 | 0 |
...
|---|---|---:|---:|
| `MECH-118` | candidate | 0.156 | 1 |
| `MECH-150` | candidate | 0.162 | 1 |
| `MECH-165` | candidate | 0.173 | 1 |
| `SD-018` | implemented | 0.176 | 1 |
| `MECH-188` | candidate | 0.177 | 1 |
| `SD-023` | candidate | 0.202 | 1 |
| `ARC-032` | candidate | 0.203 | 2 |
| `MECH-116` | candidate | 0.203 | 2 |
| `MECH-220` | candidate | 0.203 | 1 |
| `SD-032c` | - | 0.207 | 1 |
| `MECH-091` | candidate | 0.208 | 1 |
| `MECH-120` | candidate | 0.227 | 2 |
| `MECH-186` | candidate | 0.227 | 2 |
| `MECH-155` | candidate | 0.229 | 2 |
| `SD-047` | provisional | 0.238 | 1 |
| `MECH-128` | candidate | 0.262 | 3 |
| `MECH-334` | candidate | 0.267 | 1 |
| `MECH-047` | provisional | 0.293 | 1 |
| `INV-054` | candidate | 0.306 | 3 |
| `SD-021` | candidate | 0.307 | 3 |
| `MECH-026` | provisional | 0.317 | 1 |
| `MECH-029` | provisional | 0.317 | 1 |
| `MECH-022` | provisional | 0.320 | 1 |
| `MECH-358` | candidate | 0.320 | 1 |
| `SD-059` | candidate | 0.320 | 1 |
| `MECH-025` | candidate | 0.322 | 1 |
| `MECH-263` | candidate | 0.323 | 1 |
| `SD-033b` | - | 0.323 | 1 |
| `MECH-070` | retiring | 0.336 | 4 |
| `MECH-153` | candidate | 0.341 | 4 |
| ... | ... | ... | ... (23 more) |
