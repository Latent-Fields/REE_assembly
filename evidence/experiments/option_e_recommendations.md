...
Generated: `2026-07-10T12:54:50.656517Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **67** | plausible_unproven: **405** |
...
| `SD-023` | design_decision | candidate | 0.675 | 0.141 | 0.853 | 1 | 4 | plausible_unproven |
| `SD-032c` | - | - | 0.623 | 0.146 | 0.782 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.663 | 0.147 | 0.835 | 1 | 6 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.661 | 0.177 | 0.822 | 1 | 10 | plausible_unproven |
...
| `MECH-295` | mechanism_hypothesis | candidate | 0.632 | 0.286 | 0.863 | 2 | 6 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.762 | 0.377 | 0.890 | 1 | 5 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.767 | 0.396 | 0.891 | 1 | 6 | plausible_unproven |
...
| `ARC-030` | architecture_hypothesis | candidate | 0.652 | 0.412 | 0.893 | 7 | 10 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.641 | 0.455 | 0.827 | 10 | 24 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.689 | 0.483 | 0.894 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.718 | 0.506 | 0.860 | 2 | 5 | plausible_unproven |
...
| `SD-003` | design_decision | superseded | 0.677 | 0.530 | 0.824 | 83 | 7 | plausible_unproven |
| `ARC-024` | architecture_hypothesis | provisional | 0.669 | 0.540 | 0.798 | 28 | 3 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.700 | 0.552 | 0.847 | 5 | 5 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.700 | 0.555 | 0.846 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.677 | 0.559 | 0.795 | 26 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.670 | 0.560 | 0.779 | 5 | 6 | plausible_unproven |
| `SD-012` | design_decision | provisional | 0.708 | 0.561 | 0.854 | 5 | 25 | plausible_unproven |
| `MECH-089` | mechanism_hypothesis | active | 0.715 | 0.569 | 0.860 | 12 | 10 | plausible_unproven |
| `ARC-026` | architecture_hypothesis | provisional | 0.678 | 0.573 | 0.783 | 3 | 5 | plausible_unproven |
...
| `MECH-259` | mechanism_hypothesis | stable | 0.682 | 0.596 | 0.725 | 1 | 2 | plausible_unproven |
| `SD-032a` | - | - | 0.801 | 0.596 | 0.870 | 1 | 20 | plausible_unproven |
| `MECH-256` | mechanism_hypothesis | candidate | 0.725 | 0.598 | 0.852 | 6 | 9 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.732 | 0.604 | 0.861 | 38 | 4 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.734 | 0.609 | 0.859 | 19 | 5 | plausible_unproven |
| `MECH-262` | mechanism_hypothesis | candidate | 0.800 | 0.610 | 0.864 | 1 | 8 | plausible_unproven |
| `MECH-106` | mechanism_hypothesis | provisional | 0.755 | 0.613 | 0.850 | 2 | 5 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.707 | 0.614 | 0.800 | 10 | 13 | plausible_unproven |
| `MECH-119` | mechanism_hypothesis | stable | 0.714 | 0.615 | 0.780 | 2 | 3 | plausible_unproven |
| `MECH-062` | mechanism_hypothesis | candidate | 0.712 | 0.616 | 0.760 | 1 | 2 | plausible_unproven |
| `SD-035` | design_decision | stable | 0.803 | 0.616 | 0.865 | 1 | 6 | plausible_unproven |
...
| `MECH-295` | candidate | 0.286 | 2 |
| `MECH-097` | candidate | 0.308 | 1 |
| `MECH-099` | candidate | 0.317 | 6 |
| `MECH-445` | candidate | 0.318 | 1 |
| `MECH-075` | candidate | 0.327 | 5 |
| ... | ... | ... | ... (18 more) |
