...
Generated: `2026-06-14T18:10:42.025490Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **66** | plausible_unproven: **355** |
...
Total: **239** discrepant claims (standard-gating only).
...
| `MECH-057b` | - | - | 0.857 | 0.000 | 0.857 | 0 | 4 | plausible_unproven |
...
| `MECH-171` | derived_prediction | candidate | 0.870 | 0.000 | 0.870 | 0 | 4 | plausible_unproven |
...
| `MECH-263` | mechanism_hypothesis | candidate | 0.901 | 0.000 | 0.901 | 0 | 4 | plausible_unproven |
...
| `MECH-118` | mechanism_hypothesis | candidate | 0.638 | 0.151 | 0.801 | 1 | 3 | plausible_unproven |
| `MECH-165` | mechanism_hypothesis | candidate | 0.656 | 0.169 | 0.818 | 1 | 3 | plausible_unproven |
| `MECH-188` | mechanism_hypothesis | candidate | 0.642 | 0.173 | 0.798 | 1 | 3 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.695 | 0.198 | 0.860 | 1 | 4 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.694 | 0.199 | 0.859 | 1 | 4 | plausible_unproven |
| `SD-032c` | - | - | 0.643 | 0.203 | 0.790 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.682 | 0.204 | 0.842 | 1 | 6 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.630 | 0.223 | 0.902 | 2 | 11 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.680 | 0.234 | 0.829 | 1 | 10 | plausible_unproven |
| `MECH-047` | mechanism_hypothesis | provisional | 0.717 | 0.289 | 0.859 | 1 | 4 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.722 | 0.313 | 0.858 | 1 | 6 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.725 | 0.313 | 0.862 | 1 | 6 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.727 | 0.316 | 0.864 | 1 | 5 | plausible_unproven |
| `MECH-358` | mechanism_hypothesis | candidate | 0.678 | 0.316 | 0.799 | 1 | 3 | plausible_unproven |
| `SD-059` | design_decision | candidate | 0.723 | 0.316 | 0.859 | 1 | 4 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.740 | 0.318 | 0.880 | 1 | 7 | plausible_unproven |
| `MECH-295` | mechanism_hypothesis | candidate | 0.659 | 0.343 | 0.870 | 2 | 6 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.634 | 0.384 | 0.883 | 5 | 7 | plausible_unproven |
| `SD-032b` | - | - | 0.654 | 0.424 | 0.884 | 10 | 16 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate_substrate_landed | 0.735 | 0.435 | 0.835 | 1 | 3 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.638 | 0.438 | 0.838 | 24 | 9 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.778 | 0.453 | 0.886 | 1 | 5 | plausible_unproven |
| `MECH-314b` | - | - | 0.683 | 0.465 | 0.792 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.734 | 0.465 | 0.824 | 1 | 3 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.684 | 0.469 | 0.900 | 7 | 10 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.673 | 0.512 | 0.834 | 10 | 24 | plausible_unproven |
| `SD-016` | design_decision | implemented | 0.645 | 0.513 | 0.777 | 6 | 3 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.712 | 0.533 | 0.891 | 7 | 14 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.721 | 0.541 | 0.901 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.745 | 0.563 | 0.867 | 2 | 5 | plausible_unproven |
| `ARC-024` | architecture_hypothesis | provisional | 0.685 | 0.566 | 0.805 | 28 | 3 | plausible_unproven |
...
| `SD-003` | design_decision | superseded | 0.709 | 0.587 | 0.831 | 83 | 7 | plausible_unproven |
| `MECH-089` | mechanism_hypothesis | active | 0.731 | 0.596 | 0.867 | 12 | 10 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.703 | 0.598 | 0.807 | 9 | 13 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.731 | 0.609 | 0.854 | 5 | 5 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.733 | 0.613 | 0.853 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.709 | 0.616 | 0.802 | 26 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.701 | 0.617 | 0.786 | 5 | 6 | plausible_unproven |
| `SD-012` | design_decision | provisional | 0.740 | 0.618 | 0.861 | 5 | 25 | plausible_unproven |
...
|---|---|---:|---:|---:|---:|
| `MECH-346` | candidate | 0.761 | 0.000 | 1 | 0 |
| `MECH-347` | candidate | 0.761 | 0.000 | 1 | 0 |
| `SD-057` | candidate | 0.761 | 0.000 | 1 | 0 |
| `onboarding` | - | 0.627 | 0.000 | 1 | 0 |
...
|---|---|---:|---:|
| `MECH-118` | candidate | 0.151 | 1 |
| `MECH-150` | candidate | 0.158 | 1 |
| `MECH-165` | candidate | 0.169 | 1 |
| `SD-018` | implemented | 0.172 | 1 |
| `MECH-188` | candidate | 0.173 | 1 |
| `SD-023` | candidate | 0.198 | 1 |
| `ARC-032` | candidate | 0.199 | 2 |
| `MECH-116` | candidate | 0.199 | 2 |
| `MECH-220` | candidate | 0.199 | 1 |
| `SD-032c` | - | 0.203 | 1 |
| `MECH-091` | candidate | 0.204 | 1 |
| `MECH-120` | candidate | 0.223 | 2 |
| `MECH-186` | candidate | 0.223 | 2 |
| `MECH-155` | candidate | 0.225 | 2 |
| `SD-047` | provisional | 0.234 | 1 |
| `MECH-128` | candidate | 0.258 | 3 |
| `MECH-047` | provisional | 0.289 | 1 |
| `INV-054` | candidate | 0.302 | 3 |
| `SD-021` | candidate | 0.303 | 3 |
| `MECH-026` | provisional | 0.313 | 1 |
| `MECH-029` | provisional | 0.313 | 1 |
| `MECH-022` | provisional | 0.316 | 1 |
| `MECH-358` | candidate | 0.316 | 1 |
| `SD-059` | candidate | 0.316 | 1 |
| `MECH-025` | candidate | 0.318 | 1 |
| `MECH-070` | retiring | 0.332 | 4 |
| `MECH-153` | candidate | 0.337 | 4 |
| `MECH-099` | candidate | 0.341 | 6 |
| `MECH-295` | candidate | 0.343 | 2 |
| `MECH-097` | candidate | 0.365 | 1 |
| ... | ... | ... | ... (15 more) |
