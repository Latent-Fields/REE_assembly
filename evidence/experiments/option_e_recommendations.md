...
Generated: `2026-05-27T17:29:12.343034Z`
...
| `MECH-118` | mechanism_hypothesis | candidate | 0.652 | 0.192 | 0.805 | 1 | 3 | plausible_unproven |
| `MECH-165` | mechanism_hypothesis | candidate | 0.669 | 0.209 | 0.822 | 1 | 3 | plausible_unproven |
| `MECH-188` | mechanism_hypothesis | candidate | 0.656 | 0.213 | 0.803 | 1 | 3 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.708 | 0.238 | 0.865 | 1 | 4 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.708 | 0.239 | 0.864 | 1 | 4 | plausible_unproven |
| `SD-032c` | - | - | 0.656 | 0.243 | 0.794 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.696 | 0.244 | 0.847 | 1 | 6 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.649 | 0.263 | 0.907 | 2 | 11 | plausible_unproven |
| `MECH-155` | mechanism_hypothesis | candidate | 0.628 | 0.265 | 0.870 | 2 | 5 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.694 | 0.274 | 0.834 | 1 | 10 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.743 | 0.285 | 0.895 | 1 | 4 | plausible_unproven |
| `MECH-314` | mechanism_hypothesis | candidate_substrate_landed | 0.739 | 0.300 | 0.885 | 1 | 6 | plausible_unproven |
| `SD-037` | design_decision | candidate | 0.724 | 0.311 | 0.862 | 1 | 4 | plausible_unproven |
| `MECH-047` | mechanism_hypothesis | provisional | 0.730 | 0.329 | 0.864 | 1 | 4 | plausible_unproven |
| `SD-021` | design_decision | candidate | 0.620 | 0.343 | 0.898 | 3 | 9 | plausible_unproven |
| `MECH-320` | mechanism_hypothesis | candidate_substrate_landed | 0.658 | 0.350 | 0.864 | 2 | 3 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.736 | 0.353 | 0.863 | 1 | 6 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.738 | 0.353 | 0.867 | 1 | 6 | plausible_unproven |
| `MECH-334` | mechanism_hypothesis | candidate | 0.665 | 0.354 | 0.873 | 2 | 3 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.741 | 0.356 | 0.869 | 1 | 5 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.753 | 0.358 | 0.885 | 1 | 7 | plausible_unproven |
| `SD-049` | design_decision | candidate | 0.629 | 0.367 | 0.803 | 2 | 11 | plausible_unproven |
| `MECH-302` | mechanism_hypothesis | candidate | 0.636 | 0.374 | 0.898 | 3 | 6 | plausible_unproven |
| `MECH-099` | mechanism_hypothesis | candidate | 0.638 | 0.381 | 0.895 | 6 | 7 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.649 | 0.424 | 0.874 | 5 | 6 | plausible_unproven |
| `MECH-113` | mechanism_hypothesis | candidate | 0.639 | 0.448 | 0.829 | 3 | 3 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate_substrate_landed | 0.650 | 0.459 | 0.840 | 4 | 3 | plausible_unproven |
| `SD-032b` | - | - | 0.672 | 0.464 | 0.880 | 10 | 14 | plausible_unproven |
| `MECH-280` | mechanism_hypothesis | candidate | 0.769 | 0.466 | 0.870 | 1 | 5 | plausible_unproven |
| `MECH-281` | mechanism_hypothesis | candidate | 0.768 | 0.466 | 0.869 | 1 | 4 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.660 | 0.478 | 0.843 | 24 | 9 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.707 | 0.509 | 0.905 | 7 | 10 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.743 | 0.522 | 0.891 | 2 | 5 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.697 | 0.535 | 0.859 | 3 | 5 | plausible_unproven |
| `SD-016` | design_decision | implemented | 0.662 | 0.542 | 0.782 | 7 | 3 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.742 | 0.548 | 0.872 | 2 | 5 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.696 | 0.552 | 0.839 | 10 | 24 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.734 | 0.573 | 0.895 | 7 | 14 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.744 | 0.581 | 0.906 | 19 | 9 | plausible_unproven |
| `ARC-024` | architecture_hypothesis | provisional | 0.708 | 0.606 | 0.810 | 28 | 3 | plausible_unproven |
| `MECH-056` | mechanism_hypothesis | provisional | 0.799 | 0.611 | 0.862 | 1 | 15 | plausible_unproven |
| `MECH-059` | mechanism_hypothesis | active | 0.762 | 0.611 | 0.812 | 1 | 11 | plausible_unproven |
| `MECH-060` | mechanism_hypothesis | provisional | 0.781 | 0.611 | 0.838 | 1 | 18 | plausible_unproven |
| `MECH-061` | mechanism_hypothesis | active | 0.788 | 0.611 | 0.847 | 1 | 8 | plausible_unproven |
| `SD-003-prereq` | - | - | 0.757 | 0.612 | 0.805 | 1 | 3 | plausible_unproven |
| `MECH-057a` | - | - | 0.788 | 0.613 | 0.846 | 1 | 5 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.715 | 0.617 | 0.812 | 9 | 13 | plausible_unproven |
...
|---|---|---:|---:|
| `MECH-118` | candidate | 0.192 | 1 |
| `MECH-150` | candidate | 0.198 | 1 |
| `MECH-165` | candidate | 0.209 | 1 |
| `SD-018` | implemented | 0.212 | 1 |
| `MECH-188` | candidate | 0.213 | 1 |
| `SD-023` | candidate | 0.238 | 1 |
| `ARC-032` | candidate | 0.239 | 2 |
| `MECH-116` | candidate | 0.239 | 2 |
| `MECH-220` | candidate | 0.239 | 1 |
| `SD-032c` | - | 0.243 | 1 |
| `MECH-091` | candidate | 0.244 | 1 |
| `MECH-120` | candidate | 0.263 | 2 |
| `MECH-186` | candidate | 0.263 | 2 |
| `MECH-155` | candidate | 0.265 | 2 |
| `SD-047` | provisional | 0.274 | 1 |
| `MECH-166` | candidate | 0.285 | 1 |
| `MECH-128` | candidate | 0.298 | 3 |
| `MECH-314` | candidate_substrate_landed | 0.300 | 1 |
| `SD-037` | candidate | 0.311 | 1 |
| `MECH-047` | provisional | 0.329 | 1 |
| `INV-054` | candidate | 0.342 | 3 |
| `SD-021` | candidate | 0.343 | 3 |
| `MECH-320` | candidate_substrate_landed | 0.350 | 2 |
| `MECH-026` | provisional | 0.353 | 1 |
| `MECH-029` | provisional | 0.353 | 1 |
| `MECH-334` | candidate | 0.354 | 2 |
| `MECH-022` | provisional | 0.356 | 1 |
| `MECH-025` | candidate | 0.358 | 1 |
| `SD-049` | candidate | 0.367 | 2 |
| `MECH-070` | retiring | 0.372 | 4 |
| ... | ... | ... | ... (18 more) |
