...
Generated: `2026-09-07T04:20:20.316142Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **82** | plausible_unproven: **508** |
| **low lit**             | novel_discovery: **5**         | speculative: **10** |

Total scored claims: 605
...
Total: **316** discrepant claims (standard-gating only).
...
| `MECH-535` | mechanism_hypothesis | candidate | 0.705 | 0.000 | 0.705 | 0 | 11 | plausible_unproven |
| `MECH-536` | mechanism_hypothesis | candidate | 0.713 | 0.000 | 0.713 | 0 | 6 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.658 | 0.199 | 0.811 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.666 | 0.200 | 0.822 | 1 | 21 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.638 | 0.222 | 0.776 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.660 | 0.237 | 0.801 | 1 | 5 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.694 | 0.243 | 0.844 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.672 | 0.244 | 0.815 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.714 | 0.247 | 0.869 | 1 | 4 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.730 | 0.247 | 0.891 | 1 | 5 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.638 | 0.259 | 0.765 | 1 | 3 | plausible_unproven |
...
| `MECH-144` | mechanism_hypothesis | candidate | 0.679 | 0.306 | 0.803 | 1 | 4 | plausible_unproven |
...
| `MECH-180` | mechanism_hypothesis | candidate | 0.786 | 0.399 | 0.915 | 1 | 7 | plausible_unproven |
| `MECH-025b` | - | - | 0.689 | 0.402 | 0.784 | 1 | 4 | plausible_unproven |
...
| `ARC-032` | architecture_hypothesis | candidate | 0.647 | 0.467 | 0.828 | 5 | 6 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.657 | 0.475 | 0.778 | 2 | 3 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.653 | 0.493 | 0.814 | 18 | 8 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.642 | 0.500 | 0.784 | 4 | 13 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.716 | 0.502 | 0.858 | 2 | 14 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.684 | 0.509 | 0.859 | 3 | 13 | plausible_unproven |
| `Q-034` | question | open | 0.644 | 0.525 | 0.763 | 3 | 6 | plausible_unproven |
| `MECH-150` | mechanism_hypothesis | candidate | 0.679 | 0.532 | 0.777 | 2 | 3 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.700 | 0.532 | 0.867 | 23 | 4 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.684 | 0.550 | 0.818 | 3 | 7 | plausible_unproven |
...
| `MECH-230` | mechanism_hypothesis | provisional | 0.744 | 0.560 | 0.805 | 1 | 11 | plausible_unproven |
| `MECH-440` | mechanism_hypothesis | candidate | 0.641 | 0.573 | 0.687 | 2 | 10 | plausible_unproven |
...
| `MECH-045` | mechanism_hypothesis | provisional | 0.772 | 0.576 | 0.838 | 1 | 14 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.695 | 0.581 | 0.808 | 82 | 7 | plausible_unproven |
| `MECH-087` | mechanism_hypothesis | candidate | 0.642 | 0.583 | 0.701 | 1 | 1 | plausible_unproven |
| `MECH-358` | mechanism_hypothesis | candidate | 0.730 | 0.593 | 0.776 | 1 | 3 | plausible_unproven |
| `SD-059` | design_decision | candidate | 0.775 | 0.593 | 0.836 | 1 | 4 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.719 | 0.594 | 0.843 | 18 | 5 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.809 | 0.600 | 0.879 | 1 | 11 | plausible_unproven |
| `MECH-436` | mechanism_hypothesis | candidate | 0.719 | 0.601 | 0.778 | 1 | 2 | plausible_unproven |
...
| `MECH-285` | mechanism_hypothesis | candidate | 0.802 | 0.606 | 0.868 | 1 | 16 | plausible_unproven |
| `DEV-NEED-006` | - | - | 0.764 | 0.608 | 0.816 | 1 | 5 | plausible_unproven |
| `SD-013` | design_decision | provisional | 0.721 | 0.608 | 0.834 | 4 | 4 | plausible_unproven |
| `SD-034` | design_decision | provisional | 0.764 | 0.610 | 0.815 | 1 | 9 | plausible_unproven |
...
| `SD-079` | design_decision | provisional | 0.614 | 0.680 | 0.581 | 1 | 2 | confirmed_established |
...
|---|---|---:|---:|---:|---:|
| `EXT-001` | candidate | 0.766 | 0.000 | 1 | 0 |
| `MECH-219` | candidate | 0.756 | 0.000 | 1 | 0 |
| `MECH-290` | candidate | 0.756 | 0.000 | 1 | 0 |
| `SD-019b` | - | 0.756 | 0.000 | 1 | 0 |
...
| `MECH-445` | candidate | 0.188 | 1 |
| `INV-088` | candidate | 0.199 | 1 |
| `MECH-457` | candidate | 0.200 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `MECH-329` | candidate | 0.222 | 1 |
| `MECH-466` | candidate | 0.233 | 1 |
| `MECH-475` | retired | 0.237 | 1 |
| `MECH-294` | candidate | 0.243 | 1 |
| `SD-087` | candidate | 0.244 | 1 |
| `MECH-122` | provisional | 0.247 | 1 |
| `MECH-166` | candidate | 0.247 | 1 |
| `SD-009` | candidate | 0.259 | 1 |
| `MECH-463` | candidate | 0.265 | 2 |
| `MECH-152` | provisional | 0.267 | 1 |
