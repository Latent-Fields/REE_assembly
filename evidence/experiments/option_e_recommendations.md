...
Generated: `2026-07-20T15:57:13.304715Z`
...
| `MECH-063` | mechanism_hypothesis | provisional | 0.758 | 0.000 | 0.758 | 0 | 2 | plausible_unproven |
...
| `MECH-359` | mechanism_hypothesis | candidate | 0.802 | 0.000 | 0.802 | 0 | 3 | plausible_unproven |
...
| `SD-047` | design_decision | provisional | 0.653 | 0.154 | 0.819 | 1 | 10 | plausible_unproven |
| `MECH-057b` | - | - | 0.697 | 0.246 | 0.847 | 1 | 4 | plausible_unproven |
| `MECH-295` | mechanism_hypothesis | candidate | 0.621 | 0.263 | 0.860 | 2 | 6 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.693 | 0.307 | 0.822 | 1 | 4 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.703 | 0.308 | 0.835 | 1 | 22 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.754 | 0.355 | 0.887 | 1 | 5 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.760 | 0.373 | 0.889 | 1 | 6 | plausible_unproven |
| `MECH-314b` | - | - | 0.650 | 0.385 | 0.782 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.753 | 0.385 | 0.876 | 1 | 6 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.644 | 0.396 | 0.891 | 7 | 10 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.676 | 0.461 | 0.891 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.708 | 0.483 | 0.858 | 2 | 5 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.664 | 0.507 | 0.821 | 83 | 7 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.701 | 0.508 | 0.893 | 3 | 11 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.700 | 0.518 | 0.881 | 7 | 14 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.658 | 0.518 | 0.797 | 9 | 13 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.686 | 0.529 | 0.843 | 5 | 7 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.689 | 0.533 | 0.844 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.664 | 0.536 | 0.792 | 26 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.657 | 0.538 | 0.776 | 5 | 6 | plausible_unproven |
...
| `ARC-026` | architecture_hypothesis | provisional | 0.665 | 0.550 | 0.780 | 3 | 5 | plausible_unproven |
...
| `MECH-259` | mechanism_hypothesis | stable | 0.674 | 0.575 | 0.723 | 1 | 2 | plausible_unproven |
| `SD-003-prereq` | - | - | 0.736 | 0.575 | 0.790 | 1 | 3 | plausible_unproven |
| `SD-032a` | - | - | 0.795 | 0.575 | 0.868 | 1 | 20 | plausible_unproven |
| `MECH-256` | mechanism_hypothesis | candidate | 0.713 | 0.576 | 0.850 | 6 | 9 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.708 | 0.582 | 0.792 | 2 | 3 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.703 | 0.582 | 0.824 | 11 | 24 | plausible_unproven |
| `MECH-262` | mechanism_hypothesis | candidate | 0.792 | 0.587 | 0.861 | 1 | 8 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.723 | 0.588 | 0.858 | 38 | 4 | plausible_unproven |
| `MECH-062` | mechanism_hypothesis | candidate | 0.703 | 0.593 | 0.758 | 1 | 2 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.725 | 0.593 | 0.857 | 19 | 5 | plausible_unproven |
| `SD-035` | design_decision | stable | 0.795 | 0.593 | 0.862 | 1 | 6 | plausible_unproven |
| `SD-048` | design_decision | candidate | 0.799 | 0.603 | 0.865 | 1 | 6 | plausible_unproven |
...
| `MECH-097` | candidate | 0.285 | 1 |
| `MECH-445` | candidate | 0.296 | 1 |
| `INV-088` | candidate | 0.307 | 1 |
| `MECH-111` | candidate | 0.307 | 4 |
| ... | ... | ... | ... (26 more) |
