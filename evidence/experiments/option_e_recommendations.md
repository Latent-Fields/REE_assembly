...
Generated: `2026-09-26T18:08:13.617532Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **72** | plausible_unproven: **677** |
| **low lit**             | novel_discovery: **7**         | speculative: **22** |

Total scored claims: 778
...
Total: **433** discrepant claims (standard-gating only).

| claim | type | status | legacy_overall | decoupled_overall | lit_conf | n_exp | n_lit | quadrant |
|---|---|---|---:|---:|---:|---:|---:|---|
| `ARC-031` | architecture_hypothesis | candidate | 0.742 | 0.000 | 0.742 | 0 | 4 | plausible_unproven |
...
| `ARC-050` | architecture_hypothesis | candidate | 0.780 | 0.000 | 0.780 | 0 | 3 | plausible_unproven |
| `ARC-051` | architecture_hypothesis | candidate | 0.832 | 0.000 | 0.832 | 0 | 4 | plausible_unproven |
| `ARC-053` | arch_commitment | candidate | 0.789 | 0.000 | 0.789 | 0 | 3 | plausible_unproven |
| `ARC-054` | arch_commitment | candidate | 0.645 | 0.000 | 0.645 | 0 | 3 | plausible_unproven |
| `ARC-055` | arch_commitment | candidate | 0.774 | 0.000 | 0.774 | 0 | 7 | plausible_unproven |
| `ARC-056` | arch_commitment | candidate | 0.722 | 0.000 | 0.722 | 0 | 3 | plausible_unproven |
...
| `ARC-078` | architecture_hypothesis | candidate | 0.840 | 0.000 | 0.840 | 0 | 11 | plausible_unproven |
| `ARC-079` | architecture_hypothesis | candidate | 0.632 | 0.000 | 0.632 | 0 | 4 | plausible_unproven |
...
| `ARC-115` | architecture_hypothesis | candidate | 0.758 | 0.000 | 0.758 | 0 | 4 | plausible_unproven |
| `ARC-116` | architecture_hypothesis | candidate | 0.644 | 0.000 | 0.644 | 0 | 4 | plausible_unproven |
| `ARC-117` | architecture_hypothesis | candidate | 0.769 | 0.000 | 0.769 | 0 | 4 | plausible_unproven |
| `CANDIDATE-autonomic-rebound-parasympathetic-recovery` | - | - | 0.822 | 0.000 | 0.822 | 0 | 4 | plausible_unproven |
| `CANDIDATE-blocked-agency-stream` | - | - | 0.823 | 0.000 | 0.823 | 0 | 5 | plausible_unproven |
| `CANDIDATE-contextual-memory-allocation-gate` | - | - | 0.833 | 0.000 | 0.833 | 0 | 5 | plausible_unproven |
...
| `DEV-NEED-012` | - | - | 0.848 | 0.000 | 0.848 | 0 | 6 | plausible_unproven |
...
| `EXT-008` | external_failure_mode | candidate | 0.824 | 0.000 | 0.824 | 0 | 5 | plausible_unproven |
...
| `INV-040` | invariant | candidate | 0.671 | 0.000 | 0.671 | 0 | 4 | plausible_unproven |
| `INV-043` | invariant | candidate | 0.808 | 0.000 | 0.808 | 0 | 9 | plausible_unproven |
| `INV-046` | invariant | candidate | 0.672 | 0.000 | 0.672 | 0 | 1 | plausible_unproven |
| `INV-048` | derived_prediction | candidate | 0.829 | 0.000 | 0.829 | 0 | 4 | plausible_unproven |
| `INV-050` | invariant | candidate | 0.917 | 0.000 | 0.917 | 0 | 8 | plausible_unproven |
...
| `INV-065` | invariant | candidate | 0.769 | 0.000 | 0.769 | 0 | 3 | plausible_unproven |
| `INV-078` | invariant | candidate | 0.721 | 0.000 | 0.721 | 0 | 1 | plausible_unproven |
...
| `MECH-003` | mechanism_hypothesis | provisional | 0.717 | 0.000 | 0.717 | 0 | 5 | plausible_unproven |
| `MECH-004` | mechanism_hypothesis | candidate | 0.870 | 0.000 | 0.870 | 0 | 5 | plausible_unproven |
| `MECH-005` | mechanism_hypothesis | provisional | 0.738 | 0.000 | 0.738 | 0 | 5 | plausible_unproven |
| `MECH-006` | mechanism_hypothesis | provisional | 0.703 | 0.000 | 0.703 | 0 | 2 | plausible_unproven |
...
| `MECH-018` | mechanism_hypothesis | candidate | 0.714 | 0.000 | 0.714 | 0 | 6 | plausible_unproven |
| `MECH-019` | mechanism_hypothesis | candidate | 0.703 | 0.000 | 0.703 | 0 | 5 | plausible_unproven |
| `MECH-021` | mechanism_hypothesis | provisional | 0.805 | 0.000 | 0.805 | 0 | 5 | plausible_unproven |
...
| `MECH-030` | mechanism_hypothesis | provisional | 0.853 | 0.000 | 0.853 | 0 | 4 | plausible_unproven |
...
| `MECH-037` | mechanism_hypothesis | candidate | 0.696 | 0.000 | 0.696 | 0 | 5 | plausible_unproven |
...
| `MECH-048` | mechanism_hypothesis | provisional | 0.818 | 0.000 | 0.818 | 0 | 4 | plausible_unproven |
...
| `MECH-053` | mechanism_hypothesis | provisional | 0.872 | 0.000 | 0.872 | 0 | 6 | plausible_unproven |
...
| `MECH-057` | mechanism_hypothesis | candidate | 0.782 | 0.000 | 0.782 | 0 | 5 | plausible_unproven |
| `MECH-057b` | - | - | 0.828 | 0.000 | 0.828 | 0 | 4 | plausible_unproven |
...
| `MECH-066` | mechanism_hypothesis | candidate | 0.866 | 0.000 | 0.866 | 0 | 5 | plausible_unproven |
| `MECH-067` | mechanism_hypothesis | provisional | 0.723 | 0.000 | 0.723 | 0 | 5 | plausible_unproven |
| `MECH-077` | mechanism_hypothesis | candidate | 0.734 | 0.000 | 0.734 | 0 | 2 | plausible_unproven |
...
| `MECH-083` | mechanism_hypothesis | candidate | 0.860 | 0.000 | 0.860 | 0 | 4 | plausible_unproven |
| `MECH-084` | mechanism_hypothesis | candidate | 0.775 | 0.000 | 0.775 | 0 | 5 | plausible_unproven |
| `MECH-085` | mechanism_hypothesis | candidate | 0.724 | 0.000 | 0.724 | 0 | 3 | plausible_unproven |
| `MECH-088` | mechanism_hypothesis | candidate | 0.768 | 0.000 | 0.768 | 0 | 3 | plausible_unproven |
| `MECH-092` | mechanism_hypothesis | candidate | 0.877 | 0.000 | 0.877 | 0 | 15 | plausible_unproven |
| `MECH-096` | mechanism_hypothesis | candidate | 0.767 | 0.000 | 0.767 | 0 | 2 | plausible_unproven |
| `MECH-103` | mechanism_hypothesis | candidate | 0.803 | 0.000 | 0.803 | 0 | 3 | plausible_unproven |
| `MECH-109` | mechanism_hypothesis | candidate | 0.715 | 0.000 | 0.715 | 0 | 5 | plausible_unproven |
| `MECH-121` | mechanism_hypothesis | candidate | 0.894 | 0.000 | 0.894 | 0 | 5 | plausible_unproven |
| `MECH-123` | mechanism_hypothesis | candidate | 0.817 | 0.000 | 0.817 | 0 | 5 | plausible_unproven |
| `MECH-129` | mechanism_hypothesis | candidate | 0.820 | 0.000 | 0.820 | 0 | 8 | plausible_unproven |
| `MECH-130` | mechanism_hypothesis | candidate | 0.673 | 0.000 | 0.673 | 0 | 5 | plausible_unproven |
| `MECH-140` | mechanism_hypothesis | candidate | 0.671 | 0.000 | 0.671 | 0 | 2 | plausible_unproven |
| `MECH-141` | mechanism_hypothesis | candidate | 0.854 | 0.000 | 0.854 | 0 | 4 | plausible_unproven |
| `MECH-142` | mechanism_hypothesis | candidate | 0.660 | 0.000 | 0.660 | 0 | 1 | plausible_unproven |
| `MECH-143` | mechanism_hypothesis | candidate | 0.650 | 0.000 | 0.650 | 0 | 5 | plausible_unproven |
| `MECH-147` | mechanism_hypothesis | candidate | 0.806 | 0.000 | 0.806 | 0 | 3 | plausible_unproven |
| `MECH-148` | mechanism_hypothesis | candidate | 0.754 | 0.000 | 0.754 | 0 | 2 | plausible_unproven |
| `MECH-149` | mechanism_hypothesis | candidate | 0.691 | 0.000 | 0.691 | 0 | 1 | plausible_unproven |
...
| `MECH-168` | mechanism_hypothesis | candidate | 0.836 | 0.000 | 0.836 | 0 | 4 | plausible_unproven |
| `MECH-169` | mechanism_hypothesis | candidate | 0.750 | 0.000 | 0.750 | 0 | 2 | plausible_unproven |
| `MECH-171` | derived_prediction | candidate | 0.841 | 0.000 | 0.841 | 0 | 4 | plausible_unproven |
| `MECH-172` | derived_prediction | candidate | 0.853 | 0.000 | 0.853 | 0 | 6 | plausible_unproven |
| `MECH-173` | mechanism_hypothesis | candidate | 0.737 | 0.000 | 0.737 | 0 | 2 | plausible_unproven |
| `MECH-174` | mechanism_hypothesis | candidate | 0.707 | 0.000 | 0.707 | 0 | 2 | plausible_unproven |
| `MECH-175` | mechanism_hypothesis | candidate | 0.787 | 0.000 | 0.787 | 0 | 3 | plausible_unproven |
...
| `MECH-181` | mechanism_hypothesis | candidate | 0.677 | 0.000 | 0.677 | 0 | 2 | plausible_unproven |
| `MECH-182` | mechanism_hypothesis | candidate | 0.702 | 0.000 | 0.702 | 0 | 3 | plausible_unproven |
| `MECH-183` | mechanism_hypothesis | candidate | 0.790 | 0.000 | 0.790 | 0 | 5 | plausible_unproven |
| `MECH-184` | mechanism_hypothesis | candidate | 0.689 | 0.000 | 0.689 | 0 | 3 | plausible_unproven |
| `MECH-185` | mechanism_hypothesis | candidate | 0.762 | 0.000 | 0.762 | 0 | 4 | plausible_unproven |
| `MECH-186` | mechanism_hypothesis | candidate | 0.733 | 0.000 | 0.733 | 0 | 3 | plausible_unproven |
| `MECH-191` | mechanism_hypothesis | candidate | 0.851 | 0.000 | 0.851 | 0 | 4 | plausible_unproven |
| `MECH-192` | mechanism_hypothesis | candidate | 0.781 | 0.000 | 0.781 | 0 | 3 | plausible_unproven |
| `MECH-193` | mechanism_hypothesis | candidate | 0.772 | 0.000 | 0.772 | 0 | 3 | plausible_unproven |
...
| `MECH-196` | mechanism_hypothesis | candidate | 0.698 | 0.000 | 0.698 | 0 | 2 | plausible_unproven |
...
| `MECH-200` | mechanism_hypothesis | candidate | 0.738 | 0.000 | 0.738 | 0 | 2 | plausible_unproven |
| `MECH-201` | mechanism_hypothesis | candidate | 0.738 | 0.000 | 0.738 | 0 | 2 | plausible_unproven |
| `MECH-203` | mechanism_hypothesis | candidate | 0.862 | 0.000 | 0.862 | 0 | 8 | plausible_unproven |
| `MECH-207` | mechanism_hypothesis | candidate | 0.721 | 0.000 | 0.721 | 0 | 2 | plausible_unproven |
| `MECH-214` | mechanism | candidate | 0.681 | 0.000 | 0.681 | 0 | 2 | plausible_unproven |
| `MECH-215` | mechanism | candidate | 0.799 | 0.000 | 0.799 | 0 | 5 | plausible_unproven |
...
| `MECH-244` | mechanism_hypothesis | candidate | 0.740 | 0.000 | 0.740 | 0 | 2 | plausible_unproven |
| `MECH-254` | mechanism_hypothesis | candidate | 0.671 | 0.000 | 0.671 | 0 | 2 | plausible_unproven |
...
| `MECH-260` | mechanism_hypothesis | candidate | 0.676 | 0.000 | 0.676 | 0 | 1 | plausible_unproven |
| `MECH-263` | mechanism_hypothesis | candidate | 0.872 | 0.000 | 0.872 | 0 | 4 | plausible_unproven |
| `MECH-264` | mechanism_hypothesis | candidate | 0.846 | 0.000 | 0.846 | 0 | 5 | plausible_unproven |
| `MECH-265` | mechanism_hypothesis | candidate | 0.850 | 0.000 | 0.850 | 0 | 6 | plausible_unproven |
| `MECH-266` | mechanism_hypothesis | provisional | 0.849 | 0.000 | 0.849 | 0 | 7 | plausible_unproven |
| `MECH-267` | mechanism_hypothesis | provisional | 0.854 | 0.000 | 0.854 | 0 | 5 | plausible_unproven |
| `MECH-269` | mechanism_hypothesis | candidate | 0.836 | 0.000 | 0.836 | 0 | 34 | plausible_unproven |
| `MECH-269b` | - | - | 0.802 | 0.000 | 0.802 | 0 | 7 | plausible_unproven |
...
| `MECH-280` | mechanism_hypothesis | candidate | 0.836 | 0.000 | 0.836 | 0 | 5 | plausible_unproven |
| `MECH-281` | mechanism_hypothesis | candidate | 0.836 | 0.000 | 0.836 | 0 | 4 | plausible_unproven |
| `MECH-282` | mechanism_hypothesis | candidate | 0.815 | 0.000 | 0.815 | 0 | 3 | plausible_unproven |
| `MECH-287` | mechanism_hypothesis | candidate | 0.825 | 0.000 | 0.825 | 0 | 7 | plausible_unproven |
| `MECH-288` | mechanism_hypothesis | candidate | 0.854 | 0.000 | 0.854 | 0 | 11 | plausible_unproven |
...
| `MECH-299` | mechanism_hypothesis | candidate | 0.783 | 0.000 | 0.783 | 0 | 2 | plausible_unproven |
...
| `MECH-314c` | - | - | 0.857 | 0.000 | 0.857 | 0 | 6 | plausible_unproven |
...
| `MECH-334` | mechanism_hypothesis | candidate | 0.839 | 0.000 | 0.839 | 0 | 3 | plausible_unproven |
| `MECH-337` | mechanism_hypothesis | candidate | 0.842 | 0.000 | 0.842 | 0 | 4 | plausible_unproven |
| `MECH-338` | mechanism_hypothesis | candidate | 0.777 | 0.000 | 0.777 | 0 | 3 | plausible_unproven |
| `MECH-339` | mechanism_hypothesis | candidate | 0.661 | 0.000 | 0.661 | 0 | 2 | plausible_unproven |
| `MECH-340` | mechanism_hypothesis | candidate | 0.676 | 0.000 | 0.676 | 0 | 2 | plausible_unproven |
| `MECH-342` | mechanism_hypothesis | candidate | 0.807 | 0.000 | 0.807 | 0 | 4 | plausible_unproven |
| `MECH-353` | mechanism_hypothesis | candidate | 0.823 | 0.000 | 0.823 | 0 | 5 | plausible_unproven |
| `MECH-354` | mechanism_hypothesis | candidate | 0.865 | 0.000 | 0.865 | 0 | 5 | plausible_unproven |
...
| `MECH-360` | mechanism_hypothesis | candidate | 0.681 | 0.000 | 0.681 | 0 | 2 | plausible_unproven |
| `MECH-361` | mechanism_hypothesis | candidate | 0.768 | 0.000 | 0.768 | 0 | 3 | plausible_unproven |
| `MECH-364` | mechanism_hypothesis | candidate | 0.641 | 0.000 | 0.641 | 0 | 2 | plausible_unproven |
| `MECH-366` | mechanism_hypothesis | candidate | 0.801 | 0.000 | 0.801 | 0 | 5 | plausible_unproven |
| `MECH-368` | mechanism_hypothesis | candidate | 0.736 | 0.000 | 0.736 | 0 | 2 | plausible_unproven |
| `MECH-371` | mechanism_hypothesis | candidate | 0.681 | 0.000 | 0.681 | 0 | 1 | plausible_unproven |
| `MECH-372` | mechanism_hypothesis | retired | 0.798 | 0.000 | 0.798 | 0 | 3 | plausible_unproven |
| `MECH-380` | mechanism_hypothesis | candidate | 0.711 | 0.000 | 0.711 | 0 | 2 | plausible_unproven |
| `MECH-381` | mechanism_hypothesis | candidate | 0.711 | 0.000 | 0.711 | 0 | 2 | plausible_unproven |
| `MECH-382` | mechanism_hypothesis | candidate | 0.681 | 0.000 | 0.681 | 0 | 1 | plausible_unproven |
| `MECH-383` | mechanism_hypothesis | candidate | 0.731 | 0.000 | 0.731 | 0 | 2 | plausible_unproven |
| `MECH-385` | mechanism_hypothesis | candidate | 0.671 | 0.000 | 0.671 | 0 | 1 | plausible_unproven |
| `MECH-388` | mechanism_hypothesis | candidate | 0.671 | 0.000 | 0.671 | 0 | 1 | plausible_unproven |
| `MECH-391` | mechanism_hypothesis | candidate | 0.814 | 0.000 | 0.814 | 0 | 6 | plausible_unproven |
| `MECH-394` | mechanism_hypothesis | candidate | 0.826 | 0.000 | 0.826 | 0 | 4 | plausible_unproven |
| `MECH-398` | mechanism_hypothesis | candidate | 0.817 | 0.000 | 0.817 | 0 | 3 | plausible_unproven |
| `MECH-399` | mechanism_hypothesis | candidate | 0.722 | 0.000 | 0.722 | 0 | 1 | plausible_unproven |
...
| `MECH-428` | mechanism | candidate | 0.736 | 0.000 | 0.736 | 0 | 3 | plausible_unproven |
| `MECH-429` | mechanism_hypothesis | candidate | 0.706 | 0.000 | 0.706 | 0 | 1 | plausible_unproven |
| `MECH-432` | mechanism_hypothesis | candidate | 0.750 | 0.000 | 0.750 | 0 | 3 | plausible_unproven |
| `MECH-433` | mechanism_hypothesis | candidate | 0.621 | 0.000 | 0.621 | 0 | 1 | plausible_unproven |
| `MECH-434` | mechanism_hypothesis | candidate | 0.836 | 0.000 | 0.836 | 0 | 4 | plausible_unproven |
| `MECH-435` | mechanism_hypothesis | candidate | 0.671 | 0.000 | 0.671 | 0 | 1 | plausible_unproven |
| `MECH-439` | mechanism_hypothesis | candidate | 0.795 | 0.000 | 0.795 | 0 | 7 | plausible_unproven |
...
| `MECH-448` | mechanism_hypothesis | candidate | 0.830 | 0.000 | 0.830 | 0 | 5 | plausible_unproven |
| `MECH-450` | mechanism_hypothesis | candidate | 0.813 | 0.000 | 0.813 | 0 | 5 | plausible_unproven |
...
| `MECH-454` | mechanism_hypothesis | candidate | 0.790 | 0.000 | 0.790 | 0 | 5 | plausible_unproven |
| `MECH-459` | mechanism_hypothesis | candidate | 0.783 | 0.000 | 0.783 | 0 | 3 | plausible_unproven |
| `MECH-467` | mechanism_hypothesis | candidate | 0.775 | 0.000 | 0.775 | 0 | 3 | plausible_unproven |
| `MECH-471` | mechanism_hypothesis | candidate | 0.813 | 0.000 | 0.813 | 0 | 3 | plausible_unproven |
...
| `MECH-486` | mechanism_hypothesis | candidate | 0.775 | 0.000 | 0.775 | 0 | 2 | plausible_unproven |
| `MECH-487` | mechanism_hypothesis | candidate | 0.816 | 0.000 | 0.816 | 0 | 5 | plausible_unproven |
| `MECH-489` | mechanism_hypothesis | candidate | 0.819 | 0.000 | 0.819 | 0 | 5 | plausible_unproven |
| `MECH-490` | mechanism_hypothesis | candidate | 0.777 | 0.000 | 0.777 | 0 | 4 | plausible_unproven |
...
| `MECH-501` | mechanism_hypothesis | candidate | 0.624 | 0.000 | 0.624 | 0 | 5 | plausible_unproven |
...
| `MECH-520` | mechanism_hypothesis | candidate | 0.795 | 0.000 | 0.795 | 0 | 4 | plausible_unproven |
| `MECH-521` | mechanism_hypothesis | candidate | 0.801 | 0.000 | 0.801 | 0 | 4 | plausible_unproven |
| `MECH-522` | mechanism_hypothesis | candidate | 0.722 | 0.000 | 0.722 | 0 | 2 | plausible_unproven |
| `MECH-524` | mechanism_hypothesis | candidate | 0.819 | 0.000 | 0.819 | 0 | 10 | plausible_unproven |
| `MECH-525` | mechanism_hypothesis | candidate | 0.682 | 0.000 | 0.682 | 0 | 1 | plausible_unproven |
| `MECH-526` | mechanism_hypothesis | candidate | 0.692 | 0.000 | 0.692 | 0 | 1 | plausible_unproven |
| `MECH-527` | mechanism_hypothesis | candidate | 0.884 | 0.000 | 0.884 | 0 | 4 | plausible_unproven |
| `MECH-529` | mechanism_hypothesis | candidate | 0.761 | 0.000 | 0.761 | 0 | 3 | plausible_unproven |
| `MECH-533` | mechanism_hypothesis | candidate | 0.846 | 0.000 | 0.846 | 0 | 4 | plausible_unproven |
| `MECH-534` | mechanism_hypothesis | candidate | 0.732 | 0.000 | 0.732 | 0 | 3 | plausible_unproven |
| `MECH-535` | mechanism_hypothesis | candidate | 0.699 | 0.000 | 0.699 | 0 | 11 | plausible_unproven |
| `MECH-536` | mechanism_hypothesis | candidate | 0.707 | 0.000 | 0.707 | 0 | 6 | plausible_unproven |
| `MECH-537` | mechanism_hypothesis | candidate | 0.770 | 0.000 | 0.770 | 0 | 3 | plausible_unproven |
| `MECH-539` | mechanism_hypothesis | candidate | 0.645 | 0.000 | 0.645 | 0 | 1 | plausible_unproven |
| `MECH-541` | mechanism_hypothesis | candidate | 0.793 | 0.000 | 0.793 | 0 | 4 | plausible_unproven |
| `MECH-542` | mechanism_hypothesis | candidate | 0.808 | 0.000 | 0.808 | 0 | 5 | plausible_unproven |
...
| `MECH-548` | mechanism_hypothesis | candidate | 0.700 | 0.000 | 0.700 | 0 | 3 | plausible_unproven |
...
| `MECH-561` | mechanism_hypothesis | candidate | 0.660 | 0.000 | 0.660 | 0 | 2 | plausible_unproven |
...
| `MECH-571` | mechanism_hypothesis | candidate | 0.798 | 0.000 | 0.798 | 0 | 3 | plausible_unproven |
...
| `MECH-598` | mechanism_hypothesis | candidate | 0.778 | 0.000 | 0.778 | 0 | 13 | plausible_unproven |
| `MECH-599` | mechanism_hypothesis | candidate | 0.788 | 0.000 | 0.788 | 0 | 8 | plausible_unproven |
| `MECH-900` | - | - | 0.659 | 0.000 | 0.659 | 0 | 1 | plausible_unproven |
| `MECH-CBBL-PROPOSED` | - | - | 0.864 | 0.000 | 0.864 | 0 | 7 | plausible_unproven |
...
| `Q-053` | question | open | 0.836 | 0.000 | 0.836 | 0 | 7 | plausible_unproven |
| `SD-003-SUCCESSOR` | - | - | 0.828 | 0.000 | 0.828 | 0 | 4 | plausible_unproven |
| `SD-018` | substrate_decision | implemented | 0.714 | 0.000 | 0.714 | 0 | 2 | plausible_unproven |
| `SD-021` | design_decision | candidate | 0.864 | 0.000 | 0.864 | 0 | 9 | plausible_unproven |
| `SD-025` | design_decision | candidate | 0.776 | 0.000 | 0.776 | 0 | 3 | plausible_unproven |
| `SD-027` | design_decision | candidate | 0.671 | 0.000 | 0.671 | 0 | 2 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.825 | 0.000 | 0.825 | 0 | 12 | plausible_unproven |
| `SD-030` | design_decision | candidate | 0.802 | 0.000 | 0.802 | 0 | 4 | plausible_unproven |
| `SD-032` | design_decision | stable | 0.858 | 0.000 | 0.858 | 0 | 9 | plausible_unproven |
| `SD-032b` | - | - | 0.846 | 0.000 | 0.846 | 0 | 14 | plausible_unproven |
| `SD-032c` | - | - | 0.761 | 0.000 | 0.761 | 0 | 3 | plausible_unproven |
| `SD-032d` | - | - | 0.825 | 0.000 | 0.825 | 0 | 4 | plausible_unproven |
| `SD-032e` | - | - | 0.787 | 0.000 | 0.787 | 0 | 4 | plausible_unproven |
| `SD-033` | design_decision | candidate | 0.856 | 0.000 | 0.856 | 0 | 7 | plausible_unproven |
| `SD-033b` | - | - | 0.869 | 0.000 | 0.869 | 0 | 5 | plausible_unproven |
| `SD-033c` | - | - | 0.764 | 0.000 | 0.764 | 0 | 2 | plausible_unproven |
| `SD-033d` | - | - | 0.696 | 0.000 | 0.696 | 0 | 1 | plausible_unproven |
| `SD-033e` | - | - | 0.855 | 0.000 | 0.855 | 0 | 9 | plausible_unproven |
| `SD-035` | design_decision | stable | 0.844 | 0.000 | 0.844 | 0 | 6 | plausible_unproven |
| `SD-037` | design_decision | candidate | 0.892 | 0.000 | 0.892 | 0 | 7 | plausible_unproven |
| `SD-038` | design_decision | candidate | 0.707 | 0.000 | 0.707 | 0 | 1 | plausible_unproven |
...
| `SD-045` | design_decision | retired | 0.890 | 0.000 | 0.890 | 0 | 4 | plausible_unproven |
...
| `SD-049` | design_decision | candidate | 0.769 | 0.000 | 0.769 | 0 | 11 | plausible_unproven |
| `SD-050` | design_decision | candidate | 0.639 | 0.000 | 0.639 | 0 | 4 | plausible_unproven |
| `SD-054` | design_decision | candidate | 0.843 | 0.000 | 0.843 | 0 | 7 | plausible_unproven |
| `SD-055` | design_decision | candidate | 0.745 | 0.000 | 0.745 | 0 | 2 | plausible_unproven |
| `SD-060` | design_decision | candidate | 0.726 | 0.000 | 0.726 | 0 | 2 | plausible_unproven |
| `SD-068` | design_decision | candidate | 0.784 | 0.000 | 0.784 | 0 | 4 | plausible_unproven |
...
| `SD-078` | design_decision | candidate_substrate_landed | 0.753 | 0.000 | 0.753 | 0 | 2 | plausible_unproven |
| `SD-080` | design_decision | candidate | 0.790 | 0.000 | 0.790 | 0 | 3 | plausible_unproven |
| `SD-081` | design_decision | candidate | 0.697 | 0.000 | 0.697 | 0 | 1 | plausible_unproven |
...
| `SD-097` | substrate_design | candidate | 0.731 | 0.000 | 0.731 | 0 | 5 | plausible_unproven |
| `SD-099` | design_decision | candidate | 0.772 | 0.000 | 0.772 | 0 | 4 | plausible_unproven |
| `SD-101` | design_decision | candidate | 0.809 | 0.000 | 0.809 | 0 | 5 | plausible_unproven |
...
| `SD-047` | design_decision | candidate | 0.631 | 0.125 | 0.800 | 1 | 10 | plausible_unproven |
| `INV-088` | invariant | candidate | 0.644 | 0.156 | 0.806 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.651 | 0.157 | 0.816 | 1 | 21 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.622 | 0.179 | 0.770 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.645 | 0.194 | 0.796 | 1 | 5 | plausible_unproven |
| `MECH-321` | mechanism_hypothesis | candidate | 0.652 | 0.199 | 0.803 | 1 | 14 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.658 | 0.200 | 0.810 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.699 | 0.203 | 0.864 | 1 | 4 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.715 | 0.203 | 0.886 | 1 | 5 | plausible_unproven |
| `MECH-025b` | - | - | 0.635 | 0.204 | 0.779 | 1 | 4 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.624 | 0.215 | 0.760 | 1 | 3 | plausible_unproven |
| `MECH-144` | mechanism_hypothesis | candidate | 0.664 | 0.263 | 0.798 | 1 | 4 | plausible_unproven |
...
| `MECH-180` | mechanism_hypothesis | candidate | 0.771 | 0.356 | 0.909 | 1 | 7 | plausible_unproven |
...
| `ARC-032` | architecture_hypothesis | candidate | 0.623 | 0.423 | 0.823 | 5 | 6 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.637 | 0.425 | 0.849 | 8 | 26 | plausible_unproven |
...
| `MECH-102` | mechanism_hypothesis | active | 0.629 | 0.449 | 0.808 | 18 | 8 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.695 | 0.458 | 0.853 | 2 | 14 | plausible_unproven |
| `MECH-017` | mechanism_hypothesis | candidate | 0.668 | 0.459 | 0.738 | 1 | 5 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.643 | 0.463 | 0.823 | 5 | 8 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.659 | 0.465 | 0.854 | 3 | 13 | plausible_unproven |
| `SD-017` | design_decision | stable | 0.732 | 0.478 | 0.902 | 2 | 19 | plausible_unproven |
| `MECH-150` | mechanism_hypothesis | candidate | 0.659 | 0.489 | 0.772 | 2 | 3 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.640 | 0.500 | 0.779 | 4 | 13 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.659 | 0.506 | 0.813 | 3 | 7 | plausible_unproven |
| `Q-034` | question | open | 0.642 | 0.525 | 0.758 | 3 | 6 | plausible_unproven |
| `MECH-440` | mechanism_hypothesis | candidate | 0.621 | 0.530 | 0.682 | 2 | 10 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.668 | 0.532 | 0.803 | 81 | 7 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.697 | 0.532 | 0.862 | 23 | 4 | plausible_unproven |
| `MECH-094` | mechanism_hypothesis | stable | 0.758 | 0.555 | 0.826 | 1 | 28 | plausible_unproven |
...
| `DEV-NEED-006` | - | - | 0.751 | 0.575 | 0.810 | 1 | 5 | plausible_unproven |
| `MECH-033` | mechanism_hypothesis | provisional | 0.760 | 0.575 | 0.822 | 1 | 17 | plausible_unproven |
...
| `MECH-072` | mechanism_hypothesis | candidate | 0.724 | 0.575 | 0.774 | 1 | 6 | plausible_unproven |
| `MECH-087` | mechanism_hypothesis | candidate | 0.635 | 0.575 | 0.696 | 1 | 1 | plausible_unproven |
| `MECH-106` | mechanism_hypothesis | candidate | 0.765 | 0.575 | 0.828 | 1 | 5 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.799 | 0.575 | 0.874 | 1 | 11 | plausible_unproven |
| `MECH-124` | mechanism_hypothesis | provisional | 0.776 | 0.575 | 0.843 | 1 | 4 | plausible_unproven |
| `MECH-187` | mechanism_hypothesis | candidate | 0.760 | 0.575 | 0.821 | 1 | 7 | plausible_unproven |
| `MECH-231` | mechanism_hypothesis | provisional | 0.708 | 0.575 | 0.753 | 1 | 3 | plausible_unproven |
| `MECH-259` | mechanism_hypothesis | stable | 0.783 | 0.575 | 0.852 | 1 | 8 | plausible_unproven |
| `MECH-268` | mechanism_hypothesis | provisional | 0.754 | 0.575 | 0.813 | 1 | 8 | plausible_unproven |
| `MECH-285` | mechanism_hypothesis | candidate | 0.790 | 0.575 | 0.862 | 1 | 16 | plausible_unproven |
| `MECH-306` | mechanism_hypothesis | provisional | 0.790 | 0.575 | 0.862 | 1 | 4 | plausible_unproven |
| `MECH-314` | mechanism_hypothesis | candidate_substrate_landed | 0.790 | 0.575 | 0.861 | 1 | 10 | plausible_unproven |
| `MECH-314a` | - | - | 0.776 | 0.575 | 0.843 | 1 | 6 | plausible_unproven |
...
| `MECH-436` | mechanism_hypothesis | candidate | 0.706 | 0.575 | 0.772 | 1 | 2 | plausible_unproven |
...
| `SD-057` | design_decision | candidate | 0.680 | 0.575 | 0.732 | 1 | 2 | plausible_unproven |
| `SD-059` | design_decision | candidate | 0.767 | 0.575 | 0.831 | 1 | 4 | plausible_unproven |
| `ARC-024` | architecture_hypothesis | provisional | 0.683 | 0.590 | 0.777 | 26 | 3 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.741 | 0.594 | 0.889 | 18 | 6 | plausible_unproven |
| `SD-063` | design_decision | provisional | 0.763 | 0.600 | 0.818 | 1 | 4 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.721 | 0.604 | 0.839 | 32 | 4 | plausible_unproven |
| `MECH-309` | mechanism_hypothesis | candidate | 0.753 | 0.605 | 0.851 | 2 | 14 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.731 | 0.606 | 0.773 | 1 | 3 | plausible_unproven |
| `SD-013` | design_decision | provisional | 0.718 | 0.608 | 0.828 | 4 | 4 | plausible_unproven |
| `MECH-284` | mechanism_hypothesis | provisional | 0.762 | 0.611 | 0.812 | 1 | 15 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.749 | 0.612 | 0.886 | 6 | 16 | plausible_unproven |
...
| `MECH-423` | mechanism_hypothesis | provisional | 0.768 | 0.615 | 0.819 | 1 | 6 | plausible_unproven |
| `SD-008` | design_decision | stable | 0.657 | 0.615 | 0.700 | 2 | 2 | plausible_unproven |
| `MECH-076` | mechanism_hypothesis | provisional | 0.695 | 0.617 | 0.734 | 1 | 2 | plausible_unproven |
| `MECH-086` | mechanism_hypothesis | provisional | 0.684 | 0.617 | 0.718 | 1 | 2 | plausible_unproven |
| `MECH-279` | mechanism_hypothesis | provisional | 0.812 | 0.617 | 0.877 | 1 | 6 | plausible_unproven |
| `SD-079` | design_decision | provisional | 0.596 | 0.636 | 0.576 | 1 | 2 | confirmed_established |

_Suppressed by gating: 113 substrate_coherence (ARC + universal invariant), 70 answer_state (open_question). These cross the gate under one regime but not the other; the discrepancy is not actionable under their evidence rules. See suppressed sections below._
...
| `SD-032` | design_decision | stable | 0.858 | 9 |
| `SD-106` | design_decision | implemented | 0.849 | 5 |
| `SD-035` | design_decision | stable | 0.844 | 6 |
| `SD-018` | substrate_decision | implemented | 0.714 | 2 |
...
| `ARC-010` | architectural_commitment | active | 0.865 | 4 |
| `INV-010` | invariant | active | 0.832 | 3 |
| `INV-013` | invariant | active | 0.800 | 3 |
| `ARC-002` | architectural_commitment | active | 0.782 | 5 |
| `ARC-004` | architectural_commitment | active | 0.777 | 3 |
| `ARC-011` | architectural_commitment | active | 0.765 | 3 |
...
| claim | type | status | lit_conf | n_lit |
|---|---|---|---:|---:|
| `Q-042` | open_question | resolved | 0.833 | 5 |
| `Q-079` | open_question | resolved | 0.822 | 5 |
| `Q-017` | open_question | active | 0.820 | 7 |
| `Q-016` | open_question | active | 0.817 | 5 |
| `Q-015` | open_question | active | 0.798 | 5 |
| `Q-005` | open_question | active | 0.768 | 4 |
| `Q-018` | open_question | active | 0.755 | 3 |
| `Q-087` | open_question | resolved | 0.736 | 4 |
...
|---|---|---:|---:|---:|---:|
| `SD-071` | provisional | 0.758 | 0.000 | 1 | 0 |
| `SD-098` | candidate | 0.757 | 0.000 | 1 | 0 |
| `SD-074` | candidate | 0.750 | 0.000 | 1 | 0 |
| `SD-077` | candidate | 0.749 | 0.000 | 1 | 0 |
| `SD-075` | candidate | 0.748 | 0.000 | 1 | 0 |
| `ARC-027` | active | 0.713 | 0.000 | 4 | 0 |
| `SD-019b` | - | 0.713 | 0.000 | 1 | 0 |
...
| `MECH-445` | candidate | 0.144 | 1 |
| `INV-088` | candidate | 0.156 | 1 |
| `INV-090` | candidate | 0.156 | 1 |
| `MECH-457` | candidate | 0.157 | 1 |
| `MECH-070` | superseded | 0.163 | 2 |
| `MECH-111` | candidate | 0.175 | 2 |
| `MECH-116` | candidate | 0.175 | 2 |
| `MECH-295` | candidate | 0.175 | 2 |
| `MECH-329` | candidate | 0.179 | 1 |
| `MECH-466` | candidate | 0.190 | 1 |
| `MECH-475` | retired | 0.194 | 1 |
| `MECH-321` | candidate | 0.199 | 1 |
| `SD-087` | candidate | 0.200 | 1 |
| `MECH-122` | provisional | 0.203 | 1 |
| `MECH-166` | candidate | 0.203 | 1 |
| `MECH-025b` | - | 0.204 | 1 |
| `SD-009` | candidate | 0.215 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `MECH-463` | candidate | 0.222 | 2 |
| `MECH-152` | candidate | 0.224 | 1 |
| `MECH-144` | candidate | 0.263 | 1 |
...
|---|---|---:|---:|
| `INV-050` | candidate | 0.917 | 8 |
| `MECH-121` | candidate | 0.894 | 5 |
| `SD-037` | candidate | 0.892 | 7 |
| `SD-045` | retired | 0.890 | 4 |
| `MECH-527` | candidate | 0.884 | 4 |
| `MECH-092` | candidate | 0.877 | 15 |
| `MECH-302` | candidate | 0.874 | 7 |
| `MECH-313` | candidate | 0.874 | 6 |
| `CDQ-010` | - | 0.872 | 5 |
| `MECH-053` | provisional | 0.872 | 6 |
| `MECH-263` | candidate | 0.872 | 4 |
| `MECH-004` | candidate | 0.870 | 5 |
| `MECH-307` | candidate_substrate_landed | 0.870 | 6 |
| `SD-033b` | - | 0.869 | 5 |
| `MECH-271` | candidate | 0.868 | 4 |
| `MECH-066` | candidate | 0.866 | 5 |
| `MECH-354` | candidate | 0.865 | 5 |
| `Q-035` | resolved | 0.865 | 15 |
| `MECH-CBBL-PROPOSED` | - | 0.864 | 7 |
| `SD-021` | candidate | 0.864 | 9 |
| `MECH-042` | candidate | 0.863 | 5 |
| `MECH-320` | candidate_substrate_landed | 0.863 | 5 |
| `MECH-203` | candidate | 0.862 | 8 |
| `MECH-083` | candidate | 0.860 | 4 |
| `MECH-317` | candidate | 0.860 | 6 |
| `SD-039` | candidate | 0.859 | 7 |
| `SD-032` | stable | 0.858 | 9 |
| `ARC-105` | candidate | 0.857 | 4 |
| `MECH-314c` | - | 0.857 | 6 |
| `DEV-NEED-009` | - | 0.856 | 4 |
| `EXT-006` | candidate | 0.856 | 5 |
| `SD-033` | candidate | 0.856 | 7 |
| `SD-033e` | - | 0.855 | 9 |
| `MECH-038` | candidate | 0.854 | 5 |
| `MECH-141` | candidate | 0.854 | 4 |
| `MECH-267` | provisional | 0.854 | 5 |
| `MECH-288` | candidate | 0.854 | 11 |
| `MECH-030` | provisional | 0.853 | 4 |
| `MECH-172` | candidate | 0.853 | 6 |
| `MECH-002` | provisional | 0.852 | 5 |
| `MECH-064` | candidate | 0.851 | 5 |
| `MECH-191` | candidate | 0.851 | 4 |
| `EXT-002` | candidate | 0.850 | 5 |
| `MECH-265` | candidate | 0.850 | 6 |
| `ARC-049` | candidate | 0.849 | 26 |
| `MECH-266` | provisional | 0.849 | 7 |
| `SD-106` | implemented | 0.849 | 5 |
| `DEV-NEED-012` | - | 0.848 | 6 |
| `MECH-046` | provisional | 0.847 | 4 |
| `SD-048` | candidate | 0.847 | 6 |
| ... | ... | ... | ... (319 more) |
