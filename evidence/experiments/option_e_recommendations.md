...
Generated: `2026-07-10T20:03:51.356089Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **66** | plausible_unproven: **407** |
| **low lit**             | novel_discovery: **0**         | speculative: **5** |

Total scored claims: 478
...
| `SD-023` | design_decision | candidate | 0.675 | 0.140 | 0.853 | 1 | 4 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.674 | 0.141 | 0.852 | 1 | 4 | plausible_unproven |
| `SD-032c` | - | - | 0.623 | 0.145 | 0.782 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.663 | 0.146 | 0.835 | 1 | 6 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.660 | 0.176 | 0.822 | 1 | 10 | plausible_unproven |
| `MECH-057b` | - | - | 0.704 | 0.268 | 0.850 | 1 | 4 | plausible_unproven |
...
| `MECH-295` | mechanism_hypothesis | candidate | 0.632 | 0.285 | 0.863 | 2 | 6 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.762 | 0.377 | 0.890 | 1 | 5 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.767 | 0.395 | 0.891 | 1 | 6 | plausible_unproven |
| `MECH-314b` | - | - | 0.659 | 0.407 | 0.785 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.761 | 0.407 | 0.879 | 1 | 6 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.652 | 0.411 | 0.893 | 7 | 10 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.621 | 0.411 | 0.831 | 24 | 9 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.640 | 0.454 | 0.827 | 10 | 24 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.688 | 0.483 | 0.893 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.718 | 0.505 | 0.860 | 2 | 5 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.701 | 0.518 | 0.883 | 7 | 14 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.676 | 0.529 | 0.824 | 83 | 7 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.713 | 0.530 | 0.895 | 3 | 11 | plausible_unproven |
| `ARC-024` | architecture_hypothesis | provisional | 0.669 | 0.540 | 0.798 | 28 | 3 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.670 | 0.540 | 0.800 | 9 | 13 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.699 | 0.551 | 0.847 | 5 | 5 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.700 | 0.555 | 0.846 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.676 | 0.558 | 0.795 | 26 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.669 | 0.559 | 0.779 | 5 | 6 | plausible_unproven |
| `SD-012` | design_decision | provisional | 0.707 | 0.560 | 0.854 | 5 | 25 | plausible_unproven |
| `MECH-089` | mechanism_hypothesis | active | 0.715 | 0.569 | 0.860 | 12 | 10 | plausible_unproven |
| `ARC-026` | architecture_hypothesis | provisional | 0.677 | 0.572 | 0.783 | 3 | 5 | plausible_unproven |
...
| `MECH-259` | mechanism_hypothesis | stable | 0.682 | 0.595 | 0.725 | 1 | 2 | plausible_unproven |
| `SD-032a` | - | - | 0.801 | 0.595 | 0.870 | 1 | 20 | plausible_unproven |
| `MECH-256` | mechanism_hypothesis | candidate | 0.725 | 0.598 | 0.852 | 6 | 9 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.732 | 0.603 | 0.860 | 38 | 4 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.733 | 0.608 | 0.859 | 19 | 5 | plausible_unproven |
| `MECH-262` | mechanism_hypothesis | candidate | 0.800 | 0.609 | 0.864 | 1 | 8 | plausible_unproven |
| `MECH-106` | mechanism_hypothesis | provisional | 0.755 | 0.613 | 0.850 | 2 | 5 | plausible_unproven |
| `MECH-062` | mechanism_hypothesis | candidate | 0.712 | 0.615 | 0.760 | 1 | 2 | plausible_unproven |
| `MECH-119` | mechanism_hypothesis | stable | 0.714 | 0.615 | 0.780 | 2 | 3 | plausible_unproven |
| `SD-035` | design_decision | stable | 0.802 | 0.615 | 0.865 | 1 | 6 | plausible_unproven |
...
| `SD-023` | candidate | 0.140 | 1 |
| `MECH-220` | candidate | 0.141 | 1 |
| `SD-032c` | - | 0.145 | 1 |
| `MECH-091` | candidate | 0.146 | 1 |
| `MECH-155` | candidate | 0.167 | 2 |
| `ARC-032` | candidate | 0.175 | 2 |
| `MECH-116` | candidate | 0.175 | 2 |
| `MECH-186` | candidate | 0.175 | 2 |
| `SD-047` | provisional | 0.176 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `INV-054` | candidate | 0.244 | 3 |
| `SD-021` | candidate | 0.245 | 3 |
| `MECH-057b` | - | 0.268 | 1 |
| `MECH-070` | retiring | 0.274 | 4 |
| `MECH-026` | provisional | 0.275 | 1 |
| `MECH-029` | provisional | 0.275 | 1 |
| `MECH-047` | provisional | 0.275 | 1 |
| `MECH-153` | candidate | 0.279 | 4 |
| `MECH-022` | provisional | 0.280 | 1 |
| `MECH-025` | candidate | 0.280 | 1 |
| `MECH-295` | candidate | 0.285 | 2 |
| `MECH-097` | candidate | 0.307 | 1 |
| `MECH-099` | candidate | 0.317 | 6 |
| `MECH-445` | candidate | 0.317 | 1 |
| `MECH-075` | candidate | 0.326 | 5 |
| ... | ... | ... | ... (19 more) |
