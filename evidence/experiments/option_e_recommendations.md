...
Generated: `2026-07-25T16:56:42.528277Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **78** | plausible_unproven: **413** |
...
| `CANDIDATE-contextual-memory-allocation-gate` | - | - | 0.851 | 0.000 | 0.851 | 0 | 5 | plausible_unproven |
...
| `INV-041` | invariant | candidate | 0.628 | 0.000 | 0.628 | 0 | 1 | plausible_unproven |
...
| `INV-047` | derived_prediction | candidate | 0.624 | 0.000 | 0.624 | 0 | 4 | plausible_unproven |
...
| `INV-056` | invariant | candidate | 0.628 | 0.000 | 0.628 | 0 | 1 | plausible_unproven |
...
| `INV-065` | invariant | candidate | 0.787 | 0.000 | 0.787 | 0 | 3 | plausible_unproven |
| `INV-078` | invariant | candidate | 0.739 | 0.000 | 0.739 | 0 | 1 | plausible_unproven |
...
| `MECH-085` | mechanism_hypothesis | candidate | 0.742 | 0.000 | 0.742 | 0 | 3 | plausible_unproven |
...
| `MECH-147` | mechanism_hypothesis | candidate | 0.824 | 0.000 | 0.824 | 0 | 3 | plausible_unproven |
| `MECH-148` | mechanism_hypothesis | candidate | 0.771 | 0.000 | 0.771 | 0 | 2 | plausible_unproven |
| `MECH-149` | mechanism_hypothesis | candidate | 0.709 | 0.000 | 0.709 | 0 | 1 | plausible_unproven |
...
| `MECH-174` | mechanism_hypothesis | candidate | 0.725 | 0.000 | 0.725 | 0 | 2 | plausible_unproven |
...
| `MECH-191` | mechanism_hypothesis | candidate | 0.869 | 0.000 | 0.869 | 0 | 4 | plausible_unproven |
...
| `MECH-207` | mechanism_hypothesis | candidate | 0.739 | 0.000 | 0.739 | 0 | 2 | plausible_unproven |
| `MECH-214` | mechanism | candidate | 0.699 | 0.000 | 0.699 | 0 | 2 | plausible_unproven |
| `MECH-215` | mechanism | candidate | 0.817 | 0.000 | 0.817 | 0 | 5 | plausible_unproven |
...
| `MECH-245` | mechanism_hypothesis | candidate | 0.753 | 0.000 | 0.753 | 0 | 2 | plausible_unproven |
| `MECH-254` | mechanism_hypothesis | candidate | 0.689 | 0.000 | 0.689 | 0 | 2 | plausible_unproven |
...
| `MECH-269b` | - | - | 0.820 | 0.000 | 0.820 | 0 | 7 | plausible_unproven |
...
| `MECH-360` | mechanism_hypothesis | candidate | 0.699 | 0.000 | 0.699 | 0 | 2 | plausible_unproven |
| `MECH-361` | mechanism_hypothesis | candidate | 0.785 | 0.000 | 0.785 | 0 | 3 | plausible_unproven |
| `MECH-364` | mechanism_hypothesis | candidate | 0.659 | 0.000 | 0.659 | 0 | 2 | plausible_unproven |
| `MECH-365` | mechanism_hypothesis | candidate | 0.769 | 0.000 | 0.769 | 0 | 2 | plausible_unproven |
| `MECH-366` | mechanism_hypothesis | candidate | 0.819 | 0.000 | 0.819 | 0 | 5 | plausible_unproven |
...
| `MECH-380` | mechanism_hypothesis | candidate | 0.729 | 0.000 | 0.729 | 0 | 2 | plausible_unproven |
| `MECH-381` | mechanism_hypothesis | candidate | 0.729 | 0.000 | 0.729 | 0 | 2 | plausible_unproven |
| `MECH-382` | mechanism_hypothesis | candidate | 0.699 | 0.000 | 0.699 | 0 | 1 | plausible_unproven |
| `MECH-383` | mechanism_hypothesis | candidate | 0.749 | 0.000 | 0.749 | 0 | 2 | plausible_unproven |
| `MECH-385` | mechanism_hypothesis | candidate | 0.689 | 0.000 | 0.689 | 0 | 1 | plausible_unproven |
| `MECH-388` | mechanism_hypothesis | candidate | 0.689 | 0.000 | 0.689 | 0 | 1 | plausible_unproven |
...
| `MECH-398` | mechanism_hypothesis | candidate | 0.835 | 0.000 | 0.835 | 0 | 3 | plausible_unproven |
| `MECH-399` | mechanism_hypothesis | candidate | 0.740 | 0.000 | 0.740 | 0 | 1 | plausible_unproven |
| `MECH-400` | mechanism_hypothesis | candidate | 0.620 | 0.000 | 0.620 | 0 | 1 | plausible_unproven |
| `MECH-411` | mechanism_hypothesis | candidate | 0.708 | 0.000 | 0.708 | 0 | 1 | plausible_unproven |
| `MECH-429` | mechanism_hypothesis | candidate | 0.724 | 0.000 | 0.724 | 0 | 1 | plausible_unproven |
| `MECH-434` | mechanism_hypothesis | candidate | 0.853 | 0.000 | 0.853 | 0 | 4 | plausible_unproven |
| `MECH-435` | mechanism_hypothesis | candidate | 0.689 | 0.000 | 0.689 | 0 | 1 | plausible_unproven |
...
| `MECH-454` | mechanism_hypothesis | candidate | 0.808 | 0.000 | 0.808 | 0 | 5 | plausible_unproven |
| `MECH-459` | mechanism_hypothesis | candidate | 0.800 | 0.000 | 0.800 | 0 | 3 | plausible_unproven |
| `MECH-466` | mechanism_hypothesis | candidate | 0.697 | 0.000 | 0.697 | 0 | 2 | plausible_unproven |
...
| `SD-027` | design_decision | candidate | 0.689 | 0.000 | 0.689 | 0 | 2 | plausible_unproven |
| `SD-030` | design_decision | candidate | 0.820 | 0.000 | 0.820 | 0 | 4 | plausible_unproven |
| `SD-032b` | - | - | 0.873 | 0.000 | 0.873 | 0 | 16 | plausible_unproven |
...
| `MECH-188` | mechanism_hypothesis | candidate | 0.622 | 0.125 | 0.787 | 1 | 3 | plausible_unproven |
...
| `MECH-057b` | - | - | 0.693 | 0.235 | 0.846 | 1 | 4 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.689 | 0.296 | 0.820 | 1 | 4 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.670 | 0.319 | 0.787 | 1 | 5 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.754 | 0.344 | 0.891 | 1 | 6 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.756 | 0.362 | 0.887 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.647 | 0.368 | 0.833 | 2 | 22 | plausible_unproven |
| `MECH-314b` | - | - | 0.645 | 0.374 | 0.781 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.750 | 0.374 | 0.875 | 1 | 6 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.642 | 0.396 | 0.889 | 7 | 10 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.669 | 0.450 | 0.889 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.702 | 0.472 | 0.856 | 2 | 5 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.658 | 0.496 | 0.820 | 83 | 7 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.694 | 0.497 | 0.891 | 3 | 11 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.651 | 0.507 | 0.796 | 9 | 13 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.679 | 0.518 | 0.841 | 5 | 7 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.699 | 0.518 | 0.879 | 7 | 14 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.682 | 0.522 | 0.842 | 5 | 12 | plausible_unproven |
...
| `ARC-026` | architecture_hypothesis | provisional | 0.659 | 0.539 | 0.779 | 3 | 5 | plausible_unproven |
...
| `MECH-256` | mechanism_hypothesis | candidate | 0.707 | 0.565 | 0.848 | 6 | 9 | plausible_unproven |
| `MECH-089` | mechanism_hypothesis | active | 0.713 | 0.569 | 0.856 | 12 | 10 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.702 | 0.571 | 0.790 | 2 | 3 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.697 | 0.571 | 0.823 | 11 | 24 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.738 | 0.573 | 0.903 | 3 | 13 | plausible_unproven |
| `MECH-056` | mechanism_hypothesis | provisional | 0.778 | 0.575 | 0.846 | 1 | 15 | plausible_unproven |
| `MECH-057a` | - | - | 0.766 | 0.575 | 0.830 | 1 | 5 | plausible_unproven |
| `MECH-059` | mechanism_hypothesis | active | 0.741 | 0.575 | 0.796 | 1 | 11 | plausible_unproven |
...
| `MECH-062` | mechanism_hypothesis | candidate | 0.698 | 0.582 | 0.756 | 1 | 2 | plausible_unproven |
| `SD-035` | design_decision | stable | 0.791 | 0.582 | 0.861 | 1 | 6 | plausible_unproven |
| `MECH-071` | mechanism_hypothesis | provisional | 0.722 | 0.588 | 0.856 | 38 | 4 | plausible_unproven |
| `SD-048` | design_decision | candidate | 0.796 | 0.592 | 0.864 | 1 | 6 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.724 | 0.593 | 0.855 | 19 | 5 | plausible_unproven |
| `SD-013` | design_decision | provisional | 0.727 | 0.608 | 0.846 | 4 | 4 | plausible_unproven |
...
| `MECH-090` | mechanism_hypothesis | active | 0.658 | 0.617 | 0.699 | 18 | 19 | plausible_unproven |

_Suppressed by gating: 56 substrate_coherence (ARC + universal invariant), 57 answer_state (open_question). These cross the gate under one regime but not the other; the discrepancy is not actionable under their evidence rules. See suppressed sections below._
...
| `INV-088` | candidate | 0.296 | 1 |
| `MECH-111` | candidate | 0.296 | 4 |
| ... | ... | ... | ... (28 more) |
...
| `CANDIDATE-contextual-memory-allocation-gate` | - | 0.851 | 5 |
