...
Generated: `2026-08-30T07:12:28.843536Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **85** | plausible_unproven: **476** |
...
Total: **300** discrepant claims (standard-gating only).
...
| `INV-088` | invariant | candidate | 0.665 | 0.217 | 0.814 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.672 | 0.218 | 0.824 | 1 | 21 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.643 | 0.240 | 0.778 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.666 | 0.255 | 0.803 | 1 | 5 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.701 | 0.261 | 0.847 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.678 | 0.261 | 0.817 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.670 | 0.264 | 0.805 | 1 | 3 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.718 | 0.264 | 0.869 | 1 | 4 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.699 | 0.275 | 0.841 | 1 | 6 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.645 | 0.276 | 0.768 | 1 | 3 | plausible_unproven |
| `MECH-258` | mechanism_hypothesis | candidate | 0.708 | 0.280 | 0.850 | 1 | 9 | plausible_unproven |
| `MECH-439` | mechanism_hypothesis | candidate | 0.678 | 0.303 | 0.803 | 1 | 7 | plausible_unproven |
| `MECH-144` | mechanism_hypothesis | candidate | 0.685 | 0.324 | 0.806 | 1 | 4 | plausible_unproven |
| `MECH-321` | mechanism_hypothesis | candidate | 0.620 | 0.334 | 0.810 | 2 | 14 | plausible_unproven |
...
| `MECH-180` | mechanism_hypothesis | candidate | 0.792 | 0.417 | 0.917 | 1 | 7 | plausible_unproven |
| `MECH-025b` | - | - | 0.695 | 0.420 | 0.786 | 1 | 4 | plausible_unproven |
...
| `INV-089` | invariant | provisional | 0.665 | 0.492 | 0.781 | 2 | 3 | plausible_unproven |
...
| `MECH-163` | mechanism_hypothesis | candidate | 0.724 | 0.519 | 0.860 | 2 | 14 | plausible_unproven |
...
| `MECH-150` | mechanism_hypothesis | candidate | 0.688 | 0.550 | 0.780 | 2 | 3 | plausible_unproven |
...
| `MECH-153` | mechanism_hypothesis | candidate | 0.694 | 0.567 | 0.821 | 3 | 7 | plausible_unproven |
...
| `MECH-230` | mechanism_hypothesis | provisional | 0.750 | 0.578 | 0.807 | 1 | 11 | plausible_unproven |
| `MECH-306` | mechanism_hypothesis | provisional | 0.796 | 0.578 | 0.869 | 1 | 4 | plausible_unproven |
| `MECH-268` | mechanism_hypothesis | provisional | 0.761 | 0.581 | 0.821 | 1 | 8 | plausible_unproven |
...
| `MECH-045` | mechanism_hypothesis | provisional | 0.778 | 0.594 | 0.840 | 1 | 14 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.720 | 0.594 | 0.846 | 18 | 5 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.704 | 0.598 | 0.810 | 82 | 7 | plausible_unproven |
| `MECH-087` | mechanism_hypothesis | candidate | 0.652 | 0.600 | 0.704 | 1 | 1 | plausible_unproven |
...
| `MECH-120` | mechanism_hypothesis | candidate | 0.815 | 0.618 | 0.881 | 1 | 11 | plausible_unproven |
| `MECH-094` | mechanism_hypothesis | stable | 0.755 | 0.619 | 0.845 | 2 | 26 | plausible_unproven |
| `MECH-436` | mechanism_hypothesis | candidate | 0.726 | 0.619 | 0.780 | 1 | 2 | plausible_unproven |
...
|---|---|---:|---:|---:|---:|
| `MECH-219` | candidate | 0.774 | 0.000 | 1 | 0 |
| `SD-019b` | - | 0.774 | 0.000 | 1 | 0 |
| `MECH-290` | candidate | 0.773 | 0.000 | 1 | 0 |
...
| `INV-088` | candidate | 0.217 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `MECH-457` | candidate | 0.218 | 1 |
| `MECH-329` | candidate | 0.240 | 1 |
| `MECH-466` | candidate | 0.251 | 1 |
| `MECH-475` | retired | 0.255 | 1 |
| `MECH-294` | candidate | 0.261 | 1 |
| `SD-087` | candidate | 0.261 | 1 |
| `MECH-122` | provisional | 0.264 | 1 |
| `MECH-166` | candidate | 0.264 | 1 |
