...
Generated: `2026-09-18T18:50:08.140947Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **81** | plausible_unproven: **583** |
| **low lit**             | novel_discovery: **11**         | speculative: **17** |

Total scored claims: 692
...
Total: **363** discrepant claims (standard-gating only).
...
| `CDQ-010` | - | - | 0.874 | 0.000 | 0.874 | 0 | 5 | plausible_unproven |
...
| `MECH-023` | mechanism_hypothesis | provisional | 0.745 | 0.000 | 0.745 | 0 | 5 | plausible_unproven |
| `MECH-024` | mechanism_hypothesis | provisional | 0.803 | 0.000 | 0.803 | 0 | 5 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.832 | 0.000 | 0.832 | 0 | 6 | plausible_unproven |
| `MECH-028` | mechanism_hypothesis | provisional | 0.816 | 0.000 | 0.816 | 0 | 5 | plausible_unproven |
| `MECH-030` | mechanism_hypothesis | provisional | 0.856 | 0.000 | 0.856 | 0 | 4 | plausible_unproven |
| `MECH-034` | mechanism_hypothesis | provisional | 0.774 | 0.000 | 0.774 | 0 | 5 | plausible_unproven |
| `MECH-035` | mechanism_hypothesis | candidate | 0.741 | 0.000 | 0.741 | 0 | 6 | plausible_unproven |
| `MECH-037` | mechanism_hypothesis | provisional | 0.699 | 0.000 | 0.699 | 0 | 5 | plausible_unproven |
| `MECH-038` | mechanism_hypothesis | candidate | 0.856 | 0.000 | 0.856 | 0 | 5 | plausible_unproven |
| `MECH-039` | mechanism_hypothesis | provisional | 0.828 | 0.000 | 0.828 | 0 | 5 | plausible_unproven |
| `MECH-040` | mechanism_hypothesis | provisional | 0.696 | 0.000 | 0.696 | 0 | 1 | plausible_unproven |
| `MECH-042` | mechanism_hypothesis | candidate | 0.865 | 0.000 | 0.865 | 0 | 5 | plausible_unproven |
| `MECH-043` | mechanism_hypothesis | provisional | 0.772 | 0.000 | 0.772 | 0 | 5 | plausible_unproven |
...
| `MECH-408` | mechanism_hypothesis | candidate | 0.660 | 0.000 | 0.660 | 0 | 1 | plausible_unproven |
...
| `INV-088` | invariant | candidate | 0.650 | 0.174 | 0.808 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.657 | 0.175 | 0.818 | 1 | 21 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.628 | 0.196 | 0.772 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.651 | 0.211 | 0.798 | 1 | 5 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.663 | 0.218 | 0.812 | 1 | 4 | plausible_unproven |
| `MECH-025b` | - | - | 0.641 | 0.221 | 0.781 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.705 | 0.221 | 0.866 | 1 | 4 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.721 | 0.221 | 0.888 | 1 | 5 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.630 | 0.233 | 0.762 | 1 | 3 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.696 | 0.275 | 0.836 | 1 | 6 | plausible_unproven |
| `MECH-144` | mechanism_hypothesis | candidate | 0.670 | 0.280 | 0.800 | 1 | 4 | plausible_unproven |
...
| `MECH-180` | mechanism_hypothesis | candidate | 0.778 | 0.374 | 0.912 | 1 | 7 | plausible_unproven |
...
| `ARC-032` | architecture_hypothesis | candidate | 0.633 | 0.441 | 0.825 | 5 | 6 | plausible_unproven |
| `SD-012` | design_decision | provisional | 0.638 | 0.442 | 0.835 | 3 | 25 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.645 | 0.449 | 0.775 | 2 | 3 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.644 | 0.463 | 0.825 | 5 | 8 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.639 | 0.467 | 0.811 | 18 | 8 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.703 | 0.476 | 0.855 | 2 | 14 | plausible_unproven |
| `MECH-017` | mechanism_hypothesis | candidate | 0.674 | 0.477 | 0.740 | 1 | 5 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.669 | 0.483 | 0.856 | 3 | 13 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.640 | 0.500 | 0.781 | 4 | 13 | plausible_unproven |
| `MECH-150` | mechanism_hypothesis | candidate | 0.667 | 0.506 | 0.774 | 2 | 3 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.669 | 0.524 | 0.815 | 3 | 7 | plausible_unproven |
...
| `MECH-440` | mechanism_hypothesis | candidate | 0.629 | 0.547 | 0.684 | 2 | 10 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.678 | 0.550 | 0.805 | 81 | 7 | plausible_unproven |
...
| `MECH-285` | mechanism_hypothesis | candidate | 0.794 | 0.581 | 0.865 | 1 | 16 | plausible_unproven |
| `DEV-NEED-006` | - | - | 0.754 | 0.582 | 0.812 | 1 | 5 | plausible_unproven |
| `SD-034` | design_decision | provisional | 0.755 | 0.585 | 0.812 | 1 | 9 | plausible_unproven |
...
| `ARC-024` | architecture_hypothesis | provisional | 0.693 | 0.608 | 0.779 | 26 | 3 | plausible_unproven |
...
| `MECH-094` | mechanism_hypothesis | stable | 0.743 | 0.615 | 0.829 | 2 | 28 | plausible_unproven |
...
| `SD-063` | design_decision | provisional | 0.769 | 0.617 | 0.820 | 1 | 4 | plausible_unproven |
| `SD-079` | design_decision | provisional | 0.603 | 0.654 | 0.578 | 1 | 2 | confirmed_established |

_Suppressed by gating: 95 substrate_coherence (ARC + universal invariant), 69 answer_state (open_question). These cross the gate under one regime but not the other; the discrepancy is not actionable under their evidence rules. See suppressed sections below._
...
| `ARC-010` | architectural_commitment | active | 0.738 | 2 |
...
|---|---|---:|---:|---:|---:|
| `SD-098` | candidate | 0.775 | 0.000 | 1 | 0 |
| `SD-074` | candidate | 0.768 | 0.000 | 1 | 0 |
| `SD-077` | candidate | 0.767 | 0.000 | 1 | 0 |
| `SD-075` | candidate | 0.766 | 0.000 | 1 | 0 |
| `MECH-349` | candidate | 0.759 | 0.000 | 1 | 0 |
| `MECH-464` | candidate | 0.757 | 0.000 | 1 | 0 |
| `EXT-001` | candidate | 0.740 | 0.000 | 1 | 0 |
| `MECH-219` | candidate | 0.731 | 0.000 | 1 | 0 |
| `SD-019b` | - | 0.731 | 0.000 | 1 | 0 |
| `MECH-290` | candidate | 0.730 | 0.000 | 1 | 0 |
...
| `MECH-445` | candidate | 0.162 | 1 |
| `MECH-070` | retiring | 0.163 | 2 |
| `INV-088` | candidate | 0.174 | 1 |
| `MECH-111` | candidate | 0.175 | 2 |
| `MECH-116` | candidate | 0.175 | 2 |
| `MECH-295` | candidate | 0.175 | 2 |
| `MECH-457` | candidate | 0.175 | 1 |
| `MECH-329` | candidate | 0.196 | 1 |
| `MECH-466` | candidate | 0.207 | 1 |
| `MECH-475` | retired | 0.211 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `SD-087` | candidate | 0.218 | 1 |
| `MECH-025b` | - | 0.221 | 1 |
| `MECH-122` | provisional | 0.221 | 1 |
| `MECH-166` | candidate | 0.221 | 1 |
| `SD-009` | candidate | 0.233 | 1 |
| `MECH-463` | candidate | 0.240 | 2 |
| `MECH-152` | candidate | 0.241 | 1 |
