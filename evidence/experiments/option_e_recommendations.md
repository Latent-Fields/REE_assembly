...
Generated: `2026-09-17T10:57:18.775699Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **82** | plausible_unproven: **565** |
| **low lit**             | novel_discovery: **10**         | speculative: **17** |

Total scored claims: 674
...
Total: **347** discrepant claims (standard-gating only).
...
| `INV-088` | invariant | candidate | 0.651 | 0.176 | 0.809 | 1 | 6 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.659 | 0.178 | 0.819 | 1 | 21 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.629 | 0.199 | 0.773 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.652 | 0.214 | 0.798 | 1 | 5 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.664 | 0.221 | 0.812 | 1 | 4 | plausible_unproven |
| `MECH-025b` | - | - | 0.642 | 0.224 | 0.781 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.706 | 0.224 | 0.867 | 1 | 4 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.723 | 0.224 | 0.889 | 1 | 5 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.631 | 0.236 | 0.763 | 1 | 3 | plausible_unproven |
...
| `MECH-144` | mechanism_hypothesis | candidate | 0.671 | 0.283 | 0.801 | 1 | 4 | plausible_unproven |
...
| `ARC-032` | architecture_hypothesis | candidate | 0.634 | 0.444 | 0.825 | 5 | 6 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.646 | 0.452 | 0.776 | 2 | 3 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.644 | 0.463 | 0.826 | 5 | 8 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.640 | 0.470 | 0.811 | 18 | 8 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.705 | 0.479 | 0.855 | 2 | 14 | plausible_unproven |
| `MECH-017` | mechanism_hypothesis | candidate | 0.676 | 0.480 | 0.741 | 1 | 5 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.671 | 0.486 | 0.856 | 3 | 13 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.640 | 0.500 | 0.781 | 4 | 13 | plausible_unproven |
| `MECH-150` | mechanism_hypothesis | candidate | 0.669 | 0.509 | 0.775 | 2 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.643 | 0.525 | 0.760 | 3 | 6 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.671 | 0.527 | 0.816 | 3 | 7 | plausible_unproven |
...
| `SD-003` | design_decision | superseded | 0.679 | 0.553 | 0.805 | 81 | 7 | plausible_unproven |
...
| `MECH-120` | mechanism_hypothesis | candidate | 0.801 | 0.577 | 0.876 | 1 | 11 | plausible_unproven |
| `MECH-436` | mechanism_hypothesis | candidate | 0.709 | 0.578 | 0.775 | 1 | 2 | plausible_unproven |
| `MECH-285` | mechanism_hypothesis | candidate | 0.795 | 0.584 | 0.865 | 1 | 16 | plausible_unproven |
| `DEV-NEED-006` | - | - | 0.756 | 0.585 | 0.813 | 1 | 5 | plausible_unproven |
| `SD-034` | design_decision | provisional | 0.756 | 0.588 | 0.812 | 1 | 9 | plausible_unproven |
...
| `SD-079` | design_decision | provisional | 0.604 | 0.657 | 0.578 | 1 | 2 | confirmed_established |
...
|---|---|---:|---:|---:|---:|
| `SD-074` | candidate | 0.771 | 0.000 | 1 | 0 |
| `SD-077` | candidate | 0.770 | 0.000 | 1 | 0 |
| `SD-075` | candidate | 0.769 | 0.000 | 1 | 0 |
| `MECH-349` | candidate | 0.762 | 0.000 | 1 | 0 |
| `MECH-464` | candidate | 0.760 | 0.000 | 1 | 0 |
| `EXT-001` | candidate | 0.743 | 0.000 | 1 | 0 |
| `MECH-219` | candidate | 0.734 | 0.000 | 1 | 0 |
| `SD-019b` | - | 0.734 | 0.000 | 1 | 0 |
| `MECH-290` | candidate | 0.733 | 0.000 | 1 | 0 |
...
| `MECH-445` | candidate | 0.165 | 1 |
| `MECH-111` | candidate | 0.175 | 2 |
| `MECH-116` | candidate | 0.175 | 2 |
| `MECH-295` | candidate | 0.175 | 2 |
| `INV-088` | candidate | 0.176 | 1 |
| `MECH-457` | candidate | 0.178 | 1 |
| `MECH-329` | candidate | 0.199 | 1 |
| `MECH-466` | candidate | 0.210 | 1 |
| `MECH-475` | retired | 0.214 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `SD-087` | candidate | 0.221 | 1 |
| `MECH-025b` | - | 0.224 | 1 |
| `MECH-122` | provisional | 0.224 | 1 |
| `MECH-166` | candidate | 0.224 | 1 |
| `SD-009` | candidate | 0.236 | 1 |
| `MECH-463` | candidate | 0.243 | 2 |
| `MECH-152` | provisional | 0.244 | 1 |
