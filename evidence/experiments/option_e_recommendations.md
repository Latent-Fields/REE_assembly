...
Generated: `2026-06-21T16:31:29.919118Z`
...
| `MECH-216` | mechanism | provisional | 0.738 | 0.548 | 0.865 | 2 | 5 | plausible_unproven |
...
| `SD-029` | design_decision | candidate | 0.724 | 0.597 | 0.852 | 5 | 12 | plausible_unproven |
...
|---|---|---:|---:|---:|---:|
| `ARC-013` | active | 0.775 | 0.000 | 1 | 0 |
...
| `MECH-075` | candidate | 0.368 | 5 |
| `MECH-111` | candidate | 0.372 | 4 |
| ... | ... | ... | ... (14 more) |
