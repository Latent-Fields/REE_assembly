...
Generated: `2026-06-16T12:53:18.227523Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **67** | plausible_unproven: **356** |
| **low lit**             | novel_discovery: **2**         | speculative: **4** |
...
| `MECH-118` | mechanism_hypothesis | candidate | 0.637 | 0.148 | 0.800 | 1 | 3 | plausible_unproven |
| `MECH-165` | mechanism_hypothesis | candidate | 0.654 | 0.165 | 0.817 | 1 | 3 | plausible_unproven |
| `MECH-188` | mechanism_hypothesis | candidate | 0.640 | 0.169 | 0.797 | 1 | 3 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.694 | 0.194 | 0.860 | 1 | 4 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.693 | 0.195 | 0.859 | 1 | 4 | plausible_unproven |
| `SD-032c` | - | - | 0.641 | 0.199 | 0.789 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.681 | 0.200 | 0.842 | 1 | 6 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.629 | 0.219 | 0.902 | 2 | 11 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.678 | 0.230 | 0.828 | 1 | 10 | plausible_unproven |
| `MECH-047` | mechanism_hypothesis | provisional | 0.716 | 0.285 | 0.859 | 1 | 4 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.721 | 0.309 | 0.858 | 1 | 6 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.724 | 0.309 | 0.862 | 1 | 6 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.726 | 0.312 | 0.864 | 1 | 5 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.738 | 0.314 | 0.879 | 1 | 7 | plausible_unproven |
| `MECH-057b` | - | - | 0.723 | 0.322 | 0.856 | 1 | 4 | plausible_unproven |
| `MECH-295` | mechanism_hypothesis | candidate | 0.657 | 0.339 | 0.869 | 2 | 6 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.632 | 0.380 | 0.883 | 5 | 7 | plausible_unproven |
| `SD-032b` | - | - | 0.651 | 0.420 | 0.883 | 10 | 16 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate_substrate_landed | 0.734 | 0.431 | 0.835 | 1 | 3 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.636 | 0.434 | 0.838 | 24 | 9 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.777 | 0.449 | 0.886 | 1 | 5 | plausible_unproven |
| `MECH-314b` | - | - | 0.682 | 0.461 | 0.792 | 1 | 2 | plausible_unproven |
| `MECH-314c` | - | - | 0.732 | 0.461 | 0.823 | 1 | 3 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.683 | 0.465 | 0.900 | 7 | 10 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.670 | 0.508 | 0.833 | 10 | 24 | plausible_unproven |
| `SD-016` | design_decision | implemented | 0.643 | 0.509 | 0.777 | 6 | 3 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.709 | 0.529 | 0.890 | 7 | 14 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.719 | 0.537 | 0.900 | 19 | 9 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.744 | 0.559 | 0.867 | 2 | 5 | plausible_unproven |
| `ARC-024` | architecture_hypothesis | provisional | 0.683 | 0.562 | 0.805 | 28 | 3 | plausible_unproven |
...
| `SD-003` | design_decision | superseded | 0.707 | 0.583 | 0.831 | 83 | 7 | plausible_unproven |
| `MECH-089` | mechanism_hypothesis | active | 0.729 | 0.592 | 0.867 | 12 | 10 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.701 | 0.594 | 0.807 | 9 | 13 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.729 | 0.605 | 0.854 | 5 | 5 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.731 | 0.609 | 0.853 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.707 | 0.612 | 0.801 | 26 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.700 | 0.613 | 0.786 | 5 | 6 | plausible_unproven |
| `SD-012` | design_decision | provisional | 0.738 | 0.614 | 0.861 | 5 | 25 | plausible_unproven |
| `MECH-187` | mechanism_hypothesis | candidate | 0.791 | 0.618 | 0.849 | 1 | 7 | plausible_unproven |
...
|---|---|---:|---:|---:|---:|
| `SD-057` | candidate | 0.757 | 0.000 | 1 | 0 |
| `onboarding` | - | 0.623 | 0.000 | 1 | 0 |
...
|---|---|---:|---:|
| `MECH-118` | candidate | 0.148 | 1 |
| `MECH-150` | candidate | 0.154 | 1 |
| `MECH-165` | candidate | 0.165 | 1 |
| `SD-018` | implemented | 0.168 | 1 |
| `MECH-188` | candidate | 0.169 | 1 |
| `SD-023` | candidate | 0.194 | 1 |
| `ARC-032` | candidate | 0.195 | 2 |
| `MECH-116` | candidate | 0.195 | 2 |
| `MECH-220` | candidate | 0.195 | 1 |
| `SD-032c` | - | 0.199 | 1 |
| `MECH-091` | candidate | 0.200 | 1 |
| `MECH-120` | candidate | 0.219 | 2 |
| `MECH-186` | candidate | 0.219 | 2 |
| `MECH-155` | candidate | 0.221 | 2 |
| `SD-047` | provisional | 0.230 | 1 |
| `MECH-128` | candidate | 0.254 | 3 |
| `MECH-047` | provisional | 0.285 | 1 |
| `INV-054` | candidate | 0.298 | 3 |
| `SD-021` | candidate | 0.299 | 3 |
| `MECH-026` | provisional | 0.309 | 1 |
| `MECH-029` | provisional | 0.309 | 1 |
| `MECH-022` | provisional | 0.312 | 1 |
| `MECH-025` | candidate | 0.314 | 1 |
| `MECH-057b` | - | 0.322 | 1 |
| `MECH-070` | retiring | 0.328 | 4 |
| `MECH-153` | candidate | 0.333 | 4 |
| `MECH-099` | candidate | 0.337 | 6 |
| `MECH-295` | candidate | 0.339 | 2 |
| `MECH-097` | candidate | 0.361 | 1 |
| `MECH-075` | candidate | 0.380 | 5 |
| ... | ... | ... | ... (14 more) |
