...
Generated: `2026-08-13T19:53:26.256674Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **99** | plausible_unproven: **434** |
...
Total: **265** discrepant claims (standard-gating only).
...
| `ARC-051` | architecture_hypothesis | candidate | 0.844 | 0.000 | 0.844 | 0 | 4 | plausible_unproven |
...
| `MECH-254` | mechanism_hypothesis | candidate | 0.683 | 0.000 | 0.683 | 0 | 2 | plausible_unproven |
...
| `MECH-339` | mechanism_hypothesis | candidate | 0.673 | 0.000 | 0.673 | 0 | 2 | plausible_unproven |
| `MECH-340` | mechanism_hypothesis | candidate | 0.688 | 0.000 | 0.688 | 0 | 2 | plausible_unproven |
...
| `MECH-394` | mechanism_hypothesis | candidate | 0.838 | 0.000 | 0.838 | 0 | 4 | plausible_unproven |
...
| `SD-027` | design_decision | candidate | 0.683 | 0.000 | 0.683 | 0 | 2 | plausible_unproven |
...
| `SD-037` | design_decision | candidate | 0.840 | 0.000 | 0.840 | 0 | 4 | plausible_unproven |
...
| `SD-060` | design_decision | candidate | 0.738 | 0.000 | 0.738 | 0 | 2 | plausible_unproven |
...
| `MECH-057b` | - | - | 0.678 | 0.192 | 0.840 | 1 | 4 | plausible_unproven |
| `INV-088` | invariant | candidate | 0.677 | 0.253 | 0.818 | 1 | 6 | plausible_unproven |
...
| `MECH-329` | mechanism_hypothesis | candidate | 0.655 | 0.276 | 0.782 | 1 | 5 | plausible_unproven |
| `MECH-144` | mechanism_hypothesis | candidate | 0.677 | 0.280 | 0.810 | 1 | 4 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.734 | 0.291 | 0.882 | 1 | 6 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.679 | 0.291 | 0.808 | 1 | 5 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.713 | 0.298 | 0.851 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.691 | 0.298 | 0.822 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.726 | 0.301 | 0.868 | 1 | 4 | plausible_unproven |
| `MECH-267` | mechanism_hypothesis | provisional | 0.725 | 0.301 | 0.866 | 1 | 5 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.740 | 0.301 | 0.886 | 1 | 6 | plausible_unproven |
| `MECH-428` | mechanism | candidate | 0.637 | 0.301 | 0.749 | 1 | 3 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.657 | 0.313 | 0.772 | 1 | 3 | plausible_unproven |
| `MECH-357` | mechanism_hypothesis | candidate | 0.653 | 0.314 | 0.766 | 1 | 3 | plausible_unproven |
| `MECH-236` | mechanism_hypothesis | candidate | 0.698 | 0.319 | 0.824 | 1 | 4 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.627 | 0.326 | 0.828 | 2 | 22 | plausible_unproven |
| `MECH-314b` | - | - | 0.707 | 0.331 | 0.832 | 1 | 3 | plausible_unproven |
| `MECH-314c` | - | - | 0.735 | 0.331 | 0.870 | 1 | 6 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.650 | 0.352 | 0.848 | 2 | 5 | plausible_unproven |
...
| `MECH-476` | mechanism_hypothesis | retired | 0.620 | 0.398 | 0.842 | 3 | 5 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.638 | 0.404 | 0.873 | 3 | 4 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.656 | 0.428 | 0.884 | 19 | 9 | plausible_unproven |
| `MECH-180` | mechanism_hypothesis | candidate | 0.766 | 0.453 | 0.871 | 1 | 4 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.670 | 0.454 | 0.886 | 3 | 11 | plausible_unproven |
| `MECH-074d` | - | - | 0.635 | 0.462 | 0.807 | 4 | 4 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.655 | 0.475 | 0.835 | 5 | 8 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.667 | 0.497 | 0.837 | 5 | 12 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.644 | 0.504 | 0.785 | 26 | 3 | plausible_unproven |
| `Q-034` | question | open | 0.638 | 0.505 | 0.770 | 5 | 6 | plausible_unproven |
| `MECH-025b` | - | - | 0.677 | 0.506 | 0.791 | 2 | 4 | plausible_unproven |
| `ARC-026` | architecture_hypothesis | provisional | 0.646 | 0.518 | 0.774 | 3 | 5 | plausible_unproven |
| `ARC-032` | architecture_hypothesis | candidate | 0.679 | 0.521 | 0.838 | 5 | 8 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.673 | 0.528 | 0.818 | 11 | 24 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.683 | 0.529 | 0.785 | 2 | 3 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.698 | 0.531 | 0.865 | 3 | 14 | plausible_unproven |
...
| `SD-014` | design_decision | candidate | 0.715 | 0.563 | 0.866 | 3 | 13 | plausible_unproven |
...
| `SD-048` | design_decision | candidate | 0.747 | 0.579 | 0.859 | 2 | 6 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.703 | 0.581 | 0.825 | 4 | 7 | plausible_unproven |
| `MECH-135` | mechanism_hypothesis | candidate | 0.704 | 0.582 | 0.825 | 7 | 11 | plausible_unproven |
| `MECH-150` | mechanism_hypothesis | candidate | 0.650 | 0.586 | 0.714 | 2 | 2 | plausible_unproven |
...
| `MECH-102` | mechanism_hypothesis | active | 0.708 | 0.595 | 0.822 | 25 | 9 | plausible_unproven |
...
| `MECH-306` | mechanism_hypothesis | provisional | 0.809 | 0.615 | 0.874 | 1 | 4 | plausible_unproven |
| `MECH-268` | mechanism_hypothesis | provisional | 0.773 | 0.618 | 0.825 | 1 | 8 | plausible_unproven |
...
|---|---|---:|---:|---:|---:|
| `MECH-151` | candidate | 0.751 | 0.000 | 1 | 0 |
...
| `SD-037` | candidate | 0.840 | 4 |
| `MECH-394` | candidate | 0.838 | 4 |
