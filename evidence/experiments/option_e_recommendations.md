...
Generated: `2026-08-22T13:23:58.598989Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **88** | plausible_unproven: **454** |
| **low lit**             | novel_discovery: **0**         | speculative: **8** |

Total scored claims: 550
...
| `ARC-060` | architecture_hypothesis | candidate | 0.852 | 0.000 | 0.852 | 0 | 13 | plausible_unproven |
| `ARC-078` | architecture_hypothesis | candidate | 0.850 | 0.000 | 0.850 | 0 | 11 | plausible_unproven |
| `ARC-090` | architecture_hypothesis | candidate | 0.733 | 0.000 | 0.733 | 0 | 2 | plausible_unproven |
| `CANDIDATE-autonomic-rebound-parasympathetic-recovery` | - | - | 0.831 | 0.000 | 0.831 | 0 | 4 | plausible_unproven |
...
| `DEV-NEED-010` | - | - | 0.703 | 0.000 | 0.703 | 0 | 1 | plausible_unproven |
| `DEV-NEED-012` | - | - | 0.858 | 0.000 | 0.858 | 0 | 6 | plausible_unproven |
| `DEV-NEED-013` | - | - | 0.786 | 0.000 | 0.786 | 0 | 3 | plausible_unproven |
| `DEV-NEED-014` | - | - | 0.803 | 0.000 | 0.803 | 0 | 3 | plausible_unproven |
| `DEV-NEED-015` | - | - | 0.703 | 0.000 | 0.703 | 0 | 1 | plausible_unproven |
...
| `INV-043` | invariant | candidate | 0.817 | 0.000 | 0.817 | 0 | 9 | plausible_unproven |
...
| `INV-048` | derived_prediction | candidate | 0.838 | 0.000 | 0.838 | 0 | 4 | plausible_unproven |
...
| `INV-055` | invariant | candidate | 0.831 | 0.000 | 0.831 | 0 | 5 | plausible_unproven |
| `INV-056` | invariant | candidate | 0.620 | 0.000 | 0.620 | 0 | 1 | plausible_unproven |
| `INV-060` | invariant | candidate | 0.753 | 0.000 | 0.753 | 0 | 2 | plausible_unproven |
...
| `INV-082` | invariant | candidate | 0.804 | 0.000 | 0.804 | 0 | 4 | plausible_unproven |
| `MECH-006` | mechanism_hypothesis | provisional | 0.713 | 0.000 | 0.713 | 0 | 2 | plausible_unproven |
...
| `MECH-048` | mechanism_hypothesis | provisional | 0.828 | 0.000 | 0.828 | 0 | 4 | plausible_unproven |
...
| `MECH-088` | mechanism_hypothesis | candidate | 0.777 | 0.000 | 0.777 | 0 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.823 | 0.000 | 0.823 | 0 | 6 | plausible_unproven |
| `MECH-096` | mechanism_hypothesis | candidate | 0.777 | 0.000 | 0.777 | 0 | 2 | plausible_unproven |
| `MECH-103` | mechanism_hypothesis | candidate | 0.812 | 0.000 | 0.812 | 0 | 3 | plausible_unproven |
...
| `MECH-148` | mechanism_hypothesis | candidate | 0.763 | 0.000 | 0.763 | 0 | 2 | plausible_unproven |
| `MECH-149` | mechanism_hypothesis | candidate | 0.701 | 0.000 | 0.701 | 0 | 1 | plausible_unproven |
| `MECH-151` | mechanism_hypothesis | candidate | 0.815 | 0.000 | 0.815 | 0 | 4 | plausible_unproven |
...
| `MECH-181` | mechanism_hypothesis | candidate | 0.687 | 0.000 | 0.687 | 0 | 2 | plausible_unproven |
...
| `MECH-195` | mechanism_hypothesis | candidate | 0.698 | 0.000 | 0.698 | 0 | 2 | plausible_unproven |
...
| `MECH-257` | mechanism_hypothesis | candidate | 0.742 | 0.000 | 0.742 | 0 | 2 | plausible_unproven |
...
| `MECH-266` | mechanism_hypothesis | provisional | 0.821 | 0.000 | 0.821 | 0 | 6 | plausible_unproven |
| `MECH-269` | mechanism_hypothesis | candidate | 0.845 | 0.000 | 0.845 | 0 | 34 | plausible_unproven |
| `MECH-269b` | - | - | 0.812 | 0.000 | 0.812 | 0 | 7 | plausible_unproven |
| `MECH-270` | mechanism_hypothesis | candidate | 0.827 | 0.000 | 0.827 | 0 | 4 | plausible_unproven |
| `MECH-271` | mechanism_hypothesis | candidate | 0.877 | 0.000 | 0.877 | 0 | 4 | plausible_unproven |
...
| `MECH-312` | mechanism_hypothesis | candidate | 0.837 | 0.000 | 0.837 | 0 | 14 | plausible_unproven |
| `MECH-316` | mechanism_hypothesis | candidate | 0.856 | 0.000 | 0.856 | 0 | 9 | plausible_unproven |
| `MECH-317` | mechanism_hypothesis | candidate | 0.869 | 0.000 | 0.869 | 0 | 6 | plausible_unproven |
...
| `MECH-337` | mechanism_hypothesis | candidate | 0.851 | 0.000 | 0.851 | 0 | 4 | plausible_unproven |
| `MECH-338` | mechanism_hypothesis | candidate | 0.787 | 0.000 | 0.787 | 0 | 3 | plausible_unproven |
...
| `MECH-372` | mechanism_hypothesis | candidate | 0.807 | 0.000 | 0.807 | 0 | 3 | plausible_unproven |
...
| `MECH-439` | mechanism_hypothesis | candidate | 0.805 | 0.000 | 0.805 | 0 | 7 | plausible_unproven |
| `MECH-440` | mechanism_hypothesis | candidate | 0.876 | 0.000 | 0.876 | 0 | 5 | plausible_unproven |
| `MECH-442` | mechanism_hypothesis | candidate | 0.759 | 0.000 | 0.759 | 0 | 5 | plausible_unproven |
...
| `MECH-446` | mechanism_hypothesis | candidate | 0.746 | 0.000 | 0.746 | 0 | 3 | plausible_unproven |
| `MECH-450` | mechanism_hypothesis | candidate | 0.823 | 0.000 | 0.823 | 0 | 5 | plausible_unproven |
...
| `MECH-459` | mechanism_hypothesis | candidate | 0.792 | 0.000 | 0.792 | 0 | 3 | plausible_unproven |
| `MECH-471` | mechanism_hypothesis | candidate | 0.823 | 0.000 | 0.823 | 0 | 3 | plausible_unproven |
| `MECH-472` | mechanism_hypothesis | candidate | 0.852 | 0.000 | 0.852 | 0 | 4 | plausible_unproven |
...
| `MECH-489` | mechanism_hypothesis | candidate | 0.828 | 0.000 | 0.828 | 0 | 5 | plausible_unproven |
...
| `Q-046` | - | - | 0.743 | 0.000 | 0.743 | 0 | 2 | plausible_unproven |
...
| `SD-030` | design_decision | candidate | 0.812 | 0.000 | 0.812 | 0 | 4 | plausible_unproven |
...
| `SD-033b` | - | - | 0.878 | 0.000 | 0.878 | 0 | 5 | plausible_unproven |
...
| `SD-039` | design_decision | candidate | 0.851 | 0.000 | 0.851 | 0 | 6 | plausible_unproven |
| `SD-040` | design_decision | candidate | 0.728 | 0.000 | 0.728 | 0 | 1 | plausible_unproven |
| `SD-042` | design_decision | candidate | 0.768 | 0.000 | 0.768 | 0 | 2 | plausible_unproven |
...
| `SD-082` | design_decision | candidate_substrate_landed | 0.835 | 0.000 | 0.835 | 0 | 8 | plausible_unproven |
...
| `MECH-057b` | - | - | 0.672 | 0.173 | 0.838 | 1 | 4 | plausible_unproven |
| `INV-088` | invariant | candidate | 0.670 | 0.234 | 0.816 | 1 | 6 | plausible_unproven |
| `MECH-329` | mechanism_hypothesis | candidate | 0.649 | 0.257 | 0.780 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.672 | 0.272 | 0.805 | 1 | 5 | plausible_unproven |
...
| `MECH-294` | mechanism_hypothesis | candidate | 0.706 | 0.278 | 0.849 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.684 | 0.278 | 0.819 | 1 | 4 | plausible_unproven |
| `MECH-144` | mechanism_hypothesis | candidate | 0.676 | 0.280 | 0.808 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.676 | 0.281 | 0.807 | 1 | 3 | plausible_unproven |
| `MECH-267` | mechanism_hypothesis | provisional | 0.718 | 0.281 | 0.864 | 1 | 5 | plausible_unproven |
| `MECH-467` | mechanism_hypothesis | candidate | 0.659 | 0.281 | 0.785 | 1 | 3 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.733 | 0.282 | 0.883 | 1 | 6 | plausible_unproven |
| `MECH-428` | mechanism | candidate | 0.630 | 0.282 | 0.746 | 1 | 3 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.651 | 0.294 | 0.770 | 1 | 3 | plausible_unproven |
| `MECH-357` | mechanism_hypothesis | candidate | 0.646 | 0.295 | 0.763 | 1 | 3 | plausible_unproven |
| `MECH-314b` | - | - | 0.700 | 0.312 | 0.829 | 1 | 3 | plausible_unproven |
| `MECH-314c` | - | - | 0.728 | 0.312 | 0.867 | 1 | 6 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.640 | 0.333 | 0.845 | 2 | 5 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.628 | 0.384 | 0.871 | 3 | 4 | plausible_unproven |
...
| `MECH-180` | mechanism_hypothesis | candidate | 0.798 | 0.434 | 0.919 | 1 | 7 | plausible_unproven |
| `MECH-074d` | - | - | 0.624 | 0.443 | 0.805 | 4 | 4 | plausible_unproven |
...
| `MECH-321` | mechanism_hypothesis | candidate | 0.640 | 0.467 | 0.813 | 4 | 14 | plausible_unproven |
| `MECH-025b` | - | - | 0.668 | 0.487 | 0.788 | 2 | 4 | plausible_unproven |
| `ARC-032` | architecture_hypothesis | candidate | 0.667 | 0.502 | 0.833 | 5 | 6 | plausible_unproven |
| `SD-005` | design_decision | implemented | 0.688 | 0.504 | 0.871 | 26 | 4 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.673 | 0.509 | 0.783 | 2 | 3 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.662 | 0.509 | 0.815 | 11 | 24 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.686 | 0.511 | 0.862 | 3 | 14 | plausible_unproven |
| `ARC-026` | architecture_hypothesis | provisional | 0.644 | 0.518 | 0.771 | 3 | 5 | plausible_unproven |
| `Q-034` | question | open | 0.646 | 0.525 | 0.767 | 3 | 6 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.704 | 0.544 | 0.863 | 3 | 13 | plausible_unproven |
...
| `SD-048` | design_decision | candidate | 0.738 | 0.560 | 0.856 | 2 | 6 | plausible_unproven |
| `MECH-150` | mechanism_hypothesis | candidate | 0.696 | 0.567 | 0.782 | 2 | 3 | plausible_unproven |
...
| `MECH-057a` | - | - | 0.762 | 0.575 | 0.824 | 1 | 4 | plausible_unproven |
...
| `MECH-102` | mechanism_hypothesis | active | 0.696 | 0.575 | 0.818 | 25 | 8 | plausible_unproven |
| `MECH-124` | mechanism_hypothesis | provisional | 0.784 | 0.575 | 0.853 | 1 | 4 | plausible_unproven |
| `MECH-187` | mechanism_hypothesis | candidate | 0.767 | 0.575 | 0.831 | 1 | 7 | plausible_unproven |
...
| `SD-035` | design_decision | stable | 0.784 | 0.575 | 0.853 | 1 | 6 | plausible_unproven |
...
| `MECH-153` | mechanism_hypothesis | candidate | 0.704 | 0.585 | 0.823 | 3 | 7 | plausible_unproven |
...
| `MECH-230` | mechanism_hypothesis | provisional | 0.756 | 0.595 | 0.809 | 1 | 11 | plausible_unproven |
| `MECH-306` | mechanism_hypothesis | provisional | 0.802 | 0.595 | 0.871 | 1 | 4 | plausible_unproven |
| `MECH-268` | mechanism_hypothesis | provisional | 0.767 | 0.598 | 0.823 | 1 | 8 | plausible_unproven |
| `MECH-314` | mechanism_hypothesis | candidate_substrate_landed | 0.805 | 0.607 | 0.871 | 1 | 10 | plausible_unproven |
| `MECH-314a` | - | - | 0.792 | 0.607 | 0.853 | 1 | 6 | plausible_unproven |
| `MECH-309` | mechanism_hypothesis | candidate | 0.760 | 0.608 | 0.861 | 2 | 14 | plausible_unproven |
| `MECH-346` | mechanism_hypothesis | candidate | 0.750 | 0.608 | 0.797 | 1 | 3 | plausible_unproven |
| `MECH-347` | mechanism_hypothesis | candidate | 0.754 | 0.608 | 0.802 | 1 | 3 | plausible_unproven |
| `SD-013` | design_decision | provisional | 0.723 | 0.608 | 0.838 | 4 | 4 | plausible_unproven |
| `SD-057` | design_decision | candidate | 0.697 | 0.608 | 0.742 | 1 | 2 | plausible_unproven |
| `MECH-045` | mechanism_hypothesis | provisional | 0.784 | 0.611 | 0.842 | 1 | 14 | plausible_unproven |
| `MECH-106` | mechanism_hypothesis | provisional | 0.748 | 0.613 | 0.838 | 2 | 5 | plausible_unproven |
| `MECH-119` | mechanism_hypothesis | stable | 0.707 | 0.615 | 0.768 | 2 | 3 | plausible_unproven |
| `MECH-261` | mechanism_hypothesis | stable | 0.763 | 0.615 | 0.861 | 2 | 20 | plausible_unproven |
| `MECH-087` | mechanism_hypothesis | candidate | 0.661 | 0.617 | 0.706 | 1 | 1 | plausible_unproven |

_Suppressed by gating: 57 substrate_coherence (ARC + universal invariant), 66 answer_state (open_question). These cross the gate under one regime but not the other; the discrepancy is not actionable under their evidence rules. See suppressed sections below._
...
| `INV-013` | invariant | active | 0.810 | 3 |
| `ARC-014` | architectural_commitment | active | 0.760 | 3 |
...
| `MECH-295` | candidate | 0.190 | 2 |
| `MECH-111` | candidate | 0.217 | 3 |
| `MECH-128` | candidate | 0.217 | 3 |
| `MECH-445` | candidate | 0.223 | 1 |
| `INV-088` | candidate | 0.234 | 1 |
| `MECH-329` | candidate | 0.257 | 1 |
| `MECH-466` | candidate | 0.268 | 1 |
| `MECH-475` | retired | 0.272 | 1 |
| `MECH-026` | provisional | 0.275 | 1 |
| `MECH-029` | provisional | 0.275 | 1 |
| `MECH-047` | provisional | 0.275 | 1 |
| `MECH-294` | candidate | 0.278 | 1 |
| `SD-087` | candidate | 0.278 | 1 |
...
| `ARC-060` | candidate | 0.852 | 13 |
| `MECH-472` | candidate | 0.852 | 4 |
| `MECH-171` | candidate | 0.851 | 4 |
| `MECH-198` | candidate | 0.851 | 8 |
| `MECH-337` | candidate | 0.851 | 4 |
| `SD-039` | candidate | 0.851 | 6 |
