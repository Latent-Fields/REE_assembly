...
Generated: `2026-08-09T05:55:17.206862Z`
...
| **low lit**             | novel_discovery: **0**         | speculative: **17** |

Total scored claims: 538
...
| `MECH-057b` | - | - | 0.682 | 0.202 | 0.842 | 1 | 4 | plausible_unproven |
...
| `MECH-329` | mechanism_hypothesis | candidate | 0.660 | 0.286 | 0.784 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.682 | 0.301 | 0.809 | 1 | 5 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.738 | 0.302 | 0.883 | 1 | 6 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.716 | 0.308 | 0.852 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.694 | 0.308 | 0.823 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.730 | 0.311 | 0.869 | 1 | 4 | plausible_unproven |
| `MECH-267` | mechanism_hypothesis | provisional | 0.729 | 0.311 | 0.868 | 1 | 5 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.743 | 0.311 | 0.887 | 1 | 6 | plausible_unproven |
| `MECH-428` | mechanism | candidate | 0.640 | 0.311 | 0.750 | 1 | 3 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.632 | 0.336 | 0.829 | 2 | 22 | plausible_unproven |
| `MECH-314b` | - | - | 0.710 | 0.341 | 0.833 | 1 | 3 | plausible_unproven |
| `MECH-314c` | - | - | 0.739 | 0.341 | 0.871 | 1 | 6 | plausible_unproven |
| `MECH-321` | mechanism_hypothesis | candidate | 0.634 | 0.361 | 0.816 | 2 | 14 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.654 | 0.362 | 0.849 | 2 | 5 | plausible_unproven |
| `MECH-074d` | - | - | 0.634 | 0.373 | 0.808 | 2 | 4 | plausible_unproven |
...
| `MECH-476` | mechanism_hypothesis | retired | 0.626 | 0.408 | 0.843 | 3 | 5 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.644 | 0.414 | 0.874 | 3 | 4 | plausible_unproven |
| `ARC-032` | architecture_hypothesis | candidate | 0.632 | 0.425 | 0.839 | 3 | 8 | plausible_unproven |
...
| `MECH-120` | mechanism_hypothesis | candidate | 0.675 | 0.464 | 0.887 | 3 | 11 | plausible_unproven |
| `MECH-180` | mechanism_hypothesis | candidate | 0.770 | 0.464 | 0.872 | 1 | 4 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.661 | 0.486 | 0.836 | 5 | 8 | plausible_unproven |
...
| `MECH-075` | mechanism_hypothesis | candidate | 0.691 | 0.514 | 0.868 | 5 | 7 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.725 | 0.516 | 0.864 | 2 | 7 | plausible_unproven |
| `MECH-025b` | - | - | 0.682 | 0.516 | 0.792 | 2 | 4 | plausible_unproven |
| `ARC-026` | architecture_hypothesis | provisional | 0.647 | 0.518 | 0.775 | 3 | 5 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.678 | 0.538 | 0.819 | 11 | 24 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.687 | 0.539 | 0.786 | 2 | 3 | plausible_unproven |
| `MECH-256` | mechanism_hypothesis | candidate | 0.692 | 0.540 | 0.844 | 6 | 9 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.704 | 0.541 | 0.866 | 3 | 14 | plausible_unproven |
...
| `SD-014` | design_decision | candidate | 0.720 | 0.573 | 0.867 | 3 | 13 | plausible_unproven |
...
| `SD-048` | design_decision | candidate | 0.752 | 0.589 | 0.860 | 2 | 6 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.708 | 0.591 | 0.826 | 4 | 7 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.722 | 0.593 | 0.851 | 19 | 5 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.714 | 0.605 | 0.823 | 25 | 9 | plausible_unproven |
...
| `MECH-295` | candidate | 0.220 | 2 |
| `INV-054` | candidate | 0.225 | 3 |
| `SD-021` | candidate | 0.225 | 3 |
| `MECH-445` | candidate | 0.252 | 1 |
