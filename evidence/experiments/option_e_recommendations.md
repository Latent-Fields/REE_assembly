...
Generated: `2026-05-20T20:58:38.507436Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **71** | plausible_unproven: **261** |
...
| `MECH-280` | mechanism_hypothesis | candidate | 0.871 | 0.000 | 0.871 | 0 | 5 | plausible_unproven |
...
| `MECH-118` | mechanism_hypothesis | candidate | 0.657 | 0.207 | 0.807 | 1 | 3 | plausible_unproven |
| `MECH-165` | mechanism_hypothesis | candidate | 0.674 | 0.224 | 0.824 | 1 | 3 | plausible_unproven |
| `MECH-188` | mechanism_hypothesis | candidate | 0.661 | 0.228 | 0.805 | 1 | 3 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.714 | 0.253 | 0.867 | 1 | 4 | plausible_unproven |
| `MECH-116` | mechanism_hypothesis | candidate | 0.624 | 0.254 | 0.870 | 2 | 7 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.713 | 0.254 | 0.866 | 1 | 4 | plausible_unproven |
| `SD-032c` | - | - | 0.661 | 0.258 | 0.796 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.701 | 0.259 | 0.849 | 1 | 6 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.657 | 0.278 | 0.909 | 2 | 11 | plausible_unproven |
| `MECH-155` | mechanism_hypothesis | candidate | 0.636 | 0.281 | 0.872 | 2 | 5 | plausible_unproven |
| `SD-047` | design_decision | provisional | 0.699 | 0.289 | 0.836 | 1 | 10 | plausible_unproven |
| `SD-049` | design_decision | candidate | 0.676 | 0.291 | 0.805 | 1 | 11 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.747 | 0.301 | 0.896 | 1 | 4 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate_substrate_landed | 0.710 | 0.315 | 0.842 | 1 | 3 | plausible_unproven |
| `MECH-314` | mechanism_hypothesis | candidate_substrate_landed | 0.744 | 0.315 | 0.887 | 1 | 6 | plausible_unproven |
| `MECH-047` | mechanism_hypothesis | provisional | 0.735 | 0.344 | 0.866 | 1 | 4 | plausible_unproven |
| `SD-021` | design_decision | candidate | 0.629 | 0.358 | 0.900 | 3 | 9 | plausible_unproven |
| `MECH-320` | mechanism_hypothesis | candidate_substrate_landed | 0.666 | 0.365 | 0.866 | 2 | 3 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.744 | 0.368 | 0.869 | 1 | 6 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.741 | 0.369 | 0.865 | 1 | 6 | plausible_unproven |
| `MECH-334` | mechanism_hypothesis | candidate | 0.673 | 0.369 | 0.875 | 2 | 3 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.746 | 0.371 | 0.871 | 1 | 5 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.758 | 0.373 | 0.886 | 1 | 7 | plausible_unproven |
| `MECH-302` | mechanism_hypothesis | candidate | 0.644 | 0.389 | 0.899 | 3 | 6 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.620 | 0.392 | 0.848 | 4 | 7 | plausible_unproven |
| `MECH-099` | mechanism_hypothesis | candidate | 0.646 | 0.396 | 0.897 | 6 | 7 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.658 | 0.439 | 0.876 | 5 | 6 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.783 | 0.453 | 0.893 | 1 | 5 | plausible_unproven |
| `MECH-113` | mechanism_hypothesis | candidate | 0.647 | 0.463 | 0.831 | 3 | 3 | plausible_unproven |
| `SD-032b` | - | - | 0.680 | 0.480 | 0.881 | 10 | 14 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.669 | 0.493 | 0.845 | 24 | 9 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.716 | 0.525 | 0.907 | 7 | 10 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.706 | 0.550 | 0.861 | 3 | 5 | plausible_unproven |
| `SD-016` | design_decision | implemented | 0.671 | 0.558 | 0.784 | 7 | 3 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.750 | 0.563 | 0.874 | 2 | 5 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.704 | 0.567 | 0.841 | 10 | 24 | plausible_unproven |
| `SD-004` | design_decision | implemented | 0.743 | 0.588 | 0.897 | 7 | 14 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.752 | 0.596 | 0.907 | 19 | 9 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.710 | 0.606 | 0.814 | 8 | 13 | plausible_unproven |
...
|---|---|---:|---:|
| `MECH-118` | candidate | 0.207 | 1 |
| `MECH-150` | candidate | 0.213 | 1 |
| `MECH-165` | candidate | 0.224 | 1 |
| `SD-018` | implemented | 0.227 | 1 |
| `MECH-188` | candidate | 0.228 | 1 |
| `SD-023` | candidate | 0.253 | 1 |
| `ARC-032` | candidate | 0.254 | 2 |
| `MECH-116` | candidate | 0.254 | 2 |
| `MECH-220` | candidate | 0.254 | 1 |
| `SD-032c` | - | 0.258 | 1 |
| `MECH-091` | candidate | 0.259 | 1 |
| `MECH-120` | candidate | 0.278 | 2 |
| `MECH-186` | candidate | 0.278 | 2 |
| `MECH-155` | candidate | 0.281 | 2 |
| `SD-047` | provisional | 0.289 | 1 |
| `SD-049` | candidate | 0.291 | 1 |
| `MECH-166` | candidate | 0.301 | 1 |
| `MECH-128` | candidate | 0.313 | 3 |
| `MECH-313` | candidate_substrate_landed | 0.315 | 1 |
| `MECH-314` | candidate_substrate_landed | 0.315 | 1 |
| `MECH-047` | provisional | 0.344 | 1 |
| `INV-054` | candidate | 0.357 | 3 |
| `SD-021` | candidate | 0.358 | 3 |
| `MECH-320` | candidate_substrate_landed | 0.365 | 2 |
| `MECH-029` | provisional | 0.368 | 1 |
| `MECH-026` | provisional | 0.369 | 1 |
| `MECH-334` | candidate | 0.369 | 2 |
| `MECH-022` | provisional | 0.371 | 1 |
| `MECH-025` | candidate | 0.373 | 1 |
| `MECH-070` | retiring | 0.387 | 4 |
| ... | ... | ... | ... (12 more) |
