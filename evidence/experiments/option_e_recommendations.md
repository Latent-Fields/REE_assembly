...
Generated: `2026-05-03T23:56:49.218490Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **69** | plausible_unproven: **201** |
| **low lit**             | novel_discovery: **1**         | speculative: **3** |

Total scored claims: 274
...
| `MECH-302` | mechanism_hypothesis | candidate | 0.904 | 0.000 | 0.904 | 0 | 6 | plausible_unproven |
| `MECH-303` | mechanism_hypothesis | candidate | 0.780 | 0.000 | 0.780 | 0 | 2 | plausible_unproven |
...
| `SD-047` | design_decision | provisional | 0.840 | 0.000 | 0.840 | 0 | 10 | plausible_unproven |
| `SD-049` | design_decision | candidate | 0.898 | 0.000 | 0.898 | 0 | 5 | plausible_unproven |
| `MECH-165` | mechanism_hypothesis | candidate | 0.687 | 0.262 | 0.829 | 1 | 3 | plausible_unproven |
| `MECH-188` | mechanism_hypothesis | candidate | 0.673 | 0.266 | 0.809 | 1 | 3 | plausible_unproven |
| `MECH-216` | mechanism | provisional | 0.732 | 0.291 | 0.879 | 1 | 5 | plausible_unproven |
| `MECH-220` | mechanism_hypothesis | candidate | 0.726 | 0.291 | 0.871 | 1 | 4 | plausible_unproven |
| `SD-023` | design_decision | candidate | 0.727 | 0.291 | 0.872 | 1 | 4 | plausible_unproven |
| `ARC-032` | architecture_hypothesis | candidate | 0.636 | 0.292 | 0.866 | 2 | 8 | plausible_unproven |
| `MECH-116` | mechanism_hypothesis | candidate | 0.642 | 0.292 | 0.875 | 2 | 7 | plausible_unproven |
| `SD-032c` | - | - | 0.675 | 0.296 | 0.801 | 1 | 3 | plausible_unproven |
| `MECH-091` | mechanism_hypothesis | candidate | 0.715 | 0.297 | 0.854 | 1 | 6 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.665 | 0.316 | 0.898 | 2 | 7 | plausible_unproven |
| `MECH-155` | mechanism_hypothesis | candidate | 0.653 | 0.318 | 0.877 | 2 | 5 | plausible_unproven |
| `MECH-047` | mechanism_hypothesis | provisional | 0.749 | 0.382 | 0.871 | 1 | 4 | plausible_unproven |
| `SD-021` | design_decision | candidate | 0.646 | 0.396 | 0.895 | 3 | 8 | plausible_unproven |
| `MECH-026` | mechanism_hypothesis | provisional | 0.754 | 0.406 | 0.870 | 1 | 6 | plausible_unproven |
| `MECH-029` | mechanism_hypothesis | provisional | 0.757 | 0.406 | 0.874 | 1 | 6 | plausible_unproven |
| `MECH-022` | mechanism_hypothesis | provisional | 0.759 | 0.408 | 0.876 | 1 | 5 | plausible_unproven |
| `MECH-025` | mechanism_hypothesis | candidate | 0.756 | 0.411 | 0.871 | 1 | 5 | plausible_unproven |
| `MECH-153` | mechanism_hypothesis | candidate | 0.641 | 0.429 | 0.853 | 4 | 7 | plausible_unproven |
| `MECH-099` | mechanism_hypothesis | candidate | 0.668 | 0.434 | 0.902 | 6 | 7 | plausible_unproven |
| `SD-029` | design_decision | candidate | 0.657 | 0.453 | 0.861 | 4 | 9 | plausible_unproven |
| `MECH-075` | mechanism_hypothesis | candidate | 0.679 | 0.477 | 0.881 | 5 | 6 | plausible_unproven |
| `MECH-113` | mechanism_hypothesis | candidate | 0.667 | 0.500 | 0.835 | 3 | 3 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | active | 0.684 | 0.524 | 0.845 | 9 | 24 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.691 | 0.531 | 0.850 | 24 | 9 | plausible_unproven |
| `ARC-030` | architecture_hypothesis | candidate | 0.737 | 0.562 | 0.912 | 7 | 10 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.758 | 0.604 | 0.912 | 18 | 9 | plausible_unproven |
...
|---|---|---:|---:|
| `MECH-150` | candidate | 0.251 | 1 |
| `MECH-165` | candidate | 0.262 | 1 |
| `SD-018` | implemented | 0.264 | 1 |
| `MECH-188` | candidate | 0.266 | 1 |
| `MECH-111` | candidate | 0.283 | 2 |
| `MECH-118` | candidate | 0.283 | 2 |
| `MECH-216` | provisional | 0.291 | 1 |
| `MECH-220` | candidate | 0.291 | 1 |
| `SD-023` | candidate | 0.291 | 1 |
| `ARC-032` | candidate | 0.292 | 2 |
| `MECH-116` | candidate | 0.292 | 2 |
| `SD-032c` | - | 0.296 | 1 |
| `MECH-091` | candidate | 0.297 | 1 |
| `MECH-120` | candidate | 0.316 | 2 |
| `MECH-186` | candidate | 0.316 | 2 |
| `MECH-155` | candidate | 0.318 | 2 |
| `MECH-128` | candidate | 0.351 | 3 |
| `MECH-047` | provisional | 0.382 | 1 |
| `INV-054` | candidate | 0.394 | 3 |
| `SD-021` | candidate | 0.396 | 3 |
| `MECH-026` | provisional | 0.406 | 1 |
| `MECH-029` | provisional | 0.406 | 1 |
| `MECH-022` | provisional | 0.408 | 1 |
| `MECH-025` | candidate | 0.411 | 1 |
| `SD-016` | implemented | 0.414 | 3 |
| `MECH-070` | retiring | 0.424 | 4 |
| `MECH-153` | candidate | 0.429 | 4 |
| `MECH-099` | candidate | 0.434 | 6 |
| `SD-029` | candidate | 0.453 | 4 |
| `MECH-097` | candidate | 0.458 | 1 |
| ... | ... | ... | ... (5 more) |
