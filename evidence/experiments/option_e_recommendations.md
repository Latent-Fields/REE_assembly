...
Generated: `2026-08-08T08:05:57.932027Z`
...
|---|---|---|
| **high lit (>= 0.55)** | confirmed_established: **97** | plausible_unproven: **423** |
| **low lit**             | novel_discovery: **0**         | speculative: **10** |

Total scored claims: 530
...
| `MECH-063` | mechanism_hypothesis | provisional | 0.752 | 0.000 | 0.752 | 0 | 2 | plausible_unproven |
...
| `MECH-130` | mechanism_hypothesis | candidate | 0.687 | 0.000 | 0.687 | 0 | 5 | plausible_unproven |
...
| `MECH-471` | mechanism_hypothesis | candidate | 0.827 | 0.000 | 0.827 | 0 | 3 | plausible_unproven |
...
| `MECH-057b` | - | - | 0.682 | 0.204 | 0.842 | 1 | 4 | plausible_unproven |
| `INV-088` | invariant | candidate | 0.681 | 0.266 | 0.820 | 1 | 6 | plausible_unproven |
...
| `MECH-329` | mechanism_hypothesis | candidate | 0.660 | 0.288 | 0.784 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.682 | 0.303 | 0.809 | 1 | 5 | plausible_unproven |
| `MECH-307` | mechanism_hypothesis | candidate_substrate_landed | 0.739 | 0.304 | 0.884 | 1 | 6 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.717 | 0.310 | 0.853 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.695 | 0.310 | 0.823 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.731 | 0.313 | 0.870 | 1 | 4 | plausible_unproven |
| `MECH-267` | mechanism_hypothesis | provisional | 0.729 | 0.313 | 0.868 | 1 | 5 | plausible_unproven |
| `MECH-313` | mechanism_hypothesis | candidate | 0.744 | 0.313 | 0.887 | 1 | 6 | plausible_unproven |
| `MECH-428` | mechanism | candidate | 0.641 | 0.313 | 0.750 | 1 | 3 | plausible_unproven |
| `MECH-074d` | - | - | 0.688 | 0.324 | 0.809 | 1 | 4 | plausible_unproven |
| `MECH-457` | mechanism_hypothesis | candidate | 0.633 | 0.338 | 0.830 | 2 | 22 | plausible_unproven |
| `MECH-314b` | - | - | 0.710 | 0.343 | 0.833 | 1 | 3 | plausible_unproven |
| `MECH-314c` | - | - | 0.739 | 0.343 | 0.871 | 1 | 6 | plausible_unproven |
| `MECH-321` | mechanism_hypothesis | candidate | 0.635 | 0.363 | 0.816 | 2 | 14 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.670 | 0.374 | 0.867 | 2 | 13 | plausible_unproven |
...
| `MECH-476` | mechanism_hypothesis | retired | 0.626 | 0.410 | 0.843 | 3 | 5 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.646 | 0.416 | 0.875 | 3 | 4 | plausible_unproven |
| `MECH-098` | mechanism_hypothesis | candidate | 0.657 | 0.428 | 0.886 | 19 | 9 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.621 | 0.449 | 0.792 | 9 | 13 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.676 | 0.466 | 0.887 | 3 | 11 | plausible_unproven |
| `MECH-180` | mechanism_hypothesis | candidate | 0.771 | 0.466 | 0.872 | 1 | 4 | plausible_unproven |
| `MECH-204` | mechanism_hypothesis | candidate | 0.662 | 0.488 | 0.837 | 5 | 8 | plausible_unproven |
...
| `MECH-025` | mechanism_hypothesis | candidate | 0.726 | 0.518 | 0.865 | 2 | 7 | plausible_unproven |
| `MECH-025b` | - | - | 0.682 | 0.518 | 0.792 | 2 | 4 | plausible_unproven |
| `MECH-095` | mechanism_hypothesis | candidate | 0.679 | 0.540 | 0.819 | 11 | 24 | plausible_unproven |
| `MECH-256` | mechanism_hypothesis | candidate | 0.693 | 0.540 | 0.845 | 6 | 9 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.689 | 0.541 | 0.787 | 2 | 3 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.705 | 0.543 | 0.866 | 3 | 14 | plausible_unproven |
...
| `MECH-153` | mechanism_hypothesis | candidate | 0.710 | 0.593 | 0.827 | 4 | 7 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.723 | 0.593 | 0.852 | 19 | 5 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.715 | 0.607 | 0.823 | 25 | 9 | plausible_unproven |
...
_Suppressed by gating: 54 substrate_coherence (ARC + universal invariant), 62 answer_state (open_question). These cross the gate under one regime but not the other; the discrepancy is not actionable under their evidence rules. See suppressed sections below._
...
| `MECH-295` | candidate | 0.222 | 2 |
| `INV-054` | candidate | 0.225 | 3 |
| `SD-021` | candidate | 0.225 | 3 |
| `MECH-445` | candidate | 0.254 | 1 |
| `MECH-075` | candidate | 0.263 | 4 |
| `INV-088` | candidate | 0.266 | 1 |
