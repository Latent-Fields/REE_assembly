...
Generated: `2026-09-01T15:54:05.855584Z`
...
Total: **303** discrepant claims (standard-gating only).
...
| `MECH-329` | mechanism_hypothesis | candidate | 0.641 | 0.234 | 0.777 | 1 | 5 | plausible_unproven |
| `MECH-475` | mechanism_hypothesis | retired | 0.665 | 0.249 | 0.803 | 1 | 5 | plausible_unproven |
| `MECH-294` | mechanism_hypothesis | candidate | 0.698 | 0.256 | 0.846 | 1 | 9 | plausible_unproven |
| `SD-087` | design_decision | candidate | 0.677 | 0.256 | 0.817 | 1 | 4 | plausible_unproven |
| `MECH-122` | mechanism_hypothesis | provisional | 0.668 | 0.259 | 0.804 | 1 | 3 | plausible_unproven |
| `MECH-166` | mechanism_hypothesis | candidate | 0.716 | 0.259 | 0.868 | 1 | 4 | plausible_unproven |
| `SD-009` | design_decision | candidate | 0.643 | 0.271 | 0.767 | 1 | 3 | plausible_unproven |
...
| `MECH-144` | mechanism_hypothesis | candidate | 0.683 | 0.318 | 0.805 | 1 | 4 | plausible_unproven |
...
| `MECH-025b` | - | - | 0.692 | 0.414 | 0.785 | 1 | 4 | plausible_unproven |
...
| `ARC-032` | architecture_hypothesis | candidate | 0.654 | 0.479 | 0.830 | 5 | 6 | plausible_unproven |
| `INV-089` | invariant | provisional | 0.663 | 0.487 | 0.780 | 2 | 3 | plausible_unproven |
| `SD-015` | design_decision | candidate | 0.643 | 0.500 | 0.786 | 4 | 13 | plausible_unproven |
| `MECH-102` | mechanism_hypothesis | active | 0.660 | 0.505 | 0.815 | 18 | 8 | plausible_unproven |
| `MECH-163` | mechanism_hypothesis | candidate | 0.722 | 0.514 | 0.860 | 2 | 14 | plausible_unproven |
| `SD-014` | design_decision | candidate | 0.691 | 0.521 | 0.860 | 3 | 13 | plausible_unproven |
...
| `MECH-150` | mechanism_hypothesis | candidate | 0.685 | 0.544 | 0.779 | 2 | 3 | plausible_unproven |
...
| `MECH-153` | mechanism_hypothesis | candidate | 0.691 | 0.562 | 0.820 | 3 | 7 | plausible_unproven |
...
| `MECH-268` | mechanism_hypothesis | provisional | 0.759 | 0.576 | 0.820 | 1 | 8 | plausible_unproven |
| `MECH-314` | mechanism_hypothesis | candidate_substrate_landed | 0.797 | 0.584 | 0.868 | 1 | 10 | plausible_unproven |
| `MECH-314a` | - | - | 0.783 | 0.584 | 0.850 | 1 | 6 | plausible_unproven |
| `MECH-346` | mechanism_hypothesis | candidate | 0.742 | 0.585 | 0.794 | 1 | 3 | plausible_unproven |
| `MECH-347` | mechanism_hypothesis | candidate | 0.746 | 0.585 | 0.799 | 1 | 3 | plausible_unproven |
| `MECH-440` | mechanism_hypothesis | candidate | 0.647 | 0.585 | 0.689 | 2 | 10 | plausible_unproven |
| `SD-057` | design_decision | candidate | 0.688 | 0.585 | 0.739 | 1 | 2 | plausible_unproven |
| `MECH-045` | mechanism_hypothesis | provisional | 0.776 | 0.589 | 0.839 | 1 | 14 | plausible_unproven |
| `SD-003` | design_decision | superseded | 0.701 | 0.593 | 0.810 | 82 | 7 | plausible_unproven |
| `SD-007` | design_decision | implemented | 0.720 | 0.594 | 0.845 | 18 | 5 | plausible_unproven |
| `MECH-087` | mechanism_hypothesis | candidate | 0.649 | 0.595 | 0.703 | 1 | 1 | plausible_unproven |
...
| `MECH-358` | mechanism_hypothesis | candidate | 0.735 | 0.605 | 0.778 | 1 | 3 | plausible_unproven |
| `SD-059` | design_decision | candidate | 0.780 | 0.605 | 0.838 | 1 | 4 | plausible_unproven |
| `SD-013` | design_decision | provisional | 0.721 | 0.608 | 0.835 | 4 | 4 | plausible_unproven |
| `MECH-120` | mechanism_hypothesis | candidate | 0.814 | 0.612 | 0.881 | 1 | 11 | plausible_unproven |
| `MECH-436` | mechanism_hypothesis | candidate | 0.724 | 0.613 | 0.779 | 1 | 2 | plausible_unproven |
...
| `SD-079` | design_decision | provisional | 0.619 | 0.692 | 0.582 | 1 | 2 | confirmed_established |
...
| `MECH-290` | candidate | 0.768 | 0.000 | 1 | 0 |
...
| `MECH-445` | candidate | 0.200 | 1 |
| `INV-088` | candidate | 0.212 | 1 |
| `MECH-457` | candidate | 0.213 | 1 |
| `MECH-128` | candidate | 0.217 | 3 |
| `MECH-329` | candidate | 0.234 | 1 |
| `MECH-466` | candidate | 0.245 | 1 |
| `MECH-475` | retired | 0.249 | 1 |
| `MECH-294` | candidate | 0.256 | 1 |
| `SD-087` | candidate | 0.256 | 1 |
| `MECH-122` | provisional | 0.259 | 1 |
| `MECH-166` | candidate | 0.259 | 1 |
| `SD-009` | candidate | 0.271 | 1 |
| `MECH-029` | provisional | 0.275 | 1 |
| `MECH-463` | candidate | 0.278 | 2 |
| `MECH-152` | provisional | 0.279 | 1 |
