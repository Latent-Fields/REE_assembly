...
|---|---|---|
| none (locomotion)        | 0.3730 | 101 |
| hazard_approach (NEW)    | 0.6120 | 832 |
| env_caused_hazard        | 0.6661 | 13 |
| agent_caused_hazard      | 0.4973 | 33 |

- **gap_approach** (approach - none): **0.2390**  (PASS > 0.08)
- **gap_contact** (contact - none):   **0.2088**  (PASS > 0.05)
- reafference_r2: **0.4079**  (PASS > 0.10)
- harm_pred_std: 0.2032

## Training Counts

- approach events: 8125
- contact events:  463
...
|---|---|---|
| C1: gap_approach > 0.08 (E3 detects approach) | PASS | 0.2390 |
| C2: gap_contact > 0.05 (E3 still detects contact) | PASS | 0.2088 |
| C3: reafference_r2 > 0.10 | PASS | 0.4079 |
| C4: harm_pred_std > 0.01 | PASS | 0.2032 |
| C5: n_hazard_approach >= 30 | PASS | 832 |
