...
|---|---|
| none (locomotion) | 0.7653 |
| env_caused_hazard | 1.6477 |
| agent_caused_hazard | 1.8812 |
| **selectivity margin** (env - none) | **0.8824** |

Event classifier accuracy: 0.692
Training CE loss mean: 1.0411
...
| C3: selectivity_margin > 0.005 | PASS | 0.8824 |
