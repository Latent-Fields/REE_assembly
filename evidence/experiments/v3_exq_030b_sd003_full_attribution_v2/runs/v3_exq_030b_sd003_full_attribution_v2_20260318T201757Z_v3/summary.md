...
|---|---|---|---|
| none (locomotion)    | 0.2566 | -0.070255 | 70 |
| hazard_approach      | 0.2610 | 0.003149 | 817 |
| env_caused_hazard    | 0.2573 | 0.001098 | 20 |
| agent_caused_hazard  | 0.2672 | -0.007940 | 32 |

- **world_forward R²**: 0.9665  (PASS > 0.05)
- **attribution_gap** (approach − env): 0.002050  (PASS > 0)

## PASS Criteria (Revised)

| Criterion | Result | Value |
|---|---|---|
| C1: attribution_gap > 0 (agent approach > env attribution) | PASS | 0.002050 |
| C2: causal_sig_approach > causal_sig_none (approach > baseline) | PASS | 0.003149 vs -0.070255 |
| C3: causal_sig_approach > 0.005 (minimum attribution signal) | FAIL | 0.003149 |
| C4: world_forward_r2 > 0.05 (E2 learned world dynamics) | PASS | 0.9665 |
| C5: n_approach >= 50 (sufficient approach events) | PASS | 817 |

Criteria met: 4/5 → **FAIL**

## Failure Notes

- C3 FAIL: causal_sig_approach=0.003149 <= 0.005
