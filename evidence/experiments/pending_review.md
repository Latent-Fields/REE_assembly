...
Generated: `2026-08-13T19:53:23Z`  
Last review: `2026-08-13T06:33:28Z`  
Pending: **2** item(s) -- 0 PASS, 1 FAIL, 0 runner-only (ERROR/UNKNOWN/smoke), 0 unclaimed manifest(s), 1 ERROR manifest(s); 0 diagnostic self-route(s) flagged for adjudication; 1 run(s) with a DEAD z_goal stream

## FAIL (action required)

| Run ID | Timestamp | Claims | Failure signatures |
|--------|-----------|--------|--------------------|
| `v3_exq_861b_inv050_mech180_independent_seed_replication_20260813T113330Z_v3` | 2026-08-13T11:33 | INV-050, MECH-180 | — |
...
|--------|--------|-------|--------------|-------------|-----------|
| `v3_exq_861b_inv050_mech180_independent_seed_replication_20260813T113330Z_v3` | FAIL | 43583 | **0** | 0.000 | live |
