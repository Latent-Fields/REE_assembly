...
Generated: `2026-03-30T21:04:27Z`  
...
| `V3-EXQ-085k` | FAIL | `?` | FAIL (index stale — run build_experiment_indexes.py) |
| `V3-EXQ-180` | FAIL | `?` | FAIL (index stale — run build_experiment_indexes.py) |
