...
|---|---|
| none (safe locomotion) | -0.029615 |
| hazard_approach        | 0.005714 |
| contact (combined)     | 0.021582 |

- **world_forward R²**: 0.9437
- **calibration_gap_approach**: 0.0600
- **mean_harm_eval_none**: 0.4872  (collapse guard: < 0.2 required)

## PASS Criteria

| Criterion | Result | Value |
|---|---|---|
| C1: causal_sig_approach > 0.001 | PASS | 0.005714 |
| C2: calibration_gap_approach > 0.05 | PASS | 0.0600 |
| C3: mean_harm_eval_none < 0.2 (no collapse) | FAIL | 0.4872 |
| C4: causal_sig_contact > causal_sig_approach (MECH-102) | PASS | 0.021582 vs 0.005714 |
...
- C3 FAIL: mean_harm_eval_none=0.4872 >= 0.2. E3 predicting harm everywhere — collapse still occurring.
