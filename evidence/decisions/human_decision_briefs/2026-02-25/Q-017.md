...
- Conflict ratio: `0.808`; overall confidence: `0.738`
...
- Conflict report window: supports=59, weakens=40, conflict_ratio=0.808, entries_considered=100.
- Dossier direction mix: supports=74, weakens=53, mixed=1, unknown=0.
- Source counts: experimental=95, literature=5.
