...
- Conflict ratio: `0.848`; overall confidence: `0.729`
- Trigger signals: external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures
- Recurring failure signatures:
  - `q017:control_axis_stability_drop` (48)
  - `q017:control_axis_entropy_collapse` (48)
  - `q017:control_axis_policy_loss_spike` (34)

## Evidence Snapshot

- Conflict report window: supports=57, weakens=40, conflict_ratio=0.825, entries_considered=98.
- Dossier direction mix: supports=72, weakens=53, mixed=1, unknown=0.
- Source counts: experimental=118, literature=8.
