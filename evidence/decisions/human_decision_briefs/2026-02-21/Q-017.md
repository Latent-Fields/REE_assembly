...
- Conflict ratio: `0.845`; overall confidence: `0.722`
...
- Conflict report window: supports=41, weakens=28, conflict_ratio=0.812, entries_considered=70.
- Dossier direction mix: supports=56, weakens=41, mixed=1, unknown=0.
- Source counts: experimental=90, literature=8.
