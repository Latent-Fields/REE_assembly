...
- Subject: ethics / axiom conflict resolution
- Architecture anchor: `docs/architecture/five_axioms_foundations.md`
- Upstream dependencies: `INV-025`, `INV-026`, `INV-027`, `INV-028`, `INV-029`
...
- Why this lane is open: overall_conf=0.625, conflict_ratio=0, exp_entries=0, lit_entries=2; directions supports=1, weakens=0, mixed=1, unknown=0, conflict_ratio=0
- Options:
