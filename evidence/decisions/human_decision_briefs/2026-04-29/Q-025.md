...
- Subject: ethics / axiom forbidden actions
...
- Why this lane is open: overall_conf=0.632, conflict_ratio=0, exp_entries=0, lit_entries=2; directions supports=1, weakens=0, mixed=1, unknown=0, conflict_ratio=0
- Options:
