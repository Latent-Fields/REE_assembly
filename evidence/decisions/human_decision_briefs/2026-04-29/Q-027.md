...
- Subject: ethics / irreversible harm under uncertainty
- Architecture anchor: `docs/architecture/five_axioms_foundations.md`
- Upstream dependencies: `INV-025`, `ARC-024`
...
- Why this lane is open: overall_conf=0.663, conflict_ratio=0, exp_entries=0, lit_entries=3; directions supports=2, weakens=0, mixed=1, unknown=0, conflict_ratio=0
- Options:
