...
|---|---|---|---|---|
| `ARC-012` | `dormant_low_activity` | 1 | `active` | 0 |
| `ARC-061` | `dormant_low_activity` | 1 | `candidate` | 0 |
| `ARC-076` | `dormant_low_activity` | 1 | `candidate` | 0 |
| `ARC-102` | `dormant_low_activity` | 1 | `candidate` | 0 |
...
| `MECH-321` | `chronic_under_threshold` | 0.778 | `candidate` | 10 |
| `ARC-083` | `dormant_low_activity` | 0.75 | `candidate` | 0 |
...
| `ARC-054` | `dormant_low_activity` | 0.667 | `candidate` | 0 |
| `ARC-059` | `dormant_low_activity` | 0.667 | `candidate` | 0 |
| `ARC-073` | `dormant_low_activity` | 0.667 | `candidate` | 0 |
| `ARC-079` | `dormant_low_activity` | 0.667 | `candidate` | 0 |
| `ARC-111` | `dormant_low_activity` | 0.667 | `candidate` | 0 |
| `INV-040` | `dormant_low_activity` | 0.667 | `candidate` | 0 |
| `INV-047` | `chronic_under_threshold` | 0.667 | `candidate` | 10 |
| `INV-087` | `dormant_low_activity` | 0.667 | `candidate` | 1 |
| `MECH-019` | `dormant_low_activity` | 0.667 | `candidate` | 0 |
| `MECH-025b` | `chronic_under_threshold` | 0.667 | `candidate` | 3 |
| `MECH-037` | `dormant_low_activity` | 0.667 | `candidate` | 0 |
| `MECH-080` | `dormant_low_activity` | 0.667 | `candidate` | 0 |
| `MECH-112` | `chronic_under_threshold` | 0.667 | `candidate` | 22 |
...
| `SD-078` | `chronic_under_threshold` | 0.667 | `candidate_substrate_landed` | 8 |
...
| `MECH-090` | `chronic_under_threshold` | 0.606 | `active` | 24 |
