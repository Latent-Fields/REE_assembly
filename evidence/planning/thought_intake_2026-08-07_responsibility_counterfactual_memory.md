...
**Status:** Stage 2 structured analysis. Two candidate claims registered this pass (MECH-485, Q-090); two related pieces deliberately NOT registered this pass (see "Deliberately not registered" below).
