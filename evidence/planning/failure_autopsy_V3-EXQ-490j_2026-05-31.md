...
### Original (2026-05-31T11:50Z) routing recommendation, preserved for audit

The original autopsy routed only to /queue-experiment metric redesign with per-claim direction narrow_supports. That routing is preserved in Section 13 along with the reasoning that led to its revision.
