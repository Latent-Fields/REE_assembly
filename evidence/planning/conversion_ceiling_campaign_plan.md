...
closure_plan:
  ...
  nodes:
    ...
    - id: "conversion_ceiling_campaign:P4-learned-gating"
      ...
      status: assembling
      severity: load-bearing
      awaiting: "ARC-108 + MECH-450 substrate build; TERMINAL falsifier V3-EXQ-700c (supersedes the V3-EXQ-700 -> 700a -> 700b lineage) CLAIMED/running, awaiting score. PRE-REGISTERED TERMINAL: any further null routes to the loop-segregation build (ARC-110), which was REAPPOINTED V4->V3 2026-06-24 (user-directed) and is now GATED on V3-EXQ-704 (MECH-451 finer-channel pre-emption); no further V3 *700-lineage same-arena* letters. The escalation is no longer a V4 hand-off -- it is a V3 build, build-deferred behind the 704 gate."
      assembly_status: in_progress
      owner_exq: "null -- mirror prong; build owned by behavioral_diversity_isolation:GAP-K (V3-EXQ-700c, TERMINAL; supersedes V3-EXQ-700 -> 700a -> 700b)"
