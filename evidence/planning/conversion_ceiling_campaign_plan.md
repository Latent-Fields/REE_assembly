...
closure_plan:
  ...
  nodes:
    ...
    - id: "conversion_ceiling_campaign:P4-learned-gating"
      ...
      status: assembling
      severity: load-bearing
      awaiting: "ARC-108 + MECH-450 substrate build; TERMINAL falsifier V3-EXQ-700c (supersedes the V3-EXQ-700 -> 700a -> 700b lineage) CLAIMED/running, awaiting score. PRE-REGISTERED TERMINAL: any further null -> V4 loop-segregation, no further V3 letters"
      assembly_status: in_progress
