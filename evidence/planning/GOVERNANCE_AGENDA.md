...
Generated: `2026-02-15T14:59:53.643277Z`
...
- `MECH-056` conflict_ratio=0.979; trigger_signals=external_precedence_pressure,high_conflict_ratio,recurring_failure_signatures
- `MECH-058` conflict_ratio=0.954; trigger_signals=external_precedence_pressure,high_conflict_ratio,recurring_failure_signatures
- `MECH-060` conflict_ratio=0.949; trigger_signals=external_precedence_pressure,high_conflict_ratio,recurring_failure_signatures
- `Q-017` conflict_ratio=0.929; trigger_signals=external_precedence_pressure,high_conflict_ratio,recurring_failure_signatures
- `MECH-059` conflict_ratio=0.717; trigger_signals=external_precedence_pressure,high_conflict_ratio,recurring_failure_signatures
...
- `MECH-056` external_precedence_candidate=yes; delta_lit_minus_exp=0.292
- `MECH-058` external_precedence_candidate=yes; delta_lit_minus_exp=0.359
- `MECH-060` external_precedence_candidate=yes; delta_lit_minus_exp=0.326
- `Q-017` external_precedence_candidate=yes; delta_lit_minus_exp=0.305
- `MECH-059` external_precedence_candidate=yes; delta_lit_minus_exp=0.224
...
10. Evidence Dispatch: 32 high-priority proposal(s), 52 total.
