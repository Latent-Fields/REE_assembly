...
| GAP-I- | 2-3 | deferred | `arc_062_rule_apprehension:GAP-I` | **NEW ROW 2026-07-29 — this child node has existed in the frontmatter since the 2026-06-23 split but was never added to this table.** ARC-064 absorption checks for MECH-316 (cross-episode regularities) + MECH-317 (behavioural-pattern compression). Split out of GAP-I because it sits at a radically different readiness level: these are **doc-only absorption checks with no V3 modules**, whereas GAP-I retains the MECH-318 empirical retire-vs-promote gate. Deferred, not blocked — nothing is waiting on a runner. | n/a (doc-only) | 2026-07-29 (row added; node record 2026-06-23) |
