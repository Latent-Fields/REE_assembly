...
closure_plan:
  ...
  nodes:
    ...
    - id: "arc_062_rule_apprehension:GAP-B"
      ...
      status: in-progress
      severity: load-bearing
      owner_exq: "V3-EXQ-654 (QUEUED 2026-06-09; arc_062 GAP-B behavioural falsifier; ARM_OFF use_candidate_rule_field=False vs ARM_ON differentiated crf_source; PRIMARY DV committed-class diversity; awaiting run)"
      ...
      resume_condition: "QUEUED 2026-06-09 as V3-EXQ-654 (priority 250, machine any; committed-class-diversity DV, NOT within-class-representative -- see governance_2026_06_09 for the class-keyed-bias rationale). Awaiting run. ON PASS (C1+C2 paired committed-class lift) -> supports MECH-309 + ARC-062; route /governance (MECH-309/ARC-062 supports evidence; GAP-B closure candidate + the trained-bias-head behavioural successor). ON C1-ok/C2-fail -> weakens (route /governance + /failure-autopsy: does propagation require a TRAINED bias head?). ON C1-fail -> substrate_not_ready_requeue (re-queue as 654a at higher P0 / enrich candidate-pool within-class multiplicity or CRF mint rate; do NOT weaken). Do not re-open the old rule-creator or GAP-A blocker; within-class-representative entropy is a secondary negative control (expected ~null)."
