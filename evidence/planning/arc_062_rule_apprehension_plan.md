...
closure_plan:
  ...
  nodes:
    ...
    - id: "arc_062_rule_apprehension:GAP-B"
      ...
      status: open
      severity: load-bearing
      owner_exq: "GAP-B behavioural falsifier successor owed (not yet numbered)"
      ...
      resume_condition: "READY TO QUEUE 2026-06-08. Queue the GAP-B behavioural falsifier with ARM_OFF use_candidate_rule_field=False vs ARM_ON CandidateRuleField + lateral_pfc + gated_policy, both arms on the matched V3-EXQ-649 GAP-A-ready / V3-EXQ-643a-643b authority-ready / SD-056 stack. Use within-class-representative-diversity readout, not committed-class entropy. Do not re-open the old rule-creator or GAP-A blocker."
