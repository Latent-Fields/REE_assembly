...
closure_plan:
  ...
  nodes:
    ...
    - id: "arc_005_control_plane_routing:GAP-B"
      ...
      last_updated: 2026-08-13
      outcome_2026_08_13: "GOVERNANCE DRIFT RECONCILE: V3-EXQ-846 landed PASS/supports 2026-07-31 and was applied to ARC-005 in claims.yaml the same day (2026-08-01 governance note) -- this node's status was never flipped to match. Answers the GAP-B question: ARC-005's disjunctive test (>=1 channel demonstrates causal occupancy authority) is met by ONE of four channels (MODEPRIOR: authority_mean=1.0, retained_effect_mean=0.0 -- ablating it fully reverts the argmax to baseline). The other three (5-HT, PHASIC, PCC) show ZERO measured authority (authority_mean=0.0). Node closes here; the asymmetry is recorded on ARC-005's own evidence_quality_note as informing any future narrower per-channel claim."
    ...
    - id: "arc_005_control_plane_routing:GAP-A-precision-diagnostic"
      ...
      owner_exq: "V3-EXQ-848, V3-EXQ-848a, V3-EXQ-848b"
      unblocks_claims: []
      depends_on: ["arc_005_control_plane_routing:GAP-A"]
      last_updated: 2026-08-13
      outcome_2026_08_13: "GOVERNANCE DRIFT RECONCILE: 848b (the 'recommended, not yet queued' successor named in the stale owner_exq text) actually ran and was confirmed 2026-08-07 governance (failure_autopsy_2026-08-05_pending_review_batch #4) -- this node's owner_exq/status were never updated to match. The full 848->848a->848b line is now CLOSED per the 848b autopsy's own explicit recommendation: 'FINAL reading for this design line -- no further same-design lettered iteration' (mixed/standard; the 7-level ladder redesign broke the resolution ceiling 848a hit, 4/10 units now clear |rho|>=0.6, but the raw effect is ~180x smaller than cross-seed SD -- genuinely small, not absent, and further power against a d~0.006 target was judged not worthwhile). A 2026-08-07 /lit-pull (targeted_review_arc_005) subsequently confirmed the biology predicts a materially larger effect (d~0.2-0.5) than REE's measured ratio, favouring the untrained-dACC-adapter reading over a genuine ceiling -- informational for any FUTURE instrument-fix redesign, not a reopening of this line."
