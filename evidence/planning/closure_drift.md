...
|------|------|--------|-----------|-------------------|-----------------|
| policy_decomposition_trigger_plan.md | `policy_decomposition_trigger:REPOSE` | in_progress | V3-EXQ-938 | 2026-08-18 | manifest `evidence/experiments/v3_exq_938_arc070_mech321_pe_selectivity_yoked_wholeepisode_20260818T215558Z_v3.json` + autopsy `evidence/planning/failure_autopsy_V3-EXQ-938_2026-08-20.json` |
...
|------|------|--------|-----------|-------------------|-----|
| behavioral_diversity_isolation_plan.md | `behavioral_diversity_isolation:GAP-I` | in-progress | _none_ | 2026-08-01 | failure_autopsy_V3-EXQ-936_2026-08-18.json (2026-08-18) reclassified MECH-439 |
