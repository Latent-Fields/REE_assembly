...
Generated: 2026-08-21T17:11:59Z
...
## Status-plane drift -- projected `live` != stored `live` (7 of 99 collapsed node(s))
...
|------|------|-------------|----------------|----------------|
| conversion_ceiling_campaign_plan.md | `conversion_ceiling_campaign:CAMPAIGN` | failure_autopsy_V3-EXQ-937b_2026-08-20 | failure_autopsy_V3-EXQ-937b_2026-08-20 | needs_review: stored=False projected=True; needs_review_reasons: stored=[] projected=['newest_forward_predates_later_decision_event(s)'] |
| conversion_ceiling_campaign_plan.md | `conversion_ceiling_campaign:P-comp` | failure_autopsy_V3-EXQ-937b_2026-08-20 | failure_autopsy_V3-EXQ-937b_2026-08-20 | needs_review: stored=False projected=True; needs_review_reasons: stored=[] projected=['newest_forward_predates_later_decision_event(s)'] |
| conversion_ceiling_campaign_plan.md | `conversion_ceiling_campaign:P2-rootC` | failure_autopsy_V3-EXQ-937b_2026-08-20 | failure_autopsy_V3-EXQ-937b_2026-08-20 | needs_review: stored=False projected=True; needs_review_reasons: stored=[] projected=['newest_forward_predates_later_decision_event(s)'] |
| conversion_ceiling_campaign_plan.md | `conversion_ceiling_campaign:P3-ofc` | failure_autopsy_V3-EXQ-937b_2026-08-20 | failure_autopsy_V3-EXQ-937b_2026-08-20 | needs_review: stored=False projected=True; needs_review_reasons: stored=[] projected=['newest_forward_predates_later_decision_event(s)'] |
| conversion_ceiling_campaign_plan.md | `conversion_ceiling_campaign:FULLSTACK` | failure_autopsy_V3-EXQ-937b_2026-08-20 | failure_autopsy_V3-EXQ-937b_2026-08-20 | needs_review: stored=False projected=True; needs_review_reasons: stored=[] projected=['newest_forward_predates_later_decision_event(s)'] |
| conversion_ceiling_campaign_plan.md | `conversion_ceiling_campaign:P4-learned-gating` | failure_autopsy_V3-EXQ-937b_2026-08-20 | failure_autopsy_V3-EXQ-937b_2026-08-20 | needs_review: stored=False projected=True; needs_review_reasons: stored=[] projected=['newest_forward_predates_later_decision_event(s)'] |
| conversion_ceiling_campaign_plan.md | `conversion_ceiling_campaign:GENERATION` | failure_autopsy_V3-EXQ-937b_2026-08-20 | failure_autopsy_V3-EXQ-937b_2026-08-20 | needs_review: stored=False projected=True; needs_review_reasons: stored=[] projected=['newest_forward_predates_later_decision_event(s)'] |
