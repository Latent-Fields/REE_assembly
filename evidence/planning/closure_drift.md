...
Generated: 2026-08-02T12:08:11Z
...
## Stale since last update -- review (3)
...
|------|------|--------|-----------|-------------------|-----|
| commitment_closure_plan.md | `commitment_closure:GAP-4` | in-progress | _none_ | 2026-06-25 | failure_autopsy_V3-EXQ-871_2026-08-02.json (2026-08-02) reclassified MECH-090; failure_autopsy_V3-EXQ-869_2026-08-02.json (2026-08-02) reclassified MECH-267 |
| commitment_closure_plan.md | `commitment_closure:GAP-4-battery` | in_progress | _none_ | 2026-07-24 | failure_autopsy_V3-EXQ-869_2026-08-02.json (2026-08-02) reclassified MECH-267 |
| sleep_substrate_plan.md | `sleep_substrate:GAP-2` | upstream-blocked | _none_ | 2026-07-10 | failure_autopsy_V3-EXQ-436b_2026-08-02.json (2026-08-02) reclassified ARC-045, MECH-166, SD-017 |
...
| behavioral_diversity_isolation_plan.md | `behavioral_diversity_isolation:GAP-K` | assembling | _unset_ | exhausted | _none_ | no |
...
## Status-plane drift -- projected `live` != stored `live` (1 of 99 collapsed node(s))
...
|------|------|-------------|----------------|----------------|
| commitment_closure_plan.md | `commitment_closure:GAP-4-battery` | failure_autopsy_V3-EXQ-732_2026-07-10 | failure_autopsy_V3-EXQ-871_2026-08-02 | as_of: stored='2026-07-10' projected='2026-08-02'; from: stored='failure_autopsy_V3-EXQ-732_2026-07-10' projected='failure_autopsy_V3-EXQ-871_2026-08-02'; verdict: stored='non_contributory/precondition_unmet' projected='non_contributory/measurement_test_design_defect'; needs_review: stored=True projected=False; needs_review_reasons: stored=['newest_forward_predates_later_manifest+measurement_event(s)'] projected=[] |
