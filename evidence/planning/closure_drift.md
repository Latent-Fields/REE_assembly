...
Generated: 2026-06-03T22:40:44Z
...
|------|------|--------|-----------|-------------------|-----------------|
| commitment_closure_plan.md | `commitment_closure:GAP-8` | in-progress | V3-EXQ-485b | 2026-06-03 | manifest `evidence/experiments/v3_exq_485b_sd033b_devaluation_sensitivity_20260603T201054Z_v3.json` |
| goal_pipeline_plan.md | `goal_pipeline:GAP-4` | in-progress | V3-EXQ-490j TERMINAL 2026-05-31 (severed-bridge baseline; evidence_direction_per_claim[MECH-295]=weakens; supersedes 490i; reviewed -- pending_review clear); lineage: V3-EXQ-490g (FAIL 2026-05-29 cohort autopsy), V3-EXQ-490h FAIL silent-drop 2026-05-30 (runner bug 41c3411), V3-EXQ-490i ran 2026-05-30 (superseded by 490j) | 2026-06-03 | manifest `evidence/experiments/v3_exq_490j_mech295_cascade_gap4_tier1_severed_bridge_baseline_20260531T112417Z_v3.json` + autopsy `evidence/planning/failure_autopsy_V3-EXQ-490j_2026-05-31.json` |
