...
Generated: `2026-02-15T15:37:22.371994Z`
Cycle: `2026-02-15`
...
|---|---|---|---|---:|---|
| `CPULL-0001` | `MECH-056` | `high` | yes | 0.966 | `targeted_review_connectome_mech_056` |
| `CPULL-0002` | `MECH-058` | `high` | yes | 0.959 | `targeted_review_connectome_mech_058` |
| `CPULL-0003` | `MECH-060` | `high` | yes | 0.953 | `targeted_review_connectome_mech_060` |
| `CPULL-0004` | `Q-017` | `high` | yes | 0.944 | `targeted_review_connectome_q_017` |
...
- Evidence pressure: conflict_ratio=0.959, overall_confidence=0.707, trigger_signals=external_precedence_pressure,high_conflict_ratio,recurring_failure_signatures.
...
- Evidence pressure: conflict_ratio=0.944, overall_confidence=0.725, trigger_signals=external_precedence_pressure,high_conflict_ratio,recurring_failure_signatures.
