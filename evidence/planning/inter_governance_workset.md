...
Generated: `2026-06-16T16:10:24Z`
...
- Items: **201** (ready 21, in_flight 0, blocked 159)
- Pending review: **1**
- Queue pending (unclaimed): **0**

- Live EXQs: V3-EXQ-603q

- Auto-absorbed retests (queued, suppressed from workset): SD-059 -> V3-EXQ-603q

## Work packages

### IGW-20260616-001 -- Complete governance review (1 pending)
...
- **Why now:** AWAITING /failure-autopsy V3-EXQ-569h -> /implement-substrate (the AUTHORITATIVE current state 2026-06-16; see governance_2026_06_16). V3-EXQ-569h RAN on the 684a-identified ARM_STD_G2 conversion config and landed FAIL/non_contributory (con
