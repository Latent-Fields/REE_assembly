...
Generated: `2026-08-08T20:44:14Z`
...
- Items: **228** (ready 19, in_flight 0, blocked 160)
- By generation: clinical 11, meta 4, process 6, v3 67, v4 77, v5 38, v6 25
- Pending review: **14**
- Queue pending (unclaimed): **6**

- Live EXQs: V3-EXQ-603r, V3-EXQ-899, V3-EXQ-903, V3-EXQ-905
...
### IGW-20260808-001 -- Complete governance review (14 pending)
...
- **Lane:** experiment | **Skill:** `/queue-experiment` | **Status:** blocked | **Priority:** 28 | **Generation:** v3
- **Blocked by:** not v3-testable: INV-034 epistemic_category=substrate_ceiling
- **Why now:** Held by the governance V3-pending gate (INV-034 epistemic_category=substrate_ceiling) -- a /queue-experiment cannot yield contributory evidence. See blocked_by. (R5; mirrors R1.)
...
### IGW-20260808-221 -- Confirm evidence: MECH-191 (lit 0.86, exp ~0)

- **Lane:** experiment | **Skill:** `/queue-experiment` | **Status:** blocked | **Priority:** 55 | **Generation:** v3
- **Blocked by:** experiment_proposals.v1.json EXP-0338 status=blocked_substrate: functional-state channels do not externalize >=2 differentially-active, cross-architecturally-consistent dimensions; scalar channel-norm readouts of tonic accumulators are satu
- **Why now:** ALREADY ADJUDICATED -- do not re-investigate. A prior session (metaworker-chip-20260803-igw-confirm-mech191) recorded EXP-0338 status=blocked_substrate in experiment_proposals.v1.json. See blocked_by; re-runs of this confirmer are NO-OPs un
...
### IGW-20260808-222 -- Confirm evidence: MECH-269 (lit 0.85, exp ~0)
...
### IGW-20260808-223 -- Confirm evidence: MECH-282 (lit 0.83, exp ~0)
...
### IGW-20260808-224 -- Confirm evidence: MECH-338 (lit 0.79, exp ~0)

- **Lane:** experiment | **Skill:** `/queue-experiment` | **Status:** blocked | **Priority:** 55 | **Generation:** v3
- **Blocked by:** experiment_proposals.v1.json EXP-0365 status=gated: MECH-338 is the 'select-face' child mechanism of ARC-077 (EXP-0311): 'Structural slot only; hard-gated on the GAP-L biology lit-pull.' Same absent caregiver-agent substrate as its parent.
- **Why now:** ALREADY ADJUDICATED -- do not re-investigate. A prior session (elastic-merkle-e0cca8) recorded EXP-0365 status=gated in experiment_proposals.v1.json. See blocked_by; re-runs of this confirmer are NO-OPs until that status is cleared.
...
### IGW-20260808-225 -- Confirm evidence: SD-055 (lit 0.76, exp ~0)
...
### IGW-20260808-226 -- Confirm evidence: MECH-186 (lit 0.74, exp ~0)
...
### IGW-20260808-227 -- Confirm evidence: MECH-340 (lit 0.69, exp ~0)
...
### IGW-20260808-228 -- Confirm evidence: MECH-339 (lit 0.68, exp ~0)
