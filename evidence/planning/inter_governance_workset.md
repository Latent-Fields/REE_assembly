...
Generated: `2026-08-01T19:38:59Z`
...
- Items: **245** (ready 30, in_flight 0, blocked 147)
- By generation: clinical 11, meta 4, process 4, v3 86, v4 77, v5 38, v6 25
- Pending review: **2**
- Queue pending (unclaimed): **2**

- Live EXQs: V3-EXQ-847, V3-EXQ-858, V3-EXQ-861, V3-EXQ-862

- Auto-absorbed retests (queued, suppressed from workset): MECH-180 -> V3-EXQ-861

## Work packages

### IGW-20260801-001 -- Complete governance review (2 pending)
...
```
REE inter-governance work item: IGW-20260801-001
...
### IGW-20260801-202 -- Implement substrate: ARC-046 (unblocks ARC-046)
...
```
REE inter-governance work item: IGW-20260801-202
...
### IGW-20260801-204 -- Implement substrate: escape-affordance-bridge (unblocks ARC-060)
...
```
REE inter-governance work item: IGW-20260801-204
...
### IGW-20260801-206 -- Implement substrate: ARC-062 (unblocks ARC-062)
...
```
REE inter-governance work item: IGW-20260801-206
...
### IGW-20260801-207 -- Implement substrate: SD-054 (unblocks ARC-062)
...
```
REE inter-governance work item: IGW-20260801-207
...
### IGW-20260801-208 -- Implement substrate: f_dominance_conversion_ceiling (unblocks ARC-062)
...
```
REE inter-governance work item: IGW-20260801-208
...
### IGW-20260801-212 -- Implement substrate: v4_loop_segregation (unblocks ARC-108)
...
```
REE inter-governance work item: IGW-20260801-212
...
### IGW-20260801-215 -- Implement substrate: SD-MEL-CONSUMER (unblocks INV-050)
...
```
REE inter-governance work item: IGW-20260801-215
...
### IGW-20260801-092 -- Inferred state must not collapse to perceived observation (invariant)
...
```
REE inter-governance work item: IGW-20260801-092
...
### IGW-20260801-103 -- Enabling-conditions register: the pre-linguistic substrate inventory communication needs before it can bootstrap
...
```
REE inter-governance work item: IGW-20260801-103
...
### IGW-20260801-143 -- PILLAR 1 -- token-instance object-file substrate (permanence through occlusion)
...
```
REE inter-governance work item: IGW-20260801-143
...
### IGW-20260801-150 -- PILLAR A -- low-adaptor (smell/gradient) primitive: near-raw orientation signal as the earliest V4 sense
...
```
REE inter-governance work item: IGW-20260801-150
...
### IGW-20260801-195 -- Substrate (blocked): SD-033b
...
```
REE inter-governance work item: IGW-20260801-195
...
### IGW-20260801-196 -- Substrate (blocked): scaffolded_sd054_onboarding
...
```
REE inter-governance work item: IGW-20260801-196
...
### IGW-20260801-197 -- Substrate ready: MECH324-REACQ-WINDOW-GATING-DECOUPLE

- **Lane:** substrate | **Skill:** `/implement-substrate` | **Status:** ready | **Priority:** 25 | **Generation:** v3
- **Why now:** LIKELY ALREADY LANDED, verify before building: session clever-fermat-ea60a4 implemented+landed this exact fix today (ree-v3 7747a01c94, REE_assembly 1c69d0ca82) but the substrate_queue.json sd_id=MECH324-REACQ-WINDOW-GATING-DECOUPLE entry was never flipped to implemented (still pending_implementation/ready:true as of this regen). Check ree-v3 CLAUDE.md for the landed use_chunk_dissolution_retention sub-flag before re-implementing.

<details><summary>Agent brief (copy-paste)</summary>

```
REE inter-governance work item: IGW-20260801-197
...
Instructions:
- VERIFY FIRST: check ree-v3/CLAUDE.md and git log for the reacquisition-window-isolation fix (clever-fermat-ea60a4, 2026-07-31/08-01) before starting -- it may already be landed and only substrate_queue.json needs its status flipped to implemented.
- If genuinely unimplemented, use /implement-substrate for the SD/MECH named in title.
- Workset: http://localhost:8000/workset
```

</details>

### IGW-20260801-198 -- Substrate ready: SD-hazard-aware-policy-decomposition

- **Lane:** substrate | **Skill:** `/implement-substrate` | **Status:** ready | **Priority:** 25 | **Generation:** v3
- **Why now:** Extend SD-039's AnchorGoalPayload/build_goal_payload with a signed harm-valence field sourced from z_harm_a/BLA threat_scale (a VALENCE_HARM_DISCRIMINATIVE residue-field channel already exists elsewhe

<details><summary>Agent brief (copy-paste)</summary>

```
REE inter-governance work item: IGW-20260801-198
Title: Substrate ready: SD-hazard-aware-policy-decomposition
Lane: substrate | Skill: /implement-substrate
Status: ready
Claims: MECH-321
Why now: Extend SD-039's AnchorGoalPayload/build_goal_payload with a signed harm-valence field sourced from z_harm_a/BLA threat_scale (a VALENCE_HARM_DISCRIMINATIVE residue-field channel already exists elsewhe
...
### IGW-20260801-199 -- Substrate ready: arc005_dacc_adapter_goal_proximity_training

- **Lane:** substrate | **Skill:** `/implement-substrate` | **Status:** ready | **Priority:** 25 | **Generation:** v3
- **Why now:** The SD-057 L7 dACC-consume bug (reading the collapsed proposer starting state) was fixed in the same session that produced V3-EXQ-848, so goal_proximity now reaches dacc_adapter as a genuine, non-dege

<details><summary>Agent brief (copy-paste)</summary>

```
REE inter-governance work item: IGW-20260801-199
Title: Substrate ready: arc005_dacc_adapter_goal_proximity_training
Lane: substrate | Skill: /implement-substrate
Status: ready
Claims: ARC-005
Why now: The SD-057 L7 dACC-consume bug (reading the collapsed proposer starting state) was fixed in the same session that produced V3-EXQ-848, so goal_proximity now reaches dacc_adapter as a genuine, non-dege
...
### IGW-20260801-201 -- Retest after substrate: ARC-046
...
```
REE inter-governance work item: IGW-20260801-201
...
### IGW-20260801-203 -- Retest after substrate: ARC-060
...
```
REE inter-governance work item: IGW-20260801-203
...
### IGW-20260801-205 -- Retest after substrate: ARC-062
...
```
REE inter-governance work item: IGW-20260801-205
...
### IGW-20260801-209 -- Retest after substrate: ARC-063
...
```
REE inter-governance work item: IGW-20260801-209
...
### IGW-20260801-210 -- Retest after substrate: ARC-068
...
```
REE inter-governance work item: IGW-20260801-210
...
### IGW-20260801-211 -- Retest after substrate: ARC-108
...
```
REE inter-governance work item: IGW-20260801-211
...
### IGW-20260801-213 -- Retest after substrate: ARC-110
...
```
REE inter-governance work item: IGW-20260801-213
...
### IGW-20260801-214 -- Retest after substrate: INV-050
...
```
REE inter-governance work item: IGW-20260801-214
...
### IGW-20260801-216 -- Retest after substrate: INV-089
...
```
REE inter-governance work item: IGW-20260801-216
...
### IGW-20260801-217 -- Retest after substrate: INV-091
...
```
REE inter-governance work item: IGW-20260801-217
...
### IGW-20260801-015 -- Which channel carries it? Per-channel leave-one-out ablation grid, RE-SCOPED to mode-occupancy after 802
...
```
REE inter-governance work item: IGW-20260801-015
...
### IGW-20260801-016 -- MECH-309/ARC-062 behavioural falsifier now unblocked by CandidateRuleField + GAP-A + authority readiness
...
```
REE inter-governance work item: IGW-20260801-016
...
### IGW-20260801-028 -- Theory 2 / Layer B: E3 scoring collapses diverse candidates to one (MECH-341)
...
```
REE inter-governance work item: IGW-20260801-028
...
### IGW-20260801-030 -- F-dominance committed-selection variance monopoly (MECH-439) -- the GENERAL root behind GAP-A's local conversion ceiling
...
```
REE inter-governance work item: IGW-20260801-030
...
### IGW-20260801-031 -- ARC-108 learned cortico-striatal gating + MECH-450 recurrent-settling step -- the next MECH-439 attack after GAP-J. Turn
...
```
REE inter-governance work item: IGW-20260801-031
...
### IGW-20260801-039 -- Umbrella: assemble the multi-face substrate that converts per-candidate diversity to committed-class diversity
...
```
REE inter-governance work item: IGW-20260801-039
...
### IGW-20260801-040 -- Selection-face composition: does MECH-448 demotion x MECH-449 Go/No-Go compound or cancel at committed-class entropy (C2
...
```
REE inter-governance work item: IGW-20260801-040
...
### IGW-20260801-041 -- Commit-duration face (root C, MECH-445/446): de-commit authority on a substrate where natural-commit and closure-de-comm
...
```
REE inter-governance work item: IGW-20260801-041
...
### IGW-20260801-043 -- The real test: co-armed full-stack arm (demotion + Go/No-Go + floor + root-C + OFC ON), sweep use_candidate_rule_field, 
...
```
REE inter-governance work item: IGW-20260801-043
...
### IGW-20260801-044 -- Learned-gating face (ARC-108 / MECH-450): make the ARC-107 arithmetic BG arbitration LEARNABLE. The selection face was n
...
```
REE inter-governance work item: IGW-20260801-044
...
### IGW-20260801-045 -- GENERATION face (the missing 6th face, MECH-458): per-candidate strategy diversity may be generation-LIMITED, not merely
...
```
REE inter-governance work item: IGW-20260801-045
...
### IGW-20260801-137 -- Substrate-vocabulary expansion is the gating fork (atomic-only V3 has no second granularity)
...
```
REE inter-governance work item: IGW-20260801-137
...
### IGW-20260801-170 -- Capability floor before structure -- isolate can-it-act from does-structure-help
...
```
REE inter-governance work item: IGW-20260801-170
...
### IGW-20260801-180 -- Phase 1b -- substrate-readiness diagnostic: re-run the V3-EXQ-620 protocol under SD-029 scheduled-external-hazard curric
...
```
REE inter-governance work item: IGW-20260801-180
...
### IGW-20260801-188 -- z_self enters E3 viability scoring (DR-10): bodily state modulates trajectory viability
...
```
REE inter-governance work item: IGW-20260801-188
...
### IGW-20260801-120 -- False-linking-risk / reality-coherence cost term (the single aspect with no REE home)
...
```
REE inter-governance work item: IGW-20260801-120
...
### IGW-20260801-165 -- Frame-tag failure modes: derealization, delusion, commitment-gate (developmental etiology)
...
```
REE inter-governance work item: IGW-20260801-165
...
### IGW-20260801-171 -- Ceiling-claim demotion rule (new GOV-* pre-registered falsification/demotion rule)
...
```
REE inter-governance work item: IGW-20260801-171
...
### IGW-20260801-200 -- Queue depth low (2 pending)
...
```
REE inter-governance work item: IGW-20260801-200
...
### IGW-20260801-002 -- Compositional generalisation over named primitives (recombine grounded symbols to novel combinations)
...
```
REE inter-governance work item: IGW-20260801-002
...
### IGW-20260801-006 -- Symbolic reasoning cannot override embodied harm sensing (the V6 instance of INV-007)
...
```
REE inter-governance work item: IGW-20260801-006
...
### IGW-20260801-007 -- FOUNDATION -- per-candidate multi-channel affect vector substrate (MECH-359)
...
```
REE inter-governance work item: IGW-20260801-007
...
### IGW-20260801-021 -- Unified autobiographical event-token store (ARC-085): ONE self-tagged store backing both replay and prospective simulati
...
```
REE inter-governance work item: IGW-20260801-021
...
### IGW-20260801-022 -- Provenance-bearing event token + one-way committed-vs-imagined gate (MECH-365)
...
```
REE inter-governance work item: IGW-20260801-022
...
### IGW-20260801-048 -- Graded action-status + self-reference-frame vocabulary decision (Q-068 fork)
...
```
REE inter-governance work item: IGW-20260801-048
...
### IGW-20260801-049 -- PILLAR -- externalised DMN play scaffold (ARC-090): simulation pushed outward into objects/roles/as-if worlds
...
```
REE inter-governance work item: IGW-20260801-049
...
### IGW-20260801-054 -- Multidrive arbitration / orchestration policy (which drive wins when several are active)
...
```
REE inter-governance work item: IGW-20260801-054
...
### IGW-20260801-058 -- Multi-agent D_V substrate: extend temporal-depth coherence optimisation over self AND represented others (ARC-056 entry)
...
```
REE inter-governance work item: IGW-20260801-058
...
### IGW-20260801-059 -- Typed causal-attribution ontology: ownership tags for self / world / body / model / commitment / OTHER / shared / accide
...
```
REE inter-governance work item: IGW-20260801-059
...
### IGW-20260801-060 -- Guilt-as-repair routing: self-attributed harm opens repair-search + policy-update pathways (E3 repair-trajectory generat
...
```
REE inter-governance work item: IGW-20260801-060
...
### IGW-20260801-065 -- Stream-binding mechanism: route own motivational-affective streams across the other-model
...
```
REE inter-governance work item: IGW-20260801-065
...
### IGW-20260801-066 -- Falsifiable dissociation: prediction != reciprocity-reward != residue-aware repair (A/B/C/D)
...
```
REE inter-governance work item: IGW-20260801-066
...
### IGW-20260801-069 -- Experiment A -- REE-native J-lens dispositional readout (does REE have a J-space?)
...
```
REE inter-governance work item: IGW-20260801-069
...
### IGW-20260801-071 -- Experiment B -- workspace-ablation cliff (cliff vs graceful degradation; the SD-064 falsifier)
...
```
REE inter-governance work item: IGW-20260801-071
...
### IGW-20260801-073 -- PILLAR 1 -- frontopolar-analog deliberation substrate (SD-033e module + mode transitions)
...
```
REE inter-governance work item: IGW-20260801-073
...
### IGW-20260801-079 -- Predicate-argument-event bridge to ARC-063 CandidateRuleField: render minted rules as 'if context, then action-object, c
...
```
REE inter-governance work item: IGW-20260801-079
...
### IGW-20260801-082 -- Language-bootstrap-from-ecology: proto-language stabilises from grounded proto-communication in the social ecology (gram
...
```
REE inter-governance work item: IGW-20260801-082
...
### IGW-20260801-083 -- GATE -- multi-step hippocampally-planned system validated in V3 (MECH-163)
...
```
REE inter-governance work item: IGW-20260801-083
...
### IGW-20260801-084 -- PILLAR -- dorsal/ventral hippocampal functional segregation (ARC-040)
...
```
REE inter-governance work item: IGW-20260801-084
...
### IGW-20260801-093 -- Belief-state hypothesis set (top-k latent-state hypotheses with precision)
...
```
REE inter-governance work item: IGW-20260801-093
...
### IGW-20260801-095 -- Safety-route inference (infer route to safety from partial map/cue/gradient)
...
```
REE inter-governance work item: IGW-20260801-095
...
### IGW-20260801-098 -- Pre-linguistic-grounding gate: no affect adaptor before object/self/other primitives exist (the load-bearing ordering)
...
```
REE inter-governance work item: IGW-20260801-098
...
### IGW-20260801-099 -- Uncertainty-propagation invariant: parsed affect enters as a hypothesis (distribution), NEVER as ground truth
...
```
REE inter-governance work item: IGW-20260801-099
...
### IGW-20260801-100 -- The adaptor itself: a lightweight LanguageAffectAdaptor (SLM-class) text -> distribution-over-affect
...
```
REE inter-governance work item: IGW-20260801-100
...
### IGW-20260801-104 -- Minimal signalling channel: smallest signal that lets one agent alter another's attention or action (MECH-014)
...
```
REE inter-governance work item: IGW-20260801-104
...
### IGW-20260801-105 -- Joint-attention coordination games: signalling emerges under partial observability + coordination pressure (the emergenc
...
```
REE inter-governance work item: IGW-20260801-105
...
### IGW-20260801-109 -- Trust-calibration over linguistic signals (sender-reliability estimate weights symbolic updates)
...
```
REE inter-governance work item: IGW-20260801-109
...
### IGW-20260801-110 -- Deception detection / honest-signal pressure (deception = modelling another model)
...
```
REE inter-governance work item: IGW-20260801-110
...
### IGW-20260801-113 -- Caregiver/multi-agent substrate exists (ARC-047 SocialGridWorld) -- the prerequisite OTHER
...
```
REE inter-governance work item: IGW-20260801-113
...
### IGW-20260801-114 -- Loveability internalisation: care received as APPLICABLE-TO-SELF (close the MECH-158 failure)
...
```
REE inter-governance work item: IGW-20260801-114
...
### IGW-20260801-115 -- Live unethical affordance: harmful action representable as a chooseable possibility (not absent)
...
```
REE inter-governance work item: IGW-20260801-115
...
### IGW-20260801-116 -- Correction without annihilation: caregiver correction updates rule/harm/residue models WITHOUT self-valence collapse
...
```
REE inter-governance work item: IGW-20260801-116
...
### IGW-20260801-118 -- Ethical agency as care-biased choice among live alternatives (kindness is NOT constraint compliance)
...
```
REE inter-governance work item: IGW-20260801-118
...
### IGW-20260801-123 -- Otherness inference: tag an entity OTHER_SELFLIKE without symbolic identity (MECH-031/032)
...
```
REE inter-governance work item: IGW-20260801-123
...
### IGW-20260801-124 -- Reuse the self generative model to SIMULATE the other (ARC-010): shared L-space, reduced precision, no interoceptive clo
...
```
REE inter-governance work item: IGW-20260801-124
...
### IGW-20260801-125 -- Precision-weighted coupling apparatus (ARC-010 signed coupling): the alpha_k / coupling-strength control that scales oth
...
```
REE inter-governance work item: IGW-20260801-125
...
### IGW-20260801-126 -- Empathy veto + harm-equivalence: predicted other-degradation treated as homologous to self-harm (INV-005, MECH-036)
...
```
REE inter-governance work item: IGW-20260801-126
...
### IGW-20260801-130 -- Multi-agent substrate: MultiAgentCausalGridWorldV4 + per-agent REEAgent instances + inter-agent arbitration
...
```
REE inter-governance work item: IGW-20260801-130
...
### IGW-20260801-131 -- Per-agent observation + collision/cooperation arbitration: how agents perceive and act on each other
...
```
REE inter-governance work item: IGW-20260801-131
...
### IGW-20260801-138 -- PILLAR A -- action-chunk cache (SD-045): the first reusable-unit substrate, model-free habit pathway
...
```
REE inter-governance work item: IGW-20260801-138
...
### IGW-20260801-142 -- PILLAR D -- theta-packaging + cognitive-map traversal scale to the active abstraction level (MECH-299 / MECH-300)
...
```
REE inter-governance work item: IGW-20260801-142
...
### IGW-20260801-153 -- PILLAR C -- cross-modal negotiation currency: making heterogeneous sense geometries mutually negotiable in one world mod
...
```
REE inter-governance work item: IGW-20260801-153
...
### IGW-20260801-155 -- Opening-vs-closure asymmetry framing + the V3-conservative-is-insufficient gate
...
```
REE inter-governance work item: IGW-20260801-155
...
### IGW-20260801-156 -- PILLAR A -- ACh-analog basal-forebrain plasticity-gain gate
...
```
REE inter-governance work item: IGW-20260801-156
...
### IGW-20260801-174 -- Harm-to-agency signal: goal-interference over trajectory pairs (MECH-129), distinct from harm-to-agent
...
```
REE inter-governance work item: IGW-20260801-174
...
### IGW-20260801-177 -- Love as agent-indexed terrain inference with self-like gradient weighting (MECH-164)
...
```
REE inter-governance work item: IGW-20260801-177
...
### IGW-20260801-187 -- Finish self-attribution: complete the per-stream comparator topology (SD-030 z_self stream)
...
```
REE inter-governance work item: IGW-20260801-187
...
### IGW-20260801-008 -- Anti-collapse MAP consolidation (ARC-088) -- audit distinctness across the affect stack
...
```
REE inter-governance work item: IGW-20260801-008
...
### IGW-20260801-032 -- Commitment / de-commit latch grounding L1 -> L3
...
```
REE inter-governance work item: IGW-20260801-032
...
### IGW-20260801-036 -- OCD battery completeness (V3-EXQ-460..468) + MECH-090 commit-entry conjunction
...
```
REE inter-governance work item: IGW-20260801-036
...
### IGW-20260801-046 -- Phase 1 -- emit a derived gitignored SQLite read-model from build_experiment_indexes.py at the point it already writes c
...
```
REE inter-governance work item: IGW-20260801-046
...
### IGW-20260801-057 -- Phase 2 (Option B): pairwise MRF + damped loopy belief propagation, additive output schema, evidence-flow animation
...
```
REE inter-governance work item: IGW-20260801-057
...
### IGW-20260801-159 -- 2x2 motivational state taxonomy + three-stage pipeline (depression / GAD)
...
```
REE inter-governance work item: IGW-20260801-159
...
### IGW-20260801-160 -- Catatonia subtype II: harm-stream lock-in (SD-036 decay regulator, MECH-279 PAG freeze gate)
...
```
REE inter-governance work item: IGW-20260801-160
...
### IGW-20260801-161 -- OCD as a three-layer architectural failure
...
```
REE inter-governance work item: IGW-20260801-161
...
### IGW-20260801-194 -- SD-017 retest cohort (V3-EXQ-265a PASS 2026-05-09; V3-EXQ-418l + 436a reclassified non_contributory 2026-05-10 pending A
...
```
REE inter-governance work item: IGW-20260801-194
...
### IGW-20260801-218 -- Proposal for Q-086
...
```
REE inter-governance work item: IGW-20260801-218
Title: Proposal for Q-086
Lane: experiment | Skill: /queue-experiment
Status: ready
Claims: Q-086
Proposal backlog id (stable): EVB-0481
Why now: insufficient_experimental_replication; low_exp_conf; missing_literature_evidence
...
### IGW-20260801-219 -- Proposal for Q-086
...
```
REE inter-governance work item: IGW-20260801-219
Title: Proposal for Q-086
Lane: experiment | Skill: /queue-experiment
Status: ready
Claims: Q-086
...
### IGW-20260801-220 -- Proposal for INV-034
...
```
REE inter-governance work item: IGW-20260801-220
...
### IGW-20260801-221 -- Proposal for MECH-166
...
```
REE inter-governance work item: IGW-20260801-221
...
### IGW-20260801-222 -- Proposal for MECH-123
...
```
REE inter-governance work item: IGW-20260801-222
...
### IGW-20260801-078 -- Grammar->substrate mapping table (the mining artifact): per primitive, which substrate, which version, grounded-or-merel
...
```
REE inter-governance work item: IGW-20260801-078
...
### IGW-20260801-097 -- Inference failure-mode register + biology grounding (lit-pulls)
...
```
REE inter-governance work item: IGW-20260801-097
...
### IGW-20260801-154 -- Adaptor-maturity curriculum gate: each sense admitted when its adaptor is mature, not all at once
...
```
REE inter-governance work item: IGW-20260801-154
...
### IGW-20260801-166 -- Self-model failure modes: E1 schema poverty vs E2 capacity degradation
...
```
REE inter-governance work item: IGW-20260801-166
...
### IGW-20260801-167 -- Narcolepsy and cataplexy: bilateral orexin-loss failure
...
```
REE inter-governance work item: IGW-20260801-167
...
### IGW-20260801-168 -- Difficulty-gated proposal entropy: stuck-state cognition (working hypothesis)
...
```
REE inter-governance work item: IGW-20260801-168
...
### IGW-20260801-172 -- Minimal 2-agent world (put any load on the ethics thesis, currently V5-only)
...
```
REE inter-governance work item: IGW-20260801-172
...
### IGW-20260801-173 -- Early-gating vs late-judging demo (REE early commit-gating beats a Constitutional-AI-style late judge)
...
```
REE inter-governance work item: IGW-20260801-173
...
### IGW-20260801-003 -- Relational / propositional inference over named relations (transitivity, role-binding, relational chaining)
...
```
REE inter-governance work item: IGW-20260801-003
...
### IGW-20260801-004 -- Analogy / structure-mapping across grounded domains (relational alignment, not surface match)
...
```
REE inter-governance work item: IGW-20260801-004
...
### IGW-20260801-005 -- Grammatical realisation of the event-arc: tense / aspect / because / but / unless / done / again
...
```
REE inter-governance work item: IGW-20260801-005
...
### IGW-20260801-009 -- Expression as emergent action geometry (MECH-360) -- the readout side of the affect vector
...
```
REE inter-governance work item: IGW-20260801-009
...
### IGW-20260801-010 -- Candidate-gradient hippocampal episode schema (MECH-361) -- affect gradient as write-weight + retrieval-query
...
```
REE inter-governance work item: IGW-20260801-010
...
### IGW-20260801-013 -- Compulsion-risk substrate -- slow modulator (MECH-369) + composed readout (MECH-370) + chunk-cache loop (SD-045) + value
...
```
REE inter-governance work item: IGW-20260801-013
...
### IGW-20260801-014 -- Slow value-INDEPENDENT decommit-friction / engagement-release modulator substrate (the slow-modulator-class distinction 
...
```
REE inter-governance work item: IGW-20260801-014
...
### IGW-20260801-023 -- Imagination-learning licit/forbidden principle (ARC-level, folded into the provenance gate)
...
```
REE inter-governance work item: IGW-20260801-023
...
### IGW-20260801-024 -- Event-level write-authority gate over the durable model-update path (MECH-368) + its falsifier (Q-062)
...
```
REE inter-governance work item: IGW-20260801-024
...
### IGW-20260801-050 -- PILLAR -- private speech as external cognitive-control surface (MECH-380): Vygotskian internalisation ladder
...
```
REE inter-governance work item: IGW-20260801-050
...
### IGW-20260801-051 -- PILLAR -- developmental compression ladder (MECH-381): externalise-then-internalise across the whole curriculum
...
```
REE inter-governance work item: IGW-20260801-051
...
### IGW-20260801-056 -- Orienting/surveying drive: pre-approach active-sensing control state
...
```
REE inter-governance work item: IGW-20260801-056
...
### IGW-20260801-061 -- Anti-shame safety invariants: no-global-self-condemnation write + containment-not-shame autonomy suspension
...
```
REE inter-governance work item: IGW-20260801-061
...
### IGW-20260801-062 -- Love as agent-indexed terrain inference: infer another agent's goal/harm gradients and weight them with self-equal motiv
...
```
REE inter-governance work item: IGW-20260801-062
...
### IGW-20260801-067 -- Residue-aware social repair: regret-residue after exploitation generates a repair-goal
...
```
REE inter-governance work item: IGW-20260801-067
...
### IGW-20260801-068 -- Developmental ordering of other-bound streams: protective streams before appetitive (safety gate)
...
```
REE inter-governance work item: IGW-20260801-068
...
### IGW-20260801-070 -- SD-027 / MECH-254 V3 boundary top-k access-gate build (use_boundary_access_gate, no-op-default)
...
```
REE inter-governance work item: IGW-20260801-070
...
### IGW-20260801-074 -- PILLAR 2 -- counterfactual-value tracking and switch-to-alternative gate (MECH-264)
...
```
REE inter-governance work item: IGW-20260801-074
...
### IGW-20260801-075 -- PILLAR 3 -- relative-importance monitoring across competing goals + dACC cross-slot arbitrator (MECH-265, SD-046)
...
```
REE inter-governance work item: IGW-20260801-075
...
### IGW-20260801-076 -- PILLAR 4 -- interrupted-task resumption / Zeigarnik (the event-arc's weak interrupt->reorient->resume span)
...
```
REE inter-governance work item: IGW-20260801-076
...
### IGW-20260801-085 -- DG-equivalent pattern separation before rollout proposal (MECH-147)
...
```
REE inter-governance work item: IGW-20260801-085
...
### IGW-20260801-086 -- Pure time cells -- temporal scaffolding for E3 credit assignment (MECH-148)
...
```
REE inter-governance work item: IGW-20260801-086
...
### IGW-20260801-087 -- CA1 mismatch novelty gate on rollout injection (MECH-149)
...
```
REE inter-governance work item: IGW-20260801-087
...
### IGW-20260801-094 -- Inferred affordance field (afford. not directly perceived; biases E3 candidates)
...
```
REE inter-governance work item: IGW-20260801-094
...
### IGW-20260801-096 -- Epistemic action pressure (information-gathering as survival-relevant, not just curiosity)
...
```
REE inter-governance work item: IGW-20260801-096
...
### IGW-20260801-101 -- Consumption wiring: parsed other-affect prior feeds the V5 empathy stream-binding layer (not a parallel path)
...
```
REE inter-governance work item: IGW-20260801-101
...
### IGW-20260801-102 -- Falsifiable test: language-parsed affect must change other-directed behaviour vs literal-semantics-only baseline (and mu
...
```
REE inter-governance work item: IGW-20260801-102
...
### IGW-20260801-106 -- Signal-to-rule minting: repeated signal/action/outcome regularities become CandidateRuleField rules (ARC-063 bridge)
...
```
REE inter-governance work item: IGW-20260801-106
...
### IGW-20260801-107 -- Convention robustness: partner variation + repair distinguish true convention from overfitted co-adaptation
...
```
REE inter-governance work item: IGW-20260801-107
...
### IGW-20260801-108 -- Language-as-play-game substrate reuse: the bootstrap runs inside play_mode, not a parallel language-acquisition module (
...
```
REE inter-governance work item: IGW-20260801-108
...
### IGW-20260801-111 -- Language failure modes as REE pathologies (rationalisation / ideological capture / bureaucratic dissociation / moral lic
...
```
REE inter-governance work item: IGW-20260801-111
...
### IGW-20260801-112 -- Institutions as multi-agent linguistic coordination structures (residue absorb / diffuse / deny)
...
```
REE inter-governance work item: IGW-20260801-112
...
### IGW-20260801-117 -- Love-mediated repair after harm: repair as relationship restoration, not punishment avoidance
...
```
REE inter-governance work item: IGW-20260801-117
...
### IGW-20260801-119 -- Explicit active-separation operation (separate != failed-integration) + DG pattern-separation pairing
...
```
REE inter-governance work item: IGW-20260801-119
...
### IGW-20260801-121 -- Provenance + contradiction-flag + rollback layer on consolidated memory
...
```
REE inter-governance work item: IGW-20260801-121
...
### IGW-20260801-127 -- Gain-calibration window: low/high/miscalibrated coupling failure modes (psychopathy / overwhelm / burnout)
...
```
REE inter-governance work item: IGW-20260801-127
...
### IGW-20260801-129 -- Care persistence + counterfactual empathic activation: love/cooperation as long-horizon coupling (MECH-052, MECH-127)
...
```
REE inter-governance work item: IGW-20260801-129
...
### IGW-20260801-132 -- Agency detection with a structurally-distinct OTHER (MECH-095 retest; MECH-099 richer-causation attribution)
...
```
REE inter-governance work item: IGW-20260801-132
...
### IGW-20260801-133 -- Multi-channel coping repertoire so violence is genuinely terminal (MECH-102): negotiation / withdrawal / cooperation cha
...
```
REE inter-governance work item: IGW-20260801-133
...
### IGW-20260801-134 -- Ethics-as-coherence under axiom conflict (Q-028): context-sensitive self-vs-other comparator + moral-residue mechanism
...
```
REE inter-governance work item: IGW-20260801-134
...
### IGW-20260801-136 -- ARC-010 mirror-modelling cutover: other-agent state re-represented through the self's own predictive machinery
...
```
REE inter-governance work item: IGW-20260801-136
...
### IGW-20260801-139 -- PILLAR B -- type-encoder + category prototypes (SD-040): type-keyed anchors over z_world
...
```
REE inter-governance work item: IGW-20260801-139
...
### IGW-20260801-140 -- PILLAR B retrieval -- prototype-readout operator + type-V_s gating (MECH-296 / MECH-297)
...
```
REE inter-governance work item: IGW-20260801-140
...
### IGW-20260801-141 -- PILLAR C -- option library (SD-042): named reusable subroutines (init-set / termination / internal-policy)
...
```
REE inter-governance work item: IGW-20260801-141
...
### IGW-20260801-144 -- PILLAR 2 -- self-as-object cutover (ARC-081): z_self -> privileged object-file slot
...
```
REE inter-governance work item: IGW-20260801-144
...
### IGW-20260801-145 -- PILLAR 3 -- tools/affordances object->action binding (ARC-082)
...
```
REE inter-governance work item: IGW-20260801-145
...
### IGW-20260801-146 -- PILLAR 4 -- others-as-object (ARC-083): per-agent token-keyed object-file slots
...
```
REE inter-governance work item: IGW-20260801-146
...
### IGW-20260801-151 -- PILLAR B -- deep-adaptor (sight) perceptual-manifold constructor: metric/geometry before world-model entry
...
```
REE inter-governance work item: IGW-20260801-151
...
### IGW-20260801-152 -- Metric-origin fork: per-sense perceptual metric LEARNED from similarity statistics vs partly DEFINED (structural prior)
...
```
REE inter-governance work item: IGW-20260801-152
...
### IGW-20260801-157 -- PILLAR B -- state-conditional plasticity-gain architectural commitment
...
```
REE inter-governance work item: IGW-20260801-157
...
### IGW-20260801-158 -- Layer-specificity adjudication (one global scalar vs per-substrate gates)
...
```
REE inter-governance work item: IGW-20260801-158
...
### IGW-20260801-175 -- Agent-policy novelty typing (MECH-130): world-state novelty != agent-policy novelty
...
```
REE inter-governance work item: IGW-20260801-175
...
### IGW-20260801-176 -- Consent / incidental-vs-constitutive qualifier on harm-to-agency (the discriminant layer of MECH-129)
...
```
REE inter-governance work item: IGW-20260801-176
...
### IGW-20260801-178 -- Self-like weighting calibration: full-symmetry vs collapse vs callousness (the lambda the structural claim leaves open)
...
```
REE inter-governance work item: IGW-20260801-178
...
### IGW-20260801-181 -- Phase 2 (re-application) -- deterministic p70 recalibration over the Phase-1b manifest; emit a non-empty per-knob overri
...
```
REE inter-governance work item: IGW-20260801-181
...
### IGW-20260801-182 -- Phase 3 (re-application) -- verification diagnostic: recalibrated thresholds lift consumer outputs above zero; acceptanc
...
```
REE inter-governance work item: IGW-20260801-182
...
### IGW-20260801-183 -- Phase 4 (re-application) -- V3-EXQ-483f behavioural validation (4-arm 2x2) on the axis-(b)-recalibrated substrate
...
```
REE inter-governance work item: IGW-20260801-183
...
### IGW-20260801-184 -- ARC-033 vs ARC-058 path arbitration (forensic 445h read)
...
```
REE inter-governance work item: IGW-20260801-184
...
### IGW-20260801-185 -- SD-029 / MECH-256 retest under full substrate stack
...
```
REE inter-governance work item: IGW-20260801-185
...
### IGW-20260801-190 -- z_self-domain goal representation (DR-11): self-state goals representable, not just world-location goals
...
```
REE inter-governance work item: IGW-20260801-190
...
### IGW-20260801-191 -- Proxy/hedonic dissociating environment (DR-14): substrate that surfaces the wanting-without-satisfaction failure
...
```
REE inter-governance work item: IGW-20260801-191
...
### IGW-20260801-192 -- Maturational-sequence honesty gate (INV-064): self-stability must precede the social/other pillar
...
```
REE inter-governance work item: IGW-20260801-192
...
### IGW-20260801-017 -- ARC-065 diversity-generation cluster: MECH-313 / MECH-314 substrates landed; Q-043 / Q-044 / Q-045 ablation EXQs pending
...
```
REE inter-governance work item: IGW-20260801-017
...
### IGW-20260801-018 -- ARC-064 bottom-up rule-discovery cluster (MECH-316 / MECH-317 / MECH-318 absorption check done); empirical gate pending
...
```
REE inter-governance work item: IGW-20260801-018
...
### IGW-20260801-020 -- MECH-319 simulation-mode rule-write-gating: substrate landed; V3-EXQ-628 evidence falsifier LANDED PASS (supports) 2026-
...
```
REE inter-governance work item: IGW-20260801-020
...
### IGW-20260801-027 -- Biology grounding completion (emotional-modulation-of-consolidation write-weight, source/provenance monitoring, imaginat
...
```
REE inter-governance work item: IGW-20260801-027
...
### IGW-20260801-029 -- Theory 3 / Layer C: missing tonic noise floor (MECH-313 LC-NE analog)
...
```
REE inter-governance work item: IGW-20260801-029
...
### IGW-20260801-033 -- Goal / wanting layer grounding L1 -> L2 [L2 REACHED 2026-07-07 via on-file anchors]
...
```
REE inter-governance work item: IGW-20260801-033
...
### IGW-20260801-037 -- OCD-battery completeness: the *b behavioural cohort (460b/461/463b/464b/466b/467b/468b) for SD-034/MECH-266/267/268 + ME
...
```
REE inter-governance work item: IGW-20260801-037
...
### IGW-20260801-038 -- SD-033b behavioural validation (devaluation + perceptual discrimination)
...
```
REE inter-governance work item: IGW-20260801-038
...
### IGW-20260801-042 -- Valuation face (SD-033b/MECH-263): decoupled OFC devaluation head feeding F
...
```
REE inter-governance work item: IGW-20260801-042
...
### IGW-20260801-047 -- Phase 2 -- cut over the six identified consumers, incl. a /api/claims/summary endpoint replacing explorer.html's 10 MB p
...
```
REE inter-governance work item: IGW-20260801-047
...
### IGW-20260801-055 -- Drive-arbitration biology grounding (multidrive competition / drive hierarchy lit-pull)
...
```
REE inter-governance work item: IGW-20260801-055
...
### IGW-20260801-064 -- Biology grounding: guilt-as-reparative-motivation vs shame-as-withdrawal, moral-repair, typed-causal-attribution, and p-
...
```
REE inter-governance work item: IGW-20260801-064
...
### IGW-20260801-090 -- EXQ-ISEF-004: novelty bonus calibration (Goldilocks sweep; identify optimal novelty_bonus_weight before stochastic attra
...
```
REE inter-governance work item: IGW-20260801-090
...
### IGW-20260801-091 -- EXQ-ISEF-005: 4-phase curriculum vs flat parameter baselines (gate-criterion satisfaction comparison)
...
```
REE inter-governance work item: IGW-20260801-091
...
### IGW-20260801-147 -- Biology grounding completion (object-files / permanence / affordances / self / ToM lit-pulls)
...
```
REE inter-governance work item: IGW-20260801-147
...
### IGW-20260801-148 -- Unify the pack skeleton (sync build_runpack_docs + pack_writer.write_pack delegate to one shared skeleton)
...
```
REE inter-governance work item: IGW-20260801-148
...
### IGW-20260801-149 -- Carry the always-core through sync into the pack (substrate_hash/config/seeds/machine/elapsed_seconds + rich governance 
...
```
REE inter-governance work item: IGW-20260801-149
...
### IGW-20260801-162 -- Hyperarousal insomnia and schema-repair starvation (PTSD chronicity)
...
```
REE inter-governance work item: IGW-20260801-162
...
### IGW-20260801-163 -- Dream phenomenology as diagnostic and treatment-response marker
...
```
REE inter-governance work item: IGW-20260801-163
...
### IGW-20260801-164 -- Serotonergic cross-state architecture (replay salience tagging, REM-gate zero-point)
...
```
REE inter-governance work item: IGW-20260801-164
...
### IGW-20260801-169 -- Pharmacological predictions registry + receptor-subtype resolution layer
...
```
REE inter-governance work item: IGW-20260801-169
...
### IGW-20260801-179 -- Biology grounding for relational harm + love-as-care (harm-to-agency, ToM-of-goals, empathy-as-shared-circuit lit-pulls)
...
```
REE inter-governance work item: IGW-20260801-179
...
### IGW-20260801-189 -- E2 prediction error modulates E3 confidence (DR-12): PE-magnitude signals trajectory unreliability
...
```
REE inter-governance work item: IGW-20260801-189
...
### IGW-20260801-193 -- Own-future-option uncertainty: does REE need an explicit self-model of its OWN future option-space (second-order uncerta
...
```
REE inter-governance work item: IGW-20260801-193
...
### IGW-20260801-223 -- Confirm evidence: MECH-166 (lit 0.88, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-223
...
### IGW-20260801-224 -- Confirm evidence: MECH-122 (lit 0.87, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-224
...
### IGW-20260801-225 -- Confirm evidence: MECH-292 (lit 0.87, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-225
...
### IGW-20260801-226 -- Confirm evidence: MECH-267 (lit 0.87, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-226
...
### IGW-20260801-227 -- Confirm evidence: MECH-293 (lit 0.87, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-227
...
### IGW-20260801-228 -- Confirm evidence: SD-014 (lit 0.87, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-228
...
### IGW-20260801-229 -- Confirm evidence: MECH-191 (lit 0.87, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-229
...
### IGW-20260801-230 -- Confirm evidence: MECH-074 (lit 0.86, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-230
...
### IGW-20260801-231 -- Confirm evidence: SD-039 (lit 0.86, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-231
...
### IGW-20260801-232 -- Confirm evidence: MECH-269 (lit 0.85, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-232
...
### IGW-20260801-233 -- Confirm evidence: INV-064 (lit 0.84, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-233
...
### IGW-20260801-234 -- Confirm evidence: MECH-282 (lit 0.83, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-234
...
### IGW-20260801-235 -- Confirm evidence: MECH-286 (lit 0.82, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-235
...
### IGW-20260801-236 -- Confirm evidence: MECH-074d (lit 0.81, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-236
...
### IGW-20260801-237 -- Confirm evidence: MECH-338 (lit 0.79, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-237
...
### IGW-20260801-238 -- Confirm evidence: MECH-232 (lit 0.78, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-238
...
### IGW-20260801-239 -- Confirm evidence: SD-055 (lit 0.76, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-239
...
### IGW-20260801-240 -- Confirm evidence: MECH-074c (lit 0.76, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-240
...
### IGW-20260801-241 -- Confirm evidence: SD-009 (lit 0.73, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-241
...
### IGW-20260801-242 -- Confirm evidence: SD-024 (lit 0.70, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-242
...
### IGW-20260801-243 -- Confirm evidence: MECH-217 (lit 0.70, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-243
...
### IGW-20260801-244 -- Confirm evidence: MECH-340 (lit 0.69, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-244
...
### IGW-20260801-245 -- Confirm evidence: MECH-339 (lit 0.68, exp ~0)
...
```
REE inter-governance work item: IGW-20260801-245
...
### IGW-20260801-011 -- Soothing / comfort autonomic state-gain modulator (MECH-355) -- V4-social
...
```
REE inter-governance work item: IGW-20260801-011
...
### IGW-20260801-012 -- Laughter regime-transition discharge (MECH-364) + crying/distress-vocalisation analogue and laughter-valence adjudicatio
...
```
REE inter-governance work item: IGW-20260801-012
...
### IGW-20260801-019 -- MECH-312 precision-gating family registered (MECH-312a / MECH-312b / MECH-312c / MECH-312d sub-MECHs)
...
```
REE inter-governance work item: IGW-20260801-019
...
### IGW-20260801-025 -- Candidate-gradient episode content schema (MECH-361): affect gradient as write-weight + retrieval-query
...
```
REE inter-governance work item: IGW-20260801-025
...
### IGW-20260801-026 -- Switchable episodic perspective tag (MECH-366): participant/observer viewpoint as a represented, switchable property
...
```
REE inter-governance work item: IGW-20260801-026
...
### IGW-20260801-034 -- Attention (distributed precision-selection) grounding -- containment, not a module
...
```
REE inter-governance work item: IGW-20260801-034
...
### IGW-20260801-035 -- Ethics / commitment policy grounding (or honest 'no clean analog')
...
```
REE inter-governance work item: IGW-20260801-035
...
### IGW-20260801-052 -- Distancing operator (MECH-382): first/third-person reframe as an arbitration-altering control move
...
```
REE inter-governance work item: IGW-20260801-052
...
### IGW-20260801-053 -- Labels as top-down perceptual-control signals (MECH-383): self-directed labels tune perceptual search
...
```
REE inter-governance work item: IGW-20260801-053
...
### IGW-20260801-063 -- Prescriptive + diagnostic ethical-trajectory certification: CBF forward-invariance + backward-reachability barrier certi
...
```
REE inter-governance work item: IGW-20260801-063
...
### IGW-20260801-072 -- MECH-191 cross-architecture legibility unblock check (does A's dispositional readout resolve the tonic-channel gap?)
...
```
REE inter-governance work item: IGW-20260801-072
...
### IGW-20260801-077 -- PILLAR 5 -- capacity-limited E3 access gate + attentional template (SD-027/SD-028/MECH-254/MECH-255) feeding deliberatio
...
```
REE inter-governance work item: IGW-20260801-077
...
### IGW-20260801-080 -- V5/V6 frame inventory: feeding / hazard / contact / interruption / help-harm / give-receive / request-response / belief-
...
```
REE inter-governance work item: IGW-20260801-080
...
### IGW-20260801-081 -- Aspect / event-arc as closure map: starting / ongoing / repeated / interrupted / resumed / completed / failed / abandone
...
```
REE inter-governance work item: IGW-20260801-081
...
### IGW-20260801-088 -- ACh permissive write-gate on the surprise buffer (MECH-207)
...
```
REE inter-governance work item: IGW-20260801-088
...
### IGW-20260801-089 -- Schema-primed rapid assimilation (INV-039)
...
```
REE inter-governance work item: IGW-20260801-089
...
### IGW-20260801-122 -- Gated-write-authority on consolidation (over-frequent rewriting is a failure mode)
...
```
REE inter-governance work item: IGW-20260801-122
...
### IGW-20260801-128 -- Affective expression as mode-broadcast: emit own control-plane regime to reduce the OTHER'S prediction load (MECH-041)
...
```
REE inter-governance work item: IGW-20260801-128
...
### IGW-20260801-135 -- Loneliness as architectural harm (Q-029): unshared suffering measurable only against present-or-absent others
...
```
REE inter-governance work item: IGW-20260801-135
...
### IGW-20260801-186 -- MECH-257 dual-function 3-arm ablation re-queue
...
```
REE inter-governance work item: IGW-20260801-186
