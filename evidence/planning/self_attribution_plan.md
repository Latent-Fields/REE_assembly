...
closure_plan:
  ...
  nodes:
    ...
    - id: "self_attribution:GAP-2"
      ...
      blocking_external: ["behavioral_diversity_isolation:GAP-A/GAP-B behaviourally-validated non-monostrategy policy in the main agent path (the re-pointed gate; supersedes the stale 2026-05-16 'SP-CEM in main path' satisfier)"]
      last_updated: 2026-06-23
