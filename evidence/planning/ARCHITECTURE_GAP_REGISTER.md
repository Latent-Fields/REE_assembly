...
|---|---|---|---|---|---|---|---|---|---|
| `AGR-0001` | `MECH-060` | `candidate` | 0.885 | 0.308 | 0.308 | 5 | yes | yes | `escalate_architecture_decision` |
| `AGR-0002` | `MECH-058` | `candidate` | 0.881 | 0.222 | 0.318 | 5 | yes | yes | `escalate_architecture_decision` |
| `AGR-0003` | `Q-017` | `active` | 0.862 | 0.125 | 0.327 | 3 | yes | yes | `escalate_architecture_decision` |
...
| `AGR-0007` | `ARC-003` | `active` | 0.889 | 0 | 0.201 | 3 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0008` | `MECH-061` | `candidate` | 0.8 | 0 | 0.239 | 3 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0019` | `MECH-056` | `candidate` | 0.688 | 0.111 | 0.167 | 5 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0024` | `MECH-059` | `candidate` | 0.565 | 0.333 | 0.148 | 5 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0025` | `IMPL-022` | `stable` | 0 | 1 | -0.151 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0026` | `MECH-062` | `provisional` | 0 | 0 | -0.17 | 1 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0027` | `Q-016` | `active` | 0 | 0 | -0.169 | 2 | no | no | `monitor_and_collect_targeted_evidence` |

## Consider New Structure Queue

- `MECH-060` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.885; lit_non_support_ratio=0.308.
  - recurring_signatures: `mech060:postcommit_channel_contamination`(58), `mech060:attribution_reliability_break`(56), `mech060:commitment_reversal_spike`(44), `mech060:precommit_channel_contamination`(10), `threshold:pre_commit_error_signal_to_noise`(5)
...
- `MECH-058` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.881; lit_non_support_ratio=0.222.
  - recurring_signatures: `mech058:anchor_separation_collapse`(51), `mech058:ema_drift_under_shift`(23), `mech058:latent_cluster_collapse`(10), `threshold:latent_prediction_error_mean`(5), `threshold:latent_prediction_error_p95`(5)
  - external_precedence_candidate: yes; delta_lit_minus_exp=0.318
  - escalation_required: yes; route directly to architecture decision checkpoint.
- `Q-017` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.862; lit_non_support_ratio=0.125.
  - recurring_signatures: `q017:control_axis_stability_drop`(42), `q017:control_axis_entropy_collapse`(42), `q017:control_axis_policy_loss_spike`(30)
