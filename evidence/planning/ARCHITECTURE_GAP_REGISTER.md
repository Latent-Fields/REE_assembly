...
| `AGR-0027` | `MECH-070` | `retiring` | 0.286 | 0.75 | 0.417 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0030` | `INV-045` | `candidate` | 0 | 1 | 0.384 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0031` | `INV-053` | `stable` | 0 | 0.5 | -0.017 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0052` | `Q-062` | `candidate` | 0 | 0.667 | 0.762 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0055` | `SD-027` | `candidate` | 0 | 0.5 | 0.698 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0056` | `SD-055` | `candidate` | 0 | 0.5 | 0.375 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
