...
| `AGR-0002` | `MECH-060` | `candidate` | 0.936 | 0.5 | 0.33 | 5 | yes | yes | `consider_new_structure` |
| `AGR-0003` | `MECH-059` | `candidate` | 0.884 | 0.5 | 0.3 | 5 | yes | yes | `consider_new_structure` |
...
- `MECH-060` triggers=external_precedence_pressure, high_conflict_ratio, literature_non_support_pressure, recurring_failure_signatures; conflict_ratio=0.936; lit_non_support_ratio=0.5.
...
- `MECH-059` triggers=external_precedence_pressure, high_conflict_ratio, literature_non_support_pressure, recurring_failure_signatures; conflict_ratio=0.884; lit_non_support_ratio=0.5.
  ...
  - external_precedence_candidate: yes; delta_lit_minus_exp=0.3
