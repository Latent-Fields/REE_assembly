...
|---|---|---|---|---|---|---|---|---|---|
| `AGR-0001` | `MECH-060` | `candidate` | 0.875 | 0.308 | 0.302 | 5 | yes | yes | `mandatory_decision_checkpoint` |
| `AGR-0002` | `MECH-058` | `candidate` | 0.871 | 0.222 | 0.311 | 5 | yes | yes | `mandatory_decision_checkpoint` |
| `AGR-0003` | `Q-017` | `active` | 0.848 | 0.125 | 0.318 | 3 | yes | yes | `escalate_architecture_decision` |
| `AGR-0004` | `MECH-057` | `candidate` | 0.769 | 0.429 | 0.286 | 2 | yes | yes | `consider_new_structure` |
...
| `AGR-0007` | `ARC-003` | `active` | 0.889 | 0 | 0.203 | 3 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0010` | `MECH-040` | `provisional` | 0.727 | 0 | 0.242 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0011` | `MECH-046` | `provisional` | 0.727 | 0 | 0.217 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0019` | `ARC-018` | `provisional` | 0.667 | 0.167 | 0.241 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0023` | `ARC-007` | `active` | 0.615 | 0 | 0.082 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0026` | `MECH-062` | `provisional` | 0 | 0 | -0.169 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
...
- `MECH-060` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.875; lit_non_support_ratio=0.308.
  ...
  - external_precedence_candidate: yes; delta_lit_minus_exp=0.302
  - escalation_required: yes; route directly to architecture decision checkpoint.
  - mandatory_decision_checkpoint: yes; deadline=2026-02-25T09:29:08.059135Z; required_outcomes=retain_ree|hybridize|adopt_jepa_structure|retire_ree_claim
...
- `MECH-057` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.769; lit_non_support_ratio=0.429.
  ...
  - external_precedence_candidate: yes; delta_lit_minus_exp=0.286
  - atomic_split_recommended: yes; split into narrower subclaims before broad reruns.
