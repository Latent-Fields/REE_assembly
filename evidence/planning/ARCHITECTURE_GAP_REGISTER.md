...
|---|---|---|---|---|---|---|---|---|---|
| `AGR-0001` | `Q-017` | `active` | 0.921 | 0 | 0.364 | 3 | yes | yes | `consider_new_structure` |
| `AGR-0002` | `MECH-060` | `candidate` | 0.919 | 0.333 | 0.323 | 5 | yes | yes | `consider_new_structure` |
| `AGR-0003` | `MECH-058` | `candidate` | 0.918 | 0.2 | 0.341 | 5 | yes | yes | `consider_new_structure` |
| `AGR-0004` | `MECH-056` | `candidate` | 0.892 | 0.111 | 0.247 | 5 | yes | yes | `consider_new_structure` |
| `AGR-0005` | `ARC-003` | `active` | 0.667 | 0 | 0.305 | 0 | no | yes | `monitor_and_collect_targeted_evidence` |
| `AGR-0006` | `ARC-007` | `active` | 0.667 | 0 | 0.108 | 2 | no | yes | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0017` | `Q-011` | `provisional` | 0.333 | 1 | 0.483 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
...
- `Q-017` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.921; lit_non_support_ratio=0.
  ...
  - external_precedence_candidate: yes; delta_lit_minus_exp=0.364
- `MECH-060` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.919; lit_non_support_ratio=0.333.
...
- `MECH-058` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.918; lit_non_support_ratio=0.2.
  ...
  - external_precedence_candidate: yes; delta_lit_minus_exp=0.341
