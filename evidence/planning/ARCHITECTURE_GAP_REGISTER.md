...
| `AGR-0007` | `SD-029` | `candidate` | 0.933 | 0.222 | 0.32 | 0 | no | no | `mandatory_decision_checkpoint` |
...
| `AGR-0016` | `ARC-042` | `candidate` | 0.75 | 0 | 0.409 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0017` | `ARC-032` | `candidate` | 0.727 | 0.125 | 0.433 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0018` | `MECH-099` | `candidate` | 0.727 | 0 | 0.467 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0019` | `MECH-116` | `candidate` | 0.727 | 0 | 0.439 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0020` | `MECH-093` | `provisional` | 0.714 | 0 | 0.095 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0021` | `ARC-030` | `candidate` | 0.706 | 0 | 0.398 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0031` | `MECH-074d` | `provisional` | 0 | 0.5 | 0.036 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
