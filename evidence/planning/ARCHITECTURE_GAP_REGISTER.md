...
| `AGR-0020` | `SD-004` | `implemented` | 0.714 | 0 | 0.228 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0021` | `MECH-102` | `active` | 0.625 | 0.5 | 0.22 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0022` | `Q-020` | `resolved` | 0.4 | 0.833 | 0.314 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0023` | `MECH-075` | `candidate` | 0 | 0.5 | 0.782 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
