...
| `AGR-0008` | `MECH-061` | `candidate` | 0.8 | 0 | 0.24 | 3 | no | no | `mandatory_decision_checkpoint` |
| `AGR-0009` | `Q-012` | `active` | 0.8 | 0.333 | 0.282 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0018` | `Q-015` | `active` | 0.727 | 0 | 0.19 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0021` | `MECH-033` | `provisional` | 0.625 | 0.167 | 0.197 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0022` | `MECH-056` | `candidate` | 0.619 | 0.111 | 0.142 | 5 | no | no | `monitor_and_collect_targeted_evidence` |
...
- `MECH-060` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.875; lit_non_support_ratio=0.308.
  ...
  - mandatory_decision_checkpoint: yes; deadline=2026-02-25T20:38:12.637347Z; required_outcomes=retain_ree|hybridize|adopt_jepa_structure|retire_ree_claim
