...
|---|---|---|---|---|---|---|---|---|---|
| `AGR-0001` | `ARC-016` | `provisional` | 1 | 0 | 0.168 | 0 | no | no | `mandatory_decision_checkpoint` |
| `AGR-0002` | `INV-054` | `candidate` | 1 | 0 | 0.298 | 0 | no | no | `mandatory_decision_checkpoint` |
| `AGR-0003` | `MECH-257` | `candidate` | 1 | 0 | 0.427 | 0 | no | no | `mandatory_decision_checkpoint` |
| `AGR-0004` | `SD-016` | `implemented` | 1 | 0.333 | 0.094 | 0 | no | no | `mandatory_decision_checkpoint` |
| `AGR-0005` | `SD-018` | `implemented` | 1 | 0.5 | 0.489 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0017` | `ARC-032` | `candidate` | 0.727 | 0.125 | 0.434 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
