...
| `AGR-0016` | `ARC-042` | `candidate` | 0.75 | 0 | 0.412 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0017` | `ARC-032` | `candidate` | 0.727 | 0.125 | 0.437 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0018` | `MECH-099` | `candidate` | 0.727 | 0 | 0.469 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0019` | `MECH-116` | `candidate` | 0.727 | 0 | 0.441 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0020` | `MECH-093` | `provisional` | 0.714 | 0 | 0.097 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0021` | `ARC-030` | `candidate` | 0.706 | 0 | 0.401 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0031` | `MECH-074d` | `provisional` | 0 | 0.5 | 0.039 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
...
| `AGR-0034` | `MECH-268` | `provisional` | 0 | 0.667 | -0.047 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0035` | `MECH-E2-DUAL-FUNCTION` | `unknown` | 0 | 0.6 | 0.813 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0036` | `Q-006` | `active` | 0 | 0.5 | 0.286 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
