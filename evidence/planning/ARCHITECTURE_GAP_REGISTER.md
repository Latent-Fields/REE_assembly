...
|---|---|---|---|---|---|---|---|---|---|
| `AGR-0001` | `MECH-060` | `candidate` | 0.875 | 0.308 | 0.314 | 5 | yes | yes | `escalate_architecture_decision` |
| `AGR-0002` | `MECH-058` | `candidate` | 0.87 | 0.222 | 0.323 | 5 | yes | yes | `escalate_architecture_decision` |
| `AGR-0003` | `Q-017` | `active` | 0.845 | 0.125 | 0.33 | 3 | yes | yes | `escalate_architecture_decision` |
...
| `AGR-0007` | `MECH-056` | `candidate` | 0.726 | 0.111 | 0.188 | 5 | yes | yes | `consider_new_structure` |
| `AGR-0008` | `ARC-003` | `active` | 0.889 | 0 | 0.201 | 3 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0009` | `MECH-061` | `candidate` | 0.8 | 0 | 0.239 | 3 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0010` | `Q-012` | `active` | 0.8 | 0.333 | 0.281 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0011` | `MECH-040` | `provisional` | 0.727 | 0 | 0.241 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0012` | `MECH-046` | `provisional` | 0.727 | 0 | 0.216 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0013` | `Q-001` | `active` | 0.727 | 0 | -0.177 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0014` | `Q-002` | `active` | 0.727 | 0 | -0.177 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0015` | `Q-003` | `active` | 0.727 | 0 | -0.177 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0016` | `Q-004` | `active` | 0.727 | 0 | -0.177 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0017` | `Q-005` | `active` | 0.727 | 0 | -0.177 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0018` | `Q-006` | `active` | 0.727 | 0 | -0.177 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0019` | `Q-015` | `active` | 0.727 | 0 | 0.189 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0020` | `ARC-018` | `provisional` | 0.667 | 0.167 | 0.241 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0021` | `Q-007` | `active` | 0.667 | 0 | -0.209 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0022` | `MECH-033` | `provisional` | 0.625 | 0.167 | 0.196 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0023` | `ARC-007` | `active` | 0.615 | 0 | 0.081 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0024` | `MECH-059` | `candidate` | 0.605 | 0.333 | 0.175 | 5 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0025` | `IMPL-022` | `stable` | 0 | 1 | -0.151 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0026` | `MECH-062` | `provisional` | 0 | 0 | -0.163 | 1 | no | no | `monitor_and_collect_targeted_evidence` |
...
- `MECH-056` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.726; lit_non_support_ratio=0.111.
  ...
  - external_precedence_candidate: yes; delta_lit_minus_exp=0.188
