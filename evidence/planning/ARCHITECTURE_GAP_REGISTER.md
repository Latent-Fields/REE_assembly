...
| `AGR-0004` | `MECH-057` | `candidate` | 0.769 | 0.429 | 0.288 | 2 | yes | yes | `consider_new_structure` |
| `AGR-0005` | `Q-013` | `active` | 0.727 | 1 | 0.028 | 2 | yes | no | `consider_new_structure` |
| `AGR-0006` | `Q-014` | `active` | 0.727 | 1 | 0.028 | 2 | yes | no | `consider_new_structure` |
...
| `AGR-0010` | `MECH-040` | `provisional` | 0.727 | 0 | 0.244 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0011` | `MECH-046` | `provisional` | 0.727 | 0 | 0.219 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0012` | `Q-001` | `active` | 0.727 | 0 | -0.174 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0013` | `Q-002` | `active` | 0.727 | 0 | -0.174 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0014` | `Q-003` | `active` | 0.727 | 0 | -0.174 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0015` | `Q-004` | `active` | 0.727 | 0 | -0.174 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0016` | `Q-005` | `active` | 0.727 | 0 | -0.174 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0017` | `Q-006` | `active` | 0.727 | 0 | -0.174 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0018` | `Q-015` | `active` | 0.727 | 0 | 0.191 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0019` | `ARC-018` | `provisional` | 0.667 | 0.167 | 0.243 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0020` | `Q-007` | `active` | 0.667 | 0 | -0.206 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0021` | `MECH-033` | `provisional` | 0.625 | 0.167 | 0.198 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0022` | `MECH-056` | `candidate` | 0.623 | 0.111 | 0.143 | 5 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0023` | `ARC-007` | `active` | 0.615 | 0 | 0.084 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0024` | `MECH-059` | `candidate` | 0.566 | 0.333 | 0.148 | 5 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0025` | `IMPL-022` | `stable` | 0 | 1 | -0.149 | 0 | no | no | `monitor_and_collect_targeted_evidence` |
| `AGR-0026` | `MECH-062` | `provisional` | 0 | 0 | -0.167 | 2 | no | no | `monitor_and_collect_targeted_evidence` |
...
- `MECH-060` triggers=external_precedence_pressure, high_conflict_ratio, recurring_failure_signatures; conflict_ratio=0.875; lit_non_support_ratio=0.308.
  ...
  - mandatory_decision_checkpoint: yes; deadline=2026-02-25T21:33:01.070556Z; required_outcomes=retain_ree|hybridize|adopt_jepa_structure|retire_ree_claim
