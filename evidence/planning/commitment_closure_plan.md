...
closure_plan:
  ...
  nodes:
    ...
    - id: "commitment_closure:GAP-4"
      ...
      last_updated: 2026-06-01
      resume_condition: "MECH-090 R-c commit-entry readiness conjunction substrate LANDED in two passes (2026-05-28 within-tick score_margin axis + 2026-05-29 across-tick CommitReadiness EMA / nav_competence axis; 523/523 contracts PASS masters OFF). V3-EXQ-592b/c/d THIRD CONSECUTIVE FAIL on the same ARM_0 baseline-zero-commits mode: 592b DLAPTOP-4 2026-05-29 FAIL (2-arm score_margin axis only); 592c ree-cloud-3 2026-05-30 FAIL (2-arm re-run post-runner-pipeline-fix 41c3411); 592d ree-cloud-2 2026-05-31T21:38Z FAIL (4-arm expansion ARM_0 BASELINE_BOTH_OFF / ARM_1 SCORE_MARGIN_ONLY / ARM_2 NAV_COMPETENCE_ONLY / ARM_3 BOTH_GATES_ON; FIRST-EVER nav_competence axis validation). 592d acceptance: C1=False (ARM_0 baseline commit_rate=0.0 across 18729 P2 steps vs threshold 0.001), C2=False (cannot demonstrate score-margin reduction when baseline never fires), C3=False (ARM_2 nav_competence axis commit_rate=0.0 across 150 nav blocks), C4=False (ARM_3 conjunction false_commit_rate=0.0 trivially since neither axis fires). overall_pass=False. [2026-06-01T05:55Z governance cycle: third consecutive FAIL on the same baseline-zero-commits pattern is a not-yet-explained recurring substrate-readiness signal. Per /governance protocol, routed to /failure-autopsy rather than inline does_not_support reclassification. No claims.yaml evidence_direction edit applied to MECH-090 this cycle; manifest left at does_not_support pending autopsy disposition. GAP-4 status held at in-progress; node remains drifted in closure_drift.md until autopsy artifact lands. Cross-reference: failure_autopsy_V3-EXQ-592d_<date>.{md,json} will be the disposition artifact when written.] Next action: /failure-autopsy on V3-EXQ-592d. Autopsy should diagnose whether baseline-zero-commits is (a) a substrate gap in CommitReadiness EMA / score_margin gating that the conjunction does not address, (b) a config-default issue where baseline commit_threshold is too high for the env / curriculum stage being measured, or (c) an experiment-script grid mis-calibration. On autopsy disposition: apply per /governance Step 4 to claims.yaml; GAP-4 routing follows. Cross-link IGW-20260531-021."
