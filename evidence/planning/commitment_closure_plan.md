...
closure_plan:
  ...
  nodes:
    ...
    - id: "commitment_closure:GAP-4"
      ...
      last_updated: 2026-06-19T21:30:31Z
      ...
      resume_condition: "Closes when V3-EXQ-460h returns a contributory PASS (within-arm post-closure occupancy < pre-closure by >= DECOMMIT_MIN_DROP_FRAC on >= 2/3 seeds, on the refractory-independent commit-intent non-vacuity gate) for the re-grained children MECH-445 + MECH-446. 460h (ree-v3 main b46c777, supersedes 460g, ingested in the coordinator DB) retests the de-commit MAGNITUDE lever + the within-arm around-closure C2 occupancy-delta DV with non-vacuity gated on sd034_n_closure_commit_intent>0 (the BetaGate.note_closure_commit_intent counter landed ree-v3 main 167b3b7), so the 460g self-defeat -- where the committed-run-scaled refractory pinned at the 60-tick cap and suppressed sd034_n_closure_coupled_elevations 36->0 -- cannot recur: the commit-intent counter is incremented independently of whether the refractory is active. On the post-run 460h manifest /governance walk: (PASS, commit-intent non-vacuity met + within-arm post-closure occupancy drop >= DECOMMIT_MIN_DROP_FRAC on >= 2/3 seeds) -> apply supports to MECH-446 (de-commit-authority magnitude) + MECH-445 (coupling engagement, precondition), clear their pending_retest_after_substrate, and close GAP-4 (subject to the 468f perseveration retest); (non-vacuity met but the occupancy-drop DV unmet) -> GENUINE weakens on MECH-446, route /failure-autopsy; (commit-intent non-vacuity gate unmet) -> substrate_not_ready_requeue, amend again, NEVER a false weakens. SD-034 narrowed umbrella + MECH-445 + MECH-446 stay candidate / v3_pending / pending_retest_after_substrate until 460h lands (governance applies; this session changed NO claims.yaml status). 468f (MECH-090 commit-entry / perseveration side, the 468e successor) is separately owed once the amend validates. Do NOT re-author 460d/468d/460e/460f/460g (superseded). --- HISTORICAL prior-amend routing (460f/468e de-commit-authority MAGNITUDE + graded post-contradiction DV; superseded by the 2026-06-19 claim-synthesis decomposition + the refractory-independent commit-intent amend) retained in governance_2026_06_18/_18b + governance_2026_06_19/_19b. Cross-link IGW-20260531-021."
