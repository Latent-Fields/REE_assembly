...
closure_plan:
  ...
  nodes:
    ...
    - id: "commitment_closure:GAP-4"
      ...
      resume_condition: "AWAITING V3-EXQ-460e RUN + REVIEW (queued 2026-06-16, ree-v3 main f0fbbf6, coordinator DB confirmed present). 460e is the 460d successor on the NOW-TRAINED rule_bias_head (commitment_closure:GAP-4 Leg C landed 2026-06-16: scaffold_train_rule_bias_head 598b REINFORCE in P1). On the next /governance walk of the 460e manifest: (PASS, all 4 readiness gates met + ON<OFF non-cap-pinned latch-occupancy drop >=2/3 seeds) -> apply supports to SD-034 (de-commit authority) + MECH-261 + MECH-260, clear SD-034 pending_retest_after_substrate, and close GAP-4 (subject to also owing 468e for the MECH-090 commit-entry conjunction leg); (readiness met but C2 de-commit DV unmet) -> a GENUINE weakens, route /failure-autopsy; (any readiness gate unmet -- contact / rule_bias-head-trained / beta-engagement-both-arms / closure-trigger) -> substrate_not_ready_requeue (non_contributory), re-queue/amend, NEVER a false weakens. 468e (the 468d successor, MECH-090 commit-entry conjunction under the trained head) is OWED -- queue it next; its only prerequisite (the trained rule_bias_head) is now built. Do NOT re-author 460d/468d (superseded). --- HISTORICAL (superseded by the 2026-06-12 *c rewire + the 2026-06-13 *d validation + this 2026-06-16 Leg C build; retained for the substrate-soundness audit trail): the 2026-06-12 *c-cohort RUNNER-EXECUTION resume + the MECH-090 R-c commit-entry readiness conjunction substrate (LANDED two passes 2026-05-28 + 2026-05-29; V3-EXQ-592d measurement-defect diagnosis 2026-06-01, R-c substrate sound). Cross-link IGW-20260531-021."
