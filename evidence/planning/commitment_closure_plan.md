...
closure_plan:
  ...
  nodes:
    ...
    - id: "commitment_closure:GAP-4"
      ...
      last_updated: 2026-06-20T08:51:43Z
      ...
      resume_condition: "Closes when the de-commit retest (V3-EXQ-460i) returns a CONTRIBUTORY PASS for MECH-445 + MECH-446 on the F-dominance commit-ENTRY-decisiveness lever (substrate_queue f_dominance_conversion_ceiling -- the commit/release-duration FACE of root B), NOT a re-queue on the current selector. V3-EXQ-460h RAN terminal FAIL/non_contributory 2026-06-20 (confirmed failure_autopsy_V3-EXQ-460h_2026-06-20, applied by autopsy-apply-460h-20260620T0843Z; supersedes 460g): the refractory-independent commit-intent fix WORKED (seed-44 sd034_n_closure_commit_intent=375 where 460g collapsed 36->0, closing the S5 self-defeat) but the run self-routed substrate_not_ready_requeue because the MECH-445 (commit-intent) and MECH-446 (within-arm-window) non-vacuity certifiers fire on DISJOINT seeds -- commit-intent only where the F-driven natural commit is WEAK (seed 44, OFF committed_steps=0), the within-arm window only where it is STRONG (seed 42) -- empty intersection, so C2 was never scorable on a coupling-certified seed. Existence proofs BOTH children (MECH-445 seed-44 375 commit-intent / OFF beta=0; MECH-446 seed-42 within-arm 0.333->0.0 C2 PASS), recorded as narrow non-scoring positives (claims.yaml evidence_quality_note). NOT a falsification, NOT a substrate ceiling. The SD-034 de-commit is RECLASSIFIED the COMMIT/RELEASE-DURATION FACE of the F-dominance conversion ceiling (root C, was open/orthogonal; conversion_ceiling_phase0_synthesis_2026-06-18 + GAP-I), so the 460i retest is gated on a commit-entry-decisiveness / natural-commit-latch-occupancy lever (the selection-face levers k + commit-T do NOT shorten latch occupancy) routed via the f_dominance_conversion_ceiling front + behavioral_diversity_isolation:GAP-I -- NOT a bespoke SD-034 eval (the closure-exclusive de-commit eval mode is a SECONDARY fallback only if the front lever is far out). On the post-run 460i manifest /governance walk: (PASS, commit-intent non-vacuity met + within-arm post-closure occupancy drop >= DECOMMIT_MIN_DROP_FRAC on >= 2/3 coupling-certified seeds) -> apply supports to MECH-445 + MECH-446, clear pending_retest, close GAP-4 (subject to 468f); (non-vacuity met but DV unmet) -> GENUINE weakens on MECH-446, route /failure-autopsy; (non-vacuity unmet) -> substrate_not_ready_requeue, NEVER a false weakens. SD-034 narrowed umbrella + MECH-445 + MECH-446 stay candidate / v3_pending / pending_retest_after_substrate. 468f (perseveration side) separately owed. Do NOT re-author 460d/468d/460e/460f/460g/460h (superseded/run). --- HISTORICAL prior 460h-PASS-criterion routing retained in governance_2026_06_19b + governance_2026_06_20. Cross-link IGW-20260531-021."
