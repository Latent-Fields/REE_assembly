...
closure_plan:
  ...
  nodes:
    ...
    - id: "commitment_closure:GAP-4"
      ...
      resume_condition: "AWAITING /implement-substrate AMEND of commitment-closure-control-plane (beta-engagement deliverable). 460e RAN 2026-06-17 and was autopsied (confirmed failure_autopsy_V3-EXQ-460e_2026-06-17): Legs A/B/C built+working; residual gap = beta-engagement (the bistable latch elevates only on E3 result.committed, which fires on 1/3 seeds on the 603n foraging substrate; commit-without-beta dissociation). NEXT ACTION: /implement-substrate amend commitment-closure-control-plane with the beta-engagement deliverable -- (a) couple closure->beta elevation so the env-hook/closure-installed commitment also elevates the bistable latch (decouples the de-commit DV from the fragile natural running_variance crossing); and/or (b) commit-entry decisiveness (adapt commit_threshold for the foraging substrate OR scaffold a more decisive P1 policy so result.committed fires on >=2/3 seeds); (c) budget escalation deprioritized secondary. After the amend lands + readiness validates (beta_engagement_both_arms >=2/3 seeds): re-queue 460f (de-commit retest on the non-cap-pinned ON<OFF latch-occupancy DV) AND 468e (MECH-090 commit-entry conjunction under the trained head) TOGETHER on the amended substrate. Do NOT queue 460f/468e before the amend (would re-derive beta_engagement=0 -- 654d/654e anti-pattern; user-confirmed 2026-06-17). Do NOT re-author 460d/468d (superseded). On the post-amend 460f manifest /governance walk: (PASS, all readiness gates met + ON<OFF non-cap-pinned latch-occupancy drop >=2/3 seeds) -> apply supports to SD-034 (de-commit authority) + MECH-261 + MECH-260, clear SD-034 pending_retest_after_substrate, close GAP-4 (subject to 468e); (readiness met but C2 unmet) -> GENUINE weakens, route /failure-autopsy; (readiness gate unmet) -> substrate_not_ready_requeue, amend again, NEVER a false weakens. --- HISTORICAL (superseded by the 2026-06-12 *c rewire + the 2026-06-13 *d validation + this 2026-06-16 Leg C build; retained for the substrate-soundness audit trail): the 2026-06-12 *c-cohort RUNNER-EXECUTION resume + the MECH-090 R-c commit-entry readiness conjunction substrate (LANDED two passes 2026-05-28 + 2026-05-29; V3-EXQ-592d measurement-defect diagnosis 2026-06-01, R-c substrate sound). Cross-link IGW-20260531-021."
