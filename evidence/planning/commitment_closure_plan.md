...
closure_plan:
  ...
  nodes:
    ...
    - id: "commitment_closure:GAP-4-battery"
      ...
      result_note: "2026-06-24 (governance-cycle-20260624T2142Z): owner V3-EXQ-466d RAN to completion but FAILed -- preconditions BOTH met (contact guard 1.0, commitment+completion engaged 1.0; substrate engaged, NON-vacuous) and all criteria non-degenerate, but the load-bearing C2_discharge_events FAILED while C1_n_closures PASSED. So closures now FORM (466c's absent Leg-A hook is fixed) but the satisficing residue-DISCHARGE does not follow -- a genuine, undiagnosed evidence-FAIL, not a self-route. DEFERRED to /failure-autopsy this cycle (user directive: a FAIL needs an autopsy before we decide its evidence_direction); SD-034/MECH-094 get NO evidence_direction yet. Node stays in_progress pending that autopsy (it will route: re-queue / substrate-gap / weakens). A /failure-autopsy chip carries the debt forward."
