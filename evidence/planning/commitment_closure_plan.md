...
closure_plan:
  ...
  nodes:
    - id: "commitment_closure:GAP-1"
      ...
      live:
        as_of: "2026-09-26"
        from: "failure_autopsy_V3-EXQ-1067_2026-09-26"
    ...
    - id: "commitment_closure:GAP-4"
      ...
      last_updated: 2026-09-26
      governance_2026_09_26b: "GFLAG-0467 resolved (governance-gflags-20260926). Supersedes the gating clause in governance_2026_09_25: dec-20260923T185804-MECH-268 was APPLIED 2026-09-25T12:01Z (rec-20260925-02281b11, option B: keep dacc_saturation_strength 0.3, normalise dacc_pe at source). V3-EXQ-1089a is gated on substrate_queue dacc-pe-scale-normalisation (pending_implementation; IGW-20260925-219 design-first build in progress), not on a user decision. No status change. PROMOTES/DEMOTES NOTHING."
      governance_2026_09_26: "Stale-since-review ACKNOWLEDGE (governance cycle governance-20260926). Flagged because failure_autopsy_V3-EXQ-1067_2026-09-26 (MECH-266/SD-032a, non_contributory/standard, applied this cycle) post-dates the node. No status change: 1067 is a squash-vs-clamp operator sweep for the mode-governance-engagement bounding operator, not an OCD-battery arm; its successor is a finer CLAMP-only sweep (new EXQ) after the GFLAG-0508 freeze-gate question. MECH-266 stays provisional with pending_retest_after_substrate true."
      governance_2026_09_25: "Stale-since-review ACKNOWLEDGE (/governance gov-20260925-orch1707, bounded 5-item pass, user standing delegation via orchestrate-20260924-1707). Flagged because confirmed failure_autopsy_V3-EXQ-1089_2026-09-25 reclassified MECH-268 (in this node's unblocks set) after the 2026-09-16 last_updated. V3-EXQ-1089 (closure-cadence dose, mode-register DV, reset ON/OFF bracket) is non_contributory / substrate_not_ready_requeue: 2/5 seeds ready (4 required); seeds 43/45/46 were latch-dominated so the closure-to-FIFO bracket was never exercised, ready seed 44 had no headroom, and the discrete register was pinned in every arm (corroborates GFLAG-0466). Autopsy note applied to MECH-268 (REE_assembly 9994eea01e); status stays provisional. The same-question re-run (1089a) is gated on the user-held decision dec-20260923T185804-MECH-268 and is NOT queued. GFLAG-0467 (this node's prose may be stale against the mode-register experiment) stays open for /inter-governance-brief. No status change. PROMOTES/DEMOTES NOTHING."
      reconcile_2026_09_08: "PROSE RECONCILE (docs-only; session admiring-heisenberg-6c7b32, chip-20260902-plan-prose-460k-724-ran-not-queued; NO status change, NO claims.yaml / queue action). resume_condition still opened with 'the LIVE in-flight de-commit falsifier (QUEUED + INGESTED 2026-06-22 ...)'. V3-EXQ-460k is NOT in flight: it RAN 2026-06-22T19:17Z and is terminal FAIL / non_contributory (manifest evidence/experiments/v3_exq_460k_natural_commit_occupancy_release_decommit_falsifier_20260622T191736Z_v3.json; claims MECH-445 / MECH-446; adjudicated substrate_ceiling by the concurrent failure-autopsy-460k session -- see governance_2026_06_23). Verified 2026-09-02 via /morning-digest Step 7c: not in the live queue, manifest present, positive provenance -- neither owed nor phantom. A non_contributory FAIL does not advance this node, so the blocker is still real; what GAP-4 now waits on is the /implement-substrate AMEND of substrate_queue f_dominance_conversion_ceiling named in governance_2026_06_23 (decouple closure-coupled hold-arming from the F-driven e3._committed_trajectory so a hold arms+sustains independently of the F-dominated natural commit), NOT a 460k result. The re-derive brake FIRED (5th lineage autopsy) and REFUSED a same-claim 460m re-queue; no successor EXQ has been named -- stated explicitly rather than invented. The pre-registered acceptance shape in resume_condition is retained as the HISTORICAL form for that eventual successor."
      governance_2026_09_16: "Stale-since-review ACKNOWLEDGE (governance cycle governance-20260916). Flagged because confirmed failure_autopsy_V3-EXQ-729_2026-09-14 (applied this cycle, GOV-APPLY-1) reclassified MECH-268: supports STANDS but NARROWED -- V3-EXQ-729 x2 establishes only the LIVE-WIRING bar (DACC.record_outcome called from the live select_action tail); C1 is arithmetic once the FIFO saturates, C2/C3/C5 are tautologies of the OFF arm; graded saturation in the live loop is untested and V3-EXQ-468's falsifier is NOT satisfied in spirit. MECH-268 stays provisional, epistemic_category set standard. This node tracks the (b) de-commit-conversion lineage, which the 729 result does not touch. Status stays in-progress; last_updated bumped to acknowledge."
      governance_2026_09_02: "Closure-drift stale-since-review ACKNOWLEDGE + DISPOSITION APPLIED (governance cycle 2026-09-02, session governance-20260902). Flagged because confirmed failure_autopsy_V3-EXQ-968-871b_2026-09-02 reclassified MECH-090 after this node's last_updated (2026-08-18). The live: block above was already current (as_of 2026-09-02, from that artifact#V3-EXQ-871b, verdict non_contributory/standard, brake fired); last_updated lagged by two weeks. SUBSTANTIVE, not a bare acknowledgement: that artifact's MECH-090 per-claim disposition -- non-degeneracy precondition satisfied and the wiring fix exercised by 871b, so the substrate hold is DISCHARGED (pending_retest_after_substrate true -> false) plus diagnostic_evidence_adjudicated true, status stays active, epistemic_category stays standard -- had been CONFIRMED but never APPLIED. It was invisible to the pending-review walk because 871b was already in reviewed_run_ids (the GOV-APPLY-1 blind spot exactly); this cycle read the GOV-APPLY-1 ACTIONABLE bucket and applied it. Discharging the hold removes a standing substrate blocker from this node's MECH-090 commit-entry conjunction half; the OCD battery completeness half (V3-EXQ-460..468) is untouched and still open, so status stays in-progress and owner_exq is unchanged. last_updated bumped 2026-08-18 -> 2026-09-02."
    ...
    - id: "commitment_closure:GAP-4-battery"
      ...
      last_updated: 2026-09-26
      governance_2026_09_26b: "GFLAG-0467 resolved (governance-gflags-20260926): battery-completeness text unchanged; see the GAP-4 governance_2026_09_26b note for the corrected V3-EXQ-1089a gating."
      governance_2026_09_26: "Stale-since-review ACKNOWLEDGE (governance cycle governance-20260926). Flagged because failure_autopsy_V3-EXQ-1067_2026-09-26 (MECH-266/SD-032a, non_contributory/standard, applied this cycle) post-dates the node. No status change: 1067 is a squash-vs-clamp operator sweep for the mode-governance-engagement bounding operator, not a *b-cohort arm; its successor is a finer CLAMP-only sweep (new EXQ) after the GFLAG-0508 freeze-gate question. MECH-266 stays provisional with pending_retest_after_substrate true."
      governance_2026_09_25: "Stale-since-review ACKNOWLEDGE (/governance gov-20260925-orch1707, bounded 5-item pass, user standing delegation via orchestrate-20260924-1707). Flagged because confirmed failure_autopsy_V3-EXQ-1089_2026-09-25 reclassified MECH-268 after this node's last_updated. 1089 is non_contributory (readiness failure, 2/5 seeds ready); it is the closure-cadence dose leg, not a *b battery arm, so this node's battery-completeness question is unchanged. See the GAP-4 governance_2026_09_25 note. No status change."
      governance_2026_09_16: "Stale-since-review ACKNOWLEDGE (governance cycle governance-20260916). Flagged because confirmed failure_autopsy_V3-EXQ-729_2026-09-14 reclassified MECH-268 (supports, NARROWED to live wiring; gradedness untested in the live loop). Relevant to this node only as context for the MECH-266/267/268 commitment-dependent arms: the 729 autopsy routes a NEW /queue-experiment successor (non-saturating harm regime, post-saturation PE readout) for ecological gradedness -- a new measurement question, not a re-derive of MECH-268's SD-034 substrate_ceiling autopsies. Residual openness unchanged; status stays in_progress; last_updated bumped to acknowledge."
...
### 2026-09-08 - GAP-4 prose reconcile: `resume_condition` still called V3-EXQ-460k the LIVE in-flight falsifier; it ran on 2026-06-22

**Docs-only. No experiments queued, no claims.yaml edit, no manifest touched, no status change** (session admiring-heisenberg-6c7b32, chip-20260902-plan-prose-460k-724-ran-not-queued).

The GAP-4 node's `resume_condition` opened with "the LIVE in-flight de-commit falsifier (QUEUED + INGESTED 2026-06-22 ...)". V3-EXQ-460k RAN 2026-06-22T19:17Z and is terminal FAIL / `non_contributory` (MECH-445 / MECH-446; substrate_ceiling), as `governance_2026_06_23` on the same node already records. The prose was simply never reconciled. A `non_contributory` FAIL does not advance the node, so GAP-4 stays `in-progress`; what it waits on is the `f_dominance_conversion_ceiling` substrate AMEND routed by the 460l autopsy (decouple closure-coupled hold-arming from `e3._committed_trajectory`), with no successor EXQ yet named (the re-derive brake refused a 460m re-queue). Added `reconcile_2026_09_08`, prefixed `resume_condition` with the reconciled state, bumped `last_updated`.
