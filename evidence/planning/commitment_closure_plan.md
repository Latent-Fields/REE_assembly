...
closure_plan:
  ...
  nodes:
    ...
    - id: "commitment_closure:GAP-4-battery"
      ...
      resume_condition: "Owner repointed 466d -> V3-EXQ-466e (queued, pending) at /governance 2026-06-24T22:49Z. 466d AUTOPSIED non_contributory (C2 degenerate: empty residue field, harness gap) and its manifest corrected (SD-034 non_contributory + pending_retest; MECH-094 drop-tagged); 466e wires update_residue into the scaffold P1/P2 + eval and adds a residue-field-populated non-vacuity gate so C2 can actually fire. Node stays in_progress pending the 466e run. See failure_autopsy_V3-EXQ-466d_2026-06-24.{md,json}."
