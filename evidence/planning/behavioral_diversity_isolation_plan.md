...
closure_plan:
  ...
  nodes:
    ...
    - id: "behavioral_diversity_isolation:GAP-B"
      ...
      phase: "GAP-A ready -> MECH-341 committed-class diversity retest owed"
      status: partial
      severity: load-bearing
      next_owner_exq: "V3-EXQ-660 QUEUED 2026-06-09 (MECH-341 within-class-representative-diversity retest on the GAP-A-ready/authority-ready stack; within_class_rep_cond_entropy = H(rep_signature | committed_class) PRIMARY DV, committed-class entropy SECONDARY negative-control; supersedes 614e readout); awaiting run"
      owner_exq: "V3-EXQ-614e autopsy applied 2026-06-07 (non_contributory substrate_ceiling; GAP-A blocker moved upstream); V3-EXQ-649 GAP-A readiness PASS; MECH-341 GAP-A-ready retest QUEUED as V3-EXQ-660 2026-06-09 (within-class-representative-diversity readout)"
      ...
      resume_condition: "PARTIAL 2026-06-09. The MECH-341 within-class-representative-diversity retest is now QUEUED as V3-EXQ-660 (queued 2026-06-09 on the GAP-A-ready/authority-ready stack; within_class_rep_cond_entropy PRIMARY DV; supersedes the 614e committed-class-entropy readout). Do NOT re-queue. On V3-EXQ-660 landing: C1-fail -> non_contributory/substrate_not_ready_requeue (re-queue on a more-trained/larger-pool substrate, NOT a weakens); C1+C2 -> /governance MECH-341 within-class sub-axis supports (v3_pending clearance candidate); C1 + C2-fail -> /governance MECH-341 within-class sub-axis weakens. Ignore V3-EXQ-542a/610f overlap flags for this node; they do not change the 614-lineage question."
