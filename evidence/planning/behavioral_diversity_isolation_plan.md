...
closure_plan:
  ...
  nodes:
    ...
    - id: "behavioral_diversity_isolation:GAP-B"
      ...
      governance_2026_06_08: "Closure-drift stale-since-review acknowledgement only (no status change). Flagged because confirmed failure_autopsy_V3-EXQ-610f_2026-06-08 reclassified MECH-341 (in this node's unblocks_claims) -- but that autopsy targets the INV-074 crystallization-necessity lineage, not the within-class-diversity falsifier this node owns. 610f re-FAILed D2 (stripped REINFORCE control did not collapse entropy under the IGW-023 noise regime, so the necessity premise was never instantiated), with MECH-341/MECH-313 D4 floor-contrast uninterpretable BECAUSE D2 failed -> non_contributory / substrate_ceiling; INV-074 unweakened (universal); routed to a task-shift redesign successor. This does NOT touch GAP-B's within-class committed-class-diversity question (the 614-lineage). MECH-341 stays candidate / v3_pending=true; node stays partial; 614e /failure-autopsy adjudication remains the outstanding work-list. last_updated bumped to acknowledge."
