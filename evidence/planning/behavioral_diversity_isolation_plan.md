...
closure_plan:
  ...
  nodes:
    ...
    - id: "behavioral_diversity_isolation:GAP-B"
      ...
      next_owner_exq: "MECH-341 committed-class diversity retest owed after V3-EXQ-649 GAP-A readiness PASS; use within-class-representative-diversity readout per 614e autopsy; not yet queued"
      owner_exq: "V3-EXQ-614e autopsy applied 2026-06-07 (non_contributory substrate_ceiling; GAP-A blocker moved upstream); V3-EXQ-649 GAP-A readiness PASS; MECH-341 GAP-A-ready retest owed, not queued"
      ...
      resume_condition: "PARTIAL 2026-06-08. V3-EXQ-614e is fully autopsied and applied as non_contributory/substrate_ceiling, not pending adjudication. GAP-A is now ready via V3-EXQ-649 PASS, so queue the MECH-341 committed-class diversity retest on the GAP-A-ready/authority-ready stack using a within-class-representative-diversity readout. Ignore V3-EXQ-542a/610f overlap flags for this node; they do not change the 614-lineage question."
    - id: "behavioral_diversity_isolation:GAP-C"
      title: "Theory 3 / Layer C: missing tonic noise floor (MECH-313 LC-NE analog)"
      phase: "P1"
      status: in-progress
      severity: medium
      owner_exq: "V3-EXQ-603i claimed 2026-06-08 on ree-cloud-1 (escape-affordance bridge validation; claim_ids=[]); prior 603a/b/c/f/g/h lineage non_contributory substrate-ceiling"
