...
Generated: 2026-08-03T09:54:37Z
...
Audited **22** open question(s) across **16** time-series snapshot(s). **2** flag(s) raised, **27** advisory note(s), **16** git-witnessed pre-registration(s), **0** unverifiable, **1** fan-out recurrence overlay(s).
...
- `inv088_evaluator_degeneracy_cause`: grew 2 -> 3 (+1) but only 0 leg(s) are covered by a valid fanout_growth_events entry -- 1 unaccounted, which is post-hoc enlargement.
...
- time series 2026-08-02 -> 2026-08-03: total_initial grew by 8, fully attributed to labelled sources landing in this window (new-question registrations + fanout_growth_events, 8 leg(s)) -- advisory, not a violation.
