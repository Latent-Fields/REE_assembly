...
closure_plan:
  ...
  nodes:
    - id: "policy_decomposition_trigger:REPOSE"
      ...
      depends_on: []
      last_updated: 2026-09-25
      governance_2026_09_25: "Stale-since-review ACKNOWLEDGE (/governance gov-20260925-orch1707, bounded 5-item pass, user standing delegation via orchestrate-20260924-1707). Flagged because confirmed failure_autopsy_V3-EXQ-1087_2026-09-25 reclassified MECH-321 after the 2026-08-21 last_updated. V3-EXQ-1087 (diagnostic) shows the built harm-aware selection's per-leaf harm_penalty DISCRIMINATES leaves (tie rate 0.078) but ANTI-TRACKS realised harm (excess -0.070, z -2.23), so V3-EXQ-919's weakens was re-adjudicated non_contributory (applied REE_assembly 9994eea01e) and substrate_queue SD-hazard-aware-policy-decomposition was amended (severity corrupting, ready=false, gated on the native waking trainer / E2 world-head objective). That is the harm-aware leaf-SELECTION leg of MECH-321; this node re-poses the decomposition TRIGGER (owner V3-EXQ-938), which 1087 does not test, so status is unchanged. PROMOTES/DEMOTES NOTHING."
