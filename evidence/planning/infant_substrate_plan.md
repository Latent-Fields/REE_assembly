...
| GAP-14 EXQ-ISEF-005 | blocked_pending_substrate (UPDATED 2026-06-15: prereq b z_goal CLEARED via V3-EXQ-603n PASS; prereq c (c-1) exploration-strength collapse still blocked on modulatory-bias-selection-authority [667 sweep exhausted, 667a not yet queued]; (c-2) gate over-permissiveness RESOLVED at criterion level -- 591f PASS found a crossing-count criterion that discriminates; residual = wire crossing-count into the scheduler. Both (c-1) and the (c-2) wiring must land) | V3-EXQ-591 (FAIL) -> 591b/591c (FAIL) -> 667 (FAIL) -> 591d (FAIL) -> 591e (FAIL) -> 591f (PASS, crossing-count discriminates) | 2026-06-15 |
