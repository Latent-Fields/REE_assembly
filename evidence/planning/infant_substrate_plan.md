...
closure_plan:
  ...
  nodes:
    ...
    - id: "infant_substrate:GAP-14"
      ...
      blocked_by: "Of the three substrate prerequisites (per failure_autopsy_V3-EXQ-591_2026-05-27 section 7), TWO are now CLEARED and ONE remains the live blocker: (a) MECH-307 default-value recalibration validated -- CLEARED 2026-05-15 via V3-EXQ-540g supports; (c) InfantCurriculumScheduler Phase 0->1 advancement gate -- CLEARED: H_POS_FRAC_OF_MAX recalibrated 0.70 -> 0.20 on 2026-05-31 (threshold 3.48 -> 0.994, inside the observed per-ep band), confirmed early-policy-reachable by a live untrained-agent smoke 2026-06-09 (option (a) threshold fix; options z_goal-norm / residue-progression are non-viable for THIS transition -- z_goal is collapsed (=prereq b) and residue_scale_factor=0.0 in Phase 0); full-scale readiness validation queued as V3-EXQ-591b 2026-06-10 (diagnostic, claim_ids=[]). (b) goal-pipeline training regime produces non-trivial z_goal in default config -- STILL OPEN, the sole remaining blocker, owned by goal_pipeline:GAP-4 / V3-EXQ-490g cohort (shared ceiling with bdi:GAP-C and the scaffolded_sd054_onboarding cluster). Once (b) clears, the full GAP-14 curriculum-vs-flat V3-EXQ-591 successor can be queued."
...
| GAP-14 EXQ-ISEF-005 | blocked_pending_substrate (prereq c CLEARED 2026-05-31 gate retune + V3-EXQ-591b readiness queued 2026-06-10; sole remaining blocker = prereq b z_goal, goal_pipeline:GAP-4) | V3-EXQ-591 (FAIL) -> V3-EXQ-591b (readiness) | 2026-06-10 |
