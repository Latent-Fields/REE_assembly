...
| GAP-14 EXQ-ISEF-005 | blocked_pending_substrate (CORRECTED 2026-06-14: prereq b z_goal CLEARED via V3-EXQ-603n PASS; prereq c Phase 0->1 gate RE-OPENED by 591b/591c FAIL into (c-1) exploration-strength collapse [667 magnitude sweep exhausted, blocked on modulatory-bias-selection-authority, 667a not yet queued] + (c-2) single-episode-gate over-permissiveness [591d queued]; both must resolve) | V3-EXQ-591 (FAIL) -> 591b/591c (FAIL) -> 667 (FAIL) -> 591d (queued) | 2026-06-14 |
