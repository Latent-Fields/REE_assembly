...
| A1 noise floors + P1g (A1 draft `2028729662`/`b92196db2c`; decided 2026-09-25 ~13:20Z) | **Accept the measured floors** (per 100 steps: reward 0.90 benign / 2.4 trapped; harm contacts 1.6 / 4.8) **and P1g** (a benign reward gain must include fewer harm contacts or more consumption; approach shaping alone cannot pass). These supersede the draft floors accepted in rec-20260925-7e7e9825. | rec-20260925-5fc6c256 |
