...
closure_plan:
  ...
  nodes:
    ...
    - id: "arm_reuse_fingerprint:P1-auto"
      ...
      status: blocked
      severity: low
      owner_exq: "V3-EXQ-685 -- QUEUED 2026-06-15 (ree-v3 main 51906a9; priority 10, machine_affinity any). A minimal purpose-built consumer (experiment_purpose=baseline, claim_ids=[]); supersedes the now-cancelled 610g/643c natural-trigger plan."
      depends_on: []
