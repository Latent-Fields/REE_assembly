...
| ARC-004 | `active/substrate_conditional -- LAYERED+DIFFERENTIATED stands; the RATE (timescale-stratification) assertion is narrowed and awaits serial-cascade wiring` | `active/substrate_conditional` | reading: stored='active/substrate_conditional -- LAYERED+DIFFERENTIATED stands; the RATE (timescale-stratification) assertion is narrowed and awaits serial-cascade wiring' derived='active/substrate_conditional' |
...
| MECH-011 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-012 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-013 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-014 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-015 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
...
| MECH-074c | `provisional` | `provisional/substrate_conditional` | reading: stored='provisional' derived='provisional/substrate_conditional' |
| MECH-074d | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
...
| MECH-096 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-103 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-106 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| ARC-030 | `candidate` | `candidate/substrate_ceiling` | reading: stored='candidate' derived='candidate/substrate_ceiling' |
| ARC-027 | `active` | `active/substrate_conditional` | reading: stored='active' derived='active/substrate_conditional' |
...
| MECH-125 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-126 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
...
| ARC-037 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
...
| ARC-044 | `candidate` | `candidate` | needs_review: stored=True derived=False |
...
| MECH-182 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| INV-056 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| ARC-047 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-192 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-193 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| ARC-048 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
...
| MECH-206 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
...
| MECH-244 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-248 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-250 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
...
| MECH-258 | `candidate/v3_pending` | `candidate/v3_pending/substrate_ceiling` | reading: stored='candidate/v3_pending' derived='candidate/v3_pending/substrate_ceiling' |
...
| ARC-061 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-294 | `candidate/v3_pending` | `candidate/v3_pending/substrate_ceiling` | reading: stored='candidate/v3_pending' derived='candidate/v3_pending/substrate_ceiling' |
| SD-040 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| MECH-354 | `candidate/v3_pending` | `candidate/v3_pending/substrate_conditional` | reading: stored='candidate/v3_pending' derived='candidate/v3_pending/substrate_conditional' |
...
| MECH-317 | `candidate/v3_pending` | `candidate/v3_pending/substrate_conditional` | reading: stored='candidate/v3_pending' derived='candidate/v3_pending/substrate_conditional' |
...
| MECH-327 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
| ARC-073 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
...
| ARC-113 | `candidate` | `candidate/substrate_ceiling` | reading: stored='candidate' derived='candidate/substrate_ceiling' |
| MECH-474 | `candidate` | `candidate/substrate_conditional` | reading: stored='candidate' derived='candidate/substrate_conditional' |
...
| MECH-515 | `candidate/v3_pending/substrate_conditional` | `candidate/substrate_conditional` | reading: stored='candidate/v3_pending/substrate_conditional' derived='candidate/substrate_conditional' |
...
| SD-104 | `candidate/v3_pending/implemented_pending_validation` | `candidate/v3_pending` | reading: stored='candidate/v3_pending/implemented_pending_validation' derived='candidate/v3_pending' |
| SD-105 | `candidate/v3_pending/implemented_pending_validation` | `candidate/v3_pending` | reading: stored='candidate/v3_pending/implemented_pending_validation' derived='candidate/v3_pending' |
...
|-------|--------------|
| MECH-464 | `candidate` |
| MECH-465 | `candidate/substrate_ceiling` |
| Q-092 | `open` |
...
| Q-094 | `open` |
| Q-095 | `open` |
| INV-102 | `candidate/substrate_conditional` |
| MECH-504 | `candidate/substrate_conditional` |
...
| ARC-138 | `candidate/substrate_conditional` |
| INV-104 | `candidate` |
...
| ARC-142 | `candidate/substrate_conditional` |
| GOV-CONTRACT-1 | `candidate` |
| MECH-545 | `candidate/substrate_conditional` |
| MECH-546 | `candidate/substrate_conditional` |
| Q-104 | `open/substrate_conditional` |
| MECH-547 | `candidate/substrate_conditional` |
| MECH-548 | `candidate/substrate_conditional` |
| ARC-143 | `candidate/substrate_conditional` |
| MECH-549 | `candidate/substrate_conditional` |
| MECH-550 | `candidate/substrate_conditional` |
| MECH-551 | `candidate/substrate_conditional` |
...
| ARC-013 | `v3_exq_697_arc013_residue_separability_falsifier_20260621T133052Z_v3` | `failure_autopsy_V3-EXQ-983a_2026-09-06` |
...
| MECH-012 | `_none_` | `decision:MECH-012@2026-09-15T01:15:56.624301Z` |
| MECH-013 | `_none_` | `decision:MECH-013@2026-09-15T01:15:56.662132Z` |
...
| ARC-016 | `v3_exq_818_arc016_eval_derived_noise_precision_sweep_20260725T185821Z_v3` | `failure_autopsy_V3-EXQ-642c_2026-09-05` |
...
| ARC-019 | `failure_autopsy_V3-EXQ-591h_2026-09-03` | `failure_autopsy_V3-EXQ-591h_2026-09-03` |
...
| MECH-027 | `_none_` | `failure_autopsy_band-contrast-instrument-cluster_2026-09-09#V3-EXQ-981a` |
...
| MECH-063 | `failure_autopsy_V3-EXQ-779b_2026-07-19` | `failure_autopsy_V3-EXQ-963a_2026-09-02` |
...
| MECH-074a | `v3_exq_888_mech074_readwrite_head_route_dissociation_20260804T075257Z_v3` | `v3_exq_888_mech074_readwrite_head_route_dissociation_20260804T075257Z_v3` |
