...
4. **`/governance`: re-state the hero question's `live_gate`** (`conversion_ceiling_root` still reads "V3-EXQ-1010 RUNNING, H-F alive"), and record the decision on `zworld_actor_adequacy_locus` (closed to fan-out 2026-09-23, 0 alive, `decided_utc` null). This is governance work, reported here and not chipped. It is the source of `CURRENT_FRONT.md`'s outdated "Live question" line.
