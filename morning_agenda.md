...
- Fleet-idle watcher: status OK, idle_risk=**true**, claimable backlog=0 (threshold 3), snapshot 2026-09-21T03:55:36Z. Only one ready-SD candidate: **SD-106 -> V3-EXQ-1023** (leverage 6: SD-015, ARC-030, MECH-117, MECH-457, ARC-065, the EXQ-085h..o goal cluster). NOTE: this candidate is **not actionable as stated**. SD-106 validation has already run repeatedly (V3-EXQ-1023 FAIL 09-12, 1023a FAIL 09-17, 1041 PASS diagnostic, 1065 FAIL 09-19), and all of them have chips/autopsies. The live SD-106 work is the user-decided option-C encoder-plane moderator probe (chip done). The watcher's `included_ran_only_pre_implementation=1` is what lets it through. Refill needs a fresh `/queue-experiment` design elsewhere, not an SD-106 re-queue. 39 other built SDs are already validated, and 43 have no queueable validation experiment.
