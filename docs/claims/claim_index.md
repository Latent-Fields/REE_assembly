...
- [MECH-057](../architecture/precision_control.md#mech-057) Residue precision escalation is depth-ordered across L-space with sensory anti-overwrite constraints.
...
- [Q-012](../architecture/l_space.md#q-012) What is the functional boundary of `z_delta` relative to `z_theta`, and what evidence best constrains it?
