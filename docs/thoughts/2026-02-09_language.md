# Thoughts: Language as Compression and Coordination

Status: processed

Processed in:
- `docs/architecture/language.md` (ARC-009)
- `docs/architecture/language/emergence_and_bootstrapping.md` (MECH-010)

---

Related claims: ARC-009, MECH-010, ARC-010
...
- Language as emergent coordination layer (ARC-009)
- Language emergence and bootstrapping (MECH-010)
- Social cognition / joint attention (ARC-010)
