...
_Generated 2026-09-24T17:40:17Z — regenerated every governance run; do not edit by hand._
...
98 non-deferred nodes across 18 plan(s) · **64 done · 34 remaining · 10 deferred** · **11 on the assembly frontier** (under construction, off the % axis).
...
Cheap first proxy over the last **30 days** of commits across `REE_assembly` + `ree-v3` (5257 commits). Coarse, prefix-based, and judgment-laden by construction -- read the per-bucket tallies below, not just the headline.

- **Machine coordination data** (the doc's literal cheap proxy: `phase3*` / `igw-ledger` -- sync_daemon + IGW writers): **39%** of all commits (2064 / 5257). The source critique's ~60-77% estimate, live.
- **Governance-mass : cognitive-mass** (refinement -- machine coordination + human bookkeeping vs substrate builds; neutral tooling/docs excluded): **14 : 1** (governance 3451 : cognitive 248).

Bucket tally (both repos, window):

| bucket | commits | what it is |
|--------|--------:|------------|
| machine coordination | 2064 | `phase3*` result/queue/heartbeat writers + `igw-ledger` (automated) |
| human governance | 1387 | registry, queue, governance cycles, reviews, closure/plan reconciles, autopsies, thought-intake, session-land |
| cognitive / substrate | 248 | `implement-substrate`, MECH/ARC/SD builds, `ree_core` code, substrate tests -- effort that (tries to) move a capability metric |
| neutral / other | 1558 | docs, explorer/serve, site, tooling (excluded from the ratio) |
