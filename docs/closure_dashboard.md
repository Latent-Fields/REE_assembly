...
_Generated 2026-06-14T20:02:50Z — regenerated every governance run; do not edit by hand._
...
<p style="font-size:1.6em;font-weight:600;margin:.2em 0">75.7%</p>

<div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#1a7f37;height:18px;width:75.7%"></div></div>

75 non-deferred nodes across 11 plan(s) · **52 done · 23 remaining · 14 deferred**.

Status tally: `blocked`&nbsp;8 · `blocked_pending_substrate`&nbsp;4 · `deferred`&nbsp;14 · `done`&nbsp;52 · `in_progress`&nbsp;6 · `open`&nbsp;1 · `partial`&nbsp;2 · `upstream_blocked`&nbsp;2
