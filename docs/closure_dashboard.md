...
_Generated 2026-06-16T20:37:29Z — regenerated every governance run; do not edit by hand._
...
<p style="font-size:1.6em;font-weight:600;margin:.2em 0">80.0%</p>

<div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#1a7f37;height:18px;width:80.0%"></div></div>

77 non-deferred nodes across 11 plan(s) · **57 done · 20 remaining · 12 deferred**.

Status tally: `blocked`&nbsp;7 · `blocked_pending_substrate`&nbsp;3 · `deferred`&nbsp;12 · `done`&nbsp;57 · `in_progress`&nbsp;6 · `partial`&nbsp;2 · `upstream_blocked`&nbsp;2
