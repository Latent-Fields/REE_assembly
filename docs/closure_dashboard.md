...
_Generated 2026-07-09T17:56:30Z — regenerated every governance run; do not edit by hand._
...
Cheap first proxy over the last **30 days** of commits across `REE_assembly` + `ree-v3` (3289 commits). Coarse, prefix-based, and judgment-laden by construction -- read the per-bucket tallies below, not just the headline.

- **Machine coordination data** (the doc's literal cheap proxy: `phase3*` / `igw-ledger` -- sync_daemon + IGW writers): **65%** of all commits (2129 / 3289). The source critique's ~60-77% estimate, live.
- **Governance-mass : cognitive-mass** (refinement -- machine coordination + human bookkeeping vs substrate builds; neutral tooling/docs excluded): **22 : 1** (governance 2738 : cognitive 124).

Bucket tally (both repos, window):

| bucket | commits | what it is |
|--------|--------:|------------|
| machine coordination | 2129 | `phase3*` result/queue/heartbeat writers + `igw-ledger` (automated) |
...
| neutral / other | 427 | docs, explorer/serve, site, tooling (excluded from the ratio) |
