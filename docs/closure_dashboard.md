...
_Generated 2026-08-18T08:23:59Z — regenerated every governance run; do not edit by hand._
...
95 non-deferred nodes across 17 plan(s) · **63 done · 32 remaining · 12 deferred** · **10 on the assembly frontier** (under construction, off the % axis).

Status tally: `assembling`&nbsp;10 · `blocked`&nbsp;12 · `blocked_pending_substrate`&nbsp;2 · `deferred`&nbsp;12 · `done`&nbsp;63 · `in_progress`&nbsp;8 · `open`&nbsp;7 · `partial`&nbsp;2 · `upstream_blocked`&nbsp;1
...
<tr style="border-bottom:1px solid #eaeef2"><td style="padding:6px 10px"><strong>Rule Apprehension</strong></td><td style="padding:6px 10px"><div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#bf8700;height:18px;width:61.1%"></div></div>&nbsp;<span style="color:#57606a">61%</span></td><td style="padding:6px 10px">13</td><td style="padding:6px 10px;color:#57606a">2026-08-01</td></tr>
<tr style="border-bottom:1px solid #eaeef2"><td style="padding:6px 10px"><strong>Behavioural Diversity Isolation</strong></td><td style="padding:6px 10px"><div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#1a7f37;height:18px;width:78.8%"></div></div>&nbsp;<span style="color:#57606a">79%</span></td><td style="padding:6px 10px">12</td><td style="padding:6px 10px;color:#57606a">2026-08-12</td></tr>
<tr style="border-bottom:1px solid #eaeef2"><td style="padding:6px 10px"><strong>Commitment / Closure / Mode-Governance</strong></td><td style="padding:6px 10px"><div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#1a7f37;height:18px;width:79.0%"></div></div>&nbsp;<span style="color:#57606a">79%</span></td><td style="padding:6px 10px">12</td><td style="padding:6px 10px;color:#57606a">2026-08-16</td></tr>
...
Cheap first proxy over the last **30 days** of commits across `REE_assembly` + `ree-v3` (4776 commits). Coarse, prefix-based, and judgment-laden by construction -- read the per-bucket tallies below, not just the headline.

- **Machine coordination data** (the doc's literal cheap proxy: `phase3*` / `igw-ledger` -- sync_daemon + IGW writers): **56%** of all commits (2658 / 4776). The source critique's ~60-77% estimate, live.
- **Governance-mass : cognitive-mass** (refinement -- machine coordination + human bookkeeping vs substrate builds; neutral tooling/docs excluded): **13 : 1** (governance 3281 : cognitive 254).

Bucket tally (both repos, window):

| bucket | commits | what it is |
|--------|--------:|------------|
| machine coordination | 2658 | `phase3*` result/queue/heartbeat writers + `igw-ledger` (automated) |
| human governance | 623 | registry, queue, governance cycles, reviews, closure/plan reconciles, autopsies, thought-intake, session-land |
| cognitive / substrate | 254 | `implement-substrate`, MECH/ARC/SD builds, `ree_core` code, substrate tests -- effort that (tries to) move a capability metric |
| neutral / other | 1241 | docs, explorer/serve, site, tooling (excluded from the ratio) |
...
- Registered claims (denominator): **1012**.
