...
_Generated 2026-08-15T05:03:57Z — regenerated every governance run; do not edit by hand._
...
<p style="font-size:1.6em;font-weight:600;margin:.2em 0">71.9%</p>

<div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#bf8700;height:18px;width:71.9%"></div></div>

94 non-deferred nodes across 17 plan(s) · **62 done · 32 remaining · 13 deferred** · **10 on the assembly frontier** (under construction, off the % axis).
...
<tr style="border-bottom:1px solid #eaeef2"><td style="padding:6px 10px"><strong>Behavioural Diversity Isolation</strong></td><td style="padding:6px 10px"><div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#1a7f37;height:18px;width:78.8%"></div></div>&nbsp;<span style="color:#57606a">79%</span></td><td style="padding:6px 10px">12</td><td style="padding:6px 10px;color:#57606a">2026-08-01</td></tr>
<tr style="border-bottom:1px solid #eaeef2"><td style="padding:6px 10px"><strong>Commitment / Closure / Mode-Governance</strong></td><td style="padding:6px 10px"><div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#1a7f37;height:18px;width:86.7%"></div></div>&nbsp;<span style="color:#57606a">87%</span></td><td style="padding:6px 10px">12</td><td style="padding:6px 10px;color:#57606a">2026-07-10</td></tr>
<tr style="border-bottom:1px solid #eaeef2"><td style="padding:6px 10px"><strong>Sleep Substrate</strong></td><td style="padding:6px 10px"><div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#1a7f37;height:18px;width:91.0%"></div></div>&nbsp;<span style="color:#57606a">91%</span></td><td style="padding:6px 10px">11</td><td style="padding:6px 10px;color:#57606a">2026-08-12</td></tr>
<tr style="border-bottom:1px solid #eaeef2"><td style="padding:6px 10px"><strong>Infant Substrate Expansion</strong></td><td style="padding:6px 10px"><div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#1a7f37;height:18px;width:91.2%"></div></div>&nbsp;<span style="color:#57606a">91%</span></td><td style="padding:6px 10px">17</td><td style="padding:6px 10px;color:#57606a">2026-05-30</td></tr>
...
Cheap first proxy over the last **30 days** of commits across `REE_assembly` + `ree-v3` (0 commits). Coarse, prefix-based, and judgment-laden by construction -- read the per-bucket tallies below, not just the headline.

- **Machine coordination data** (the doc's literal cheap proxy: `phase3*` / `igw-ledger` -- sync_daemon + IGW writers): **0%** of all commits (0 / 0). The source critique's ~60-77% estimate, live.
- **Governance-mass : cognitive-mass** (refinement -- machine coordination + human bookkeeping vs substrate builds; neutral tooling/docs excluded): **n/a (no cognitive-mass commits in window)** (governance 0 : cognitive 0).

Bucket tally (both repos, window):

| bucket | commits | what it is |
|--------|--------:|------------|
| machine coordination | 0 | `phase3*` result/queue/heartbeat writers + `igw-ledger` (automated) |
| human governance | 0 | registry, queue, governance cycles, reviews, closure/plan reconciles, autopsies, thought-intake, session-land |
| cognitive / substrate | 0 | `implement-substrate`, MECH/ARC/SD builds, `ree_core` code, substrate tests -- effort that (tries to) move a capability metric |
| neutral / other | 0 | docs, explorer/serve, site, tooling (excluded from the ratio) |
