...
_Generated 2026-08-28T07:13:56Z — regenerated every governance run; do not edit by hand._
...
<p style="font-size:1.6em;font-weight:600;margin:.2em 0">71.1%</p>

<div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#bf8700;height:18px;width:71.1%"></div></div>

97 non-deferred nodes across 17 plan(s) · **63 done · 34 remaining · 10 deferred** · **10 on the assembly frontier** (under construction, off the % axis).

Status tally: `assembling`&nbsp;10 · `blocked`&nbsp;14 · `blocked_pending_substrate`&nbsp;3 · `deferred`&nbsp;10 · `done`&nbsp;63 · `in_progress`&nbsp;8 · `open`&nbsp;6 · `partial`&nbsp;2 · `upstream_blocked`&nbsp;1
...
<tr style="border-bottom:1px solid #eaeef2"><td style="padding:6px 10px"><strong>Infant Substrate Expansion</strong></td><td style="padding:6px 10px"><div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#1a7f37;height:18px;width:91.2%"></div></div>&nbsp;<span style="color:#57606a">91%</span></td><td style="padding:6px 10px">17</td><td style="padding:6px 10px;color:#57606a">2026-07-21</td></tr>
...
_Plus 41 V4/V5 forward-roadmap plan(s), excluded from the V3 closure percentage._
...
Cheap first proxy over the last **30 days** of commits across `REE_assembly` + `ree-v3` (5969 commits). Coarse, prefix-based, and judgment-laden by construction -- read the per-bucket tallies below, not just the headline.

- **Machine coordination data** (the doc's literal cheap proxy: `phase3*` / `igw-ledger` -- sync_daemon + IGW writers): **65%** of all commits (3851 / 5969). The source critique's ~60-77% estimate, live.
- **Governance-mass : cognitive-mass** (refinement -- machine coordination + human bookkeeping vs substrate builds; neutral tooling/docs excluded): **25 : 1** (governance 4563 : cognitive 185).

Bucket tally (both repos, window):

| bucket | commits | what it is |
|--------|--------:|------------|
| machine coordination | 3851 | `phase3*` result/queue/heartbeat writers + `igw-ledger` (automated) |
| human governance | 712 | registry, queue, governance cycles, reviews, closure/plan reconciles, autopsies, thought-intake, session-land |
| cognitive / substrate | 185 | `implement-substrate`, MECH/ARC/SD builds, `ree_core` code, substrate tests -- effort that (tries to) move a capability metric |
| neutral / other | 1221 | docs, explorer/serve, site, tooling (excluded from the ratio) |
...
- Registered claims (denominator): **1064**.
