...
_Generated 2026-08-13T05:19:16Z — regenerated every governance run; do not edit by hand._
...
<p style="font-size:1.6em;font-weight:600;margin:.2em 0">76.0%</p>

<div style="background:#eaeef2;border-radius:5px;height:18px;width:100%;max-width:520px;overflow:hidden;display:inline-block;vertical-align:middle"><div style="background:#1a7f37;height:18px;width:76.0%"></div></div>

84 non-deferred nodes across 13 plan(s) · **58 done · 26 remaining · 13 deferred** · **10 on the assembly frontier** (under construction, off the % axis).
...
Cheap first proxy over the last **30 days** of commits across `REE_assembly` + `ree-v3` (4535 commits). Coarse, prefix-based, and judgment-laden by construction -- read the per-bucket tallies below, not just the headline.

- **Machine coordination data** (the doc's literal cheap proxy: `phase3*` / `igw-ledger` -- sync_daemon + IGW writers): **55%** of all commits (2511 / 4535). The source critique's ~60-77% estimate, live.
- **Governance-mass : cognitive-mass** (refinement -- machine coordination + human bookkeeping vs substrate builds; neutral tooling/docs excluded): **11 : 1** (governance 3139 : cognitive 283).
...
| human governance | 628 | registry, queue, governance cycles, reviews, closure/plan reconciles, autopsies, thought-intake, session-land |
...
| neutral / other | 1113 | docs, explorer/serve, site, tooling (excluded from the ratio) |
