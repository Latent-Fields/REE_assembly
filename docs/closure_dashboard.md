...
_Generated 2026-07-20T20:14:06Z — regenerated every governance run; do not edit by hand._
...
- **Machine coordination data** (the doc's literal cheap proxy: `phase3*` / `igw-ledger` -- sync_daemon + IGW writers): **61%** of all commits (1795 / 2941). The source critique's ~60-77% estimate, live.
- **Governance-mass : cognitive-mass** (refinement -- machine coordination + human bookkeeping vs substrate builds; neutral tooling/docs excluded): **14 : 1** (governance 2241 : cognitive 157).

Bucket tally (both repos, window):

| bucket | commits | what it is |
|--------|--------:|------------|
| machine coordination | 1795 | `phase3*` result/queue/heartbeat writers + `igw-ledger` (automated) |
| human governance | 446 | registry, queue, governance cycles, reviews, closure/plan reconciles, autopsies, thought-intake, session-land |
...
| neutral / other | 543 | docs, explorer/serve, site, tooling (excluded from the ratio) |
