...
- **Conceptual stack (ARC-043):** The Layer 0-12 ordering of REE's full architecture from epistemic ground through the learning loop. Layers 0-7 are the eight axioms (cannot be updated by experience); D1 and D2 are first derivations; Layer 8 is derived ethics; Layer 9 is REE itself; Layers 10-12 are actions, consequences, and learning. See `docs/architecture/five_axioms_foundations.md`.
- **Derived ethical objectives (INV-042):** The ten objectives that follow necessarily from the eight axioms plus first derivations: preserve minds; preserve future options; reduce unnecessary suffering; increase shared joy; maintain corrigibility; maintain truth-seeking; maintain the ability to love and be loved; maintain the shared world; maintain the possibility of future minds and future love; maintain honest communication. These are not design choices -- they are what the axioms jointly require.
