...
<!-- Home page body is owned + regenerated by scripts/generate_status_stubs.py (SHP-7); Generated: 2026-09-09T09:08:19Z. Edit the INDEX_BODY template in that script, not this file. apply_nav_frontmatter.py owns the frontmatter above. -->
  ...
  <section class="ree-hero" aria-labelledby="ree-title">
    ...
    <div class="ree-shell">
      ...
      <div class="ree-evidence-strip" role="group" aria-label="Programme evidence snapshot">
        ...
        <div class="ree-evidence-strip-item">
          <span class="ree-evidence-strip-value">2,955</span>
          <span class="ree-evidence-strip-label">logged experiment runs</span>
        </div>
        <div class="ree-evidence-strip-item">
          <span class="ree-evidence-strip-value">489</span>
          <span class="ree-evidence-strip-label">results recorded as weakening a claim</span>
          <span class="ree-evidence-strip-sub">of 6,059 linked evidence entries</span>
        </div>
      </div>
