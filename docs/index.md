...
<!-- Home page body is owned + regenerated by scripts/generate_status_stubs.py (SHP-7); Generated: 2026-09-08T07:15:51Z. Edit the INDEX_BODY template in that script, not this file. apply_nav_frontmatter.py owns the frontmatter above. -->
...
<div class="ree-home">
  <section class="ree-hero" aria-labelledby="ree-title">
    ...
    <div class="ree-shell">
      ...
      <div class="ree-evidence-strip" role="group" aria-label="Programme evidence snapshot">
        <div class="ree-evidence-strip-item">
          <span class="ree-evidence-strip-value">73%</span>
          <span class="ree-evidence-strip-label">v3 closure</span>
          <span class="ree-evidence-strip-sub">64 of 97 nodes complete</span>
        </div>
        <div class="ree-evidence-strip-item">
          <span class="ree-evidence-strip-value">228</span>
          <span class="ree-evidence-strip-label">claims with supporting experimental evidence</span>
          <span class="ree-evidence-strip-sub">each linked to at least one run that supports it</span>
        </div>
        <div class="ree-evidence-strip-item">
          <span class="ree-evidence-strip-value">2,946</span>
          <span class="ree-evidence-strip-label">logged experiment runs</span>
        </div>
        <div class="ree-evidence-strip-item">
          <span class="ree-evidence-strip-value">482</span>
          <span class="ree-evidence-strip-label">results recorded as weakening a claim</span>
          <span class="ree-evidence-strip-sub">of 5,947 linked evidence entries</span>
        </div>
      </div>
