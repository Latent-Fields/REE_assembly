...
8. For canonical `REE_assembly` docs and user-facing text, use REE-first wording with optional JEPA interface translation (`REE term (JEPA term)`) per `docs/notes/jepa_language_policy.md`.
