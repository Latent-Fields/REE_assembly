...
E2 supplies short-horizon predictions and affordances that seed hippocampal candidate generation. References below
to "E2 rollouts" should be read as implementation approximations unless hippocampal generation is explicitly modeled.
