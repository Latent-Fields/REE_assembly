...
**Depends On:** INV-011 (imagination without belief update), [E3](e3.md), [control plane](control_plane.md), [hippocampal systems](hippocampal_systems.md), [residue geometry](residue_geometry.md)  
**Status:** stable  
**Claim ID:** ARC-014
<a id="arc-014"></a>
...
<a id="mech-029"></a>
## Reflective / DMN Mode and Ethical Replay (MECH-029)
...
Cross-references
	•	Hippocampal systems: hippocampal_systems.md
	•	Latent stack: l_space.md
	•	Trajectory selection (E3): trajectory_selection.md
	•	Residue geometry: residue_geometry.md
	•	Offline reprojection / sleep: sleep.md
